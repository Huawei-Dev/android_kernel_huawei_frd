...
static void hi6403_headphone_pop_on(struct snd_soc_codec *codec)
{
	...
	snd_soc_write(codec, HI6403_ANALOG_REG52, 0x13);
...
static void hi6403_headphone_pop_off(struct snd_soc_codec *codec)
{
	...
	snd_soc_write(codec, HI6403_ANALOG_REG52, 0x1A);
	/* pop auto enable */
	//hi64xx_update_bits(codec, HI6403_ANALOG_REG47,
	//		1<<HI6403_HP_POP_AUTO_EN_BIT, 1<<HI6403_HP_POP_AUTO_EN_BIT);
	...
	hi64xx_update_bits(codec, HI6403_ANALOG_REG2,
			0x3<<HI6403_DAC_HPL_MUTE_BIT, 0x3<<HI6403_DAC_HPL_MUTE_BIT);
}
			...
			struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (4 == priv->voice_params.channels) {
			...
			hi64xx_update_bits(codec, HI6403_S4_PORT_CLKEN_REG, 1 << 3, 1 << 3);
		}
		...
		if (4 == priv->voice_params.channels)
			hi64xx_update_bits(codec, HI6403_S4_PORT_CLKEN_REG, 1 << 3, 0);
		break;
	case SND_SOC_DAPM_POST_PMD:
...
void hi6403_headphone_low_to_high_ib05_current_config(struct snd_soc_codec *codec)
{
	hi64xx_update_bits(codec, HI6403_ANALOG_REG73,
		0xF<<HI6403_IB05_HP_BIT, 0x5<<HI6403_IB05_HP_BIT);
	msleep(10);
	hi64xx_update_bits(codec, HI6403_ANALOG_REG73,
		0xF<<HI6403_IB05_HP_BIT, 0x6<<HI6403_IB05_HP_BIT);
	msleep(10);
	hi64xx_update_bits(codec, HI6403_ANALOG_REG73,
		0xF<<HI6403_IB05_HP_BIT, 0x7<<HI6403_IB05_HP_BIT);
	msleep(10);
	hi64xx_update_bits(codec, HI6403_ANALOG_REG73,
		0xF<<HI6403_IB05_HP_BIT, 0x8<<HI6403_IB05_HP_BIT);
	msleep(10);
	hi64xx_update_bits(codec, HI6403_ANALOG_REG73,
...
void hi6403_headphone_high_mode_shadow_config(struct snd_soc_codec *codec)
{
	...
	hi64xx_update_bits(codec, HI6403_ANALOG_REG38_SHADOW,
			0x1<<HI6403_DAC_HP_PLAN_SEL_BIT_SHADOW, 1<<HI6403_DAC_HP_PLAN_SEL_BIT_SHADOW);
	/* shadow headphone dac VB current select */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG38_SHADOW,
			0x3<<HI6403_DAC_HP_VBR_SEL_BIT_SHADOW, 0<<HI6403_DAC_HP_VBR_SEL_BIT_SHADOW);
	/* shadow headphone ICELL VB disable */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG38_SHADOW,
			0x1<<HI6403_DAC_HP_VBSWEN_BIT_SHADOW, 1<<HI6403_DAC_HP_VBSWEN_BIT_SHADOW);
	/* shadow headphone select SGND */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			1<<HI6403_HP_GND_CTR_BIT_SHADOW, 1<<HI6403_HP_GND_CTR_BIT_SHADOW);
	/* shadow headphone feed back enable */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			0x1<<HI6403_HP_FB_EN_BIT_SHADOW, 0x1<<HI6403_HP_FB_EN_BIT_SHADOW);
	/* shadow hp ibct current 10uA */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			0x3<<HI6403_HP_IBCT_BIT_SHADOW, 0x2<<HI6403_HP_IBCT_BIT_SHADOW);
	/* shadow headphone mode select high mode */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			0x1<<HI6403_HP_SRB_CTRL_BIT_SHADOW, 1<<HI6403_HP_SRB_CTRL_BIT_SHADOW);
	/* shadow headphone res select */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			0x7<<HI6403_HP_RES_CT_BIT_SHADOW, 0x3<<HI6403_HP_RES_CT_BIT_SHADOW);
	/* shadow headphone feed back ibct config */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG49_SHADOW,
			0x3<<HI6403_HP_FB_IBCT_BIT_SHADOW, 0x2<<HI6403_HP_FB_IBCT_BIT_SHADOW);
	/* shadow headphone feed back mode config */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG49_SHADOW,
			0x1<<HI6403_HP_FB_STB_CTRL_BIT_SHADOW, 1<<HI6403_HP_FB_STB_CTRL_BIT_SHADOW);
	/* shadow headphone feed back res config */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG49_SHADOW,
			0x7<<HI6403_HP_FB_RES_CT_BIT_SHADOW, 0x3<<HI6403_HP_FB_RES_CT_BIT_SHADOW);

	/* headphone VBR plan sel */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG38,
			0x1<<HI6403_DAC_HP_PLAN_SEL_BIT, 1<<HI6403_DAC_HP_PLAN_SEL_BIT);
	/* headphone dac VB current select */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG38,
			0x3<<HI6403_DAC_HP_VBR_SEL_BIT, 0<<HI6403_DAC_HP_VBR_SEL_BIT);
	/* headphone ICELL VB disable */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG38,
			0x1<<HI6403_DAC_HP_VBSWEN_BIT, 1<<HI6403_DAC_HP_VBSWEN_BIT);
	...
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48,
			0x3<<HI6403_HP_IBCT_BIT, 0x2<<HI6403_HP_IBCT_BIT);
	/* headphone mode select high mode */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48,
			0x1<<HI6403_HP_SRB_CTRL_BIT, 1<<HI6403_HP_SRB_CTRL_BIT);
	/* headphone res select */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48,
			0x7<<HI6403_HP_RES_CT_BIT, 0x3<<HI6403_HP_RES_CT_BIT);
	/* headphone feed back ibct config */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG49,
			0x3<<HI6403_HP_FB_IBCT_BIT, 0x2<<HI6403_HP_FB_IBCT_BIT);
	/* headphone feed back mode config */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG49,
			0x1<<HI6403_HP_FB_STB_CTRL_BIT, 1<<HI6403_HP_FB_STB_CTRL_BIT);
	/* headphone feed back res config */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG49,
			0x7<<HI6403_HP_FB_RES_CT_BIT, 0x3<<HI6403_HP_FB_RES_CT_BIT);
...
void hi6403_headphone_low_mode_shadow_config(struct snd_soc_codec *codec)
{
	...
	/* reg pga gain */
	snd_soc_write(codec, HI6403_CLASSH_CTRL4, 0x18);
	...
	/* shadow headphone dac VB current select */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG38_SHADOW,
			0x3<<HI6403_DAC_HP_VBR_SEL_BIT_SHADOW, 1<<HI6403_DAC_HP_VBR_SEL_BIT_SHADOW);
	/* shadow headphone ICELL VB disable */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG38_SHADOW,
			0x1<<HI6403_DAC_HP_VBSWEN_BIT_SHADOW, 1<<HI6403_DAC_HP_VBSWEN_BIT_SHADOW);
	/* shadow headphone select SGND */
	...
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			0x1<<HI6403_HP_FB_EN_BIT_SHADOW, 1<<HI6403_HP_FB_EN_BIT_SHADOW);
	/* shadow hp ibct current 10uA */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			0x3<<HI6403_HP_IBCT_BIT_SHADOW, 0x2<<HI6403_HP_IBCT_BIT_SHADOW);
	/* shadow headphone mode select low mode */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			0x1<<HI6403_HP_SRB_CTRL_BIT_SHADOW, 0<<HI6403_HP_SRB_CTRL_BIT_SHADOW);
	/* shadow headphone res select */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48_SHADOW,
			0x7<<HI6403_HP_RES_CT_BIT_SHADOW, 0x5<<HI6403_HP_RES_CT_BIT_SHADOW);
	...
	/* shadow headphone feed back mode config
	hi64xx_update_bits(codec, HI6403_ANALOG_REG49_SHADOW,
			0x1<<HI6403_HP_FB_STB_CTRL_BIT_SHADOW, 0<<HI6403_HP_FB_STB_CTRL_BIT_SHADOW);*/
	/* shadow headphone feed back res config
	hi64xx_update_bits(codec, HI6403_ANALOG_REG49_SHADOW,
			0x7<<HI6403_HP_FB_RES_CT_BIT_SHADOW, 0x5<<HI6403_HP_FB_RES_CT_BIT_SHADOW);*/
	...
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48,
			0x1<<HI6403_HP_FB_EN_BIT, 1<<HI6403_HP_FB_EN_BIT);
	/* hp ibct current 10uA */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48,
			0x3<<HI6403_HP_IBCT_BIT, 0x2<<HI6403_HP_IBCT_BIT);
	/* headphone mode select low mode */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG48,//dirrerent
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (true == priv->board_config.hp_high_low_change_enable) {
			...
			hi64xx_update_bits(codec, HI6403_PERF_SWITCH_CTRL8,
					0x1<<HI6403_PERF_TRIGGER_EN_BIT, 0x0<<HI6403_PERF_TRIGGER_EN_BIT);
			...
			hi64xx_update_bits(codec, HI6403_PERF_SWITCH_CTRL8,
					0x1<<HI6403_PERF_TRIGGER_EN_BIT, 0x1<<HI6403_PERF_TRIGGER_EN_BIT);
		}
		break;
...
void hi6403_headphone_resdet_config(struct snd_soc_codec *codec)
{
	...
	snd_soc_write(codec, HI6403_ANALOG_REG48, 0xEA);
	/* headphone 0x200070D2 config */
	snd_soc_write(codec, HI6403_ANALOG_REG49, 0x2A);
	/* hpl_fb off */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG43,
...
void hi6403_headphone_path_enable(struct snd_soc_codec *codec)
{
	...
	hi64xx_update_bits(codec, HI6403_PERF_SWITCH_CTRL8,
			0x1<<HI6403_PERF_SWITCH_EN_BIT, 0x0<<HI6403_PERF_SWITCH_EN_BIT);
...
void hi6403_headphone_path_disable(struct snd_soc_codec *codec)
{
	...
	if (true == priv->board_config.hp_high_low_change_enable) {
		...
		hi64xx_update_bits(codec, HI6403_PERF_SWITCH_CTRL8,
				0x1<<HI6403_PERF_SWITCH_EN_BIT, 0x1<<HI6403_PERF_SWITCH_EN_BIT);
	...
	hi64xx_update_bits(codec, HI6403_DACL_PGA_CFG_REG,
			0x1<<HI6403_DACL_PGA_FD_EN_BIT, 0x0<<HI6403_DACL_PGA_FD_EN_BIT);
	hi64xx_update_bits(codec, HI6403_DACR_PGA_CFG_REG,
			0x1<<HI6403_DACR_PGA_FD_EN_BIT, 0x0<<HI6403_DACR_PGA_FD_EN_BIT);*/
}
...
unsigned int hi6403_get_resvalue(struct snd_soc_codec *codec)
{
	...
	for (i = 0; i < HI6403_IMP_RES_NUM; i++) {
		...
		hi64xx_update_bits(codec, HI6403_ANALOG_REG50,
				0x7<<HI6403_DETRES_CHAIN_SEL_BIT, i<<HI6403_DETRES_CHAIN_SEL_BIT);
		/* reset imp */
		hi64xx_update_bits(codec, HI6403_ANALOG_REG50,
...
static void hi6403_mad_set_param(struct snd_soc_codec *codec)
{
	...
	snd_soc_write(codec, HI6403_MAD_BUFFER_CTRL0, 0xff);
	snd_soc_write(codec, HI6403_MAD_BUFFER_CTRL1, 0x1f);

	/* mad_cnt_thre,vad delay cnt */
	snd_soc_write(codec, HI6403_MAD_CNT_THRE, 0x4);

	/* mad_snr_thre */
	snd_soc_write(codec, HI6403_MAD_SNR_THRE_SUM, 0x55);
	snd_soc_write(codec, HI6403_MAD_SNR_THRE, 0x20);

	/* mad_min_chan_eng */
	snd_soc_write(codec, HI6403_MAD_MIN_CHAN_ENG, 0xa);
	/* mad_vad_num */
	...
	snd_soc_write(codec, HI6403_MAD_CTRL, 0x65);

	/* clear mad_src_fifo */
	snd_soc_write(codec, HI6403_MAD_SRCDN_CTRL, 0x8);
	snd_soc_write(codec, HI6403_MAD_SRCDN_CTRL, 0x0);
...
static void hi6403_init_chip(struct snd_soc_codec *codec)
{
	...
	hi64xx_update_bits(codec, HI6403_ANALOG_REG47,
			1<<HI6403_HP_POP_AUTO_EN_BIT, 1<<HI6403_HP_POP_AUTO_EN_BIT);
	hi64xx_update_bits(codec, HI6403_ANALOG_REG47,
			0x3<<HI6403_HP_POP_RAMP_SPD_CFG_BIT, 0x2<<HI6403_HP_POP_RAMP_SPD_CFG_BIT);
	/* pop clk power on */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG15,
			1<<HI6403_POP_CLK_PD_BIT, 0);
	/* pop clk rst */
	...
	/* valid config */
	hi64xx_update_bits(codec, HI6403_HPL_SDM45_CONFIG_REG0, 0xC8, 0x88);
	hi64xx_update_bits(codec, HI6403_HPR_SDM45_CONFIG_REG0, 0xC8, 0x88);
	hi64xx_update_bits(codec, HI6403_DACL_SDM45_MUX_SEL, 0xFC, 0x9C);
	hi64xx_update_bits(codec, HI6403_DACR_SDM45_MUX_SEL, 0xFC, 0x9C);
	...
	snd_soc_write(codec, HI6403_CODEC_ANA_RWREG_106, 0x32);
	/* buck2 p triode config */
	snd_soc_write(codec, HI6403_CODEC_ANA_RWREG_119, 0x32);
	/* buck2 ramp config */
	...
	/* cp1 Vout config */
	snd_soc_write(codec, HI6403_CODEC_ANA_RWREG_145, 0xC7);
	...
	/* buck2 config */
	snd_soc_write(codec, HI6403_CODEC_ANA_RWREG_135, 0x02);
	/* cp2 config */
	snd_soc_write(codec, HI6403_CODEC_ANA_RWREG_136, 0x02);
	/* buck1 pull down disable */
	hi64xx_update_bits(codec, HI6403_ANALOG_REG111, 0x80, 0x80);
	/* modify 0113 */
	//snd_soc_write(codec, HI6403_ANALOG_REG6, 0xFE); /* no need */
	snd_soc_write(codec, HI6403_HPL_SDM45_CONFIG_REG1, 0x08);
	snd_soc_write(codec, HI6403_HPL_SDM45_CONFIG_REG2, 0x82);
	snd_soc_write(codec, HI6403_HPL_SDM45_CONFIG_REG3, 0x9C);
	snd_soc_write(codec, HI6403_HPR_SDM45_CONFIG_REG1, 0x08);
	snd_soc_write(codec, HI6403_HPR_SDM45_CONFIG_REG2, 0x82);
	snd_soc_write(codec, HI6403_HPR_SDM45_CONFIG_REG3, 0x9C);
	snd_soc_write(codec, HI6403_CODEC_ANA_RWREG_80, 0x09);
	//hi64xx_update_bits(codec, HI6403_ANALOG_REG15, 0xFE, 0xFC); /* no need */
	...
	hi64xx_update_bits(codec, HI6403_ANALOG_REG15,
			0xF<<HI6403_MADPGA_CHOP_BPS_BIT, 0xF<<HI6403_MADPGA_CHOP_BPS_BIT);
	/* imp_det enable */
	hi64xx_update_bits(codec, HI6403_IMP_DET_CTRL_REG,
	...
	/* lutlb for earphone for hi6403es */
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG0, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG1, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG2, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG3, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG4, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG5, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG6, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG7, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG8, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG9, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG10, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG11, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG12, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG13, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG14, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG15, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG16, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG17, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG18, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG19, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG20, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG21, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG22, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG23, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG24, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG25, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG26, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG27, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG28, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG29, 0x37);
	snd_soc_write(codec, HI6403_LUT1B_CFG_REG30, 0x37);
