 ...
 */
#define MT_NORMAL           0
#define MT_NORMAL_CACHE     4
#define MT_NORMAL_NC        5
...
#define SMMU_PROT_DEVICE_nGnRE  (SMMU_PAGE_DEFAULT | SMMU_PTE_PXN | \
		SMMU_PTE_UXN | SMMU_PTE_ATTRINDX(MT_DEVICE_nGnRE))
#define SMMU_PROT_NORMAL_CACHE  (SMMU_PAGE_DEFAULT | SMMU_PTE_PXN | \
		SMMU_PTE_UXN | SMMU_PTE_ATTRINDX(MT_NORMAL_CACHE))
#define SMMU_PROT_NORMAL_NC     (SMMU_PAGE_DEFAULT | SMMU_PTE_PXN | \
		SMMU_PTE_UXN | SMMU_PTE_ATTRINDX(MT_NORMAL_NC))
#define SMMU_PROT_NORMAL        (SMMU_PAGE_DEFAULT | SMMU_PTE_PXN | \
		SMMU_PTE_UXN | SMMU_PTE_ATTRINDX(MT_NORMAL))
