...
AP_RECORD_ETR;
#define PANIC_INFO_OFFSET_BBOX 0x0
#define ETR_TRACE_OFFSET_BBOX 0x50
...
enum boot_stage_point
{
 ...
 STAGE_XLOADER_GET_FASTBOOTSIZE_FAIL = 12,
 STAGE_XLOADER_FASTBOOTSIZE_ERROR = 13,
 STAGE_XLOADER_VRL_CHECK_ERROR = 14,
 STAGE_XLOADER_SECURE_VERIFY_ERROR = 15,
 STAGE_XLOADER_END = 36,
 STAGE_FASTBOOT_START = 37,
 STAGE_FASTBOOT_EMMC_INIT_FAIL = 38,
 STAGE_FASTBOOT_EMMC_INIT_OK = 39,
 STAGE_FASTBOOT_LOADLPMCU_FAIL = 40,
 ...
 STAGE_END = 255,
 STAGE_BOOTUP_END = STAGE_KERNEL_BOOTANIM_COMPLETE,
};
enum himntnEnum
{
    HIMNTN_NVE_VALID = 0,
