...
#define GAS_OM_APPLY_TASK_LIST_MAX_NUM              (10)                        /* 申请资源的最大任务个数 */
...
enum OM_GAS_MSG_ID_ENUM
{
    ...
    ID_GAS_OM_RESEL_PUNISH_INFO                   = 0xA043,     /* _H2ASN_MsgChoice GAS_GCOM_RESEL_PUNISH_GSM_CELL_LIST_ST */
    ...
    ID_GAS_OM_EVENT_GSM_TO_UTRAN_TDD_FAST_RETURN_STATUS = 0xA118,   /* _H2ASN_MsgChoice GAS_OM_EVENT_GSM_TO_UTRAN_TDD_FAST_RETURN_STATUS_STRU */
...
enum GAS_OM_SEARCH_PROC_ENUM
{
    ...
    GAS_OM_SEARCH_PROC_G2G_BG_SRCH_HISOTRY_FREQ_SRCH       ,
    GAS_OM_SEARCH_PROC_G2G_BG_SRCH_CLOUD_FREQ_SRCH         ,
    GAS_OM_SEARCH_PROC_G2G_BG_SRCH_OPERATE_CUSTOM_FREQ_SRCH,
    GAS_OM_SEARCH_PROC_G2G_BG_SRCH_FULL_LIST_SRCH          ,
    GAS_OM_SEARCH_PROC_X2G_BG_SRCH_HISOTRY_FREQ_SRCH       ,
    GAS_OM_SEARCH_PROC_X2G_BG_SRCH_CLOUD_FREQ_SRCH         ,
    GAS_OM_SEARCH_PROC_X2G_BG_SRCH_OPERATE_CUSTOM_FREQ_SRCH,
    GAS_OM_SEARCH_PROC_X2G_BG_SRCH_PRESET_FREQ_BAND_SRCH   ,
    GAS_OM_SEARCH_PROC_X2G_BG_SRCH_FULL_LIST_SRCH          ,     
