...
/* MM发给AS的原语 */
    ...
    RRMM_CSG_BG_SEARCH_REQ             = 0x008C,   /* _H2ASN_MsgChoice RRMM_CSG_BG_SEARCH_REQ_STRU */

    RRMM_ABNORMAL_CLASS_NOTIFY         = 0x008E,   /* _H2ASN_MsgChoice RRMM_ABNORMAL_CLASS_NOTIFY_STRU */
    ...
    RRMM_CSG_BG_SEARCH_CNF              = 0x00A3,   /* _H2ASN_MsgChoice RRMM_CSG_BG_SEARCH_CNF_STRU */
...
enum RRC_PLMN_SEARCH_TYPE_ENUM
{
    ...
    RRC_PLMN_SEARCH_USER_LIST           = 1,                /* 非美国搜网定制的列表搜，可以是驻留态也可以是非驻留态 */
    ...
    RRC_PLMN_SEARCH_INTER_LIST          = 7,                /* 美国搜网定制驻留态的内部list搜索,使用FULL Band进行搜索 */
    RRC_PLMN_SEARCH_INTER_LIST_PREF_BAND= 8,                /* 美国搜网定制驻留态的内部list搜索,使用Prefer Band进行搜索 */
...
enum RRC_PLMN_SEARCH_RLT_ENUM
{
    ...
    RRC_PLMN_SEARCH_RLT_USER_LIST       = 1,                /* PLMN List搜索成功      */
    RRC_PLMN_SEARCH_RLT_SPEC_FAIL       = 2,                /* 指定PLMN ID搜索失败    */
    RRC_PLMN_SEARCH_RLT_USER_LIST_REJ   = 3,
    RRC_PLMN_SEARCH_RLT_USER_LIST_FAIL  = 4,                /* 处在D态和F态发生plmn list搜回的原因值 */

    RRC_PLMN_SEARCH_RLT_SPEC_NO_RF      = 5,                /* 指定搜资源申请失败 */
    RRC_PLMN_SEARCH_RLT_USER_LIST_NO_RF = 6,                /* list搜资源申请失败 */
    ...
    RRC_PLMN_SEARCH_RLT_INTER_LIST_SUCC  = 16,
    RRC_PLMN_SEARCH_RLT_INTER_LIST_FAIL  = 17,
    RRC_PLMN_SEARCH_RLT_INTER_LIST_NO_RF = 18,
    RRC_PLMN_SEARCH_RLT_INTER_LIST_REJ   = 19,
    
    RRC_PLMN_SEARCH_RLT_INTER_LIST_PREF_BAND_SUCC  = 20,
    RRC_PLMN_SEARCH_RLT_INTER_LIST_PREF_BAND_FAIL  = 21,
    RRC_PLMN_SEARCH_RLT_INTER_LIST_PREF_BAND_NO_RF = 22,
    RRC_PLMN_SEARCH_RLT_INTER_LIST_PREF_BAND_REJ   = 23,
...
{
    RRC_BG_SPEC_PLMN_SEARCH_RLT_SUCCESS            = 0,                /* 指定的PLMN搜索成功 */
    RRC_BG_SPEC_PLMN_SEARCH_RLT_FAIL               = 1,                /* 接入层实际给DSP发起了搜网，但是搜索失败 */
    RRC_BG_SPEC_PLMN_SEARCH_RLT_ABORT              = 2,                /* PLMN没有给DSP发起搜网，因为接入层当前状态不允许，搜索被终止 */
    RRC_BG_SPEC_PLMN_SEARCH_RLT_NO_RF              = 3,                /* BG SPEC搜网，rf资源不可用 */
    RRC_BG_HISTORY_PLMN_SEARCH_RLT_SUCCESS         = 4,                /* BG HISTORY搜网成功 */
    RRC_BG_HISTORY_PLMN_SEARCH_RLT_FAIL            = 5,                /* BG HISTORY搜网，接入层实际给DSP发起了搜网，但是搜索失败 */
    RRC_BG_HISTORY_PLMN_SEARCH_RLT_ABORT           = 6,                /* BG HISTORY搜网，PLMN没有给DSP发起搜网，因为接入层当前状态不允许，搜索被终止 */
    RRC_BG_HISTORY_PLMN_SEARCH_RLT_NO_RF           = 7,                /* BG HISTORY搜网，rf资源不可用 */
...
/*****************************************************************************
 枚举名: RRMM_BG_PLMN_TYPE_ENUM
 协议格式:
 ASN.1描述:
 枚举说明:
*****************************************************************************/
enum RRMM_BG_PLMN_TYPE_ENUM
{
    RRMM_BG_PLMN_SRCH_HISTORY   = 0,                /* 指定的PLMN的History搜索 */
    RRMM_BG_PLMN_SRCH_SPEC      = 1,                /* 指定的PLMN的全Band搜索   */
    RRMM_BG_PLMN_SRCH_BUTT
    
};
typedef VOS_UINT32 RRMM_BG_PLMN_TYPE_ENUM_UINT32;
/*******************************************************************************
...
typedef struct
{
    MSG_HEADER_STRU                     MsgHeader;          /* 消息头 */        /*_H2ASN_Skip*/
    VOS_UINT32                          ulPlmnIdNum;        /* PLMN ID个数 */
    RRC_PLMN_ID_STRU                    astPlmnIdList[RRC_MAX_EQUPLMN_NUM];       /* PlMN标识 */
    RRC_NAS_RAT_TYPE_ENUM_UINT32        enRat;              /* 支持的接入技术 */

    RRMM_BG_PLMN_TYPE_ENUM_UINT32       enBgType;           /*本次bg搜索类型 */
...
/*******************************************************************************
 结构名    : RRMM_CSG_BG_SEARCH_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : CSG 背景搜网请求
*******************************************************************************/
...
typedef struct
{
    ...
    /* CSG BG成功时，该项携带搜索成功的CSG ID网络信息，
       CSG BG搜索失败时，该项携带存在的CSG ID网络信息 */
    VOS_UINT8                           ucPlmnCsgIdNum;
    RRMM_PLMN_CSG_ID_WITH_RAT_STRU      astPlmnCsgIdWithRatList[RRC_NAS_MAX_PLMN_CSG_ID_NUM];
}RRMM_CSG_BG_SEARCH_CNF_STRU;
...
enum RRMM_ABNORMAL_CLASS_ENUM
{
    RRMM_ABNORMAL_CLASS_CC_NORMAL_EVENT                      = 1,            /*   1. normal event, cc cause range 0~31 */
    RRMM_ABNORMAL_CLASS_CC_RESOURCE_UNAVAILABLE              = 2,            /*   2. resource unavailable, cc cause range 32~47 */
    RRMM_ABNORMAL_CLASS_CC_SERVICE_OR_OPTION_NOT_AVAILABLE   = 3,            /*   3. service or option not available, cc cause range 48~63 */
    RRMM_ABNORMAL_CLASS_CC_SERVICE_OR_OPTION_NOT_IMPLEMENTED = 4,            /*   4. service or option not implemented, cc cause range 64~79 */
    RRMM_ABNORMAL_CLASS_CC_INVALID_MESSAGE                   = 5,            /*   5. invalid message, cc cause range 80~95 */
    RRMM_ABNORMAL_CLASS_CC_PROTOCOL_ERROR                    = 6,            /*   6. protocol error, cc cause range 86~111 */
    RRMM_ABNORMAL_CLASS_CC_INTERWORKING                      = 7,            /*   7. interworking, cc cause range 112~127 */
    RRMM_ABNORMAL_CLASS_BUTT
};
typedef VOS_UINT8   RRMM_ABNORMAL_CLASS_ENUM_UINT8;


typedef struct
{
    MSG_HEADER_STRU                     MsgHeader;          /* 消息头    */     /*_H2ASN_Skip*/
    RRMM_ABNORMAL_CLASS_ENUM_UINT8      enClass;            /* 异常类型  */
	VOS_UINT8                           ucAbnormalCount;    /* 异常次数  */
    VOS_UINT8                           aucReserve[2];
}RRMM_ABNORMAL_CLASS_NOTIFY_STRU;
