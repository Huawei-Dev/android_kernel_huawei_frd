...
enum LRRC_GRR_MSG_TYPE_ENUM
{
    ...
    ID_LRRC_GRR_BG_PLMN_SEARCH_CSG_IND         = (LRRC_GRR_MSG_HDR + 0x2a),     /* _H2ASN_MsgChoice LRRC_GRR_BG_PLMN_SEARCH_CSG_IND_STRU */
    ID_LRRC_GRR_SEARCHED_PLMN_INFO_IND         = (LRRC_GRR_MSG_HDR + 0x2b),     /* _H2ASN_MsgChoice LRRC_GRR_SEARCHED_PLMN_INFO_IND_STRU */
    ID_GRR_LRRC_SEARCHED_PLMN_INFO_IND         = (GRR_LRRC_MSG_HDR + 0x2c),     /* _H2ASN_MsgChoice GRR_LRRC_SEARCHED_PLMN_INFO_IND_STRU */
    ID_LRRC_GRR_MSG_TYPE_BUTT                  = (GRR_LRRC_MSG_HDR + 0x3f)
...
typedef struct
{
    ...
    LRRC_GURRC_BG_PLMN_ID_LIST_STRU                         stBgPlmnIdList;     /* plmn id列表 */
...
typedef struct
{
    ...
    LRRC_GURRC_CSG_ID_INFO_STRU                 stCsgId;                        /* CSG信息结构 */
...
/*****************************************************************************
 结构名    :    LRRC_GRR_BG_PLMN_SEARCH_CSG_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :   LRRC指示GRR执行背景搜索CSG的结果
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
    LRRC_GRR_MSG_TYPE_ENUM_UINT32                           enMsgId;            /*_H2ASN_Skip*/
    LRRC_GURRC_BG_SEARCH_RESULT_ENUM_UINT16                 enRslt;
    LRRC_GURRC_SEARCH_TYPE_ENUM_UINT8                       enSearchType;       /* CSG 背景还是LIST */
    VOS_UINT8                                               aucRsv1[1];

    LRRC_GURRC_BG_PLMN_WITH_CSG_ID_LIST_STRU                stPlmnWithCsgIdList;
}LRRC_GRR_BG_PLMN_SEARCH_CSG_IND_STRU;
...
typedef struct
{
    ...
    LRRC_GURRC_PLMN_RAT_WITH_LAC_STRU       astPlmnWithLacList[LRRC_GURRC_MAX_AVAILPLMN_NUM];   /* 上报结构 */
}LRRC_GRR_SEARCHED_PLMN_INFO_IND_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                              ulAvailPlmnNum;     /* 上报PLMN个数 */
    LRRC_GURRC_PLMN_RAT_WITH_LAC_STRU       astPlmnWithLacList[LRRC_GURRC_MAX_AVAILPLMN_NUM];   /* 上报结构 */
}GRR_LRRC_SEARCHED_PLMN_INFO_IND_STRU;
