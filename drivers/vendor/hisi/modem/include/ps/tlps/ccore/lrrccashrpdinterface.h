...
#define CAS_LRRC_HRPD_BSR_MAX_PLMN_NUM                      ( 16 )
...
/** ****************************************************************************
 * Name        : CAS_LRRC_HRPD_BSR_TYPE_ENUM_UINT8
 *
 * Description :
 *******************************************************************************/
enum CAS_LRRC_HRPD_BSR_TYPE_ENUM
{
    CAS_LRRC_HRPD_BSR_TYPE_HISTORY         = 0x00,
    CAS_LRRC_HRPD_BSR_TYPE_PREF_BAND       = 0x01,
    CAS_LRRC_HRPD_BSR_TYPE_ENUM_BUTT       = 0x02
};
typedef VOS_UINT8 CAS_LRRC_HRPD_BSR_TYPE_ENUM_UINT8;
...
enum CAS_LRRC_HRPD_CONNECTED_MEAS_RESULT_ENUM
{
    ...
    CAS_LRRC_HRPD_CONNECTED_MEAS_RESULT_TIMING_NOT_PRESENT  = 0x00000002,
    CAS_LRRC_HRPD_CONNECTED_MEAS_RESULT_ENUM_BUTT           = 0x00000003
};
...
enum CAS_LRRC_HRPD_IDLE_MEAS_RESULT_ENUM
{
    ...
    CAS_LRRC_HRPD_IDLE_MEAS_RESULT_TIMING_NOT_PRESENT       = 0x00000002,
    CAS_LRRC_HRPD_IDLE_MEAS_RESULT_ENUM_BUTT                = 0x00000003
};
...
enum CAS_LRRC_HRPD_IDLE_RESEL_RESULT_ENUM
{
    ...
    CAS_LRRC_HRPD_IDLE_RESEL_RESULT_FREQ_AVOID              = 0x00000002,
    CAS_LRRC_HRPD_IDLE_RESEL_RESULT_NOT_ASSN                = 0x00000003,
    CAS_LRRC_HRPD_IDLE_RESEL_RESULT_ENUM_BUTT               = 0x00000004
};
...
enum LRRC_CAS_HRPD_IDLE_RESEL_RESULT_ENUM
{
    ...
    LRRC_CAS_HRPD_IDLE_RESEL_RESULT_NOT_EPLMNS              = 0x04,
    LRRC_CAS_HRPD_IDLE_RESEL_RESULT_ACCESS_FAIL             = 0x05,
    LRRC_CAS_HRPD_IDLE_RESEL_RESULT_FAIL                    = 0x06,
    LRRC_CAS_HRPD_IDLE_RESEL_RESULT_ENUM_BUTT               = 0x07
};
...
typedef struct
{
    ...
    LRRCCASHRPDINTERFACE_MSG_TYPE_ENUM_UINT16               enMsgId;
    VOS_UINT16                                              usOpId;
    CAS_LRRC_HRPD_BSR_TYPE_ENUM_UINT8                       enBsrType;
    VOS_UINT8                                               ucPlmnNum;
    VOS_UINT8                                               aucRsv[2];
    LRRC_CAS_HRPD_PLMN_INFO_STRU                            astPlmnList[CAS_LRRC_HRPD_BSR_MAX_PLMN_NUM];
