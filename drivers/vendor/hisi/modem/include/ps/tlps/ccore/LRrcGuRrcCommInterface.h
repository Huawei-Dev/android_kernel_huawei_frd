...
#define LRRC_GURRC_MAX_PLMN_CSG_ID_NUM                      (35)
#define LRRC_GURRC_MAX_HOME_NODEB_NAME_LEN                  (48)
/* 从模bg搜或者list搜上报plmn的最大个数 */
#define LRRC_GURRC_MAX_AVAILPLMN_NUM                        (18)
#define LRRC_GURRC_MAX_BG_PLMN_NUM                          (16)

#define LRRC_GURRC_LAC_INVALID_VALUE                        (0xFFFF)                 /* LRRC和GU之间LAC无效值 */
...
{
    LRRC_GURRC_SEARCH_TYPE_BG_SPEC                 = 0,             /* 通知做背景搜 */
    LRRC_GURRC_SEARCH_TYPE_PLMN_USER_LIST             ,             /* 通知做PLMN LIST搜  */
    LRRC_GURRC_SEARCH_TYPE_BG_HIGH_RAT           ,                              /* 高优先级背景搜 */
    LRRC_GURRC_SEARCH_TYPE_BG_CSG_SPEC           ,                              /* BG指定PLMN搜索 */
    LRRC_GURRC_SEARCH_TYPE_CSG_LIST              ,                              /* CSG ID列表搜索 */
    LRRC_GURRC_SEARCH_TYPE_BG_HISTORY                 ,             /* 进行背景历史搜索 */
    LRRC_GURRC_SEARCH_TYPE_PLMN_INTER_LIST            ,             /*内部list搜索 */
    LRRC_GURRC_SEARCH_TYPE_PLMN_INTER_LIST_PREFER_BAND,             /*内部list搜索使用prefer band */
...
typedef struct
{
    ...
    LRRC_GURRC_PLMN_ID_INFO_STRU                            astPlmnId[LRRC_GURRC_MAX_BG_PLMN_NUM];
}LRRC_GURRC_BG_PLMN_ID_LIST_STRU;


typedef struct
{
    LRRC_GURRC_PLMN_ID_INFO_STRU                            stPlmnId;           /* PLMN ID结构 */

    VOS_UINT32                                              ulCsgIdNum;         /* CSG ID个数 */
    VOS_UINT32                                              aulCsgId[LRRC_GURRC_MAX_PLMN_CSG_ID_NUM];   /* CSG ID列表 */
}LRRC_GURRC_CSG_ID_INFO_STRU;
...
/*******************************************************************************
 结构名    : LRRC_GURRC_BG_PLMN_CSG_ID_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : Plmn带CSG ID的结构
*******************************************************************************/
typedef struct
{
    LRRC_GURRC_PLMN_ID_INFO_STRU        stPlmnId;
    VOS_UINT32                          ulCsgId;
}LRRC_GURRC_BG_PLMN_CSG_ID_STRU;

/*******************************************************************************
 结构名    : LRRC_GURRC_BG_CSG_ID_HOME_NODEB_NAME_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : HomeNodeBName的结构
*******************************************************************************/
typedef struct
{
    VOS_UINT8                           ucHomeNodeBNameLen;
    VOS_UINT8                           aucReserved[3];
    VOS_UINT8                           aucHomeNodeBName[LRRC_GURRC_MAX_HOME_NODEB_NAME_LEN];
}LRRC_GURRC_BG_CSG_ID_HOME_NODEB_NAME_STRU;

/*****************************************************************************
 结构名    : LRRC_GURRC_BG_PLMN_WITH_CSG_ID_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : PLMN带CSG ID和HomeNodeBName数据结构
*****************************************************************************/
typedef struct
{
    LRRC_GURRC_BG_PLMN_CSG_ID_STRU               stPlmnCsgIdWithRat;
    LRRC_GURRC_BG_CSG_ID_HOME_NODEB_NAME_STRU    stHomeNodeBName;
    VOS_INT32                                    lRscp;                         /* RSCP测量值 */
}LRRC_GURRC_BG_PLMN_WITH_CSG_ID_STRU;

/*****************************************************************************
 结构名    : LRRC_GURRC_BG_PLMN_WITH_CSG_ID_LIST_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : CSG回复列表数据结构
*****************************************************************************/
typedef struct
{
    ...
    /* PLMN列表 */
    LRRC_GURRC_BG_PLMN_WITH_CSG_ID_STRU          astPlmnWithCsgIdList[LRRC_GURRC_MAX_PLMN_CSG_ID_NUM];

}LRRC_GURRC_BG_PLMN_WITH_CSG_ID_LIST_STRU;

/*****************************************************************************
 结构名    : LRRC_GURRC_REDIR_SAVED_EUTRA_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 从模背景搜plmn上报,从模上报给主模，由主模上报给nas
*****************************************************************************/
typedef struct
{
    LRRC_GURRC_PLMN_ID_INFO_STRU    stPlmn;
    VOS_UINT16                      usLac;    /* 位置区信息,如果没有位置信息，填0xffff*/
    VOS_UINT8                       aucReserved[2];
}LRRC_GURRC_PLMN_RAT_WITH_LAC_STRU;
