...
{
    LPP_MTA_AGNSS_ASSIST_PROCESS_SUCC   = 0,        /* 处理成功 */
    LPP_MTA_AGNSS_ERROR_ENCODE_ERROR    = 1,        /* 编码失败 */
...
typedef struct
{
    ...
    VOS_UINT32                                      ulSessionId;    /*当前sessionID,暂不使用 */
    VOS_UINT32                                      bitAgnssInfo:1; /* 对应GnssReqLocationInfo */
...
typedef struct
{
    ...
    LPP_MTA_GNSS_BAD_SIGNAL_ELEMENT_STRU        astGNSSBadSignalListArray[LPP_MAX_GNSS_SAT_CNT];
...
typedef struct
{
    ...
    */
    ...
    LOC_COM_ELLIPSOID_POINT_WITH_ALTITUDE_AND_UNCERTAINTY_ELLIPSOID_STRU      stThreeDlocation;
...
typedef struct
{
    ...
    */
    ...
    LPP_PRS_BAND_WITH_ENUM_UINT8            enPrsBandWidth;
    VOS_UINT8                               aucRsv[3];
...
typedef struct
{
    ...
    VOS_UINT8       ucRes[3];
    VOS_UINT8       aucClockModelIDList[LPP_MAX_CLOCK_MODEL_ID_PRELIST_LEN];
...
typedef struct
{
    ...
    VOS_UINT8       ucRes[3];
    VOS_UINT8       aucOrbitModelIDList[LPP_MAX_ORBIT_MODEL_ID_PREFLIST_LEN];
