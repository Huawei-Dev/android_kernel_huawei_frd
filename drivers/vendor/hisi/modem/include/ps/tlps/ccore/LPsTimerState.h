...
typedef VOS_UINT32 RRC_TIME_STATUS_ENUM_UINT32;
/*****************************************************************************
...
//#endif
    ...
    TI_RRC_PTL_CSG_IDLE_ASF,                /* IDLE ASF定时器 */
    TI_RRC_PTL_CSG_IDLE_ADD_MEASURE,        /* IDLE ASF CSG附加测量定时器 */
    TI_LRRC_LCMM_CONN_ASF,
    TI_LRRC_LCMM_PROXI_LEAVE,
    TI_RRC_M_PAGING_VALID_TIMER,
