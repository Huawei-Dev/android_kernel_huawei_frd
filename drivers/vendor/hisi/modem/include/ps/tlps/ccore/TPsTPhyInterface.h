...
enum
{
      /*TPS-->TPhy Request  Begin*/
        ...
        /* DSDS2.0 begin */
        ID_TRRC_TPHY_SUSPEND_IND,       /* DSDS2.0短抢时通知挂起DSP */
        ID_TRRC_TPHY_RESUME_IND,        /* DSDS2.0短抢时通知解挂DSP */
        /* DSDS2.0 end */
...
/* DSDS2.0 begin */
/*****************************************************************************
 结构名    : TRRC_TPHY_SUSPEND_IND_STRU
 协议表格  : rrc和Phy之间的接口 ,DSDS2.0 仅PS业务发生短抢时通知挂起DSP
 ASN.1描述 :
 结构说明  : TRRC_TPHY_SUSPEND_IND_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
...
}TRRC_TPHY_SUSPEND_IND_STRU;

/*****************************************************************************
 结构名    : TRRC_TPHY_RESUME_IND_STRU
 协议表格  : rrc和Phy之间的接口 ,DSDS2.0 仅PS业务发生短抢恢复后通知解挂DSP
 ASN.1描述 :
 结构说明  : TRRC_TPHY_RESUME_IND_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
