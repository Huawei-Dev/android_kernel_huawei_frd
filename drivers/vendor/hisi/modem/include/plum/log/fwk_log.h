...
/**
 * Log data max value,4K.
 */
#define LOG_DATA_MAX_VALUE     (4000)
...
#define CPROC_LOG_EventInfo(enEventId)                     \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_INFO,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
                              0,                           \
                              0,                           \
...
#define CPROC_LOG_EventInfo1(enEventId,uwInfo1)            \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_INFO,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventInfo2(enEventId,uwInfo1,uwInfo2)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_INFO,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventInfo3(enEventId,uwInfo1,uwInfo2,uwInfo3)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_INFO,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventInfo4(enEventId,uwInfo1,uwInfo2,uwInfo3,uwInfo4)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_INFO,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventInfo5(enEventId,uwInfo1,uwInfo2,uwInfo3,uwInfo4,uwInfo5) \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_INFO,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventWarning(enEventId)                     \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_WARNING,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
                              0,                           \
                              0,                           \
...
#define CPROC_LOG_EventWarning1(enEventId,uwInfo1)            \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_WARNING,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventWarning2(enEventId,uwInfo1,uwInfo2)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_WARNING,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventWarning3(enEventId,uwInfo1,uwInfo2,uwInfo3)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_WARNING,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventWarning4(enEventId,uwInfo1,uwInfo2,uwInfo3,uwInfo4)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_WARNING,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventWarning5(enEventId,uwInfo1,uwInfo2,uwInfo3,uwInfo4,uwInfo5) \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_WARNING,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventError(enEventId)                     \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_ERROR,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
                              0,                           \
                              0,                           \
...
#define CPROC_LOG_EventError1(enEventId,uwInfo1)            \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_ERROR,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventError2(enEventId,uwInfo1,uwInfo2)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_ERROR,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventError3(enEventId,uwInfo1,uwInfo2,uwInfo3)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_ERROR,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventError4(enEventId,uwInfo1,uwInfo2,uwInfo3,uwInfo4)    \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_ERROR,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
#define CPROC_LOG_EventError5(enEventId,uwInfo1,uwInfo2,uwInfo3,uwInfo4,uwInfo5) \
    CPROC_1X_LOG_COMMON_EVENT(enEventId,                   \
                              CPROC_LOG_EVENT_LEVEL_ERROR,  \
                              FILE_IDENTIFYER,             \
                              __LINE__,                    \
...
VOS_VOID CPROC_1X_LogFunction(UPHY_TOOL_MNTN_RPT_LEVEL_ENUM_UINT16 enLevel,
                              ...
                              VOS_UINT32 uwValue3,
                              VOS_UINT32 uwValue4);
VOS_VOID CPROC_1X_LogEventFunction(
                VOS_UINT32              ulPid,
                VOS_UINT16              usEventId,
                VOS_UINT32              ulTmpLen,
                VOS_VOID                *pstEvent);

VOS_VOID CPROC_LOG_EVENT_NOW(CPROC_COMMON_EVENT_ID_ENUM_UINT16  enEventId,
                             VOS_UINT32 ulValue0,
                             VOS_UINT32 ulValue1);


VOS_VOID CPROC_1X_LOG_COMMON_EVENT(CPROC_COMMON_EVENT_ID_ENUM_UINT16  enEventId,
...
VOS_VOID CPROC_Log_Event_Timer_Register(VOS_UINT32 ulTimeStamp,
                                        VOS_UINT16 enCdmaMode,
                                        VOS_UINT16 enPeriod,
                                        VOS_INT32  swTimeShift,
                                        VOS_UINT32 pfCallBack);

VOS_VOID CPROC_Log_Event_Timer_CallBack(VOS_UINT32 ulTimeStamp,
                                        VOS_UINT32 pfCallBack);

VOS_VOID CPROC_Log_Event_Timer_Release(VOS_UINT32 ulTimeStamp,
                                       VOS_UINT32 pfCallBack);

VOS_VOID CPROC_Log_Event_1xTimerPrint(VOS_UINT32       ulValue1,
                                      VOS_UINT32       ulValue2,
                                      VOS_UINT32       ulValue3,
                                      VOS_UINT32       ulValue4);

VOS_VOID Cproc_Log_Event_HrpdTimerPrint(VOS_UINT32       ulValue1,
                                        VOS_UINT32       ulValue2,
                                        VOS_UINT32       ulValue3,
                                        VOS_UINT32       ulValue4);

VOS_VOID CPROC_LOG_EVENT_TriggerReportIn10ms( VOS_VOID );
