...
enum TAF_CALL_VOLTE_EMC_REDIAL_TYPE_ENUM
{
    TAF_CALL_VOLTE_EMC_REDIAL_TYPE_NO_NEED,                                     /* 不需要进行重拨 */
    TAF_CALL_VOLTE_EMC_REDIAL_TYPE_NEED_TO_IMS,                                 /* 需要在IMS域重拨 */
    TAF_CALL_VOLTE_EMC_REDIAL_TYPE_NEED_TO_CS,                                  /* 需要在CS域重拨 */
    TAF_CALL_VOLTE_EMC_REDIAL_TYPE_BUTT
};
typedef VOS_UINT8 TAF_CALL_VOLTE_EMC_REDIAL_TYPE_UINT8;
...
typedef struct
{
    ...
    TAF_CALL_VOLTE_EMC_REDIAL_TYPE_UINT8   enVolteEmcRedialType;                /* VOLTE EMC的重拨类型 */
    VOS_UINT8                           aucReserved[2];
...
typedef struct
{
    ...
    VOS_UINT8                           ucVolteEmcRedialFlg;                     /* 紧急呼叫CS域失败后IMS域尝试标记 */
