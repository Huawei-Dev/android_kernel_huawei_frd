...
enum CSDR1XSM_MSG_TYPE_ENUM
{
    ...
    ID_CPROC_CSDR_1X_BUFFER_STOP_REQ                        = 0x00B4, /**< @sa CPROC_CSDR_1X_BUFFER_STOP_REQ_STRU */
    ID_CSDR_CPROC_1X_BUFFER_STOP_CNF                        = 0x00B5, /**< @sa CSDR_CPROC_1X_BUFFER_STOP_CNF_STRU */
    ID_CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ            = 0x00B6, /**< @sa CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ_STRU */
    ID_CSDR1XSM_MSG_TYPE_ENUM_BUTT                          = 0x00B7
};
...
enum CSDR_1X_MPS_TYPE_ENUM
{
    ...
    CSDR_1X_MPS_TYPE_ONE_SHOT_CS        = 0x0002,
...
/** ****************************************************************************
 * Name        : CSDR_1X_CONTINUOUS_MPSIND_MODE_ENUM_UINT16
 *
 * Description :
 *******************************************************************************/
enum CSDR_1X_CONTINUOUS_MPSIND_MODE_ENUM
{
    CSDR_1X_MPSIND_SLOTTED_MODE         = 0x0000,
    CSDR_1X_MPSIND_NORMAL_MODE          = 0x0001,
    CSDR_1X_CONTINUOUS_MPSIND_MODE_ENUM_BUTT= 0x0002
};
typedef PHY_UINT16 CSDR_1X_CONTINUOUS_MPSIND_MODE_ENUM_UINT16;
...
typedef struct
{
    ...
    PHY_UINT16                          uhwRsv;                                  /**< 32 bit aligned */
...
typedef struct
{
    ...
    PHY_UINT32                          auwWindowPosition[CSDR_1X_MAX_ANTENNAS_NUM];     /**< Tail of the search window. Unit: 1/4 chip.The diversity and main use the same WindowPostion .This parameter depending on main antenna */
 ...
 *
 * enContMpsIndMode is  valid  only when enMPSType =continuous,
 * When CPROC_1X in slotted mode,set  enContMpsIndMode
 * CSDR_1X_MPSIND_SLOTTED_MODE,When CSDR_1X_MPSIND_SLOTTED_MODE,the max number
 * MPS cell is 3 including AGPS cell.
 * When not in Slotted Mode Continuous MPS,CPROC_1X setenContMpsIndMode 
 * CSDR_1X_MPSIND_NORMAL_MODE , ,the max number MPS cell is 6.
 * When in CSDR_1X_MPSIND_SLOTTED_MODE,the CSDR_1X report MPSIND frequecy is
 * every   CEIL(3/stMpsPNList.uhwPnNum) rounds of CBBP result.
 * that is
 * uhwPnNum  CSDR_1X do rounds    report period
 * 1                                        3                      about 15ms
 * 2                                        2                      about  20ms
 * 3                                         1                     about  15ms
 *
 * When in CSDR_1X_MPSIND_NORMAL_MODE ,the CSDR_1X report MPSIND frequecy is
 * every   CEIL6/stMpsPNList.uhwPnNum) rounds of CBBP result.
 * uhwPnNum  CSDR_1X do rounds    report period
 * 1                                        6                      about 30ms
 * 2                                        3                      about 30ms
 * 3                                        2                     about  30ms
...
typedef struct
{
    ...
    PHY_UINT16                                              uhwOpId;
    PHY_UINT16                                              uhwActionTime;       /**< In PCG or CSDR_1X_ACTIVATE_AT_ONCE */
    PHY_UINT16                                              uhwUnitNum;          /**< 1 or 2 the Unitnum used in Main Ant */
    PHY_UINT16                                              uhwDiversityUnitNum; /**< the UnitNum used in Diversity,when support diversity, set uhwDiversityUnitNum 1 in spite of  diversity close or open. */
    PHY_UINT16                                              uhwWindowSize;       /**< 96: after sleep. 48: otherwise */
    CSDR_1X_MPS_TYPE_ENUM_UINT16                            enMPSType;           /**< one shot or continuous */
    CSDR_1X_ANTENNA_IND_ENUM_UINT16                         enUseAntenna;
    CSDR_1X_CONTINUOUS_MPSIND_MODE_ENUM_UINT16              enContMpsIndMode;
    PHY_UINT16                                              uhwRsv;              /**< 32 bit align */
...
typedef struct
{
    ...
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;
    PHY_UINT16                          uhwOpId;
    PHY_INT16                           shwFreqRssi;                                 /**< -880..0, resolution 0.125dBm. Measured RSSI on the frequency,from main Antenna */
    ...
    PHY_INT16                           shwAsTotalEc;                                /**< -1080..-8, resolution 1/8dB, CSDR_1X_MEAS_VALUE_NOT_INCLUDED. Total Ec of the Active set ,from main Antenna */
    ...
    PHY_UINT32                          uwFramePos;                                  /**< the base cnt of Frame head 0..512*64*16-1 resolution 1/16chip for AGPS,depending on main anntenna */
    PHY_INT16                           shwAverageRscpT1;                            /**< -1080..-8, resolution 1/8dB Average RSCP for TAS, filtered over T1,only report main antenna */
    PHY_INT16                           shwAverageRscpT2;                            /**< -1080..-8, resolution 1/8dB Average RSCP for TAS, filtered over T2,only report main antenna */
...
typedef struct
{
    ...
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;
    PHY_UINT16                          uhwOpId;
    CSDR_1X_ANTENNA_IND_ENUM_UINT16     enUseAntenna; /**< Main and diversity antenna used or  Main anntena used .When enUseAntenna is main antenna ,if  diversity is  working,CSDR_1X shall close CBBP unit being used by diversity */
    PHY_UINT16                          uhwRsv;       /**< 32 bit aligned */
    CSDR_1X_MPS_PN_LIST_STRU            stMpsPNList;
...
/** ****************************************************************************
 * Name        : CPROC_CSDR_1X_BUFFER_STOP_REQ_STRU
 *
 * Description : CPROC_CSDR_1X_BUFFER_STOP_REQ is sent from CPROC to CSDR to
 * stop ongoing buffering of measurement samples. The signal carries no
 * parameters.
 *******************************************************************************/
typedef struct
{
    ...
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;
    PHY_UINT16                          uhwOpId;
} CPROC_CSDR_1X_BUFFER_STOP_REQ_STRU;

/** ****************************************************************************
 * Name        : CSDR_CPROC_1X_BUFFER_STOP_CNF_STRU
 *
 * Description : CSDR_CPROC_1X_BUFFER_STOP_CNF is sent from CSDR to CPROC as a
 * response to CPROC_CSDR_1X_BUFFER_STOP_REQ when buffering of measurement
 * samples has stopped. It carries no parameters.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;
    PHY_UINT16                          uhwOpId;
} CSDR_CPROC_1X_BUFFER_STOP_CNF_STRU;

/** ****************************************************************************
 * Name        : CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ_STRU
 *
 * Description : CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ with FAIL is used to
 * notify CSDR that
 * the current blind HO measure fails more than 3 times .CSDR_1X will do AFC
 * UNLOCK measurement as follow.
 * CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ with SUCC is used to notify CSDR
 * that
 * the current blind HO measure success only when CPROC sent
 * CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ with FAIL before;The CSDR_1X will
 * reset AFC.
 * But after CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ with FAIL, CPROC don't
 * make sure that CPROC will always send
 * CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ with SUCC(Maybe RELEASE_ALL).
 * This signal has no cnf and ind,and only solved the special scenaro in DTS .
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;
    PHY_UINT16                          uhwOpId;
    CSDR_1X_SUCCESS_ENUM_UINT16         enResult;     /**< blind HO measure result */
    PHY_UINT16                          uhwReserved1; /**< 32 bit aligned */
} CPROC_CSDR_1X_SM_BLIND_HO_MEAS_RESULT_REQ_STRU;
