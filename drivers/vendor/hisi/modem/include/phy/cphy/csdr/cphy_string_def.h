...
#define STRING_CSDR_HRPD_TIMING_ADJUST_TIMING_LTE_INFO4                 "HTIMNG|I| CSDR_HRPD_TIMING_AdjustTimingFromLteInfo uwSlaveBasecntDiff is %d, swLteHrpdTimingDiffInLteChip is %d, uhwSysTimingDiffInLteChip is %d, uw32kTiming is %d "
...
#define STRING_CSDR_HRPD_TIMING_ADJUST_TIME_QUICK_INFO                  "HTIMNG|I| CSDR_HRPD_TIMING_AdjustTimingQuick FrameHead %d"

#define STRING_CSDR_HRPD_TIMING_ADJUST_TIME_QUICK_WRN                   "HTIMNG|W| CSDR_HRPD_TIMING_AdjustTimingQuick state is not invalid. State is:%d, FrameHead %d"
...
#define STRING_CSDR_HRPD_TIMING_QUICK_PROCESS_SWITCHQTRSLOT_INFO        "HTIMNG|I| CSDR_HRPD_TIMING quick switchslot: %d TotalNumQtrSlot:%d"
#define STRING_CSDR_HRPD_TIMING_QUICK_PROCESS_FINISH_INFO               "HTIMNG|I| CSDR_HRPD_TIMING quick time process finish"
#define STRING_CSDR_HRPD_TIMING_DRX_STATUS_ERROR                        "HTIMNG|E| CSDR_HRPD_TIMING_InitTimingStatusDrx, Timing Adjust Status is %d"

/*****************************************************************************
  csdr_hrpd_eq.c
*****************************************************************************/
#define STRING_CSDR_HRPD_EQ_EQUALIER_ERROR              "HEQ   |E| CSDR_HRPD_EQ_EqualizerProcess AGC data error! uwCurrHalfSlot:%d uwWinHeadPos:%d uwAgcDataBaseCnt:%d "
...
#define STRING_CSDR_HRPD_DEC_MAC_INDEX_INFO             "HDEC  |I| UE mac index = %d, FTC_MU contains mac index = %d"
...
#define STRING_CSDR_HRPD_CM_SET_MODE_ERROR01                "HCM   |E| CSDR_HRPD_CM_SetModeCtrl, Slave not keep the timing!!!! workmode: %d KeepTimingFlag %d"
#define STRING_CSDR_HRPD_CM_SET_MODE_ERROR02                "HCM   |E| CSDR_HRPD_CM_SetModeCtrl, cm setmode error!!!! mode: %d KeepTimingFlag %d"
...
#define STRING_CSDR_HRPD_CM_SLAVE_CONFIG_FE_INFO            "HCM   [I] CSDR_HRPD_CM_ConfigFeForSlave enLteOverCMode: %d, uhwBandClass: %d, uhwFreq: %d, swSlaveAfcPpm: %d enQtrTimeCnt:%d"
...
#define STRING_CSDR_HRPD_CM_INT1_GAP_ERR                    "HCM   [E] CSDR_HRPD_CM_ProcSlaveInt1EnterGap, can't open rf!! pstRxOn->enRcvMsgFlag:%d, enSlaveMeasStartFlag:%d enFEMode:%d"
...
#define STRING_CSDR_HRPD_CM_INT1_CONFLICT_ERR               "HCM   |E| CSDR_HRPD_CM_RxOnConfig, current RF belong to 1X, enFEMode: %d "
...
#define STRING_CSDR_HRPD_CM_LTE_OVERC_MODE_ERROR            "HCM   |I| enLteOverCMode is %d"
...
#define STRING_CSDR_HRPD_FTC_JUDGE_CE_START_NO_FINGER   "HFTC  |I|  CSDR_HRPD_FTC_JudgeCeStart CE Mps No Finger"
...
#define STRING_CSDR_HRPD_FTC_DRC_UPDATE_2               "HFTC  |I|  CSDR_HRPD_FTC_DRCMaintain DRC Update R. SlotCount[%d], R_DRC[%d], CM_DRC[%d], DRCLength[%d],enDRCGatingEnabled[%d]"
...
#define STRING_CSDR_HRPD_DEMOD_GET_FEITF_DATA_ERROR     "HDEMOD|E| CSDR_HRPD_DEMOD_GetFeItfDataAddr Get Feitf Data Failure!! PilotEarliestFinger:%d uwLSRCEarliestFinger:%d auwBaseCnt:%d CurQtrSlot:%d"
...
#define STRING_CSDR_HRPD_APC_CALC_TCH_PHR               "HAPC |W| CSDR_HRPD_APC_CalcTchPowerHeadroom, warning: uwMaxPowSum = %u, uwPowSum = %u"
...
#define STRING_CSDR_HRPD_SMC_CS_UNITNUM_ERROR       "HSMC  |E| CSDR_HRPD_SMC_InitCsStartCfg the CS UnitNum is not satisfied! The UnitNum is %d"
...
#define STRING_CSDR_HRPD_SMC_MPS_START_WRN          "HSMC  |W| CSDR_HRPD_SMC_MpsCfgMaster MpsType warning! the MpsType is %d"
#define STRING_CSDR_HRPD_SMC_MPS_START_ERR01        "HSMC  |E| CSDR_HRPD_SMC_MPSFsmStart hrpd mode error! the enHrpdMode is %d"
#define STRING_CSDR_HRPD_SMC_MPS_START_ERR02        "HSMC  |E| CSDR_HRPD_SMC_MpsCfgSlave mps config error! the enErrCode is %d"
...
#define STRING_CSDR_HRPD_SMC_MPS_PNNUM_ERROR        "HSMC  |E| CSDR_HRPD_SMC_MpsCfgMaster the MpsPnNum is error! the MpsPnNum is %d"
...
#define STRING_CSDR_HRPD_SMC_IRAT_RFCFG_ERROR       "HSMC  |E| CSDR_HRPD_SMC_SlaveMeasRFCfgNowHandle, Recv rxon(now) out of gap! can't process meas! CurrentEvent:%d,MeasFsmState:%d"
...
#define STRING_CSDR_HRPD_INTERRAT_GAPEND_GAP_OUT_INFO               "HSMC  |E| CSDR_HRPD_INTERRAT_ResetGapEnd stop gap on the outside of gap!!!!. uwTimeDiff:%d,uwGapLength:%d,uwGapEndTime:%d,uwCurrentTime:%d"
...
#define STRING_CSDR_HRPD_INTERRAT_INT0_FE_RX_ON_ERR                 "HSMC  |E| CSDR_HRPD_INTERRAT_Int0PreGap 1X or DO FE is On, FE Mode is %d, enLteOverCMode %d InterRatStatus %d"
#define STRING_CSDR_HRPD_INTERRAT_INT0_STATE_ERR                 "HSMC  |E| CSDR_HRPD_INTERRAT_Int0PreGap InterRatStatus error!! InterRatStatus %d"
#define STRING_CSDR_HRPD_INTERRAT_MASTER_MODE_RX_CHAN_ERR           "HSMC  |E| UCOM_CTU_CheckChnMasterMode master mode %d expected %d RX channel is error"
#define STRING_CSDR_HRPD_INTERRAT_MASTER_MODE_TX_CHAN_ERR           "HSMC  |E| UCOM_CTU_CheckChnMasterMode master mode %d expected %d TX channel is error"
#define STRING_CSDR_HRPD_INTERRAT_SLAVE_MODE_RX_CHAN_ERR            "HSMC  |E| UCOM_CTU_CheckChnSlaveMode slave mode %d RX channel is error"
#define STRING_CSDR_HRPD_INTERRAT_INT2_FE_RX_ON_ERR                 "HSMC  |E| CSDR_HRPD_INTERRAT_Int2ExitGap 1X or DO FE is not On, FE Mode is %d"
...
#define STRING_CSDR_HRPD_SMC_INT0_HANDLE_ERR01              "HMEAS [E] CSDR_HRPD_SMC_SLAVE_Int0EventHandle int0 can't come in enMeasFsmState: %d"
#define STRING_CSDR_HRPD_SMC_INT0_HANDLE_ERR02              "HMEAS [E] CSDR_HRPD_SMC_SLAVE_Int0EventHandle SlaveMeas is not ready when int0 come in enMeasFsmState: %d"
#define STRING_CSDR_HRPD_SMC_SLAVE_PREHANDLE_ERR02          "HMEAS [E] CSDR_HRPD_SMC_SLAVE_PreMeasHandle State error when recv ID_INTRACSDR_HRPDCM_HRPDSM_SLAVE_MEAS_PRE_HANDLE_IND !!! enMeasFsmState: %d"
...
#define STRING_CSDR_HRPD_SMC_INT2_ERROR02                   "HMEAS |I| CSDR_HRPD_SLAVE_MEAS_Int2EventHandle, can't handle int2! GapPurpose:%d, Int0Flag:%d"
...
#define STRING_CSDR_HRPD_SMC_INT4_ERROR02                   "HMEAS |I| CSDR_HRPD_SLAVE_MEAS_Int4EventHandle, can't handle int4! GapPurpose:%d, Int0Flag:%d"
...
#define STRING_CSDR_HRPD_SMC_RF_READY_WAR01                 "HMEAS [W] CSDR_HRPD_SLAVE_MEAS_RfReadyEventHandle Freq not match; FE Freq:%d, MeasFreq:%d"
...
#define STRING_CSDR_HRPD_SMC_RF_READY_INFO                      "HMPS |I| CSDR_HRPD_SMC_TriggerMeasRfReadyEvent RF Ready!! 80msBaseCntHeader:%d meas: uwBufferWindow %d, uhwPNOffset %d, uhwDataOffset %d, uwWindowPosition %d "
...
#define STRING_CSDR_HRPD_SMC_SLAVE_MEAS_MSG_REV_INFO       "HMEAS [I] Judge whether receive the rxon meas and int1, the Judgement is %d"
...
#define STRING_CSDR_HRPD_MASTER_SLEEP_CONDITION_INFO            "HDRX  |I| CSDR_HRPD_DRX_JudgeMasterSleepPermit: sleep status:%d,mbx busy flag:%d,Mbx Ready:%d,1x state:%d,Hrpd Task:%d"
#define STRING_CSDR_HRPD_SLAVE_SLEEP_CONDITION_INFO             "HDRX  |I| CSDR_HRPD_DRX_JudgeSlaveSleepPermit: Set Mode Result:%d,Mbx State Ready:%d,Lphy Meas Flag:%d,Agps Done:%d,Task Status:%d,Keep Timing:%d"
...
#define STRING_CSDR_RESMNG_DMA_RELEASE_ERROR        "RESMNG|E| dma release fail, dmaChannel:%d"
...
*****************************************************************************/
#define STRING_CSDR_HRPD_CTU_GET_LTE_TIMING_ERROR           "HCTU|E| UCOM_CTU_GetCsdrBasecntCtuTiming, Get LTE Timing Failed, BBPCOMM_TIMING_GET_IND2_ADDR:%d, BBPCOMM_TIMING_VALID2_ADDR:%d"
...
#define STRING_CSDR_DRX_BASECNT_INFO                        "HTIMNG|I| CSDR_HRPD_QuickDrx basecnt info NumOf80ms %d,wNumOf26p67ms %d,NumOfChip %d,preframepos %d,presyscnt %d"
...
#define STRING_CSDR_TIMING_DECODE_OVER_CONSTRAINT_ERROR     "HTIMNG|E| Decoding Ends Too Late: Qtr3IntrpCycCnt is %d, DecodeEndCycCnt is %d, Totoal duration is %d"
...
#define STRING_CSDR_HRPD_FTC_DRCCOVER_WAIT_UPLINK_INFO      "HFTC |I| CSDR_HRPD_FTC_DRCCoverWaitForUplinkTarget Harq Finish:%d, Maintain Drccover:%d, Current slotcnt:%d"

#define STRING_CSDR_HRPD_CM_START_CCH_FLAG_INFO1            "HCM|I| CSDR_HRPD_CM_StartCtrlChannel TimeReference flag is valid "

#define STRING_CSDR_HRPD_FTC_TCH_STOP_IN_MAINTAIN           "HFTC |I| CSDR_HRPD_CM_StopTchFChannel, rcv tch stop doing handoff flow, target cell PNOffset: %d"
#define STRING_CSDR_HRPD_TIMING_ADJUST_TIMING_SLAVE_INFO    "HTIMNG|I| STRING_CSDR_HRPD_TIMING_ADJUST_TIMING_SLAVE_INFO uwChip is %d, uwSlot is %d, uwSfn is %d, uw32kTiming is %d, uwDiffBasecnt is %d "

#define STRING_CSDR_HRPD_SLAVE_NO_TIMING_FLAG_INFO          "HSMC|I| No slave timing flag is false, can't handle int:[%d]"
#define STRING_CSDR_HRPD_GET_SLAVE_TIMING_INT1_WARNING      "HSMC|W| CSDR_HRPD_GET_SLAVE_TIMING_Int1EnterGapProc, can't handle int1! GapPurpose:%d,Int0Flag:%d"
#define STRING_CSDR_HRPD_SMC_SLAVE_MPS_REQ_INFO             "HSMC|I| CSDR_HRPD_SMC_MpsCfgReqHandle, do not handle this mps_req. HrpdMode:%d, GapState:%d"
#define STRING_CSDR_HRPD_SMC_SLAVE_PILOT_SEARCH_REQ_INFO    "HSMC|I| CSDR_HRPD_SMC_PilotSearchReqHandle, do not handle this pilot_search_req. HrpdMode:%d, GapState:%d"
#define STRING_CSDR_HRPD_SMC_SLAVE_CC_START_REQ_INFO        "HCM|I| CSDR_HRPD_CM_CCStartReqHandle, do not handle this cc_start_req. HrpdMode:%d, GapState:%d"
#define STRING_CSDR_HRPD_SMC_GET_SLAVE_TIMING_INVALID_GAP_INFO  "HSMC|I| CSDR_HRPD_SMC_ConfigDataStore, GAP is not long enough to do pilot search"
#define STRING_CSDR_HRPD_SMC_GET_SLAVE_TIMING_CS_INT2OR4_INFO   "HSMC|I| CSDR_HRPD_SMC_CS_Int2Or4ProcEntry, current enGetSlaveTimingActiveFlag:%d, enSlaveState:%d"
#define STRING_CSDR_HRPD_SMC_GET_SLAVE_TIMING_MPS_INT2OR4_INFO  "HSMC|I| CSDR_HRPD_SMC_MPS_Int2Or4ProcEntry, current enGetSlaveTimingActiveFlag:%d, enSlaveState:%d"
#define STRING_CSDR_HRPD_INTERRAT_STOP_BEFORE_INT0_INFO         "HSMC  |I| CSDR_HRPD_INTERRAT_WaitForInt0StateInt4Handle int1-now < protected timer, will stop gap after int0 come. uwDistanceINT0 %d"

#define STRING_CSDR_HRPD_FTC_UPDATE_ARQ_IN_GAP_INFO         "HFTC  |I| UpdateArqInfoInGap ParqIndex %d ParqResult %d CurSlotCnt %d ArqPacketID %d"
#define STRING_CSDR_HRPD_CM_GAP_WORK_AROUND_INFO            "HCM|I| gap start @ %d end @ %d, not send %d DSCLength"
#define STRING_CSDR_HRPD_RTC_GAP_WORK_AROUND_INFO           "HRTC|I| uwNumOfDscLengthNotSend %d"
#define STRING_CSDR_HRPD_CTU_RECV_INT_RF_ERROR             "HCTU|E| CDMA INT: Recv INT from LTE. int:[%d], rf status error! enFEMode:%d, PreRxOffFlag:%d"
#define STRING_CSDR_HRPD_INT2_TIMER_EXPIRE_INFO             "HCM|I| CDMA hrpd int2 timer expire"
#define STRING_CSDR_FEITF_CALC_DATA_ADDR_ERROR3             "CFEITF|E| CSDR_FEITF_CalcAntDataAddr Error!!  input chip:%d input chip tail:%d current head:%d current tail:%d"
#define STRING_CSDR_HRPD_INTERRAT_DRX_INFO                  "HSMC  |I| SETUP DrxTask: %d, Value: %d"

#define STRING_CSDR_HRPD_FTC_JUDGE_HARQ_FINISH_3            "HFTC |I| EcNt info for CRC Error MacIndex:%d PreambleStartHalfSlot:%d PreambleEnergy:%d DRCValue:%d EcNtCur:%d EcNtDownLimit:%d"


#define STRING_CSDR_HRPD_MEAS_JUDGE_IDLE_DRX_TRAIN_MODE     "HMEAS |I| CSDR_HRPD_MEAS_JudgeIdleTrainMode, enHSTrain:%d, uhwCMCurrentState:%d"

#define STRING_CSDR_HRPD_CM_SET_NUM_OF_NEW_FRAME_NOT_SENT   "HCM   |I| CSDR_HRPD_CM_SetNumOfNewFrameNotSent Suspend @ %d Resume @ %d, not send %d SubFrame"
#define STRING_CSDR_HRPD_FTC_SLOT_BUFF_UPDATE_IN_SUSPEND    "HFTC  |I| CSDR_HRPD_FTC_SlotBuffUpdateInSuspend Mailbox PacketID %d"
#define STRING_CSDR_HRPD_RTC_SUBTYPE2_SCHEDULE_TCH_ENC      "HRTC  |I| CSDR_HRPD_RTC_Subtype2ScheduleTchEnc uwNumOfNewFrameNotSend %d"
#define STRING_CSDR_HRPD_RTC_SUBTYPE2_INIT_HARQ_INFO        "HRTC  |I| CSDR_HRPD_RTC_Subtype2InitHarqInfo uwNumOfNewFrameNotSend %d"
#define STRING_CSDR_HRPD_PARQ_RESOLUTION_INFO               "HMAC|I| CSDR_HRPD_MAC_ParqResolution  uhwNumOfCellInAS %d, uhwCellLoop %d, swSoftValue %d, uwNoiseFactor %d, auwCellNoise %d, enHardBit %d"
#define STRING_CSDR_HRPD_CM_SLAVE_LEFT_TIMER_ERR            "HCM   [E] CSDR_HRPD_CM_SlaveCalcLeftGapTime ullCurrentTimeAll High 32bit: %d, ullCurrentTimeAll low 32bit: %d, ullInt2Time High 32bit: %d, ullInt2Time low 32bit: %d"
#define STRING_CSDR_HRPD_CM_SLAVE_GAP_TIMER_INFO            "HCM   [I] CSDR_HRPD_CM_ConfigFeForSlave  Gap not enough uwTimeLength High32:%d, uwTimeLength Low32:%d, uwGapLength High32:%d, uwGapLength Low32:%d"
#define STRING_CSDR_HRPD_CTU_PRINT_INT10_ERROR              "HCTU|E| UCOM_CTU_CsdrPrintInt10Reg: uwSendInt10Reg:%d, uwRecvInt10Reg:%d."
#define STRING_CSDR_HRPD_SLAVE_MEAS_SHORT_FLAG_TIME_INFO    "HSMC |I| CSDR_HRPD_SMC_SendMeasInd, INT1:%d, FEStable:%d, StoreFinish:%d, MeasFinish:%d"
#define STRING_CSDR_HRPD_SLAVE_MEAS_SHORT_FLAG_TIME_DELTA   "HSMC |I| CSDR_HRPD_SMC_SendMeasInd, INT1ToFEStable:%d, FEStableToStoreFinish:%d, StoreFinishToMeasFinish:%d"
#define STRING_CSDR_HRPD_SLAVE_MEAS_FE_STABLE_TIME_ERROR    "HSLAVEMEAS |E| CSDR_HRPD_SLAVE_MEAS_CheckTimeOfFEStable, qtr slot num of FE Stable is error, current qtr slot is %d"

#define STRING_CSDR_HRPD_RPC_RESOLUTION_INFO1               "HMAC|I| CSDR_HRPD_MAC_RpcResolution Scell Force Rpc 0 uhwServingCellIdx %d, uhwCellLoop %d"

#define STRING_CSDR_HRPD_RPC_RESOLUTION_INFO2               "HMAC|I| CSDR_HRPD_MAC_RpcResolution Ncell Force Rpc 0 uhwServingCellIdx %d, uhwCellLoop %d"

#define STRING_CSDR_HRPD_RTC_SUBTYPE2_INIT_HARQ_INFO1       "HRTC  |I| CSDR_HRPD_RTC_Subtype2InitHarqInfo In Silence"
#define STRING_CSDR_HRPD_RTC_SUBTYPE2_SCHEDULE_TCH_ENC1     "HRTC  |I| CSDR_HRPD_RTC_Subtype2ScheduleTchEnc enDataType is not new frame! BufferIndex is %d, enDataType is %d"

#define STRING_CSDR_HRPD_CM_DYNAMIC_FAIL_ERROR            "HCM  |E| 1x EXIST, DO dynamic fail"

#define STRING_CSDR_HRPD_CM_SUSPEND_TCH_R_CHANNEL_INFO      "HCM|I| CSDR_HRPD_CM_SuspendTchRChannel, Resume time is too short, Last Suspend time @ %d, Current time @ %d "


#define STRING_CSDR_HRPD_AFC_lockAccAlg1                    "HAFC   |I| shwLockAcc48Re %d, shwLockAcc48Im %d, shwLockAcc96Re %d, shwLockAcc96Im %d, swSmoothRe  %d"
#define STRING_CSDR_HRPD_AFC_lockAccAlg2                    "HAFC   |I| shwStateAcc48Re  %d, shwStateAcc48Im  %d, swSIRAverage  %d, shwSIRLockJudge  %d,  AfcLockInd  %d, AfcState %d"

#define STRING_CSDR_HRPD_DRC_LEN_MISMATCH_UPDATE            "HCM |I| DRC Lenght Mismatch curDrcLen %d newDrcLen %d AnConfiguredDrcLen %d"

#define STRING_CSDR_HRPD_SU_DOUBLE_DET_INFO                 "HFTC |I| su cmp det info detectedDrc %d bothDrc %x absNormLong %d absNormShort %d energyLong %d energyShort %d"

#define STRING_CSDR_HRPD_SMC_MPS_DISCARD_EDMA_INT           "HSMC |E| Wrong EDMA INT Discarded"
#endif
