...
/** ****************************************************************************
 * Name        : CSDR_HRPD_ACK_EXIST_ENUM_UINT16
 *
 * Description : it is used to indicate report a  ACK if HLPARQ is ACK
 *******************************************************************************/
enum CSDR_HRPD_ACK_EXIST_ENUM
{
    CSDR_HRPD_ACK_NO_EXIST              = 0x0000, /**< no ACK is report in this slot */
    CSDR_HRPD_ACK_EXIST                 = 0x0001, /**< ACK is report in this slot */
    CSDR_HRPD_ACK_EXIST_BUTT            = 0x0002
};
typedef VOS_UINT16 CSDR_HRPD_ACK_EXIST_ENUM_UINT16;
...
/** ****************************************************************************
 * Name        : CSDR_HRPD_HARQ_ACK_INFO_STRU
 *
 * Description : the HLARQ info
 *******************************************************************************/
typedef struct
{
    CSDR_HRPD_ACK_EXIST_ENUM_UINT16                         enFlag;           /**< EXIST---- report ACK info,  NO EXIST-----no report */
    VOS_UINT16                                              usAckPacketId;    /**< the PacketId related to this ACK */
    VOS_UINT16                                              usProcessId;      /**< the ProcessId related to this ACK */
    CSDR_HRPD_SUBPACKET_TYPE_ENUM_UINT16                    enAckSubPacketId; /**< the SubPacketId related to this ACK */
} CSDR_HRPD_HARQ_ACK_INFO_STRU;
...
typedef struct
{
    ...
    CSDR_HRPD_HARQ_ACK_INFO_STRU        stHarqAckInfo;                                           /**< the ACK info */
    VOS_UINT16                          usMailBoxPacketID;                                       /**< ID used to match mailbox packet */
    CSDR_HRPD_ARQ_TYPE_ENUM_UINT16      enMailBoxPacketArqType;                                  /**< NO_ARQ, ACK, NAK corresponds to mailbox packets */
