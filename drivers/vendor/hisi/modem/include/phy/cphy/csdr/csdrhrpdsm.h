...
enum CSDRHRPDSM_MSG_TYPE_ENUM
{
    ...
    ID_CSDR_CPROC_HRPD_MEAS_BUF_FINISH_IND                  = 0x4112, /**< @sa CSDR_CPROC_HRPD_MEAS_BUF_FINISH_IND_STRU */
    ID_CSDR_CPROC_HRPD_SLAVE_TIMING_IND                     = 0x4113, /**< @sa CSDR_CPROC_HRPD_SLAVE_TIMING_IND_STRU */
    ID_CSDRHRPDSM_MSG_TYPE_ENUM_BUTT                        = 0x4114
};
...
enum CSDR_HRPD_MPS_STOP_REASON_ENUM
{
    ...
    CSDR_HRPD_MPS_STOP_REASON_MASTER                        = 0x0003, /**< STOP by master when receive int2 or int4 */
    CSDR_HRPD_MPS_STOP_REASON_BUTT                          = 0x0004
};
...
enum CSDR_HRPD_STOP_REASON_ENUM
{
    ...
    CSDR_HRPD_STOP_REASON_IN_GAP        = 0x0004, /**< CSDR stopped measurements in gap */
    CSDR_HRPD_STOP_REASON_BUTT          = 0x0005
};
...
typedef struct
{
    ...
    PHY_UINT16                                              uhwQuickFlag;      /**< 0----normal  1-----quick mode, only for evdo only */
...
/** ****************************************************************************
 * Name        : CSDR_CPROC_HRPD_MEAS_BUF_FINISH_IND_STRU
 *
 * Description : it is used to indicate meas buffer is finished in DRX
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    CSDRHRPDSM_MSG_TYPE_ENUM_UINT16     enMsgId;
    PHY_UINT16                          uhwOpId;
} CSDR_CPROC_HRPD_MEAS_BUF_FINISH_IND_STRU;

/** ****************************************************************************
 * Name        : CSDR_CPROC_HRPD_SLAVE_TIMING_IND_STRU
 *
 * Description : CPROC_CSDR_HRPD_SLAVE_TIMING_IND informs CPROC that CSDR is
 * ready for timing.
 * CPROC calls the interface function to awake LPHY at received it.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    CSDRHRPDSM_MSG_TYPE_ENUM_UINT16     enMsgId;
    PHY_UINT16                          uhwOpId;
} CSDR_CPROC_HRPD_SLAVE_TIMING_IND_STRU;
