...
typedef struct
{
    ...
    VOS_UINT16                                  usBuffAccessEnable;   /* CSDR write and CTTF read,
                                                                       0: CTTF can not access data buffer;
                                                                       1: CTTF can access data buff */
    VOS_UINT16                                  usBuffConfigEnable;  /* CTTF write and CSDR read,
                                                                       0: CTTF will not access data buffer and CSDR can power down;
                                                                       1: CTTF will access data buff and CSDR can not power down */
