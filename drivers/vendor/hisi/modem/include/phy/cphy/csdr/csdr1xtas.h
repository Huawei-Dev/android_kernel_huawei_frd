...
/** ****************************************************************************
 * Name        : CSDR_1X_DPDT_OCCUPY_ENUM_UINT16
 *
 * Description : CSDR_1X_DPDT_OCCUPY_ENUM_UINT16 tells if CSDR needs to occupy
 * the DPDT switch before switching or not.
 *******************************************************************************/
enum CSDR_1X_DPDT_OCCUPY_ENUM
{
    CSDR_1X_DPDT_OCCUPY_NO_NEED         = 0x0000,
    CSDR_1X_DPDT_OCCUPY_NEED            = 0x0001,
    CSDR_1X_DPDT_OCCUPY_DO_NOT_CARE     = 0x0002,
    CSDR_1X_DPDT_OCCUPY_ENUM_BUTT       = 0x0003
};
typedef PHY_UINT16 CSDR_1X_DPDT_OCCUPY_ENUM_UINT16;
...
typedef struct
{
    ...
    CSDR_1X_DPDT_OCCUPY_ENUM_UINT16     enNeedOccupy;
