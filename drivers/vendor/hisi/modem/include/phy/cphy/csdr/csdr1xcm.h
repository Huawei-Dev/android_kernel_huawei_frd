...
enum CSDR1XCM_MSG_TYPE_ENUM
{
    ...
    ID_CPROC_CSDR_1X_TRAFFIC_INFO_REQ                       = 0x006E, /**< @sa CPROC_CSDR_1X_TRAFFIC_INFO_REQ_STRU */
    ID_CSDR_CPROC_1X_VE_MODE_IND                            = 0x006F, /**< @sa CSDR_CPROC_1X_VE_MODE_IND_STRU */
    ID_CPROC_CSDR_1X_WAKEUP_REQ                             = 0x0070, /**< @sa CPROC_CSDR_1X_WAKEUP_REQ_STRU */
    ID_CSDR_CPROC_1X_WAKEUP_CNF                             = 0x0071, /**< @sa CSDR_CPROC_1X_WAKEUP_CNF_STRU */
    ID_CSDR1XCM_MSG_TYPE_ENUM_BUTT                          = 0x0072
};
...
/** ****************************************************************************
 * Name        : CSDR_1X_VE_MODE_ENUM_UINT16
 *
 * Description :
 *******************************************************************************/
enum CSDR_1X_VE_MODE_ENUM
{
    CSDR_1X_VE_LOWERTHAN_5KM            = 0x0000,
    CSDR_1X_VE_BETWEEN_5KM_AND_20KM     = 0x0001,
    CSDR_1X_VE_BETWEEN_20KM_AND_60KM    = 0x0002,
    CSDR_1X_VE_BETWEEN_60KM_AND_200KM   = 0x0003,
    CSDR_1X_VE_MORETHAN_200KM           = 0x0004,
    CSDR_1X_VE_BUTT                     = 0x0005
};
typedef PHY_UINT16 CSDR_1X_VE_MODE_ENUM_UINT16;
...
/** ****************************************************************************
 * Name        : CSDR_1X_PPM_REQ_TYPE_ENUM_UINT16
 *
 * Description :
 *******************************************************************************/
enum CSDR_1X_PPM_REQ_TYPE_ENUM
{
    CSDR_1X_PPM_REQ_TYPE_RXON           = 0x0000,
    CSDR_1X_PPM_REQ_TYPE_RXOFF          = 0x0001,
    CSDR_1X_PPM_REQ_TYPE_BUTT           = 0x0002
};
typedef PHY_UINT16 CSDR_1X_PPM_REQ_TYPE_ENUM_UINT16;
 ...
 * Master Mode.
 * uhwModemId added cause: interference feature,used to indentify master card
 * or secondary card.
 *******************************************************************************/
typedef struct
{
...
typedef struct
{
    ...
    CSDR_1X_BOOL_ENUM_UINT16            enResume;                                      /**< TRUE: tell CSDR no change in Channel,So CSDR should try to resume peformance ,FALSE:normal setup */
                                                                                       /**< Channel unique parameters */
...
typedef struct
{
    ...
    PHY_UINT16                                              enResume;                                      /**< TRUE: tell CSDR no change in Channel,So CSDR should try to resume peformance ,FALSE:normal setup */
 ...
 * 2015-12-04  enSuspend for SRLTE  or DSDS feature
 * When Suspend CSDR,,CPROC  set  enSuspend TRUE,other scenarios set FALSE
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    ...
    CSDR_1X_BOOL_ENUM_UINT16            enSuspend;                                    /**< TRUE:Releas Because of Suspend,so CSDR_1X should Backup key info for resume performance and suspend performance,FALSE:normal release */
...
typedef struct
{
    ...
    CSDR_1X_PPM_REQ_TYPE_ENUM_UINT16    enPpmReqType;          /**< 0:RXON 1:RXOFF */
    CSDR_1X_RXON_TYPE_ENUM_UINT16       enRxOnType;            /**< RxOnType */
    PHY_UINT16                          uhwReserved;           /**< 32-bit alignment */
...
/** ****************************************************************************
 * Name        : CSDR_CPROC_1X_VE_MODE_IND_STRU
 *
 * Description : CSDR report the current SPEED MODE in tch state when the SPEED
 * MODE changed.
 *******************************************************************************/
typedef struct
{
    ...
    CSDR1XCM_MSG_TYPE_ENUM_UINT16       enMsgId;
    PHY_UINT16                          uhwOpId;
    CSDR_1X_VE_MODE_ENUM_UINT16         enVeMode;
    PHY_UINT16                          uhwReserved; /**< 32 bit alignment */
} CSDR_CPROC_1X_VE_MODE_IND_STRU;

/** ****************************************************************************
 * Name        : CPROC_CSDR_1X_WAKEUP_REQ_STRU
 *
 * Description : CPROC_CSDR_1X_WAKEUP_REQ is sent from CPROC to CSDR when CPROC
 * needs to wake up CSDR in deep sleep before the wake up time. The signal is
 * sent in order to get the clocks restored.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
...
/** ****************************************************************************
 * Name        : CSDR_CPROC_1X_WAKEUP_CNF_STRU
 *
 * Description : CSDR_CPROC_1X_WAKE_UP_CNF is sent from CSDR to CPROC when CSDR
 * is  in awake state.
 *******************************************************************************/
typedef struct
{
