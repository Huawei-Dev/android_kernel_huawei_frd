...
enum CSDRHRPDCM_MSG_TYPE_ENUM
{
    ...
    ID_CSDR_CHR_HRPD_MSG_IND                                = 0x4042, /**< @sa CSDR_CHR_HRPD_MSG_IND_STRU */
    ID_CPROC_CSDR_HRPD_SLAVE_TASK_END_REQ                   = 0x4043, /**< @sa CPROC_CSDR_HRPD_SLAVE_TASK_END_REQ_STRU */
    ID_CSDRHRPDCM_MSG_TYPE_ENUM_BUTT                        = 0x4044
};
typedef PHY_UINT16 CSDRHRPDCM_MSG_TYPE_ENUM_UINT16;

/** ****************************************************************************
 * Name        : CSDR_HRPD_DSDS_VERSION_ENUM_UINT16
 *
 * Description :
 *******************************************************************************/
enum CSDR_HRPD_DSDS_VERSION_ENUM
{
    CSDR_HRPD_DSDS_1_0                  = 0x0000,
    CSDR_HRPD_DSDS_2_0                  = 0x0001,
    CSDR_HRPD_DSDS_VERSION_BUTT         = 0x0002
};
typedef PHY_UINT16 CSDR_HRPD_DSDS_VERSION_ENUM_UINT16;
...
/** ****************************************************************************
 * Name        : CSDR_HRPD_CHR_CHECK_EVENT_ENUM_UINT16
 *
 * Description : chr event type
 *******************************************************************************/
enum CSDR_HRPD_CHR_CHECK_EVENT_ENUM
{
    CSDR_EVDO_AFC_REPORT                = 0x0000,
    CSDR_EVDO_RSSI_REPORT               = 0x0001,
    CSDR_EVDO_ECNO_REPORT               = 0x0002,
    CSDR_EVDO_TX_POWER_REPORT           = 0x0003,
    CSDR_EVDO_RF_TIMINGOUT_REPORT       = 0x0004,
    CSDR_EVDO_FEITF_DATA_ERROR_REPORT   = 0x0005,
    CSDR_EVDO_DRCLENGTH_CHANGE_REPORT   = 0x0006,
    CSDR_EVDO_PD_ERROR_REPORT           = 0x0007,
    CSDR_EVDO_MIMQ_CHANGE_REPORT        = 0x0008,
    CSDR_EVDO_SUSPEND_GAPLENGTH_REPORT  = 0x0009,
    CSDR_EVDO_DSCLENGTH_CHANGE_REPORT   = 0x000A,
    CSDR_CHR_INFO_BUTT                  = 0x000B
};
typedef PHY_UINT16 CSDR_HRPD_CHR_CHECK_EVENT_ENUM_UINT16;
...
was used for non-HRPD activity. */
    ...
    CSDR_HRPD_RXON_SLAVE_MEAS_GET_TIMING                    = 0x0008, /**< HRPD get timing by read sync message when slave mode */
    CSDR_HRPD_RXON_BUTT                                     = 0x0009
};
...
enum CSDR_HRPD_WORKMODE_ENUM
{
    ...
    CSDR_HRPD_WORKMODE_SLAVE_KEEP_TIMING                    = 0x0001, /**< CSDR_HRPD_WORKMODE_SLAVE_REMAIN_TIMING :CSDR_1x shall remain TIMING and shall
not sleep

CSDR_HRPD_WORKMODE_MASTER_REMAIN_TIMING :CSDR_1x shall remain TIMING */
    CSDR_HRPD_WORKMODE_MASTER                               = 0x0002,
    CSDR_HRPD_WORKMODE_MASTER_KEEP_TIMING                   = 0x0003,
    CSDR_HRPD_WORKMODE_BUTT                                 = 0x0004
};
...
/** ****************************************************************************
 * Name        : CSDR_HRPD_PPM_REQ_TYPE_ENUM_UINT16
 *
 * Description :
 *******************************************************************************/
enum CSDR_HRPD_PPM_REQ_TYPE_ENUM
{
    CSDR_HRPD_PPM_REQ_TYPE_RXON         = 0x0000,
    CSDR_HRPD_PPM_REQ_TYPE_RXOFF        = 0x0001,
    CSDR_HRPD_PPM_REQ_TYPE_BUTT         = 0x0002
};
typedef PHY_UINT16 CSDR_HRPD_PPM_REQ_TYPE_ENUM_UINT16;
...
/** ****************************************************************************
 * Name        : CSDR_HRPD_CHR_EVENT_STRU
 *
 * Description : CHR errorlog event info
 *******************************************************************************/
typedef struct
{
    CSDR_HRPD_CHR_CHECK_EVENT_ENUM_UINT16                   enCsdrChrEventType;
    PHY_UINT16                                              uhwIndex;
    PHY_UINT32                                              uwLowTimeStamp;
    PHY_UINT32                                              uwHighTimeStamp;
    PHY_UINT32                                              uwEventValue;
} CSDR_HRPD_CHR_EVENT_STRU;
...
typedef struct
{
    ...
    CSDR_HRPD_DSDS_VERSION_ENUM_UINT16  enDsdsVersion;
    PHY_UINT16                          uhwRsv;
...
typedef struct
{
    ...
    PHY_UINT16                          uhwChannelID;     /**< 0----master channel  1--- slave channel */
    CSDR_HRPD_BOOL_ENUM_UINT16          enFreqHashChange; /**< 0---not change  1-----change */
...
typedef struct
{
    ...
    PHY_UINT16                          uhwHandOffDelay; /**< Handoff delay, in step of 8 slots */
...
typedef struct
{
    ...
    CSDR_HRPD_PPM_REQ_TYPE_ENUM_UINT16  enPpmReqType;          /**< 0:RXON 1:RXOFF */
    CSDR_HRPD_RXON_ENUM_UINT16          enRxOnType;            /**< RxOnType */
    PHY_UINT16                          uhwFreqChangeFlag;     /**< CAS hash freq change flag  1----changed  0----no change */
...
/** ****************************************************************************
 * Name        : CSDR_CHR_HRPD_MSG_IND_STRU
 *
 * Description : send to arm when hrpd  checked errlog event
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    CSDRHRPDCM_MSG_TYPE_ENUM_UINT16     enMsgId;
    PHY_UINT16                          uhwOpId;
    CSDR_HRPD_CHR_EVENT_STRU            stCsdrChrEvent;
} CSDR_CHR_HRPD_MSG_IND_STRU;

/** ****************************************************************************
 * Name        : CPROC_CSDR_HRPD_SLAVE_TASK_END_REQ_STRU
 *
 * Description : This signal is sent to notify CSDR slave measurement released
 * for Dallas C20.
 *******************************************************************************/
typedef struct
{
    ...
    CSDRHRPDCM_MSG_TYPE_ENUM_UINT16     enMsgId;
    PHY_UINT16                          uhwOpId;
} CPROC_CSDR_HRPD_SLAVE_TASK_END_REQ_STRU;
