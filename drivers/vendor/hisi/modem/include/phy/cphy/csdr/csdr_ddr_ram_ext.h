...
#define CSDR_DDR_RAM_LLR0_LEN               ( 0x1800 )
...
/* DDR内开一个全0的空间,用于不完整帧和提前译码使用 */
#define CSDR_DDR_RAM_LLR0_BUFFER_ADDR     ( CSDR_DDR_RAM_SYNCH_PANG_ADDR \
                                             + CSDR_DDR_RAM_SYNCH_PANG_LEN )

/* CTTF与ENC编码前数据存放空间 */
#define CTTF_CSDR_1X_R_DATA_BUFFER_ADDR     ( CSDR_DDR_RAM_LLR0_BUFFER_ADDR \
                                             + CSDR_DDR_RAM_LLR0_LEN )
