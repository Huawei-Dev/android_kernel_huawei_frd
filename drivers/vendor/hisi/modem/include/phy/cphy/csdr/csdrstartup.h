...
#define CSDR_DSP_SHARE_NV_NUM                       ( 1 )
#define CSDR_DSP_SHARE_RESERVED_NUM                 ( 7 )
#elif ( _CHIP_BB_HI3660CS == _DSP_CHIP_BB_TYPE )
#define CSDR_DSP_SHARE_NV_NUM                       ( 2 )
#define CSDR_DSP_SHARE_RESERVED_NUM                 ( 6 )
#else
#define CSDR_DSP_SHARE_NV_NUM                       ( 2 )
#define CSDR_DSP_SHARE_RESERVED_NUM                 ( 6 )
#endif
...
typedef struct
{
    ...
    PHY_UINT32  uwCdmaCsdrNvInfoAddr[CSDR_DSP_SHARE_NV_NUM];    /* CSDR NV信息地址 */
    PHY_UINT32  uwMailBoxAddr;                                  /* 邮箱信息地址 */
    PHY_UINT32  uwObjBaseAddr;                                  /* base addrs */
    PHY_UINT32  uwReserved[CSDR_DSP_SHARE_RESERVED_NUM];        /* 保留字节 */
