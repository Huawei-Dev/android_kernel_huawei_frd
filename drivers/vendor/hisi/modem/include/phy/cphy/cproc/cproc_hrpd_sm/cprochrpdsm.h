...
/** ****************************************************************************
 * Name        : CPROC_HRPD_MEAS_RESULT_ENUM_UINT32
 *
 * Description :
 *******************************************************************************/
enum CPROC_HRPD_MEAS_RESULT_ENUM
{
    CPROC_HRPD_MEAS_RESULT_SUCC                             = 0x0000,
    CPROC_HRPD_MEAS_RESULT_FAIL                             = 0x0001,
    CPROC_HRPD_MEAS_RESULT_TIMING_NOT_PRESENT               = 0x0002,
    CPROC_HRPD_MEAS_RESULT_BUTT                             = 0x0003
};
typedef VOS_UINT32 CPROC_HRPD_MEAS_RESULT_ENUM_UINT32;
...
typedef struct
{
    ...
    VOS_INT16                                               sFreqRssiThresh; /**< -880..0, Resolution 0.125dB, valid for slave meas */
    CPROC_HRPD_CHANNEL_RECORD_STRU                          stFreq;               /**< Frequency */
...
typedef struct
{
    ...
    CPROCHRPDSM_MSG_TYPE_ENUM_UINT16    enMsgId;
    VOS_UINT16                          usOpId;
    CPROC_HRPD_MEAS_RESULT_ENUM_UINT32  ulResult; /**< pilotset meas result */
