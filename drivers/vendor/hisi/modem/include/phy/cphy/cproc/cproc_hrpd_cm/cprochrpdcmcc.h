...
/** ****************************************************************************
 * Name        : CPROC_HRPD_PILOT_SEARCH_STOP_RSLT_ENUM_UINT16
 *
 * Description : This enum shows if RF was available at the time of sending the
 * signal it is included in e.g. CPROC_CAS_HRPD_SEARCH_PILOT_STOP_CNF . It does
 * not say anything about if RF was available during the procedure.
 *******************************************************************************/
enum CPROC_HRPD_PILOT_SEARCH_STOP_RSLT_ENUM
{
    CPROC_HRPD_PILOT_SEARCH_STOP_RSLT_OTHER                 = 0x0000,
    CPROC_HRPD_PILOT_SEARCH_STOP_RSLT_NO_RF                 = 0x0001,
    CPROC_HRPD_PILOT_SEARCH_STOP_RSLT_BUTT                  = 0x0002
};
typedef VOS_UINT16 CPROC_HRPD_PILOT_SEARCH_STOP_RSLT_ENUM_UINT16;
...
enum CPROC_HRPD_SYSTIME_INFO_ENUM
{
    ...
    CPROC_HRPD_SYSTIME_INFO_ENUM_BUTT   = 0x0004
};
...
/** ****************************************************************************
 * Name        : CPROC_HRPD_PILOT_SEARCH_FREQ_INFO_STRU
 *
 * Description :
 *******************************************************************************/
typedef struct
{
    CPROC_HRPD_CHANNEL_RECORD_STRU      stFreq;
    VOS_INT16                           sFreqRssiThresh; /**< -880,0>,Resolution 0.125db */
    VOS_UINT16                          usReserved;      /**< 32-bit alignment */
} CPROC_HRPD_PILOT_SEARCH_FREQ_INFO_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                                              usFreqHashFlag; /**< frequency hash:1, not hash:0 */
...
typedef struct
{
    ...
    CPROC_HRPD_PILOT_SEARCH_FREQ_INFO_STRU                  astChannelInfoList[CPROC_HRPD_CS_MAX_CHANNEL_NUM]; /**< channels */
    CPROC_HRPD_SYSTIME_INFO_ENUM_UINT16                     enSystimeInfo;                                     /**< system time information */
...
typedef struct
{
    ...
    VOS_UINT16                                              usChannelInfoIndex; /**< The index of the searched pilot in astChannelInfoList in CAS_CPROC_HRPD_SEARCH_PILOT_REQ */
    CPROC_HRPD_CHANNEL_RECORD_STRU                          stChannelInfo;      /**< the frequence , only vaild if pilot found */
...
typedef struct
{
    ...
    CPROCHRPDCMCC_MSG_TYPE_ENUM_UINT16                      enMsgId;
    VOS_UINT16                                              usOpId;
    CPROC_HRPD_PILOT_SEARCH_STOP_RSLT_ENUM_UINT16           usResult;           /**< Value of RF allocation when CPROC_CAS_HRPD_SEARCH_PILOT_STOP_CNF is sent */
    VOS_UINT16                                              usChannelInfoIndex; /**< The index of the searched pilot in astChannelInfoList in CAS_CPROC_HRPD_SEARCH_PILOT_REQ */
