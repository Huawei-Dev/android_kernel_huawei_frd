...
enum CPROC1XCM_MSG_TYPE_ENUM
{
    ...
    ID_CPROC_CAS_1X_VE_MODE_IND                             = 0x2072, /**< @sa CPROC_CAS_1X_VE_MODE_IND_STRU */
    ID_CAS_CPROC_1X_IDLE_FER_REQ                            = 0x2073, /**< @sa CAS_CPROC_1X_IDLE_FER_REQ_STRU */
    ID_CPROC1XCM_MSG_TYPE_ENUM_BUTT                         = 0x2074
};
typedef VOS_UINT16 CPROC1XCM_MSG_TYPE_ENUM_UINT16;

/** ****************************************************************************
 * Name        : CPROC_1X_VE_MODE_ENUM_UINT16
 *
 * Description :
 *******************************************************************************/
enum CPROC_1X_VE_MODE_ENUM
{
    CPROC_1X_VE_MODE_LOWERTHAN_5KM                          = 0x0000,
    CPROC_1X_VE_MODE_BETWEEN_5KM_AND_20KM                   = 0x0001,
    CPROC_1X_VE_MODE_BETWEEN_20KM_AND_60KM                  = 0x0002,
    CPROC_1X_VE_MODE_BETWEEN_60KM_AND_200KM                 = 0x0003,
    CPROC_1X_VE_MODE_MORETHAN_200KM                         = 0x0004,
    CPROC_1X_VE_MODE_BUTT                                   = 0x0005
};
typedef VOS_UINT16 CPROC_1X_VE_MODE_ENUM_UINT16;
...
typedef struct
{
    ...
    CPROC1XCM_MSG_TYPE_ENUM_UINT16      enMsgId;
    VOS_UINT16                          usOpId;
    CPROC_1X_FREQ_INFO_STRU             stFreq;      /**< Frequency and Band Class where the search was stopped */
    CPROC_1X_BOOL_ENUM_UINT16           enNoRf;      /**< Set to TRUE if the stop was received while 1x was suspended */
    VOS_UINT16                          usFreqIndex; /**< Index in the list of frequencies in the request at which CPROC was stopped */
 ...
 * frequencies in a CAS_CPROC_1X_PILOT_SEARCH_REQ have been searched and there
...
typedef struct
{
    ...
    CPROC_1X_BOOL_ENUM_UINT16           enWaitPwrCtrlFlag;
    CPROC_1X_BOOL_ENUM_UINT16           enWaitLongCodeFlag;
...
/** ****************************************************************************
 * Name        : CPROC_CAS_1X_VE_MODE_IND_STRU
 *
 * Description : This signal is sent to CAS when CPROC received the report from
 * CSDR  in tch state;
 *******************************************************************************/
typedef struct
{
    ...
    CPROC1XCM_MSG_TYPE_ENUM_UINT16      enMsgId;
    VOS_UINT16                          usOpId;
    CPROC_1X_VE_MODE_ENUM_UINT16        enVeMode;
    VOS_UINT16                          usReserved; /**< 32 bit alignment */
} CPROC_CAS_1X_VE_MODE_IND_STRU;

/** ****************************************************************************
 * Name        : CAS_CPROC_1X_IDLE_FER_REQ_STRU
 *
 * Description : CAS_CPROC_1X_IDLE_FER_REQ is sent from CAS to CPROC_1X each
 * time a PCH frame has been delivered from L2 to L3.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    CPROC1XCM_MSG_TYPE_ENUM_UINT16      enMsgId;
    VOS_UINT16                          usOpId;
    VOS_UINT16                          usNbrErrorFrames;
    VOS_UINT16                          usResereved;      /**< 32 bit alignment */
} CAS_CPROC_1X_IDLE_FER_REQ_STRU;
