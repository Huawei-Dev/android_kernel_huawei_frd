...
enum    RRC_PHY_MSG_ID_ENUM
{
    ...
    ID_RRC_PHY_PENDING_IND                                  = 0x103A,   /* _H2ASN_MsgChoice RRC_PHY_PENDING_IND_STRU */
...
/*****************************************************************************
 枚举名    : PHYITF_PENDING_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  : Pending标识
*****************************************************************************/
enum    PHYITF_PENDING_ENUM
{
    PHYITF_START_PENDING                      = 0,
    PHYITF_STOP_PENDING                       = 1,
    PHYITF_PENDING_BUTT
};
typedef VOS_UINT16  PHYITF_PENDING_ENUM_UINT16;
