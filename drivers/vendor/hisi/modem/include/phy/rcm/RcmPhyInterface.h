...
#define RCM_GPHY_TASK_PROPERTY_TABLE  \
    ...
    { RCM_GPHY_TASK_FAST_SEARCHING_FBSB,        RCM_TASK_PRIORITY_1_6,  RCM_TASK_PREEMPTIND_FLAG_INVALID},\
...
#define RCM_LPHY_TASK_PROPERTY_TABLE  \
    ...
    { RCM_LPHY_TASK_CAMPON,                 RCM_TASK_PRIORITY_2_9,  RCM_TASK_PREEMPTIND_FLAG_VALID},\
...
#define RCM_CPHY_1X_TASK_PROPERTY_SRLTE_TABLE  \
...
#define RCM_CPHY_1X_TASK_PROPERTY_SVLTE_TABLE  \
    { RCM_CPHY_1X_TASK_LIST,                RCM_TASK_PRIORITY_BUTT, RCM_TASK_PREEMPTIND_FLAG_BUTT },\
...
enum RCM_PHY_MSG_ID_ENUM
{
    ...
    ID_PHY_RCM_GET_AFC_INFO_CNF             = 0x1826,                           /* _H2ASN_MsgChoice PHY_RCM_GET_AFC_INFO_CNF_STRU */
    ID_PHY_RCM_SWITCH_MIPI_TABLE_IND        = 0x1827,                           /* _H2ASN_MsgChoice PHY_RCM_SWITCH_MIPI_TABLE_IND_STRU */
    ID_PHY_RCM_GET_LTE_TIMING_REQ           = 0x1828,                           /* _H2ASN_MsgChoice PHY_RCM_GET_LTE_TIMING_REQ_STRU */
    ...
    ID_RCM_PHY_GET_AFC_INFO_REQ             = 0x189e,                           /* _H2ASN_MsgChoice RCM_PHY_GET_AFC_INFO_REQ_STRU */
    ...
    ID_RCM_PHY_GET_LTE_TIMING_IND           = 0x18a3,                           /* _H2ASN_MsgChoice RCM_PHY_GET_LTE_TIMING_IND_STRU */
...
enum RCM_PHY_TASK_ID_ENUM
{
    ...
    RCM_GPHY_TASK_FAST_SEARCHING_FBSB       = 48,                               /* 48快速同步任务 */
...
{
    RCM_MODEM_0                         = 0,                                    /* MODEM0 */
    RCM_MODEM_1                         = 1,                                    /* MODEM1 */
    RCM_MODEM_2                         = 2,                                    /* MODEM2 */
...
{
    RCM_TAS_MODEM_0                     = 0,                                    /* MODEM0 */
    RCM_TAS_MODEM_1                     = 1,                                    /* MODEM1 */
    RCM_TAS_MODEM_2                     = 2,                                    /* MODEM1 */
...
/*****************************************************************************
 枚举名    : RCM_PHY_DSDS_VERSION_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : RCM_PHY_DSDS 版本标识定义
*****************************************************************************/
enum RCM_PHY_DSDS_VERSION_ENUM
{
    RCM_PHY_DSDS_1_0                        = 0,                                /* DSDS 1.0 */
    RCM_PHY_DSDS_2_0                        = 1,                                /* DSDS 2.0  */
    RCM_PHY_DSDS_VERSION_BUTT
};
typedef VOS_UINT16  RCM_PHY_DSDS_VERSION_ENUM_UINT16;
...
/*****************************************************************************
 枚举名    : RCM_CHANNEL_ID_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  :使用通道号ID
*****************************************************************************/
enum RCM_CHANNEL_ID_ENUM
{
    RCM_CHANNEL_MASTER                      = 0,                                /* 不需要立即分配任务 */
    RCM_CHANNEL_SLAVE                       = 1,                                /* 需要立即分配任务 */
    RCM_CHANNEL_ID_BUTT
};
typedef VOS_UINT16  RCM_CHANNEL_ID_ENUM_UINT16;

/*****************************************************************************
 枚举名    : RCM_TASK_NEED_TX_FLAG_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  : 是否需要使用TX
*****************************************************************************/
enum RCM_TASK_NEED_TX_FLAG_ENUM
{
    RCM_TASK_NO_NEED_TX_FLAG                = 0,                                /* 不需要上行 */
    RCM_TASK_NEED_TX_FLAG                   = 1,                                /* 需要上行 */
    RCM_TASK_NEED_TX_FLAG_BUTT
};
typedef VOS_UINT16  RCM_TASK_NEED_TX_FLAG_ENUM_UINT16;
...
/*****************************************************************************
 结构名    : RCM_SRSV_MODE_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  : 根据Nv配置和RF共享情况，确定使用时支持SVLTE/SRLTE
*****************************************************************************/
enum RCM_SRSV_MODE_ENUM
{
    RCM_SRSV_MODE_SVLTE = 0,
    RCM_SRSV_MODE_SRLTE = 1,
    RCM_SRSV_MODE_ERROR = 2,
    RCM_SRSV_MODE_BUTT
};
typedef VOS_UINT16 RCM_SRSV_MODE_ENUM_UINT16;



enum RCM_PHY_CROSS_MIPI_TABLE_ENUM
{
    RCM_PHY_CROSS_MIPI_TABLE_0           = 0,                                   /* cross table 0 */
    RCM_PHY_CROSS_MIPI_TABLE_1           = 1,                                   /* cross table 1 */
    RCM_PHY_CROSS_MIPI_TABLE_BUTT
};
typedef VOS_UINT16 RCM_PHY_CROSS_MIPI_TABLE_ENUM_UINT16;
...
typedef struct
{
    ...
    RCM_TASK_NEED_TX_FLAG_ENUM_UINT16           enNeedTxFlag;                   /* 是否需要使用TX,DSDS2.0需要使用 */
...
typedef struct
{
    ...
    RCM_PHY_TASK_ID_ENUM_UINT16                 usTaskID;                       /* 任务ID */
    RCM_CHANNEL_ID_ENUM_UINT16                  enChannelID;                    /* Channel ID */
    VOS_UINT32                                  ul32KSysTime;                   /* 当前的32K 定时 */
...
typedef struct
{
    RCM_WMODE_TIMING_STRU               stW0Time;                               /* W0模系统时间 */
    RCM_WMODE_TIMING_STRU               stW1Time;                               /* W1模系统时间 */
    VOS_UINT32                          uwCTime;                                /* C模系统时间 */
    RCM_GMODE_TIMING_STRU               stG0Time;                               /* G0模系统时间 */
    RCM_GMODE_TIMING_STRU               stG1Time;                               /* G1模系统时间 */
    RCM_GMODE_TIMING_STRU               stG2Time;                               /* G2模系统时间 */
...
typedef struct
{
    ...
    RCM_PHY_DSDS_VERSION_ENUM_UINT16            enDsdsVersion;                  /* DSDS版本 */
...
/*****************************************************************************
 结构名    : PHY_RCM_SWITCH_MIPI_TABLE_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 切换CROSS MIPI表
*****************************************************************************/
typedef struct
{
    ...
    RCM_PHY_MSG_ID_ENUM_UINT16           enMsgID;                               /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                           usRsv;                                 /* 保留字 */
    RCM_PHY_CROSS_MIPI_TABLE_ENUM_UINT16 enTable;                               /* table */
    VOS_UINT16                           usRsv1;                                /* 保留字 */
}PHY_RCM_SWITCH_MIPI_TABLE_IND_STRU;

/*****************************************************************************
 结构名    : PHY_RCM_GET_LTE_TIMING_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : cproc force LPHY wakeup for getting LTE timing
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
    RCM_PHY_MSG_ID_ENUM_UINT16           enMsgID;                               /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                           usOpId;                                /* opid */
}PHY_RCM_GET_LTE_TIMING_REQ_STRU;

/*****************************************************************************
 结构名    : RCM_PHY_GET_LTE_TIMING_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 发给LPHY的唤醒信息
*****************************************************************************/
typedef struct
{
    ...
    RCM_MODE_ID_ENUM_UINT16             enModeID;                               /* 模式ID */
    RCM_MODEM_ID_ENUM_UINT16            enModemID;                              /* modem ID */
}RCM_PHY_GET_LTE_TIMING_IND_STRU;
...
extern RCM_SRSV_MODE_ENUM_UINT16 RCM_SCHDL_GetSrSvLteMode( VOS_VOID);
#endif
