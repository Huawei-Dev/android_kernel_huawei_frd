...
#define LPHY_MAILBOX_LCS_BANKA_MEM_SIZE             (0x00000000UL)
    ...
    #define TPHY_NV_CFG_SIZE                        (0x00002800UL)  /*10k字节，TDS NV项配置区大小*/
    #define LPHY_MAILBOX_RSV_BANKA_MEM_SIZE         (0x00001400UL)  /*5K rsvd segment 1*/
    #define LPHY_TOTAL_RSVD_MEM_SIZE                (104*1024)      /*104K*/
#else
    #define TPHY_NV_CFG_SIZE                        (0x00001C00UL)  /*7k字节，TDS NV项配置区大小*/
