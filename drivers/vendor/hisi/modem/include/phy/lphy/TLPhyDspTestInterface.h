...
#define LPHY_MAILBOX_BASE_ADDR_DSP          (LPHY_MBX_BASE_ADDR(LPHY_GET_MODEMID_FROM_MODEMIDX(0)))                          /*邮箱共享基地定义*/
#define TL_PHY_MAILBOX_SOC_TEST_ADDR        ((LPHY_MBX_BASE_ADDR(LPHY_GET_MODEMID_FROM_MODEMIDX(0))) + 0x4000)   /*DSP压力测试与底软的邮箱基址*/
