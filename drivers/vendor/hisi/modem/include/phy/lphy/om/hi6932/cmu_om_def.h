...
typedef enum
{
    ...
    LPHY_SG_CMU_CONIND_PCC_REPORT_ENA,
    LPHY_SG_CMU_CONIND_SCC0_REPORT_ENA,
    LPHY_SG_CMU_CONIND_SCC1_REPORT_ENA,
    LPHY_SG_CMU_CONIND_SCC2_REPORT_ENA,
    LPHY_SG_CMU_CALC_PCC_REPORT_ENA,
    LPHY_SG_CMU_CALC_SCC0_REPORT_ENA,
    LPHY_SG_CMU_CALC_SCC1_REPORT_ENA,
    LPHY_SG_CMU_CALC_SCC2_REPORT_ENA,
}LPHY_SG_CMU_ENUM;
...
typedef struct
{
    ...
    UINT32           aulCmuSinrLog[CMU_RX_MAX_NUM];
    UINT32           aulCmuPnLog[CMU_RX_MAX_NUM];
