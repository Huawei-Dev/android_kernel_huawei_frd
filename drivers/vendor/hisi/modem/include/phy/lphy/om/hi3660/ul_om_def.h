...
#define PUSCH_CAP_STR_QM_INDEX 1
#define PUSCH_CAP_OM_STR_RV_INDEX 1
#define PUSCH_CAP_STR_RV_INDEX 6
#define PUSCH_CAP_OM_STR_RB_NUM_INDEX 2
...
typedef struct __LPHY_IND_UL_BASIC_INFO_STRU__
{
    ...
    INT16  sCAPusch_Power;                     /*上行CA场景下的PUSCH总功率*/
    UINT16 usContiCA_MPR;                      /*上行连续CA场景下的MPR回退值*/
    UINT16 usContiCA_AMPR;                     /*上行连续CA场景下的AMPR回退值*/
...
typedef struct
{
    ...
    UINT16 usPuschPucchAntSel;  //1表示主集,0表示分集
    UINT16 usPrachAntSel;       //1表示主集,0表示分集
    UINT16 usBack1stSrsAntSel;  //1表示主集,0表示分集
    UINT16 usBack2stSrsAntSel;  //1表示主集,0表示分集
