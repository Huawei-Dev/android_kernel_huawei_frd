...
/************************************************************
                           2. CNF数据结构定义
************************************************************/
enum LPHY_CNF_MSGID_TIMING_ENUM
{
    LPHY_CNF_TIMING_RESERVED            = OM_CMD_ID(LPHY_TIMING_MID, OM_TYPE_CNF, 0x0),
    LPHY_CNF_TIMING_BUTT
};
typedef UINT16 LPHY_CNF_MSGID_TIMING_ENUM_UINT16;
...
enum LPHY_SG_MSGID_TIMING_ENUM
{
    ...
    LPHY_SG_PDP_RPT_PCC,
    LPHY_SG_PDP_RPT_SCC0,
    LPHY_SG_PDP_RPT_MBMS,
    LPHY_SG_EMBMS_RPT_STATUS,
    LPHY_SG_PDP_RPT_SCC1,
    LPHY_SG_PDP_RPT_SCC2,
    LPHY_SG_TIMING_BUTT
};
...
typedef UINT16 TRU_SUBFRAME_TYPE_ENUM_UINT16;
...
enum TIMING_MODULE_HOLD_ENUM
{
    TRU_BBP_UNHOLD_BIT,
    TRU_BBP_HOLD_BIT,
    TRU_BBP_HOLD_BUTT
};
typedef UINT16 TIMING_MODULE_HOLD_ENUM_UINT16;
...
enum TIMING_TRU_STATUS_ENUM
{
    TRU_BBP_IDLE = 0,
    TRU_BBP_OTHERS,
    TRU_BBP__STATUS_BUTT
};

typedef UINT16 TIMING_TRU_STATUS_ENUM_UINT16;
