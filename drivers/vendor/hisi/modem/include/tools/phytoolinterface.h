...
/*W Tx FAST CAL 最大次数*/
#define WPHY_CAL_TX_FAST_CAL_MAX_VAILD_NUM       ( 128 )
...
typedef VOS_UINT16 GPHY_NCE_PREDICT_TASK_TYPE_ELF_ENUM_UINT16;

/*****************************************************************************
 枚举名    : GPHY_NCE_OCCASION_USE_MODE_ENUM
 协议表格  :
 枚举说明  : 当前哪个模式在使用(可维可测使用)
 注意: 和GPHY_NCE_OCCASION_USE_MODE_ENUM保持一致，同步修改!!!
*****************************************************************************/
enum GPHY_NCE_OCCASION_USE_MODE_ELF_ENUM
{
...
typedef VOS_UINT16 GPHY_NCE_OCCASION_USE_MODE_ELF_ENUM_UINT16;

/*****************************************************************************
 枚举名    : GPHY_NCE_NCELL_BSIC_SEARCH_STATE_ENUM
 协议表格  :
 枚举说明  : BSIC搜索模式
 注意: 和GPHY_NCE_NCELL_BSIC_SEARCH_STATE_ENUM保持一致，同步修改!!!
*****************************************************************************/
enum GPHY_NCE_NCELL_BSIC_SEARCH_STATE_ELF_ENUM
{
...
typedef VOS_UINT16 GPHY_NCE_NCELL_BSIC_SEARCH_STATE_ELF_ENUM_UINT16;

/*****************************************************************************
 枚举名    : GPHY_NCE_NSTRONG_NCELL_ENUM_UINT16
 协议表格  :
 枚举说明  :
 注意: 和GPHY_NCE_NSTRONG_NCELL_ENUM_UINT16保持一致，同步修改!!!
*****************************************************************************/
enum GPHY_NCE_NSTRONG_NCELL_ELF_ENUM
{
...
typedef VOS_UINT16 GPHY_NCE_NSTRONG_NCELL_ELF_ENUM_UINT16;

/*****************************************************************************
 枚举名    : GPHY_NCE_NCELL_BSIC_VERIFY_STATE_ENUM
 协议表格  :
 枚举说明  : BSIC验证模式
 注意: 和GPHY_NCE_NCELL_BSIC_VERIFY_STATE_ENUM保持一致，同步修改!!!
*****************************************************************************/
enum GPHY_NCE_NCELL_BSIC_VERIFY_STATE_ELF_ENUM
{
...
typedef VOS_UINT16 GPHY_NCE_NCELL_BSIC_VERIFY_STATE_ELF_ENUM_UINT16;
...
enum WPHY_TOOL_MNTN_MSG_ID_ENUM
{
    ...
    ID_TOOL_WPHY_MNTN_FUNC_SWTICH_REQ           = 0xF05B,                       /* _H2ASN_MsgChoice WPHY_TOOL_MNTN_FUNC_SWTICH_REQ_STRU */
    ...
    ID_WPHY_TOOL_AT_TRX_CAL_MNTN_RPT_IND        = 0xF0CB,                       /* _H2ASN_MsgChoice WPHY_TOOL_AT_TRX_CAL_MNTN_RPT_STRU */
    ID_WPHY_TOOL_TX_FAST_CAL_MNTN_RPT_IND       = 0xF0CD,                       /* _H2ASN_MsgChoice WPHY_TOOL_TX_FAST_CAL_MNTN_RPT_STRU */
...
enum WPHY_TOOL_MNTN_THRESHOLD_TYPE_ENUM
{
    ...
    WPHY_MNTN_THRESHOLD_TYPE_STEPEB_NOISE                      ,
...
{
    VOS_UINT32                                  uwTaskFn;
    GPHY_NCE_PREDICT_TASK_TYPE_ELF_ENUM_UINT16  enTaskType;
    VOS_UINT16                                  uhwFreqNum;                     /* 专用态IDLE帧做邻区任务的频点数目 */
    GPHY_NCE_OCCASION_USE_MODE_ELF_ENUM_UINT16  enOccasionUseMode;              /* 当前是哪个模式在使用 */
...
typedef struct
{
    GPHY_TOOL_MNTN_MSG_ID_ENUM_UINT16                   enMsgId;                /*_H2ASN_Skip */ /* 原语类型 */
    VOS_UINT16                                          usToolsId;              /* 保留字段 */
    GPHY_NCE_NCELL_BSIC_SEARCH_STATE_ELF_ENUM_UINT16    enBsicSrchState;
    VOS_UINT16                                          uhwFreq;
    VOS_UINT16                                          uhwRank;
    GPHY_NCE_NSTRONG_NCELL_ELF_ENUM_UINT16              enNStrongIndex;
    VOS_INT16                                           shwRxlev;
...
typedef struct
{
    ...
    VOS_UINT16                                          usToolsId;                      /* 保留字段 */
    VOS_UINT32                                          uwCurFn;
    GPHY_NCE_NCELL_BSIC_VERIFY_STATE_ELF_ENUM_UINT16    enBsicVerifyState;
    VOS_UINT16                                          uhwFreq;
    VOS_UINT16                                          uhwRank;
    GPHY_NCE_NSTRONG_NCELL_ELF_ENUM_UINT16              enNStrongIndex;
    VOS_INT16                                           shwRxlev;
...
typedef struct
{
    ...
    VOS_UINT16                              usFetBlindStatus;                   /* FET SRB 盲检测开关，打开UPHY_TRUE,关闭UPHY_FALSE */
    VOS_UINT16                              usFetSrbCheckStatus;                /* FET SRB 场景评估动作状态，已经检测过为:UPHY_TRUE,没检测过为:UPHY_FALSE */
...
typedef struct
{
    ...
    VOS_UINT32                          uwChnMasterModeRx[4];                   /* Channel master mode */
    VOS_UINT32                          uwChnMasterModeTx[4];                   /* Channel master mode */
    VOS_UINT32                          uwChnSlaveMode[4];
    VOS_UINT16                          uhwWphyTdhrMode;                        /* 谐波消除模式 */
    VOS_UINT16                          uhwTdhrDelayFlag;                       /* 频点变化延迟标记 */
    VOS_UINT32                          uwHarmRemoveEnable;                     /* 谐波去除使能 */
    VOS_UINT32                          uwDcRemoveEnable;                       /* 去DC估计使能 */
    VOS_INT32                           swPhaseStep;                            /* 相位步长 */
...
/*****************************************************************************
 结构名    : WPHY_TOOL_FET_CTRL_INFO_STRU
 结构说明  : FET特性控制全局信息结构体
*****************************************************************************/
typedef struct
{
    ...
    WPHY_TOOL_FET_FRAME_PATTERN_INFO_STRU   stFramePatternInfo;                 /* FET帧级开关模板信息 */
} WPHY_TOOL_FET_CTRL_INFO_STRU;

/*****************************************************************************
 结构名    : WPHY_FET_SRB_INFO_STRU
...
typedef struct
{
    VOS_UINT16                              usFetBlindStatus;                   /* FET SRB 盲检测开关，打开UPHY_TRUE,关闭UPHY_FALSE */
    VOS_UINT16                              usFetSrbCheckStatus;                /* FET SRB 场景评估动作状态，已经检测过为:UPHY_TRUE,没检测过为:UPHY_FALSE */
    VOS_UINT16                              usFetSrbExistStatus;                /* 指示是否存在SRB包:UPHY_TRUE:存在，UPHY_FALSE:不存在 */
    VOS_UINT16                              usFetSrbWinCount;                   /* 统计接受数据平滑框内帧数 */
    VOS_UINT16                              usFetDecodeSlotNum;                 /* 启动译码时隙数 */
    VOS_UINT16                              usFetPwrLoopIndex;                  /* 指示当前维护的功率数组中最旧帧信息位置，范围[0,15] */
    VOS_UINT32                              ulPo3Linear;                        /* DPCCH和DPDCH之间PO偏差线性值 */
    VOS_UINT32                              ulSignalPwrAcc;                     /* 统计平滑框内信号噪声 */
    VOS_UINT32                              ulNoisePwrAcc;                      /* 统计平滑框内信号噪声 */
}WPHY_TOOL_FET_SRB_INFO_STRU;
...
typedef struct
{
    ...
    WPHY_TOOL_FET_CTRL_INFO_STRU            stFetCtrlInfo;                      /* FET信息 */
    WPHY_TOOL_FET_SRB_INFO_STRU             stWphyFetSrbCtrl;                   /* FET盲检测信息 */
...
/*****************************************************************************
 结构名    : WPHY_TOOL_CAL_TX_MNTN_UNIT_STRU
 结构说明  : W TX校准轨迹打印, 一次所有流程为一个打印单元
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwFreq;                                /* 频点 */
    VOS_INT16                           shwPower;                               /* 功率 */
    VOS_UINT16                          uhwSlot;                                /* 时隙 */
    VOS_UINT16                          uhwChip;                                /* chip */
    VOS_UINT32                          uwRfRpt;                                /* RF上报 */
    VOS_UINT32                          uwPaRpt;                                /* PA上报 */
    VOS_UINT32                          uwEtAptRpt;                             /* ET配置上报 */

}WPHY_TOOL_CAL_TX_MNTN_UNIT_STRU;
...
typedef struct
{
    VOS_UINT16                          uhwTxValidNum;                          /* 记录的有效个数 */
    VOS_UINT16                          uhwTxFlag;                                /* 保留 */
    WPHY_TOOL_CAL_TX_MNTN_UNIT_STRU     astWphyTxFastCalMntn[WPHY_CAL_TX_FAST_CAL_MAX_VAILD_NUM];
}WPHY_TOOL_CAL_TX_FAST_MNTN_UNIT_STRU;

/*****************************************************************************
 结构名    : WPHY_TOOL_AT_TRX_CAL_MNTN_UNIT_STRU
 结构说明  : W RX校准轨迹打印, 一次所有流程为一个打印单元
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwMask;                                /* mask */
    VOS_UINT16                          uhwReserved;                            /* 保留 */
    VOS_UINT32                          uwTxPllStatus;                          /* txpll状态 */
    VOS_UINT32                          uwTxPll;                                /* txpll状态 */
    VOS_UINT32                          uwTxConfig;                             /* tx状态 */
    VOS_UINT32                          uwRxPllStatus;                          /* RxPll状态 */
    VOS_UINT32                          uwRxPll;                                /* RxPll状态 */
    VOS_UINT32                          uwRxConfig;                             /* RxPll状态 */
    VOS_UINT32                          uwTxETRpt;                              /* ET上报 */
    VOS_UINT32                          uwTxRfRpt;                              /* APC上报 */
    VOS_UINT32                          uwTxPaRpt;                              /* PA上报 */
    VOS_UINT32                          uwTxPdRpt;                              /* Pd上报 */
    VOS_UINT32                          uwRxAagc;                               /* AGC状态上报 */
    VOS_UINT32                          uwRxAnt1Dc;                             /* 天线1直流上报 */
    VOS_UINT32                          uwRxAnt2Dc;                             /* 天线2直流上报 */
    VOS_UINT32                          uwRxAnt1RssiRpt;                        /* 天线1能量上报 */
    VOS_UINT32                          uwRxAnt2RssiRpt;                        /* 天线2能量上报 */
    VOS_UINT32                          auwReserved[10];                        /* 保留 */

}WPHY_TOOL_AT_TRX_CAL_MNTN_UNIT_STRU;


/*****************************************************************************
 结构名    : WPHY_TOOL_AT_TRX_CAL_MNTN_RPT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : AT Cal可维可测信息上报
*****************************************************************************/
typedef struct
{
    WPHY_TOOL_MNTN_MSG_ID_ENUM_UINT16               enMsgId;                            /*_H2ASN_Skip */ /* 原语类型 */
    VOS_UINT16                                      usToolsId;                          /* 保留字段 */
    WPHY_TOOL_AT_TRX_CAL_MNTN_UNIT_STRU             stWphyAtTrxCalmntn;
}WPHY_TOOL_AT_TRX_CAL_MNTN_RPT_STRU;
...
/*****************************************************************************
 结构名    : WPHY_TOOL_TX_FAST_CAL_MNTN_RPT_STRU
 协议表格  :
 ASN.1描述 :
...
typedef struct
{
    WPHY_TOOL_MNTN_MSG_ID_ENUM_UINT16               enMsgId;                            /*_H2ASN_Skip */ /* 原语类型 */
    VOS_UINT16                                      usToolsId;                          /* 保留字段 */
    WPHY_TOOL_CAL_TX_FAST_MNTN_UNIT_STRU            stWphyToolTxFastCal;
}WPHY_TOOL_TX_FAST_CAL_MNTN_RPT_STRU;
...
/*****************************************************************************
 结构名    : WPHY_TOOL_SYS_STATE_MNTN_RPT_CTRL_STRU
 协议表格  :
 ASN.1描述 :
...
typedef struct
{
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enFreeMntnRptStatus;                /* FREE态维测上报去使能标记 */
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enIdleMntnRptStatus;                /* IDLE态维测上报去使能标记，包括PI打印等 */
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enFachMntnRptStatus;                /* FACH态维测上报去使能标记，包括随机接入消息等 */
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enDchMntnRptStatus;                 /* DCH态维测上报去使能标记，包括随机接入消息等 */
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enSlaveMntnRptStatus;               /* SLAVE维测上报去使能标记 */
    VOS_UINT16                              uhwRserved;
}WPHY_TOOL_SYS_STATE_MNTN_RPT_CTRL_STRU;

/*****************************************************************************
 结构名    : WPHY_TOOL_MODULE_MNTN_RPT_CTRL_STRU
 协议表格  :
 ASN.1描述 :
...
typedef struct
{
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enCsRptStatus;                      /* 小区搜索维测上报使能标记 */
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enDrxSchdlRptStatus;                /* FACH态维测上报使能标记 */
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enOlpcRptStatus;                    /* DCH态维测上报使能标记 */
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16   enCmRptStatus;                      /* SLAVE维测上报使能标记 */
}WPHY_TOOL_MODULE_MNTN_RPT_CTRL_STRU;
...
typedef struct
{
    ...
    WPHY_TOOL_MNTN_MSG_ID_ENUM_UINT16           enMsgId;                        /*_H2ASN_Skip */ /* 原语类型 */
    VOS_UINT16                                  usToolsId;                      /* 保留字段 */
    UPHY_TOOL_MNTN_RPT_STATUS_ENUM_UINT16       enIntraMsgRptStatus;            /* 内部消息上报标记，1表示上报，0表示不上报 */
    VOS_UINT16                                  uhwReserved;
    WPHY_TOOL_SYS_STATE_MNTN_RPT_CTRL_STRU      stSysStateRptStatusCtrl;        /* 各个状态主动上报维测打印控制，内部变量0为不上报，1为主动上报，默认上报 */
    WPHY_TOOL_MODULE_MNTN_RPT_CTRL_STRU         stModuleRptStatusCtrl;          /* 各个模块上报维测打印控制，内部变量1为主动上报，0为不上报，默认不上报 */
}WPHY_TOOL_MNTN_FUNC_SWTICH_REQ_STRU;
