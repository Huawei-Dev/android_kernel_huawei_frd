...
*             非NULL指针: 分配内存成功，该指针指向分配的内存块的指针
****************************************************************************/
void *mdrv_sim_mem_malloc (unsigned long size);

/*****************************************************************************
* 函 数 名  : mdrv_sim_mem_free
*
* 功能描述  : 打桩函数，没有实质作用。
*
* 输入参数  :
...
*             MDRV_ERROR: 失败
****************************************************************************/
int mdrv_sim_mem_free(void *pBuf);

/*****************************************************************************
* 函 数 名  : mdrv_sim_mem_reset
*
* 功能描述  : 释放由mdrv_sim_mem_malloc分配的所有内存。
*
* 输入参数  : 无
*
* 输出参数  : 无
