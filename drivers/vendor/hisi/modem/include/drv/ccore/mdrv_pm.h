...
typedef struct
{
	...
	unsigned int auwG2PhySRStamp[8];
	unsigned int auwWPhySRStamp[8];
	unsigned int auwW1PhySRStamp[8];
	unsigned int auwCprocSRStamp[8];
	unsigned int auwSRStampReserved [12];
	unsigned int auwLpm3SRStamp[8];
