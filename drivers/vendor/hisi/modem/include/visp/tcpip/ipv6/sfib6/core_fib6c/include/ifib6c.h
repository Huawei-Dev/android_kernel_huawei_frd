...
DECLARE_INTERFACE( IIF_IPV6_FIBCONTR_ComIntFIBA ) 
{
    ...
    METHOD_(ULONG, pfIP6_FIBImpl_SearchAll_ForDelete)(RTMSG6_S *pstLookUp, RTMSG6_S *pstNoDelEntry);
    METHOD_(ULONG, pfIP6_FIBImpl_SearchAllAndDelete)(RTMSG6_S *pstLookUp);
};
