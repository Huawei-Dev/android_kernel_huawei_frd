...
#define TDS_DSDS_SUPPORT_CHAN_NUM  (TDS_RF_SUPPORT_BAND_NUM + 2)
...
typedef struct
{
    ...
    TDS_ANT_ALLOT_MIPI_CMD_STRU astAntMipiCmd[TDS_DSDS_SUPPORT_CHAN_NUM];
...
typedef struct
{
    ...
    TDS_ANTSEL_ALLOT_STRU astAntSelAllot[TDS_DSDS_SUPPORT_CHAN_NUM];
...
typedef struct
{
    ...
    TDS_RF_PRIVATE_CHANNEL_CFG_STRU  astRfChanCfg[TDS_DSDS_SUPPORT_CHAN_NUM];//射频通道配置
    TDS_RF_PRIVATE_CORE_DIV_CFG_STRU astRfCoreAndDivSel[TDS_DSDS_SUPPORT_CHAN_NUM];
	TDS_NV_RFIC_6362_STRU		     astRficPara[TDS_DSDS_SUPPORT_CHAN_NUM];
	TDS_NV_CHAN_PARA_STRU		     astChanPara[TDS_DSDS_SUPPORT_CHAN_NUM];
...
typedef struct
{
    UINT16 usPdmFreqChangeFlag;             //PDM降频标志，1: 降频   0: 不降频
    UINT16 reserved;
} TDS_NV_PDM_FREQ_CHANGE_PARA_STRU;
...
typedef struct
{
    ...
    TDS_NV_PDM_FREQ_CHANGE_PARA_STRU  stTdsPdmFreqChangePara;
}TDS_NV_STRU;
