...
typedef struct
{
    ...
    INT16  sPowCmp[RF_TX_FREQ_NUM]; /*天线切换后差损补偿，每个频点对应一个, 1/16单位*/
...
typedef struct
{
    UINT16 ausQPSK_B41[8];
    UINT16 aus16QAM_B41[8];
    UINT16 ausQPSKAnd16QAM_B7[20];
}NV_ID_LTE_TX_CA_AMPR_STRU;
typedef struct
{
...
/*    NV_FE_PBAND_MIPI_INFO_STRU          stPBandMipiCfg;
    ...
    NV_ID_LTE_TX_CA_AMPR_STRU               stCA_AMPR;
}LTE_NV_PARA_STRU;
/**********************************************************************************************/
/*******************************band相关的nv项*******************************************/
typedef struct
