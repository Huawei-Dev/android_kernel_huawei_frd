...
typedef struct
{
	UINT32 ulAptHoldNtxFlag; /* 1:有效   0:无效 */
}TL_COMM_NV_APT_HOLD_NTX_STRU;
...
typedef struct
{
    ...
    TL_COMM_NV_APT_HOLD_NTX_STRU             stAptHoldNtxFlag;
...
enum PS_NV_INDEX_ENUM
{
    ...
    NV_IDX_LTE_ETM_ET_APT_LAB,
    NV_IDX_LTE_ETM_ET_APT_FAC,
    NV_IDX_LTE_ET_DPD_COMP_LAB,
    NV_IDX_LTE_ET_DPD_COMP_FAC,
    NV_IDX_LTE_ETM_SEMI_STATIC_MIPI_CMD_LAB,
    NV_IDX_LTE_ETM_DYNAMIC_MIPI_CMD_LAB,
    //NV_IDX_LTE_DPD_FAC,
    //NV_IDX_LTE_DPD_LAB,
#endif
#if (FEATURE_ON == FEATURE_TLPHY_DPD)
    NV_IDX_DPD_LAB_PARA,
    NV_IDX_DPD_LAB_PIN_OFFSET,
    NV_IDX_DPD_FAC_RESULT,
    NV_IDX_DPD_FAC_LUT_00,
    NV_IDX_DPD_FAC_LUT_01,
    NV_IDX_DPD_FAC_LUT_02,
    NV_IDX_DPD_FAC_LUT_03,
#endif
    NV_IDX_TEMP_SENSOR,
...
/*****************************************************************************
 ...
 枚举说明  : 天线端口数
*****************************************************************************/
enum LPHY_ANTANNA_PORT_ENUM
{
    LPHY_ANTANNA_PORT_1              = 0,                /* 天线端口为1 */
    LPHY_ANTANNA_PORT_2,                                 /* 天线端口为2 */
    LPHY_ANTANNA_PORT_4,                                 /* 天线端口为4 */
#if (FEATURE_ON == FEATURE_LTE_R11)
    LPHY_ANTANNA_PORT_8,                                 /* 天线端口为8 */
#endif
    LPHY_ANTANNA_PORT_BUTT
};

typedef VOS_UINT16    LPHY_ANTANNA_PORT_ENUM_UINT16;
...
/*****************************************************************************
 ...
 枚举说明  : LTE模式类型
*****************************************************************************/
enum LPHY_LTE_MODE_TYPE_ENUM
{
    LPHY_LTE_MODE_TYPE_FDD_NV                = 0,                             /* LTE FDD 制式 */
    LPHY_LTE_MODE_TYPE_TDD_NV                = 1,                             /* LTE TDD 制式 */
    LPHY_LTE_MODE_TYPE_BUTT_NV
};
typedef VOS_UINT16 LPHY_LTE_MODE_TYPE_ENUM_UINT16;
