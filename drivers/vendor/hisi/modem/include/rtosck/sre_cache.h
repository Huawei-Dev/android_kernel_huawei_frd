...
/**
 * @ingroup  sre_cache
 * @brief 回写并无效所有数据Cache。
 *
 * @par 描述:
 * 将所有数据Cache内容回写至内存并无效掉。
 *
 * @attention
 * <ul>
 * <li>只有Cortex-AX支持该功能。</li>
 * </ul>
 *
 * @param 无
 *
 ...
 */
extern VOID SRE_DCacheFlushInvAll(VOID);
#endif
...
extern VOID SRE_DCacheWait(VOID);
    ...
    || (OS_HARDWARE_PLATFORM == OS_RISC220) || (OS_HARDWARE_PLATFORM == OS_DSP220) \
    || (OS_HARDWARE_PLATFORM == OS_HACCC) || (OS_HARDWARE_PLATFORM == OS_HIDSP)\
    || (OS_HARDWARE_PLATFORM == OS_CORTEX_AX))
 ...
 * @attention
 * <ul>
 * <li>只有SD6182,SD6157,SD6181,SD6108,SD6183,Cortex-AX平台支持无效所有指令Cache功能。</li>
