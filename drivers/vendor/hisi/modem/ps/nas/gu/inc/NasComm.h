...
#define     GMM_TIMER_DELAY_RADIO_CAPA_TRIGED_RAU       (27)                    /* GMM收到RADIO_ACCESS_CAPABILITIES时，延迟触发RAU/ATTACH的定时器 */
...
/* CS HO等系统消息时长定时器，包括ultra Flash CSFB，SRVCC, GU之间电话过程中的HO */
    ...
    MM_TIMER_DELAY_RADIO_CAPA_TRIGED_LAU                    = 28,

    MM_TIMER_T3241                          = 29,
   
    MM_TIMER_DELAY_NETWORK_SEARCH_AFTER_EMC = 30,                               /* 紧急呼之后不搜网定时器 */
