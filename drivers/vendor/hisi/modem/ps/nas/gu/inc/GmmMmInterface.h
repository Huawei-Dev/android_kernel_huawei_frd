...
/* GMM发给MM的原语 */
    ...
    GMMMM_RADIO_ACCESS_CAP_CHANEG_IND           = 0x100e,    /* _H2ASN_MsgChoice GMMMM_RADIO_ACCESS_CAP_CHANGE_IND_STRU */
...
typedef struct
{
    MSG_HEADER_STRU                     stMsgHeader;                            /* 消息头 */ /*_H2ASN_Skip*/
    NAS_MML_REG_FAIL_CAUSE_ENUM_UINT16  enCause;                                /* 注册失败原因 */
    VOS_UINT8                           ucDelEplmnFlg;                           /* 是否是NO RF导致的注册失败 */
...
typedef struct
{
    MSG_HEADER_STRU                     stMsgHeader;                            /* 消息头 */ /*_H2ASN_Skip*/
    VOS_UINT32                          ulReserved;                             /* 保留*/
}GMMMM_RADIO_ACCESS_CAP_CHANGE_IND_STRU;
