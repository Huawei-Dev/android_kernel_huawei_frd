...
VOS_UINT32 NAS_MMC_IsNeedRejectAnycellSerach_AnyCellSearch(VOS_VOID)
{
    ...
    if (NAS_MML_NET_RAT_TYPE_LTE == enCurrRatType)
    {
        ...
        NAS_WARNING_LOG(WUEPS_PID_MMC, "NAS_MMC_IsNeedRejectAnycellSerach_AnyCellSearch:LTE ulRrcConnExistFlag true .");
        return VOS_TRUE;
    }
    ...
    {
        NAS_WARNING_LOG(WUEPS_PID_MMC, "NAS_MMC_IsNeedRejectAnycellSerach_AnyCellSearch:ucRrcStatusFlg true .");
        return VOS_TRUE;
    }
