...
#define     MM_TIMER_T3241_VALUE                        (300 * 1000)
...
#define     MM_TIMER_DELAY_RADIO_CAPA_TRIGED_LAU_VALUE      (500)               /* 时长500ms */
...
#define     MM_EVENT_ID_SS_REL_REQ             (66)
...
#define     MM_EVENT_ID_SS_ABORT_REQ           (80)

#define     MM_EVENT_ID_T3242_EXPIRED          (90)
#define     MM_EVENT_ID_T3243_EXPIRED          (91)

#define     MM_EVENT_ID_LCS_EST_REQ            (92)
#define     MM_EVENT_ID_LCS_DATA_REQ           (93)
#define     MM_EVENT_ID_LCS_REL_REQ            (94)
#define     MM_EVENT_ID_LCS_MESSAGE            (95)

#define     MM_EVENT_ID_RRC_LCS_STATE_IND      (96)
#define     MM_EVENT_ID_T3241_EXPIRED          (97)

#define     MM_EVENT_ID_RADIO_ACCESS_CAP_CHANGE_IND         (98)
...
#define     MM_CS_SERV_LCS_EXIST                            0x05
#define     MM_CS_SERV_MT_EXIST                             0x06
