...
VOS_VOID NAS_MM_WriteLocaInCard(VOS_VOID)
{
    ...
    pulTmsiValue = (VOS_UINT32*)stCslociFile.aucTmsi;
    NAS_INFO_LOG1(WUEPS_PID_MM, "NAS_MM_WriteLocaInCard:NV_Write OK ", *pulTmsiValue);
...
VOS_VOID Mm_SndAgentUsimUpdateFileReq( VOS_UINT16 usEfId )
{
    ...
    case USIMM_GSM_EFLOCI_ID:
        ...
        if (0 != PS_MEM_CMP(pucFileContent, NAS_MML_GetSimCsLociFileContent(), MM_SIM_FILE_LEN_LOCA_INFO))
        {
            ...
            pulTmsiValue = (VOS_UINT32*)stCslociFile.aucTmsi;
            NAS_INFO_LOG1(WUEPS_PID_MM, "Mm_SndAgentUsimUpdateFileReq:NV_Write OK ", *pulTmsiValue);
...
)
{
    ...
    NAS_MM_UpdateDamNoSearchStatus(ulLuResult, ulCause);
