...
VOS_UINT32   NAS_MM_Event_Analy_From_GMM(MSG_HEADER_STRU* pMsgHeader)
{
    ...
    switch ( pMsgHeader->ulMsgName )
    {
        ...
        case GMMMM_RADIO_ACCESS_CAP_CHANEG_IND:
            ucEventID   = MM_EVENT_ID_RADIO_ACCESS_CAP_CHANGE_IND;
            break;
...
VOS_UINT8   Mm_Event_Analy_From_MMC(MSG_HEADER_STRU* pMsgHeader)
{
    ...
    case MMCMM_PLMN_SEARCH_INITIATED:
        ucEventID = NAS_MM_RcvMmcMmPlmnSearchInitiated_PreProc(pMsgHeader);
        break;
...
#if (FEATURE_ON == FEATURE_IMS)
    case MMCMM_IMS_SRV_INFO_NOTIFY:
        NAS_MM_RcvMmcImsSrvInfoNotify((struct MsgCB*)pMsgHeader);
        break;
#endif

    case MMCMM_POWER_OFF_NOTIFY:
        NAS_MM_RcvMmcPowerOffNotify((struct MsgCB*)pMsgHeader);
        break;    
...
VOS_UINT8   Mm_Event_Analy_From_GAS(MSG_HEADER_STRU* pMsgHeader)
{
    ...
    case GRRMM_EST_SAPI3_CNF: /* 建立 SAPI3 的回应信息 */
        ...
        break;
    case RRMM_REL_IND:
        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Event_Analy_From_GAS: Call NAS_MM_ResetCsPagingFlgAndT3240Len()");
    ...
    case RRMM_LCS_STATE_IND:
        ucEventID   = MM_EVENT_ID_RRC_LCS_STATE_IND;
        break;
...
VOS_UINT8   Mm_Event_Analy_From_RRCF(MSG_HEADER_STRU* pMsgHeader)
{
    ...
    case RRMM_EST_CNF:
        ...
        break;
    case RRMM_REL_IND:
        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Event_Analy_From_RRCF: Call NAS_MM_ResetCsPagingFlgAndT3240Len()");
        NAS_MM_ResetCsPagingFlgAndT3240Len();
        ucEventID   = 33;
        break;
...
VOS_UINT8   Mm_Event_Analy_From_SS(MSG_HEADER_STRU* pMsgHeader)
{
    ...
    {
    case MMSS_EST_REQ:
        ucEventID   = MM_EVENT_ID_SS_EST_REQ;
        break;
    case MMSS_REL_REQ:
        ucEventID   = MM_EVENT_ID_SS_REL_REQ;
        break;
    case MMSS_DATA_REQ:
        ucEventID   = MM_EVENT_ID_SS_DATA_REQ;
        break;
    case MMSS_ABORT_REQ:
        ucEventID   = MM_EVENT_ID_SS_ABORT_REQ;
        break;
...
VOS_UINT8   Mm_Event_Analy_From_LCS(
    MSG_HEADER_STRU                    *pMsgHeader)
{
    ...
    switch ( pMsgHeader->ulMsgName )
    {
        case ID_LCS_MM_EST_REQ:
            ucEventID = MM_EVENT_ID_LCS_EST_REQ;
            break;
        case ID_LCS_MM_DATA_REQ:
            ucEventID = MM_EVENT_ID_LCS_DATA_REQ;
            break;
        case ID_LCS_MM_REL_REQ:
            ucEventID = MM_EVENT_ID_LCS_REL_REQ;
            break;
        case ID_LCS_MM_STATUS_NTY:
            NAS_MM_RcvLcsStatusNty((VOS_VOID *)pMsgHeader);
            break;

        default:
            PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Event_Analy_From_LCS:WARNING: Msg name from LCS is Error");
            break;
    }
...
VOS_UINT8   Mm_Event_Analy(MSG_HEADER_STRU* pMsgHeader)
{
    ...
    case WUEPS_PID_SS:
        ...
        break;
    case WUEPS_PID_LCS:
        ucEventID = Mm_Event_Analy_From_LCS(pMsgHeader);
        break;
    case WUEPS_PID_TC:
...
VOS_VOID MM_DelayLuGsmTimeout()
{
    ...
    {
        NAS_NORMAL_LOG1(WUEPS_PID_MM, "MM_DelayLuGsmTimeout: trigger LAU, MM state", g_MmGlobalInfo.ucState);
        Mm_ComLuOnly();
    }
...
VOS_VOID NAS_MM_NormalCsfbHoWaitSysinfoTimeOut(VOS_VOID)
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MM, "NAS_MM_NormalCsfbHoWaitSysinfoTimeOut: csfb trigger lau");
...
VOS_UINT8 Mm_Timer_Event_Analy(VOS_UINT32 *aulRcvMsg)
{
    ...
    case MM_TIMER_T3240:
        ...
        break;
    case MM_TIMER_T3241:
        NAS_MM_RcvT3241Expired_PreProc();
        ucEventId = MM_EVENT_ID_T3241_EXPIRED;
        PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_INFO, "Mm_Timer_Event_Analy:INFO: MM T3241 TIME OUT");
        break;
    ...
    case MM_TIMER_DELAY_RADIO_CAPA_TRIGED_LAU:
        NAS_MM_RcvDelayRadioCapaTriggerLauExpired();
        break;


    case MM_TIMER_DELAY_NETWORK_SEARCH_AFTER_EMC:
        NAS_MM_RcvMmTimerDelayNetworkSearchAfterEmcExpired();
        break;
    ...
    case WAIT_FOR_MMCMM_START_REQ:                                              /* 等待MMCMM_START_REQ消息:                 */
        ...
        else
        {
            ...
            /*A32D11534==>*/
             ...
             ||  (( MMCMM_POWER_OFF_NOTIFY == pMsgHeader->ulMsgName)
                &&( WUEPS_PID_MMC == pMsgHeader->ulSenderPid )))
            {
                ucEventId = Mm_Event_Analy(pMsgHeader);
                if ( MM_EVENT_ID_INVALID != ucEventId )
...
)
{
    ...
    case MM_IDLE_ECALL_INACTIVE:
        ...
        break;
    case MM_STATE_RR_CONNECTION_RELEASE_NOT_ALLOWED:
        pMsg->enMmState    = RR_CONNECTION_RELEASE_NOT_ALLOWED;
        break;
    default:
