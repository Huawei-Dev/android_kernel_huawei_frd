...
typedef struct
{
    ...
    NAS_MMC_PLMN_LIST_SEARCH_SCENE_ENUM_UINT8               enListPlmnSearchScene;                          /* 内部列表搜网类型 */
    NAS_MMC_SEARCHED_PLMN_LIST_INFO_STRU                    astInterPlmnSearchInfo[NAS_MML_MAX_RAT_NUM];    /* 携带网络信息 */
...
{
    MSG_HEADER_STRU                                         MsgHeader;          /* 消息头 */
    NAS_MMC_BG_PLMN_SEARCH_SCENE_ENUM_UINT8                 enBgPlmnSearchScene;  /* 搜网场景 */
...
typedef struct
{
    ...
    NAS_MMC_SEARCHED_PLMN_LIST_INFO_STRU        astSearchedPlmnListInfo[NAS_MML_MAX_RAT_NUM];         /* 携带网络信息 */
    NAS_MMC_BG_PLMN_SEARCH_SCENE_ENUM_UINT8     enBgPlmnSearchScene;            /* 携带搜网场景*/

    NAS_MMC_BG_SEARCH_TYPE_ENUM_UINT8           enFsmBgSearchType;              /* 携带本次状态机进行的背景搜网类型 */
