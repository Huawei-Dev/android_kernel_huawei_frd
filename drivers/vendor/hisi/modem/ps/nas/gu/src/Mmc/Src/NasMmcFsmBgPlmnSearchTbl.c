...
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchInitActTbl[]             =
{
    ...
    NAS_ACT_TBL_ITEM(VOS_PID_TIMER,
                     ...
                     NAS_MMC_RcvTiAutonomousCsgIdSearchTimerExpired_BgPlmnSearch_Init),

    /* 收到PSF定时器超时消息 */
    NAS_ACT_TBL_ITEM(VOS_PID_TIMER,
                     TI_NAS_MMC_PERIOD_CSG_ID_SEARCH_TIMER,
                     NAS_MMC_RcvTiPeriodCsgIdSearchTimerExpired_BgPlmnSearch_Init),

    /* 收到周期尝试CSG背景搜索定时器超时消息 */
    NAS_ACT_TBL_ITEM(VOS_PID_TIMER,
                     TI_NAS_MMC_PERIOD_TRYING_CSG_ID_SEARCH,
                     NAS_MMC_RcvTiPeriodTryingCsgIdSearchExpired_BgPlmnSearch_Init),
#endif

    /* 收到内部BG搜请求 */
    NAS_ACT_TBL_ITEM(WUEPS_PID_MMC,
                     MMCMMC_INTER_BG_SEARCH_REQ,
                     NAS_MMC_RcvMmcInterBgSearchReq_BgPlmnSearch_Init),
...
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitWasBgPlmnSearchCnfActTbl[] =
{
   ...
   NAS_ACT_TBL_ITEM( WUEPS_PID_WRR,
                     ...
                     NAS_MMC_RcvRrMmSearchedPlmnInfoInd_BgPlmnSearch_WaitWasBgPlmnSearchCnf),
...
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitGasBgPlmnSearchCnfActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_GAS,
                      RRMM_SEARCHED_PLMN_INFO_IND,
                      NAS_MMC_RcvRrMmSearchedPlmnInfoInd_BgPlmnSearch_WaitGasBgPlmnSearchCnf),
...
/* NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_WAS_CSG_BG_PLMN_SEARCH_CNF 动作表 */
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitWasCsgBgPlmnSearchCnfActTbl[] =
{
   NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                     MMCMMC_ABORT_FSM_REQ,
                     NAS_MMC_RcvMmcAbortFsmMsg_BgPlmnSearch_WaitWasCsgBgPlmnSearchCnf),

   NAS_ACT_TBL_ITEM( WUEPS_PID_WRR,
                     RRMM_SYS_INFO_IND,
                     NAS_MMC_RcvRrMmSysInfoInd_BgPlmnSearch_WaitWasCsgBgPlmnSearchCnf),

   NAS_ACT_TBL_ITEM( WUEPS_PID_WRR,
                     RRMM_REL_IND,
                     NAS_MMC_RcvRrMmRelInd_BgPlmnSearch_WaitWasCsgBgPlmnSearchCnf),

   NAS_ACT_TBL_ITEM( WUEPS_PID_WRR,
                     RRMM_CSG_BG_SEARCH_CNF,
                     NAS_MMC_RcvCsgBgSearchCnf_BgPlmnSearch_WaitWasCsgBgSearchCnf),

   NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                     TI_NAS_MMC_WAIT_WAS_BG_PLMN_SEARCH_CNF,
                     NAS_MMC_RcvTiWaitBgPlmnSearchCnfExpired_BgPlmnSearch_WaitWasCsgBgPlmnSearchCnf),

   NAS_ACT_TBL_ITEM( WUEPS_PID_WRR,
                     RRMM_AREA_LOST_IND,
                     NAS_MMC_RcvRrMmAreaLostInd_BgPlmnSearch_WaitWasCsgBgPlmnSearchCnf),
};

/* NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_GAS_CSG_BG_PLMN_SEARCH_CNF 动作表 */
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitGasCsgBgPlmnSearchCnfActTbl[] =
{
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      MMCMMC_ABORT_FSM_REQ,
                      NAS_MMC_RcvMmcAbortFsmMsg_BgPlmnSearch_WaitGasCsgBgPlmnSearchCnf),

    NAS_ACT_TBL_ITEM( UEPS_PID_GAS,
                      GRRMM_SYS_INFO_IND,
                      NAS_MMC_RcvGrrMmSysInfoInd_BgPlmnSearch_WaitGasCsgBgPlmnSearchCnf),

    NAS_ACT_TBL_ITEM( UEPS_PID_GAS,
                      RRMM_CSG_BG_SEARCH_CNF,
                      NAS_MMC_RcvCsgBgSearchCnf_BgPlmnSearch_WaitGasCsgBgPlmnSearchCnf),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MMC_WAIT_GAS_BG_PLMN_SEARCH_CNF,
                      NAS_MMC_RcvTiWaitBgPlmnSearchCnfExpired_BgPlmnSearch_WaitGasCsgBgPlmnSearchCnf),

    NAS_ACT_TBL_ITEM( UEPS_PID_GAS,
                      RRMM_AREA_LOST_IND,
                      NAS_MMC_RcvRrMmAreaLostInd_BgPlmnSearch_WaitGasCsgBgPlmnSearchCnf),
};
#endif
...
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitWasBgPlmnStopCnfActTbl[]   =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_WRR,
                      RRMM_CSG_BG_SEARCH_CNF,
                      NAS_MMC_RcvCsgBgSearchCnf_BgPlmnSearch_WaitAsBgStopCnf),
#endif
...
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitLmmBgPlmnSearchCnfActTbl[]   =
{
    ...
    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ...
                      NAS_MMC_RcvLmmSearchedPlmnInfoInd_BgPlmnSearch_WaitLmmBgPlmnSearchCnf),
...
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitLmmBgPlmnStopCnfActTbl[]   =
{
    ...
    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ...
                      NAS_MMC_RcvCsgBgSearchCnf_BgPlmnSearch_WaitLmmBgStopCnf),
#endif
};
...
#if (FEATURE_ON == FEATURE_CSG)
/* NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_BG_PLMN_SEARCH_CNF 动作表 */
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitLmmCsgBgPlmnSearchCnfActTbl[] =
{
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      MMCMMC_ABORT_FSM_REQ,
                      NAS_MMC_RcvMmcAbortFsmMsg_BgPlmnSearch_WaitLmmCsgBgPlmnSearchCnf),

    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ID_LMM_MMC_SYS_INFO_IND,
                      NAS_MMC_RcvLmmSysInfoInd_BgPlmnSearch_WaitLmmCsgBgPlmnSearchCnf),

    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ID_LMM_MMC_CSG_BG_SEARCH_CNF,
                      NAS_MMC_RcvCsgBgSearchCnf_BgPlmnSearch_WaitLmmCsgBgPlmnSearchCnf),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MMC_WAIT_LMM_BG_PLMN_SEARCH_CNF,
                      NAS_MMC_RcvTiWaitBgPlmnSearchCnfExpired_BgPlmnSearch_WaitLmmCsgBgPlmnSearchCnf),

    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ID_LMM_MMC_AREA_LOST_IND,
                      NAS_MMC_RcvLmmMmcAreaLostInd_BgPlmnSearch_WaitLmmCsgBgPlmnSearchCnf),

    /* CL时不支持CSG背景搜，因此不涉及ID_MSCC_MMC_CL_ASSOCIATED_INFO_NTF的处理 */
};

/* NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_FAST_SEARCH_CNF 动作表 */
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitLmmCsgFastSearchCnfActTbl[] =
{
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      MMCMMC_ABORT_FSM_REQ,
                      NAS_MMC_RcvMmcAbortFsmMsg_BgPlmnSearch_WaitLmmCsgFastSearchCnf),

    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ID_LMM_MMC_PLMN_SRCH_CNF,
                      NAS_MMC_RcvLmmPlmnSrchCnf_BgPlmnSearch_WaitLmmCsgFastSearchCnf),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MMC_WAIT_LMM_PLMN_SEARCH_CNF,
                      NAS_MMC_RcvTiWaitLmmPlmnSearchCnfExpired_BgPlmnSearch_WaitLmmCsgFastSearchCnf),

    /* CL时不支持CSG背景搜，因此不涉及ID_MSCC_MMC_CL_ASSOCIATED_INFO_NTF的处理 */
};

/* NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_FAST_SEARCH_STOP_CNF 动作表 */
NAS_ACT_STRU   g_astNasMmcBgPlmnSearchWaitLmmCsgFastSearchStopCnfTbl[]   =
{
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      MMCMMC_ABORT_FSM_REQ,
                      NAS_MMC_RcvMmcAbortFsmMsg_BgPlmnSearch_WaitLmmCsgFastSearchStopCnf),

    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ID_LMM_MMC_STOP_PLMN_SRCH_CNF,
                      NAS_MMC_RcvLmmPlmnSrchStopCnf_BgPlmnSearch_WaitLmmCsgFastSearchStopCnf),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MMC_WAIT_LMM_PLMN_STOP_CNF,
                      NAS_MMC_RcvTiWaitLmmStopCnfExpired_BgPlmnSearch_WaitLmmCsgFastSearchStopCnf),

    /* MMC发送stop search cnf时和接入层的search cnf消息对冲，接入层在快速指定搜或指定搜过程不会再
       回复stop search cnf，MMC收到接入层的search cnf当做收到stop search cnf */
    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ID_LMM_MMC_PLMN_SRCH_CNF,
                      NAS_MMC_RcvPlmnSearchCnf_BgPlmnSearch_WaitLmmCsgFastSearchStopCnf),
};
...
NAS_STA_STRU g_astNasMmcFsmBgPlmnSearchStaTbl[] =
{
    ...
    /*  等待W模上报CSG BG搜网结果 */
    NAS_STA_TBL_ITEM( NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_WAS_CSG_BG_PLMN_SEARCH_CNF,
                      g_astNasMmcBgPlmnSearchWaitWasCsgBgPlmnSearchCnfActTbl),

    /*  等待G模上报CSG BG搜网结果 */
    NAS_STA_TBL_ITEM( NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_GAS_CSG_BG_PLMN_SEARCH_CNF,
                      g_astNasMmcBgPlmnSearchWaitGasCsgBgPlmnSearchCnfActTbl),
#endif
    ...
    /* 等待L模上报CSG BG搜网结果 */
    NAS_STA_TBL_ITEM( NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_BG_PLMN_SEARCH_CNF,
                      g_astNasMmcBgPlmnSearchWaitLmmCsgBgPlmnSearchCnfActTbl),

    /*  等待L模上报CSG快速指定搜结果 */
    NAS_STA_TBL_ITEM( NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_FAST_SEARCH_CNF,
                      g_astNasMmcBgPlmnSearchWaitLmmCsgFastSearchCnfActTbl),

    /*  等待L模上报停止CSG快速指定搜网结果 */
    NAS_STA_TBL_ITEM( NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_FAST_SEARCH_STOP_CNF,
                      g_astNasMmcBgPlmnSearchWaitLmmCsgFastSearchStopCnfTbl),
#endif
