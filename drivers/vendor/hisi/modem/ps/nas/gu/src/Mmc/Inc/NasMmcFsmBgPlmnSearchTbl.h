...
enum NAS_MMC_BG_PLMN_SEARCH_STA_ENUM
{
    ...
    /*  等待W模上报CSG BG搜网结果 */
    NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_WAS_CSG_BG_PLMN_SEARCH_CNF       =35,

    /*  等待G模上报CSG BG搜网结果 */
    NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_GAS_CSG_BG_PLMN_SEARCH_CNF       =36,

    /*  等待L模上报CSG BG搜网结果 */
    NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_BG_PLMN_SEARCH_CNF       =37,

    /*  等待L模上报CSG快速指定搜结果 */
    NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_FAST_SEARCH_CNF          =38,

    /*  等待L模上报停止CSG快速指定搜网结果 */
    NAS_MMC_BG_PLMN_SEARCH_STA_WAIT_LMM_CSG_FAST_SEARCH_STOP_CNF     =39,
#endif
