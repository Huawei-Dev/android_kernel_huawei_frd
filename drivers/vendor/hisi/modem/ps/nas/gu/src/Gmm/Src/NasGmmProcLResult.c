...
VOS_VOID NAS_GMM_ProcLmmAttachInd_Success(
...
)
{
    ...
    /* LTE紧急ATTACH不需要走后续的流程 */
    if (VOS_TRUE == NAS_MML_GetEpsEmcAttachFlg())
    {
        if (VOS_TRUE == NAS_GMM_IsDeregisterState(Gmm_GetState()))
        {
...
{
    MMCGMM_LMM_ATTACH_IND_STRU         *pstLmmAttachMsg = VOS_NULL_PTR;
    NAS_LMM_CN_CAUSE_ENUM_UINT8         enCnCause;
    VOS_UINT32                          ulAttemptCount;
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvLmmAttachResult: Ps Not In Dam No Search Status");
    ...
    {
        NAS_GMM_ProcLmmAttachInd_Success(pstLmmAttachMsg);
    }
...
VOS_VOID NAS_GMM_ProcLmmTauResultInd_Success(
    MMCMM_LMM_TAU_RESULT_IND_STRU      *pstLmmTauMsg
)
{
    NAS_MML_PLMN_RAT_PRIO_STRU          stMsRatCapabilityList;
...
{
    MMCGMM_LMM_TAU_RESULT_IND_STRU                         *pstLmmTauMsg = VOS_NULL_PTR;
    NAS_LMM_CN_CAUSE_ENUM_UINT8                             enCnCause;
    VOS_UINT32                                              ulAttemptCount;
    ...
    NAS_MML_SetPsDamNoSearchFlag(VOS_FALSE);
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvLmmTauResult: Ps Not In Dam No Search Status");
    ...
    {
        NAS_GMM_ProcLmmTauResultInd_Success(pstLmmTauMsg);
    }
...
VOS_VOID NAS_GMM_RcvLmmTimerInfoNotify_RegNmlServ(VOS_VOID)
{
    ...
    */
    ...
    if (MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState)
    {
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvLmmTimerInfoNotify_RegNmlServ:ucGsAssociationFlg is true and cs is attached");
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvLmmTimerInfoNotify_RegNmlServ:ucGsAssociationFlg is false and cs is attached");
