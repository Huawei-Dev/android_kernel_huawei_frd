...
VOS_VOID Gmm_Tim3302Expired(VOS_VOID)
{
    ...
    case GMM_DEREGISTERED_ATTEMPTING_TO_ATTACH:
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Tim3302Expired: ATTEMPTING_TO_ATTACH trigger ATT");
    ...
    case GMM_REGISTERED_ATTEMPTING_TO_UPDATE:
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Tim3302Expired: ATTEMPTING_TO_UPDATE state trigger RAU");

        Gmm_RoutingAreaUpdateInitiate(GMM_UPDATING_TYPE_INVALID);               /* 调用函数触发RAU过程                      */
        break;                                                                  /* 跳出                                     */
    case GMM_REGISTERED_ATTEMPTING_TO_UPDATE_MM:

        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Tim3302Expired: ATTEMPTING_TO_UPDATE_MM state trigger RAU");
...
VOS_VOID Gmm_Tim3311Expired(VOS_VOID)
{
    ...
    {                                                                           /* 判断GMM当前状态                          */
    case GMM_DEREGISTERED_ATTEMPTING_TO_ATTACH:
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Tim3311Expired: ATTEMPTING_TO_ATTACH trigger ATT");
    ...
    case GMM_REGISTERED_NORMAL_SERVICE:
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Tim3302Expired: ATTEMPTING_TO_UPDATE or normal srv state trigger RAU");
...
VOS_VOID Gmm_Tim3312Expired_RegNmlServ(VOS_VOID)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Tim3312Expired_RegNmlServ: trigger RAU");
...
)
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_Gmm_RcvMmT3211ExpiredNotify: w normal srv trigger RAU");
...
VOS_VOID NAS_GMM_Timer3323Expired(VOS_VOID)
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_Timer3323Expired: Modify TIN from NAS_MML_TIN_TYPE_RAT_RELATED_TMSI to NAS_MML_TIN_TYPE_GUTI");
...
VOS_VOID NAS_GMM_TimerDelayRadioCapaTrigedRauExpired(VOS_VOID)
{
    ...
    if (VOS_FALSE == NAS_MML_IsMsPsRatCapabilityListChanged(&stMsNotifyNwPsRatPrioList, NAS_MML_GetMsNotifyNwPsPrioRatList()))
    {
        return;
    }
...
VOS_VOID NAS_GMM_TimerHoWaitSysinfoExpired(VOS_VOID)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_TimerHoWaitSysinfoExpired: trigger RAU");
...
VOS_VOID NAS_GMM_TimerDelayVoiceDomainTrigRauExpired(VOS_VOID)
{
    ...
    */
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_TimerDelayVoiceDomainTrigRauExpired: trigger RAU");
