    ...
    {                                                                   /* 不是紧急呼叫                             */
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "NAS_MM_ProcCcEstReq_IdleLimitedService: ps only, limit srv trigger lau");
        ...
        if ( MM_TRUE != Mm_ComMmConnExist() )
        {
            ...
            if (RRMM_LCS_STATE_START == NAS_MM_GetRrLcsState())
            {
                ...
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S10_E25: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
            ...
            else
            {
                ...
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S10_E25: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 释放类型为释放所有的MM连接               */
              ...
              && (MM_TRUE != ucMmConnFlg) )
            {
                ...
                Mm_ComSetMmState(RR_CONNECTION_RELEASE_NOT_ALLOWED);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S13_E25: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
                Mm_TimerStart(MM_TIMER_T3241);
            }
            else
            {
                ...
                Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S13_E25: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
                Mm_TimerStart(MM_TIMER_T3240);
            }
        }
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
            ...
            /* MM连接不存在，RR连接存在，且AS存在LCS业务，则切换到MM_RR_CONNECTION_RELEASE_NOT_ALLOWED状态 */
            ucMmConnFlg = Mm_ComMmConnExist();
            if ( (RRMM_LCS_STATE_START == NAS_MM_GetRrLcsState())
              && (MM_TRUE != ucMmConnFlg) )
            {
                ...
                Mm_ComSetMmState(RR_CONNECTION_RELEASE_NOT_ALLOWED);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S9_E26: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
                Mm_TimerStart(MM_TIMER_T3241);
            }
            else
            {
                ...
                Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S9_E26: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
                Mm_TimerStart(MM_TIMER_T3240);
            }
        }
        else
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
                ...
                .aucMMConnExtFlg[0]))
            {
                  ...
                  && (MM_TRUE != ucMmConnFlg) )
                {
                    ...
                    Mm_ComSetMmState(RR_CONNECTION_RELEASE_NOT_ALLOWED);
                    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                        "Mm_Cell_S10_E26: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
                    Mm_TimerStart(MM_TIMER_T3241);
                }
                else
                {
                    ...
                    Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                        "Mm_Cell_S10_E26: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
                    Mm_TimerStart(MM_TIMER_T3240);
                }
                ...
                g_MmCcAbortReq.ulTransactionId )
        {
            ...
            if (g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_CC].ucRat == NAS_MML_GetCurrNetRatType())
            {
                  ...
                  && (MM_TRUE != ucMmConnFlg) )
                {
                    ...
                    Mm_ComSetMmState(RR_CONNECTION_RELEASE_NOT_ALLOWED);
                    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                        "Mm_Cell_S12_E26: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
                    Mm_TimerStart(MM_TIMER_T3241);
                }
                else
                {
                    ...
                    Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                        "Mm_Cell_S12_E26: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
                    Mm_TimerStart(MM_TIMER_T3240);
                }
            }
            else
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
           ...
           && (MM_IE_PD_CALL_CONTROL == g_MmGlobalInfo.ucMMConnEstingPD))
        {
            ...
            NAS_NORMAL_LOG1(WUEPS_PID_MM, "Mm_Cell_S12_E32: CallRetryCount is too large", g_MmGlobalInfo.ucCallRetryCount);
        }
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        case RRC_REL_CAUSE_G_RL_FAIL:
            ...
            /* 释放当前正在建立的MM连接的TI */
            NAS_MM_RelEstingMmConn(NAS_MM_ConvertRrcRelCauseToMmCcRelCause(pRrmmRelInd->ulRelCause));
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S9_E33: emergency call release trigger lau");
                
                /* 发起LAU */
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S9_E33: ucEmergencyLauFlg is TRUE, trigger LAU");
            ...
            {
                NAS_MM_RelBufferedServiceEstReq(NAS_MMCM_REL_CAUSE_MM_INTER_ERR_CC_CONN_REQ_EXIST);
            }
            break;
        default:
...
VOS_VOID NAS_MM_NotifyCmErrInd(
...
)
{
    ...
    {                                                                           /* 重建的MM连接                             */
        ...
        if (MM_CONST_NUM_0 != (g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_LCS].aucMMConnExtFlg[0]
                               & (0x01 << i)))
        {
            /* 通知LCS模块MM连接失效 */
            NAS_MM_SndLcsRelInd(i, enCause);
        }
        if (MM_CONST_NUM_0 != (g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_LCS].aucMMConnExtFlg[1]
                               & (0x01 << i)))
        {
            /* 通知LCS模块MM连接失效 */
            NAS_MM_SndLcsRelInd(i + 8, enCause);
        }
...
VOS_VOID NAS_MM_HandleRelIndCause15AtS10(VOS_UINT8    ucRrConnRelFlg)
{
    ...
    NAS_MM_NotifyCmErrInd(NAS_MMCM_REL_CAUSE_RR_REL_RL_FAILURE);
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 原因值                                   */
            ...
            case RRC_REL_CAUSE_G_RL_FAIL:
                ...
                if ( VOS_TRUE == ucEmergencyLauFlg )
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S10_E33: emergency call release trigger lau");
                    
                    /* 发起LAU */
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S10_E33: ucEmergencyLauFlg is TRUE, trigger LAU");
                    g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_NORMAL_LU;    /* 设置LU类型                               */
                    Mm_ComLuOnly();
        ...
        {                                                                       /* 原因值                                   */
            ...
            case RRC_REL_CAUSE_G_RL_FAIL:
                ...
                else
                {
                    ...
                    if ( VOS_TRUE == ucEmergencyLauFlg )
                    {
                        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S11_E33: emergency call release trigger lau");

                        /* 发起LAU */
                        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S11_E33: ucEmergencyLauFlg is TRUE, trigger LAU");
                        g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_NORMAL_LU;   /* 设置LU类型                               */
                        Mm_ComLuOnly();
...
VOS_VOID    Mm_Cell_S12_E33(VOS_VOID *pRcvMsg )
{
    ...
    if (MM_TRUE == ucValidFlg)
    {
        ...
        if ( VOS_TRUE == ucEmergencyLauFlg )
        {
            NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S12_E33: emergency call release trigger lau");

            /* 发起LAU */
            NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S12_E33: ucEmergencyLauFlg is TRUE, trigger LAU");
            g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_NORMAL_LU;    /* 设置LU类型                               */
            Mm_ComLuOnly();
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        case RRC_REL_CAUSE_G_RL_FAIL:
            ...
            if ( VOS_TRUE == ucEmergencyLauFlg )
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S14_E33: emergency call release trigger lau");

                /* 发起LAU */
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S14_E33: ucEmergencyLauFlg is TRUE, trigger LAU");
                g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_NORMAL_LU;           /* 设置LU类型                               */
                Mm_ComLuOnly();
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 完整性保护和安全模式启动                 */
            ...
            case MM_IE_PD_CALL_CONTROL:                                         /* CC要求建立的MM连接                       */
                /* 该MM连接建立成功 */
                Mm_SndCcEstCnf( g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_CC].ucMMConnEstingTI,
                                MMSS_EST_SUCCESS );

                NAS_MM_UpdateMmConnByTi(MM_CONN_CTRL_CC,
                                        g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_CC].ucMMConnEstingTI,
                                        NAS_MM_CONN_EXIST);
            ...
            case MM_IE_PD_SMS_MSG:                                              /* SMS要求建立的MM连接                      */
                ...
                NAS_MM_UpdateMmConnByTi(MM_CONN_CTRL_SMS,
                                        g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_SMS].ucMMConnEstingTI,
                                        NAS_MM_CONN_EXIST);
            ...
            case MM_IE_PD_NON_CALL_RLT_SS_MSG:                                  /* SS要求建立的MM连接                       */
                /* 该MM连接建立成功 */
                Mm_SndSsEstCnf( g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_SS].ucMMConnEstingTI,
                                MMSS_EST_SUCCESS );

                NAS_MM_UpdateMmConnByTi(MM_CONN_CTRL_SS,
            ...
            case MM_IE_PD_LOCATION_SRVC:
                /* 该MM连接建立成功 */
                NAS_MM_SndLcsEstCnf(g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_LCS].ucMMConnEstingTI);

                NAS_MM_UpdateMmConnByTi(MM_CONN_CTRL_LCS,
                                        g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_LCS].ucMMConnEstingTI,
                                        NAS_MM_CONN_EXIST);
...
VOS_VOID NAS_MM_ProcCmServiceRej_LcsExist( VOS_VOID )
{
    switch(g_MmMsgCmSvcRjct.MmIeRejCause.ucRejCause)
    {
        /* 原因值4时，缓存CM层业务，等待Lu完成后重新发起CM业务 */
        case NAS_MML_REG_FAIL_CAUSE_IMSI_UNKNOWN_IN_VLR:
            g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_LCS].RcvXXEstReq.ucFlg = MM_TRUE;
            break;

        /* 原因值22时，通知LCS业务失败，区分是否携带T3246，携带T3246时不需要重拨 */
        case NAS_MML_REG_FAIL_CAUSE_PROCEDURE_CONGESTION:
            if (VOS_TRUE == g_MmMsgCmSvcRjct.ucIsCmSrvRejCongestionWithT3246)
            {
                /* 通知LCS模块，MM连接建立失败: NAS_MMCM_REL_CAUSE_CM_SRV_REJ_CONGESTION_WITH_T3246 */
                NAS_MM_SndLcsRelInd(g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_LCS].ucMMConnEstingTI,
                                    NAS_MMCM_REL_CAUSE_CM_SRV_REJ_CONGESTION_WITH_T3246);
            }
            else
            {
                /* 通知LCS模块，MM连接建立失败: NAS_MMCM_REL_CAUSE_CM_SRV_REJ_CONGESTION */
                NAS_MM_SndLcsRelInd(g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_LCS].ucMMConnEstingTI,
                    ...
                    )
{
    ...
    /* LCS要求建立的MM连接 */
    case MM_IE_PD_LOCATION_SRVC:
        NAS_MM_ProcCmServiceRej_LcsExist();
        break;
    ...
    case NAS_MML_REG_FAIL_CAUSE_PROTOCOL_ERROR:
        ...
        {                                                                       /* 没有MM连接存在                           */
            ...
            if (RRMM_LCS_STATE_START == NAS_MM_GetRrLcsState())
            {
                ...
                Mm_ComSetMmState(RR_CONNECTION_RELEASE_NOT_ALLOWED);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S9_E41: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
                Mm_TimerStart(MM_TIMER_T3241);
            }
            else
            {
                ...
                Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S9_E41: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
                Mm_TimerStart(MM_TIMER_T3240);
            }
        }
        else
                    ...
                    )
{
    ...
    case NAS_MML_REG_FAIL_CAUSE_PROTOCOL_ERROR:
          ...
          && (MM_TRUE != ucMmConnFlg) )
        {
            ...
            Mm_ComSetMmState(RR_CONNECTION_RELEASE_NOT_ALLOWED);
            PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                "Mm_Cell_S14_E41: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
            Mm_TimerStart(MM_TIMER_T3241);
        }
        else
        {
            ...
            Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
            PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                "Mm_Cell_S14_E41: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
            Mm_TimerStart(MM_TIMER_T3240);
        }
        break;
    default:
                   ...
                   )
{
    ...
    NAS_NORMAL_LOG3(WUEPS_PID_MM, "Mm_Cell_S1_E5: ulCsfbExistFlag, ucPsRestrictionFlg, ulLaiChangeFlag", ulCsfbExistFlag, ucPsRestrictionFlg, ulLaiChangeFlag);
       ...
       )
    {
         ...
         || (MMCMM_FORBIDDEN_PLMN_FOR_GPRS == g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg))
        {
            ...
            if (MMCMM_FORBIDDEN_PLMN_FOR_GPRS == g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg)
            {
                ...
                NAS_NORMAL_LOG1(WUEPS_PID_MM, "Mm_Cell_S1_E5: enCsUpdateStatus", enCsUpdateStatus);
                     ...
                     ( NAS_MML_LOCATION_UPDATE_STATUS_UPDATED == enCsUpdateStatus ) )
                {
                    ...
                    {
                        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S1_E5: lai unchange,U1 trigger lau");
                    ...
                    {
                        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S1_E5: NAS_MM_IsRadioAccessCapNeedTriggerLau is true");
                ...
                {
                    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL, "Mm_Cell_S1_E5: A+I and FORBIDDEN_PLMN_FOR_GPRS, lai change or NOT U1 trigger lau");
            ...
            else
            {
                ...
                {
                    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL, "Mm_Cell_S1_E5: A+I and unsupport gprs, lai change trigger lau");
                ...
                else
                {
                    ...
                    case NAS_MML_LOCATION_UPDATE_STATUS_UPDATED:
                        ...
                        {
                            NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S1_E5: U1,NAS_MM_IsRadioAccessCapNeedTriggerLau is true");
...
VOS_VOID Mm_DealWithBuffMsg(VOS_VOID)
{
    ...
    if ((MM_IDLE_NORMAL_SERVICE == g_MmGlobalInfo.ucState)
     || (MM_IDLE_ATTEMPTING_TO_UPDATE == g_MmGlobalInfo.ucState)
     || (MM_STATE_RR_CONNECTION_RELEASE_NOT_ALLOWED == g_MmGlobalInfo.ucState))
    {
        if (MM_TRUE == g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_CC].RcvXXEstReq.ucFlg)
        {
...
VOS_VOID Mm_Cell_S2_E5(VOS_VOID *pRcvMsg)
{
    ...
    NAS_NORMAL_LOG1(WUEPS_PID_MM, "Mm_Cell_S2_E5,A+II:ucUserSpecificSearchFlg is;",ucUserSpecificSearchFlg);
    ...
    NAS_NORMAL_LOG4(WUEPS_PID_MM, "Mm_Cell_S2_E5: ulCsfbExistFlag, ucPsRestrictionFlg, ulLaiChangeFlag, enCurrentRatType",
        ulCsfbExistFlag,
        ucPsRestrictionFlg,
        ulLaiChangeFlag,
        enCurrentRatType);
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S2_E5,clear attempt counter");
    ...
    if (VOS_FALSE == NAS_MML_GetCsAttachAllowFlg())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S2_E5: CS Attach Allow flag is FALSE");
    ...
    if (VOS_TRUE == NAS_MM_IsCsForbidden())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S2_E5: CS Forbidden is TRUE");
    ...
    if (VOS_TRUE == NAS_MML_GetCsRestrictRegisterFlg())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S2_E5: CS Restrict Register Flag is TRUE");
    ...
    {
        NAS_NORMAL_LOG2(WUEPS_PID_MM, "Mm_Cell_S2_E5: Class A and Network Mode I: ucNtMod, ucNewNtMod",
            g_MmGlobalInfo.ucNtMod,
            g_MmGlobalInfo.ucNewNtMod);
         ...
         || (MMCMM_FORBIDDEN_PLMN_FOR_GPRS == g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg))
        {
              ...
              && (NAS_MML_LOCATION_UPDATE_STATUS_UPDATED == enCsUpdateStatus ) )
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S2_E5,current updated, lai no change and MM_ATT_NOT_NEED");

                    if ( MM_TRUE ==
                            g_MmGlobalInfo.LuInfo.ucT3212ExpiredFlg )
                    {
                        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S2_E5: g_MmGlobalInfo.LuInfo.ucT3212ExpiredFlg is TRUE");

                        NAS_MM_ProcBufferedEmgCallOrLau_RcvSysinfo(ulLaiChangeFlag, MM_IE_LUT_PERIODIC_UPDATING);
                    }
                    else if (VOS_TRUE == NAS_MM_IsRadioAccessCapNeedTriggerLau())
                    {
                        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S2_E5:NAS_MM_IsRadioAccessCapNeedTriggerLau is true");
                ...
                {
                    NAS_NORMAL_LOG2(WUEPS_PID_MM, "Mm_Cell_S2_E5,U1 and MM_ATT_NEED,g_MmGlobalInfo.ucPowerOnFlg is;ucT3212ExpiredFlg is",g_MmGlobalInfo.ucPowerOnFlg,g_MmGlobalInfo.LuInfo.ucT3212ExpiredFlg);
            ...
            else if  (VOS_TRUE == NAS_MM_IsDamNotNeedLau())
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S2_E5, Dam not need lau  is true;");
                
                Mm_ComRcvSysHandle(ucUserSpecificSearchFlg);
            }
            else
            {
                NAS_NORMAL_LOG2(WUEPS_PID_MM, "Mm_Cell_S2_E5,trigger lau:LIKE B LAI change is; cs updated is ;",ulLaiChangeFlag,enCsUpdateStatus);
...
VOS_VOID Mm_Cell_S2_E21(VOS_VOID *pMsg)
{
    ...
    NAS_MM_RelBufferedServiceEstReqExceptEmergencyCall(NAS_MMCM_REL_CAUSE_MM_INTER_ERR_OUT_OF_COVERAGE);

    /* 如果当前no rf或者MM状态为PLMN SEARCH，则紧急呼也直接给cc回复失败 */
    if (MM_TRUE == g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_CC].RcvXXEstReq.ucFlg)
    {
        /* VOLTE_EMC支持CS域尝试失败后去IMS域尝试,一轮搜网失败后紧急呼需要通知给CC */
...
VOS_VOID NAS_MM_RcvSysInfo_CSFB(VOS_VOID)
{
    ...
    switch (enCsfbServiceStatus)
    {
        case NAS_MML_CSFB_SERVICE_STATUS_MO_NORMAL_CC_EXIST:
            ...
            NAS_NORMAL_LOG(WUEPS_PID_MM, "NAS_MM_RcvSysInfo_CSFB: CSFB MO CC:lai change or NOT U1 trigger lau");
        ...
        case NAS_MML_CSFB_SERVICE_STATUS_MO_NORMAL_SS_EXIST:
            ...
            NAS_NORMAL_LOG(WUEPS_PID_MM, "NAS_MM_RcvSysInfo_CSFB: CSFB MO SS: lai change or NOT U1 trigger lau");
        ...
        case NAS_MML_CSFB_SERVICE_STATUS_MO_NORMAL_LCS_EXIST:
             ...
             && (NAS_MML_LOCATION_UPDATE_STATUS_UPDATED == enCsUpdateStatus))
            {
                ...
                /* 无缓存的LCS业务，进行异常处理 */
                NAS_WARNING_LOG(WUEPS_PID_MM, "NAS_MM_RcvSysInfo_CSFB: No Buffered LCS_EST_REQ.");

                NAS_MM_ProcCsfbServiceStatusChange(NAS_MML_GetCsfbServiceStatus(), NAS_MML_CSFB_SERVICE_STATUS_NOT_EXIST);
                return;
            }

            NAS_NORMAL_LOG(WUEPS_PID_MM, "NAS_MM_RcvSysInfo_CSFB: CSFB MO LCS:lai change or NOT U1 trigger lau");

            /* 发起LAU流程，LAU成功后进行CSFB的LCS业务 */
            g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_NORMAL_LU;
        ...
        case NAS_MML_CSFB_SERVICE_STATUS_MT_EXIST:
            ...
            NAS_NORMAL_LOG(WUEPS_PID_MM, "NAS_MM_RcvSysInfo_CSFB: CSFB MT:lai change or NOT U1 trigger lau");
        ...
        case NAS_MML_CSFB_SERVICE_STATUS_MO_EMERGENCY_EXIST:
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "NAS_MM_RcvSysInfo_CSFB: CSFB MO EMERGENCY: trigger lau");
...
VOS_VOID NAS_MM_ChangeToLikeBTriggerBySysInfo_MmIdleNormalService(VOS_VOID)
{
    VOS_UINT32                          ulIsRadioCapNeedTriggerLau;

    ulIsRadioCapNeedTriggerLau          = VOS_FALSE;

    NAS_MM_SetLikeBFlg();

    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_INFO, "NAS_MM_ChangeToLikeBTriggerBySysInfo_MmIdleNormalService:INFO: MmLikeB is MM_TRUE");

    ulIsRadioCapNeedTriggerLau          = NAS_MM_IsRadioAccessCapNeedTriggerLau();

    if ((VOS_TRUE == NAS_MML_IsCampLaiInfoChanged())
     || (VOS_TRUE == ulIsRadioCapNeedTriggerLau) )
    {
        NAS_NORMAL_LOG2(WUEPS_PID_MM, "NAS_MM_ChangeToLikeBTriggerBySysInfo_MmIdleNormalService,LAU cause:ulIsRadioCapNeedTriggerLau =; NAS_MML_IsCampLaiInfoChanged =",ulIsRadioCapNeedTriggerLau,NAS_MML_IsCampLaiInfoChanged());
    ...
    else
    {
        ...
        PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL, "NAS_MM_ChangeToLikeBTriggerBySysInfo_MmIdleNormalService:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
    }
}
...
VOS_VOID Mm_Cell_S3_E5(VOS_VOID *pRcvMsg)
{
        ...
        ((g_MmGlobalInfo.MsCsInfo.ucCellChgFlg == MM_TRUE) && (MM_TRUE == g_MmGlobalInfo.LuInfo.ucRetryFlg)))
    {
        ...
        {
            NAS_NORMAL_LOG3(WUEPS_PID_MM, "Mm_Cell_S3_E5,t3211 running,ulLaiChangeFlag; ucCellChgFlg; ucRetryFlg",ulLaiChangeFlag,g_MmGlobalInfo.MsCsInfo.ucCellChgFlg,g_MmGlobalInfo.LuInfo.ucRetryFlg);
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
        NAS_NORMAL_LOG2(WUEPS_PID_MM, "Mm_Cell_S3_E5,classA and NMODEI, ucNtMod; ucNewNtMod",g_MmGlobalInfo.ucNtMod, g_MmGlobalInfo.ucNewNtMod);
        ...
        if ((MM_UNSUPPORT_GPRS == g_MmGlobalInfo.usRac)
         || (MMCMM_FORBIDDEN_PLMN_FOR_GPRS == g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg))
        {
            NAS_MM_ChangeToLikeBTriggerBySysInfo_MmIdleNormalService();
        }
        else
        {                                                                       /* RAC不等于0                               */
            if ( VOS_TRUE == ulLaiChangeFlag )
    ...
    {                                                                           /* 非A+I模式                                */
        ...
        if (VOS_TRUE == NAS_MM_IsRadioAccessCapNeedTriggerLau())
        {
            NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S3_E5:NAS_MM_IsRadioAccessCapNeedTriggerLau is true");
        ...
        {
            NAS_NORMAL_LOG2(WUEPS_PID_MM, "Mm_Cell_S3_E5,Mm_ComNetModeChange ENTER,ucNtMod; ucNewNtMod",g_MmGlobalInfo.ucNtMod, g_MmGlobalInfo.ucNewNtMod);
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S3_E5,T3211 TRIGGER LAU");
                ...
                else
                {
                    ...
                    {
                        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S3_E5: lai not change,T3212 expired trigger lau");
                    ...
                    if (VOS_TRUE == NAS_MM_IsDisableGprsCombineAttach())
                    {
                        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S3_E5,NAS_MM_IsDisableGprsCombineAttach is true");
                ...
                if (enCurrentNetRatType != g_MmGlobalInfo.enPreRatType)
                {
                    ...
                    NAS_NORMAL_LOG2(WUEPS_PID_MM, "Mm_Cell_S3_E5,enCurrentNetRatType, g_MmGlobalInfo.enPreRatType", enCurrentNetRatType,g_MmGlobalInfo.enPreRatType);
...
)
{
    ...
    else
    {
        if (WAIT_FOR_RR_CONNECTION_MM_CONNECTION == g_MmGlobalInfo.ucSuspendPreState)
        {
            ...
            NAS_MM_RelEstingMmConn(NAS_MMCM_REL_CAUSE_MM_INTER_ERR_INTER_RAT_SYSTEM_CHANGE);
