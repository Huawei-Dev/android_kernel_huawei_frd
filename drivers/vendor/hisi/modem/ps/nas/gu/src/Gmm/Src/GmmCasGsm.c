...
VOS_UINT32 NAS_GMM_GasSysInfoPreCheck(VOS_VOID *pMsg)
{
      ...
      && (MMC_GMM_NO_FORBIDDEN == pSysInfoMsg->ulForbiddenFlg) )
    {
         ...
         || (RRC_NAS_ACCESS_RESTRICTION_ALL_SERVICE     == pSysInfoMsg->unAcInfo.ucRestrictType))
        {
            ...
            NAS_NORMAL_LOG1(WUEPS_PID_GMM, "NAS_GMM_GasSysInfoPreCheck  NAS_GMM_GsmAccessBarredProcess returnVal=", ulResult);
...
VOS_VOID GMM_CasCellS1E49(VOS_VOID *pRcvMsg)
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS1E49 NotSupportGprs is true");
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS1E49 ulForbiddenFlg=", pSysInfo->ulForbiddenFlg);
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS1E49 ucRaiChgFlg trigger ATTACH");
...
VOS_VOID GMM_CasCellS4E49(VOS_VOID *pRcvMsg)
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS4E49 NotSupportGprs");
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS4E49 ulForbiddenFlg=", pSysInfo->ulForbiddenFlg);
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS4E49 ucRaiChgFlg Trigger attach");
    ...
    {                                                                           /* DRX改变                                  */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS4E49 ucDrxLengthChgFlg Trigger attach");
    ...
    else
    {
        ...
        {                                                                       /* 换小区需要进行attach                     */
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS4E49 GsmCellChgFlg Trigger attach");
        ...
        else
        {
            ...
            {
                NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS4E49 T3302 T3311 not running Trigger attach, T3302Len=", g_GmmTimerMng.aTimerInf[GMM_TIMER_T3302].ulTimerVal);
...
VOS_VOID GMM_CasCellS8E49(VOS_VOID *pRcvMsg)
{
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS8E49 ulForbiddenFlg=", pSysInfo->ulForbiddenFlg);
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS8E49 RaiChgFlg Trigger attach");
...
VOS_VOID GMM_CasCellS9E49(VOS_VOID *pRcvMsg)
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS9E49 NotSupportGprs");
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS9E49 ForbiddenFlg=", pSysInfo->ulForbiddenFlg);
    ...
    {                                                                           /* DRX改变                                  */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS9E49 DrxLengthChgFlg trigger rau");
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG2(WUEPS_PID_GMM, "GMM_CasCellS9E49 raichg or gprsResume trigg rau, ucRaiChgFlg= ucGprsResumeFlg=", ucRaiChgFlg, g_GmmGlobalCtrl.ucGprsResumeFlg);
    ...
    else if (GMM_TRUE == g_GmmRauCtrl.ucT3312ExpiredFlg)
    {
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS9E49 T3312 Expired and T3311 not running trig rau");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS9E49 UeInfoChangeTriggerRau");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS9E49 A+I trigger rau");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS9E49 A+I: RaiChgFlg trigger rau");
...
VOS_VOID GMM_CasCellS10E49(VOS_VOID *pRcvMsg)
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS10E49: NotSupportGprs");
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS10E49: ulForbiddenFlg=", pSysInfo->ulForbiddenFlg);
    ...
    {                                                                           /* 小区改变                                 */
        ...
        if (GMM_TRUE == ucRauFlg)
        {
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS10E49: T3312Expired true and SysRauFlg false trigger RAU");
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS10E49: T3312Expired false or SysRauFlg true trigger RAU");
        ...
        else
        {
...
#endif
            {
                ...
                && (0 != g_GmmTimerMng.aTimerInf[GMM_TIMER_T3302].ulTimerVal))
                {                                                                       /* Timer3302在运行中                        */
                    NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS10E49: NOT GU1 trigger RAU, T3302 TimerLen=", g_GmmTimerMng.aTimerInf[GMM_TIMER_T3302].ulTimerVal);
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS10E49: ucT3312ExpiredFlg trigger RAU");
            ...
            {
                NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS10E49: ucLastDataSender=", gstGmmCasGlobalCtrl.ucLastDataSender);
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS10E49: UeInfoChangeTriggerRau");
...
VOS_VOID GMM_CasCellS11E49(VOS_VOID *pRcvMsg)
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS11E49: NotSupportGprs");
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS11E49: ulForbiddenFlg=", pSysInfo->ulForbiddenFlg);
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS11E49: ucRaiChgFlg trigger rau");
    ...
    {                                                                           /* DRX改变                                  */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS11E49: ucDrxLengthChgFlg trigger rau");
    ...
    else
    {
        if ((GMM_TRUE == g_GmmRauCtrl.ucRetryFlg)
         && (GMM_TRUE == gstGmmCasGlobalCtrl.TempMsgPara.ucGsmCellChgFlg))
        {                                                                       /* 换小区需要进行RAU                        */
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS11E49: ucGsmCellChgFlg trigger rau");
...
VOS_VOID NAS_GMM_EnterCoveryRaiNoChg_BeforeT3312Exp(VOS_VOID)
{
       ...
       && ( gstGmmCasGlobalCtrl.ucLastDataSender == enRatType ))
    {
        ...
        {                                                               /* 非A+I                                    */
            ...
            g_GmmGlobalCtrl.ucSpecProc = GMM_RAU_NORMAL;
            PS_NAS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_LOG_LEVEL_INFO, "NAS_GMM_EnterCoveryRaiNoChg_BeforeT3312Exp:INFO: normal RAU procedure started");
        ...
        {                                                               /* A+I                                      */
            ...
            {                                                           /* 更新状态不是U1                           */
                ...
                {
                    NAS_NORMAL_LOG1(WUEPS_PID_GMM, "NAS_GMM_EnterCoveryRaiNoChg_BeforeT3312Exp: cs NOT U1 trigger RAU, CsAttachAllow is", ucCsAttachAllow);
                    Gmm_RoutingAreaUpdateInitiate(
                                        GMM_UPDATING_TYPE_INVALID);     /* 调用RAU                                  */
                }
            }
        }
        PS_NAS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_LOG_LEVEL_INFO, "NAS_GMM_EnterCoveryRaiNoChg_BeforeT3312Exp:INFO: specific procedure ended");
        g_GmmGlobalCtrl.ucRealProFlg = GMM_REAL_PROCEDURE;              /* 设置真流程标志                           */
    }
    else
    {                                                                   /* 更新状态不是GU1                          */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_EnterCoveryRaiNoChg_BeforeT3312Exp: ps NOT U1 trigger RAU");
...
VOS_VOID NAS_GMM_EnterCoveryRaiNoChg_AfterT3312Exp(VOS_VOID)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_EnterCoveryRaiNoChg_AfterT3312Exp: trigger RAU");
...
VOS_VOID NAS_GMM_EnterCovery(VOS_VOID *pRcvMsg)
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS11E49: ucNotSupportGprs");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS11E49: UeInfoChangeTriggerRau");
    ...
    {                                                                           /* RA改变或者DRX参数变化                    */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS11E49: rai or drx chg trigger RAU");
...
VOS_VOID GMM_CasCellS18E49(VOS_VOID *pRcvMsg)
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS18E49: NotSupportGprs");
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS18E49: ulForbiddenFlg=", pSysInfo->ulForbiddenFlg);
    ...
    {                                                                           /* RA改变或者DRX改变                        */
        NAS_NORMAL_LOG2(WUEPS_PID_GMM, "GMM_CasCellS18E49: RaiChg or DrxChg trigger RAU, ucRaiChgFlg=, ucDrxLengthChgFlg=", ucRaiChgFlg, ucDrxLengthChgFlg);
...
VOS_VOID GMM_CasCellS19E49(VOS_VOID *pRcvMsg)
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS19E49: ucNotSupportGprs");
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasCellS19E49: ulForbiddenFlg", pSysInfo->ulForbiddenFlg);
        Gmm_TimerStop(GMM_TIMER_T3330);                                         /* 停T3330                                  */
        Gmm_TimerStop(GMM_TIMER_T3318);                                         /* 停止T3318                                */
        Gmm_TimerStop(GMM_TIMER_T3320);                                         /* 停止T3320                                */
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS19E49: RaiChg trigger RAU");
...
VOS_VOID GMM_RcvGasSysInfoInd_SuspWaitSys(VOS_VOID *pRcvMsg)
{
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS19E49: ucRaiChgFlg TRUE");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS19E49: ucRelCause IS SINGNALING_CONNECTION_RE_ESTABLISHMENT");
    ...
    else
    {
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasCellS19E49: UeInfoChangeTriggerRau");
...
VOS_VOID GMM_RcvGasRadioAccessCapa( VOS_VOID *pRcvMsg )
{
    ...
    NAS_MML_PLMN_RAT_PRIO_STRU                              stMsNotifyNwCsRatPrioList;
    ...
    else
    {
                    ...
                    pstRacMsg->aucData, MS_RADIO_ACCESS_CAPABILITY_MAX_SIZE))
        {
            ...
            /* 通知MM，在RAT-BALANCING 特性开启时候，RAT变化则触发LAU流程 */
            NAS_GMM_SndMmRadioAccesCapaChangeInd();
            ...
            {
                NAS_MML_GetMsCsCurrRatCapabilityList(&stMsNotifyNwCsRatPrioList);
                
                /* 如果RatBalacing nv开，且RAT改变,需先做LAU */
                if ((VOS_TRUE == NAS_MML_GetRatBalancingEnableFlg())
                 && (VOS_TRUE == NAS_MML_IsMsRatCapabilityChanged(&stMsNotifyNwCsRatPrioList, NAS_MML_GetMsNotifyNwCsPrioRatList())))
                {
                    Gmm_TimerStart(GMM_TIMER_DELAY_RADIO_CAPA_TRIGED_RAU);
                    return;
                }

                NAS_GMM_HandleMsRadioCapGulModeChanged();
            }
#endif
        }
...
VOS_VOID NAS_GMM_ProcSavedMmT3211ExpiredNotify(VOS_VOID)
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_ProcSavedMmT3211ExpiredNotify: plmn not support dam");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_GetMmT3211ExpiredDelayRauFlag is true");
    ...
    if (GMM_REGISTERED_NORMAL_SERVICE == g_GmmGlobalCtrl.ucState)
    {
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_ProcSavedMmT3211ExpiredNotify trigger rau");
