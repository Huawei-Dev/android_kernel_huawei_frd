...
extern  const   MM_CELL_FUN_TYPE*       gaMmStateTable[];
...
extern VOS_VOID NAS_MM_RcvGmmRadioAccessCapChangeInd_MmIdleNormalService(
    VOS_VOID                            *pRcvMsg
);

extern VOS_VOID NAS_MM_RcvGmmRadioAccessCapChangeInd_WaitForLauRrConnnection(
    VOS_VOID                            *pRcvMsg
);
...
#if (FEATURE_ON == FEATURE_IMS)
VOS_VOID NAS_MM_RcvMmcImsSrvInfoNotify(
    VOS_VOID                           *pstRcvMsg
);
#endif
...
VOS_VOID NAS_MM_RcvMmcPowerOffNotify(
    VOS_VOID                           *pstRcvMsg
);
...
extern VOS_UINT32 NAS_MM_IsMmConnExist(
    NAS_MM_CONN_CTRL_ENUM_UINT8         enMmConnCtrl,
    VOS_UINT32                          ulTransactionId
);

extern VOS_UINT32 NAS_MM_IsCsServiceBuffered(
    NAS_MM_CONN_CTRL_ENUM_UINT8         enMmConnCtrl,
    VOS_UINT32                          ulTransactionId
);

extern VOS_VOID NAS_MM_ClearConnCtrlInfoWithBuffer(
    NAS_MM_CONN_CTRL_ENUM_UINT8         enMmConnCtrl
);

extern VOS_VOID NAS_MM_UpdateMmConnByTi(
    NAS_MM_CONN_CTRL_ENUM_UINT8         enMmConnCtrl,
    VOS_UINT32                          ulTransactionId,
    NAS_MM_CONN_STATE_ENUM_UINT8        enMmConnState
);

extern VOS_VOID NAS_MM_BuildLcsEstReqFromBuffer(
    LCS_MM_EST_REQ_STRU                *pstLcsEstReq
);

extern VOS_VOID NAS_MM_ClearAllMmConn(VOS_VOID);

extern RRMM_TRANSACTION_STATUS_ENUM_UINT8 NAS_MM_ConvertLcsStatusToTransactionStatus(
    NAS_LCS_STATUS_ENUM_UINT8           enLcsStatus
);

extern VOS_VOID NAS_MM_UpdateLcsStatus(
    NAS_LCS_STATUS_ENUM_UINT8           enLcsStatus
);


extern VOS_VOID NAS_MM_RcvCcEstReq_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvGmmActionRsltInd_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvGmmAuthFailureInd_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvGmmGprsDetachIni_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvGmmGprsDetechCmpl_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvGmmLuInitiation_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvGmmNetworkDetachInd_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvMmcAttachReq_RrConnRelNotAllow(VOS_VOID *pMsg);
extern VOS_VOID NAS_MM_RcvMmcCoverageLostInd_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvMmcDetachReq_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvMmcModeChangeReq_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvMmcPowerOffReq_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvMmcRelReq_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvMmcStartReq_RrConnRelNotAllow(VOS_VOID *pMsg);
extern VOS_VOID NAS_MM_RcvMmcSysinfoInd_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvRrDataIndCc_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvRrDataIndMmInfo_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvRrDataIndSms_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvRrDataIndSs_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvRrRelInd_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvSmsEstReq_RrConnRelNotAllow(VOS_VOID* pMsg);
extern VOS_VOID NAS_MM_RcvSsEstReq_RrConnRelNotAllow(VOS_VOID* pMsg);

extern VOS_VOID Mm_ComUpdateUsimFileReq(VOS_VOID);
