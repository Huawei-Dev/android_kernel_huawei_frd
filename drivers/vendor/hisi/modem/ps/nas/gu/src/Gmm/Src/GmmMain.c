...
)
{
    ...
    else
    {
        ...
        else if ((WUEPS_PID_MMC == pMsgHeader->ulSenderPid)
            && (MMCGMM_POWER_OFF_NOTIFY == pMsgHeader->ulMsgName))
        {
            Gmm_RcvMmcPowerOffNotify((VOS_VOID*)pMsg);
        }
        else
        {
                       ...
                       )
{
        ...
        || (GMM_DETACH_NORMAL_SIM_REMOVE == g_GmmGlobalCtrl.ucSpecProc))
    {
            ...
            || (WUEPS_PID_TC == pNasMsgHeader->ulSenderPid))
        {
            ...
            if ((WUEPS_PID_MMC == pNasMsgHeader->ulSenderPid)
             && (MMCGMM_POWER_OFF_NOTIFY == pNasMsgHeader->ulMsgName))
            {
                ucRst = GMM_TRUE;
            }
            else
...
)
{
    ...
    case MMCGMM_POWER_OFF_NOTIFY:
        Gmm_RcvMmcPowerOffNotify(pRcvMsg);                                     /* MMCGMM_POWER_OFF_NOTIFY接收处理             */
        break;
                           ...
                           )
{
    ...
    for (i = 0; i < NAS_MML_MAX_PS_BEARER_NUM; i++)
    {
        ...
        if (GMMSM_PDP_STATE_ACTIVE == pSmPdpStatusInd->aucPdpContextStatus[i])
        {
            ...
            {
                /* 将连接状态报到MTC */
                NAS_MEM_SET_S(&stMmaMtcConnStInfo, sizeof(TAF_MTC_SRV_CONN_STATE_INFO_STRU), 0, sizeof(TAF_MTC_SRV_CONN_STATE_INFO_STRU));
                NAS_MEM_SET_S(&stCtrl, sizeof(stCtrl), 0x0, sizeof(stCtrl));

                /* 填写CTL头 */
                TAF_API_CTRL_HEADER(&stCtrl, WUEPS_PID_GMM, 0, 0);

                stMmaMtcConnStInfo.bitOpPsSrv       = VOS_TRUE;
                stMmaMtcConnStInfo.enPsSrvConnState = TAF_MTC_SRV_EXIST;

                MTC_SetModemServiceConnState(&stCtrl, &stMmaMtcConnStInfo);
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvSmPdpStatusInd: gmm call MTC_SetModemServiceConnState");
            }
#endif
        }
...
VOS_VOID Gmm_RcvMmcPlmnSearchInitiated(VOS_VOID)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcPlmnSearchInitiated: Ps Not In Dam No Search Status");
...
)
{
    ...
    {                                                                           /* 有信令或没有信令且还没建信令             */
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmCsConnectInd_InProc: trigger RAU");
                       ...
                       )
{
    ...
    case RRC_EST_RJ_NO_RF:
        g_GmmGlobalCtrl.ucRelCause = RR_REL_CAUSE_RR_CONNECTION_FAILURE_NO_RF;
        break;
    ...
    case RRC_EST_RJ_FASTRETURN_LTE:
        g_GmmGlobalCtrl.ucRelCause = RR_REL_CAUSE_RR_CONNECTION_FAILURE_FAST_RETURN;
        break;
    default:
                       ...
                       )
{
    ...
    if (NAS_MML_NET_RAT_TYPE_WCDMA == NAS_MML_GetCurrNetRatType())
    {
        NAS_MML_SetPsRelCause(pRrRelInd->ulRelCause);
    }
...
VOS_VOID Gmm_RcvRrmmRelInd_RegInit(RRMM_REL_IND_STRU *pRrRelInd)
{
    ...
    if (VOS_TRUE ==  ucRst)
    {
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvRrmmRelInd_RegInit: retry ATT");
                               ...
                               )
{
    ...
    if (VOS_TRUE ==  ucRst)
    {
        if (RRC_RRC_CONN_STATUS_PRESENT == pRrRelInd->ulRrcConnStatus )
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvRrmmRelInd_RauInit: Rrc present trigger RAU");
...
)
{
     ...
     && (NAS_MML_NET_RAT_TYPE_GSM   == gstGmmSuspendCtrl.ucPreRat))
    {
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvSmDataReq_SuspendWaitForSysinfo: ho g2w trigger RAU");
...
VOS_VOID Gmm_RcvCmServReq_RegAtmpToUpdt(VOS_VOID *pMsg)
{
      ...
      && (VOS_FALSE == ulIsPlmnInSupportDamPlmnInfo))
    {
        ...
        */
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvCmServReq_RegAtmpToUpdt: trigger RAU");
...
VOS_VOID Gmm_RcvCmServReq_DeregAtmpToAtch(VOS_VOID *pMsg)
{
      ...
      && (VOS_FALSE == ulIsPlmnInSupportDamPlmnInfo))
    {
        ...
        */
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvCmServReq_DeregAtmpToAtch: set ucSmCnfFlg and ucFollowOnFlg to TRUE");
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvCmServReq_DeregAtmpToAtch: retry ATT");
                                  ...
                                  )
{
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegInit ulForbiddenMask is;",pSysInfo->ulForbiddenMask);
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegInit: trigger attach: ucRaiChgFlg is true and ucRetryAttachForRelCtrlFlg is;",g_GmmAttachCtrl.ucRetryAttachForRelCtrlFlg);
    ...
    {                                                                           /* DRX改变                                  */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegInit ucDrxLengthChgFlg is true ");
                                    ...
                                    )
{
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregInit ulForbiddenMask=",pSysInfo->ulForbiddenMask);
        Gmm_TimerStop(GMM_TIMER_T3321);                                         /* 停T3321                                  */
        ...
        == g_GmmGlobalCtrl.ucRelCause)
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregInit trigger rau: ucRelCause is singnal conn reestablish");
    ...
    {                                                                           /* RA改变或者DRX改变                        */
        NAS_NORMAL_LOG3(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregInit trigger rau: ucRaiChgFlg =, ucDrxLengthChgFlg =, ucAttachSta =;", ucRaiChgFlg, ucDrxLengthChgFlg, g_MmSubLyrShare.GmmShare.ucAttachSta);
        Gmm_TimerStop(GMM_TIMER_T3321);                                         /* 停T3321                                  */
        Gmm_TimerStop(GMM_TIMER_T3318);                                         /* 停止T3318                                */
        Gmm_TimerStop(GMM_TIMER_T3320);                                         /* 停止T3320                                */
    ...
    else if (VOS_TRUE == g_GmmDetachCtrl.ucRetryDetachForRelCtrlFlg)
    {
        ...
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregInit ucRetryDetachForRelCtrlFlg is true and ucDetachType =", ucDetachType);
                                  ...
                                  )
{
    ...
    {                                                                           /* 在forbidden列表中                        */
        ...
        NAS_GMM_SndMmcActionResultIndWhenInForbiddenList(pSysInfo->ulForbiddenMask);
             ...
             == g_GmmGlobalCtrl.ucRelCause)
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RauInit ucRelCause is singnal conn reestablish");
    ...
    {                                                                           /* RA改变                                   */
        ...
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RauInit trigger RAU: ucRaiChgFlg is true, or ucRetryAttachForRelCtrlFlg =;", g_GmmRauCtrl.ucRetryRauForRelCtrlFlg);
        Gmm_TimerStop(GMM_TIMER_T3330);                                         /* 停T3330                                  */
        Gmm_TimerStop(GMM_TIMER_T3318);                                         /* 停止T3318                                */
        Gmm_TimerStop(GMM_TIMER_T3320);                                         /* 停止T3320                                */
    ...
    {                                                                           /* DRX改变                                  */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RauInit ucDrxLengthChgFlg is true");
        g_GmmGlobalCtrl.MsgHold.ucHandleRauFlg = GMM_TRUE;                      /* 流程结束之后进行RAU                      */
        g_GmmGlobalCtrl.MsgHold.ucInitiateLuFlg = GMM_TRUE;                     /* 标记GMM不能进行RAU时要触发MM的LU过程     */
    }
    else
                                      ...
                                      )
{
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_ServReqInit ulForbiddenMask=",pSysInfo->ulForbiddenMask);
        Gmm_TimerStop(GMM_TIMER_T3311);                                         /* 停T3311                                  */
        Gmm_TimerStop(GMM_TIMER_T3302);                                         /* 停T3302                                  */
        Gmm_TimerStop(GMM_TIMER_T3317);                                         /* 停T3317                                  */
    ...
    {                                                                           /* RA改变或者DRX改变                        */
        NAS_NORMAL_LOG2(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_ServReqInit trigger RAU: ucRaiChgFlg=,ucDrxLengthChgFlg=",ucRaiChgFlg, ucDrxLengthChgFlg);
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_ServReqInit RAI and DRX not chg");
                                       ...
                                       )
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregNmlServ ucNotSupportGprs",g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs);
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregNmlServ ulForbiddenMask", pSysInfo->ulForbiddenMask);
                                          ...
                                          )
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregAtmpToAtch ucNotSupportGprs", g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs);
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregAtmpToAtch ulForbiddenMask", pSysInfo->ulForbiddenMask);
    ...
    {                                                                           /* RA改变                                   */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregAtmpToAtch RaiChgFlg trigger ATT");
    ...
    {                                                                           /* DRX改变                                  */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregAtmpToAtch: DrxChgFlg trigger ATT");
    ...
    else
    {
        ...
        {                                                                       /* 换小区需要进行attach                     */
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregAtmpToAtch: cell chg trigger ATT");
        ...
        else
        {
            ...
            {
                NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregAtmpToAtch: T3302 T3311 not runing trigger ATT: T3302 TimerLen=", g_GmmTimerMng.aTimerInf[GMM_TIMER_T3302].ulTimerVal);
            ...
            else
            {
                ...
                if ((VOS_TRUE == NAS_MML_GetCsAttachAllowFlg())
                 && (GMM_NET_MODE_I == g_GmmGlobalCtrl.ucNetMod))
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_DeregAtmpToAtch NetModI and cs attach allow");
                                     ...
                                     )
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNmlServ: GMM_NOT_SUPPORT_GPRS");
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNmlServ ulForbiddenMask is",pSysInfo->ulForbiddenMask);
    ...
    {                                                                           /* DRX改变                                  */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "ucDrxLengthChgFlg trigger rau");
    ...
    else if (RR_REL_CAUSE_DIRECTED_SINGNALING_CONNECTION_RE_ESTABLISHMENT == g_GmmGlobalCtrl.ucRelCause)
    {
        ...
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "RR_REL_CAUSE_DIRECTED_SINGNALING_CONNECTION_RE_ESTABLISHMENT trigger rau, ucSpecProcHold is",g_GmmGlobalCtrl.ucSpecProcHold);
    ...
    {                                                                           /* RA改变                                   */
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "enServReq is GMM_SERVICE_REQ_PDPACT");
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "ATTEMPTING_TO_UPDATE_MM trigger rau:GMM_COMBINED_RALAU_WITH_IMSI_ATTACH");
        ...
        {
            NAS_NORMAL_LOG1(WUEPS_PID_GMM, "rai change trigger rau:ucRaiChgFlg is;",ucRaiChgFlg);
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_IsUeInfoChangeTriggerRau is true");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "ucRetrySrForRelCtrlFlg is true");
          ...
          && (VOS_FALSE == ucCsRestrictionFlg))
    {
        ...
        {                                                                   /* CS通信中的normal RAU(A+I)                */
            if (GMM_FALSE == g_GmmGlobalCtrl.CsInfo.ucCsTransFlg)
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "cs trans is false and  ucGsAssociationFlg is false triger GMM_COMBINED_RALA_UPDATING ");
        ...
        {                                                                   /* CS通信中的normal attach(A+I)             */
            if (GMM_FALSE == g_GmmGlobalCtrl.CsInfo.ucCsTransFlg)
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "attach normal cs trans is false triger GMM_COMBINED_RALAU_WITH_IMSI_ATTACH ");
        ...
        else
        {
            ...
            else if (GMM_TRUE == g_GmmRauCtrl.ucT3312ExpiredFlg)
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "t3212 expired and t3311 not running trigger periodic rau ");
            ...
            */
                ...
                && (GMM_REGISTERED_NORMAL_SERVICE == g_GmmGlobalCtrl.ucState))
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "normal service and follow on is true ");
    ...
    else
    {
        ...
        */
            ...
            && (GMM_REGISTERED_NORMAL_SERVICE == g_GmmGlobalCtrl.ucState))
        {
            ...
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "normal service and follow on flg is true ");
        ...
        if ((VOS_FALSE == NAS_GMM_QryTimerStatus(GMM_TIMER_T3311))
         ...
         && (GMM_REGISTERED_NORMAL_SERVICE == g_GmmGlobalCtrl.ucState))
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "t3312 expired and t3311 not running and curr is normal srvice");
                                     ...
                                     )
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch ucNotSupportGprs=", g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs);
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch ulForbiddenMask=", pSysInfo->ulForbiddenMask);
    ...
    {                                                                           /* DRX改变                                  */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch: drx change trigger RAU");
    ...
    {
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch ucRelCause=", g_GmmGlobalCtrl.ucRelCause);
    ...
    {                                                                           /* RA改变                                   */
        ...
        if (GMM_SERVICE_REQ_PDPACT == g_GmmGlobalCtrl.enServReq)
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch enServReq is PDPACT");
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch RaiChg Trig rau");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch UeInfoChangeTriggerRau");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch ucRetrySrForRelCtrlFlg is true");
        ...
        Gmm_DealWithBuffAfterProc();
          ...
          && (VOS_FALSE == ucCsRestrictionFlg))
    {
        NAS_NORMAL_LOG3(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch trigger rau: ucSpecProcInCsTrans=, ucCsTransFlg=,ucGsAssociationFlg=",
                                        g_GmmGlobalCtrl.ucSpecProcInCsTrans, g_GmmGlobalCtrl.CsInfo.ucCsTransFlg, g_MmSubLyrShare.GmmShare.ucGsAssociationFlg);
        ...
        else
        {
            ...
            if (GMM_TRUE == g_GmmRauCtrl.ucT3312ExpiredFlg)
            {
                ...
                if (VOS_FALSE == NAS_GMM_QryTimerStatus(GMM_TIMER_T3311))
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch T3312Expired and T3311 not runing trigger RAU");
                    Gmm_RoutingAreaUpdateInitiate(GMM_PERIODC_UPDATING);
                    g_GmmGlobalCtrl.ucSpecProcInCsTrans = GMM_NULL_PROCEDURE;
                }
            }
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch T3311Expired trigger RAU");
    ...
    else
    {
        if (GMM_TRUE == g_GmmRauCtrl.ucT3312ExpiredFlg)
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch T3312Expired trigger RAU");
        ...
        else if (GMM_FALSE == g_GmmRauCtrl.ucT3311ExpiredFlg)
        {
            if (NAS_MML_ROUTING_UPDATE_STATUS_UPDATED == NAS_MML_GetPsUpdateStatus())
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch T3311Expired is false and RAI not chg trigger RAU");
            ...
            else if (GMM_TRUE == g_GmmGlobalCtrl.ucFollowOnFlg)
            {
                ...
                */
                ...
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch ucFollowOnFlg true trigger RAU");
            ...
            else
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcSysInfoInd_RegPlmnSrch T3311 or T3302 not running true trigger RAU");
                                        ...
                                        )
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegUpdtNeed: Ue info change trigger RAU");
    ...
    {                                                                           /* 小区改变                                 */
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegUpdtNeed: gprs support trigger RAU");
                                        ...
                                        )
{
    ...
    {                                                                           /* RA改变                                   */
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegAtmpToUpdt: Rai chg trigger RAU");
    ...
    {                                                                           /* DRX改变                                  */
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegAtmpToUpdt: DRX chg trigger RAU");
    ...
    else
    {
        ...
        {                                                                       /* 换小区需要进行RAU                        */
            ...
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegAtmpToUpdt: Cell chg trigger RAU");
                                    ...
                                    )
{
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {                                                                           /* 不支持GPRS                               */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell ucNotSupportGprs=", g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs);
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell ulForbiddenMask=", pSysInfo->ulForbiddenMask);
    ...
    {                                                                           /* 回到原来的RA并且DRX参数没有改变          */
        ...
        {                                                                       /* 出覆盖区时T3312未溢出                    */
            ...
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell T3312Expired false");
            ...
            {                                                                   /* 更新状态是GU1                            */
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell GU1 and T3311Expired trigger RAU");
                ...
                else
                {
                    ...
                    {                                                               /* A+I                                      */
                        ...
                        {                                                           /* 更新状态不是U1,或者Gs关联已经移除                           */
                            ...
                            {
                                NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell not GU1 or ucGsAssociationFlg false, ,but cs reg trigger RAU");
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell NOT GU1 Trigger RAU");
        ...
        {                                                                       /* 出覆盖区时T3312溢出                      */
            ...
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell T3312Expired true");
            g_GmmGlobalCtrl.ucCvrgAreaLostFlg = GMM_FALSE;                      /* 清除出覆盖区标志                         */
            if ((VOS_TRUE != NAS_MML_GetCsAttachAllowFlg())
             || (GMM_NET_MODE_I != g_GmmGlobalCtrl.ucNetMod))
            {                                                                   /* 非A+I                                    */
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell NOT A+I trigger periodc RAU");
            ...
            {/* A+I 模式，但CS域被 BAR, 或者 当前 CS 通话中 */
                ...
                NAS_NORMAL_LOG2(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell A+I but CS not reg or restricted trigger periodc RAU: ucCsRestrictionFlg=, ucCsTransFlg=",
                                        ucCsRestrictionFlg, g_GmmGlobalCtrl.CsInfo.ucCsTransFlg);

                Gmm_RoutingAreaUpdateInitiate(GMM_PERIODC_UPDATING);
            }
            else
            {                                                                   /* A+I                                      */
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell A+I trigger combined rala with imsi attach RAU");
    ...
    {                                                                           /* RA改变或者DRX参数变化                    */
        ...
        if ((VOS_TRUE != NAS_MML_GetCsAttachAllowFlg())
         || (GMM_NET_MODE_I != g_GmmGlobalCtrl.ucNetMod))
        {                                                                       /* 非A+I                                    */
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell RA or DRX Chg, NOT A+I trigger RAU");

            Gmm_RoutingAreaUpdateInitiate(GMM_RA_UPDATING);
        }
        else
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_RegNoCell RA or DRX Chg, A+I trigger RAU");
...
VOS_VOID Gmm_RcvMmcSysInfoInd_SuspWaitSys(VOS_VOID* pRcvMsg,VOS_UINT8 ucRaiChgFlg,VOS_UINT8 ucLaiChgFlg)
{
    ...
    {                                                                           /* 在forbidden列表中                        */
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys ulForbiddenMask=", pSysInfo->ulForbiddenMask);
    ...
    {/* 新的RA,处理网络模式变更 */
        ...
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys raichg trigger rau, ucNetModeChange=", gstGmmSuspendCtrl.ucNetModeChange);
    ...
    else                                                                        /* RA 相同 */
    {
        ...
        {
            NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys rai NOT chg,trigger RAU: enTinType=", enTinType);
        ...
        else if (gstGmmCasGlobalCtrl.ucLastDataSender != NAS_MML_GetCurrNetRatType())
        {
            ...
            NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys ucLastDataSender=", gstGmmCasGlobalCtrl.ucLastDataSender);
            ...
            {
                NAS_NORMAL_LOG2(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys rai NOT chg, InterSystem trigger rau: ucT3312State=, ucFollowOnFlg=", gstGmmSuspendCtrl.ucT3312State, g_GmmGlobalCtrl.ucFollowOnFlg);
        ...
        /* NMO1下,不通过手机模式判断是否需要进行联合注册 */
              ...
              && (VOS_TRUE == g_MmSubLyrShare.GmmShare.ucGsAssociationFlg))
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys NMOI combined rau");
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys T3312Expired trigger rau");
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys UeInfoChangeTriggerRau");
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_SuspWaitSys NMOI GsAssociationFlg false trigger RAU");
...
)
{
    ...
    {                                                                           /* 设置RAI是否变化标志                      */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Get_Location_Change_info, Gmm_Compare_Rai:rai change");
    ...
    if (NAS_MML_NET_RAT_TYPE_LTE == gstGmmSuspendCtrl.ucPreRat)
    {
        ...
        */
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Get_Location_Change_info: No ISR and T3302 not running, set pucRaiChgFlg to true");
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Get_Location_Change_info: NAS_GMM_IsCsLaiChangeNeedRegister is true");
    ...
    {                                                                           /* 设置LAI是否变化标志                      */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_Get_Location_Change_info: LAI CHANGE IS TRUE");
...
VOS_UINT8 Gmm_RcvMmcSysInfoIndRelEstingLink(VOS_VOID)
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoIndRelEstingLink T3340 running,ucRaiChgRelFlg is true");
    ...
    if ((GMM_FALSE == g_GmmGlobalCtrl.ucSigConFlg)
        ...
        == (g_GmmReqCnfMng.ucCnfMask & GMM_RRC_RRMM_EST_CNF_FLG)))
    {                                                                       /* 无信令且正在建立信令连接                 */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoIndRelEstingLink ucSigConFlg is false and ucCnfMask with GMM_RRC_RRMM_EST_CNF_FLG ");
        ...
        else if (GMM_ROUTING_AREA_UPDATING_INITIATED == g_GmmGlobalCtrl.ucState)
        {
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "RAU INIT AND NOT GU1 TO ATTEMPT TO UPDATE, START T3311");
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "SERVICE INIT TO GMM_REGISTERED_NORMAL_SERVICE");
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "DEREG INIT TO GMM_REGISTERED_NORMAL_SERVICE");
    ...
    NAS_NORMAL_LOG3(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoIndRelEstingLink END ucSpecProcHold is; ucSpecProc is; ucRaiChgRelFlg is;",g_GmmGlobalCtrl.ucSpecProcHold,g_GmmGlobalCtrl.ucSpecProc,g_GmmGlobalCtrl.ucRaiChgRelFlg);
                                            ...
                                            )
{
    ...
    NAS_NORMAL_LOG3(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_Fill_pRaiTemp: ucRac is; aucLac[0] is; aucLac[1] is;",
            pRaiTemp->ucRac, pRaiTemp->Lai.aucLac[0], pRaiTemp->Lai.aucLac[1]);
                                                ...
                                                )
{
    ...
    else
    {
            ...
            && (GMM_REGISTERED_NORMAL_SERVICE == g_GmmGlobalCtrl.ucState))
        {
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_PreProcess_Handling: TRIGGER GMM_COMBINED_RALAU_WITH_IMSI_ATTACH");
                                            ...
                                            )
{
    ...
    NAS_NORMAL_LOG2(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_CSPS_INFO: pucNetMod is; ucNotSupportGprs is;",*pucNetMod, g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs);
...
)
{
    ...
    NAS_NORMAL_LOG2(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_ucNetModeChange_Handling,old ucNetMod is ; ucNetMod is; ",g_GmmGlobalCtrl.SysInfo.ucNetMod,ucNetMod);
    ...
    {                                                                           /* 网络模式变更                             */
        ...
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_ucNetModeChange_Handling,ucNetModeChange is ;",gstGmmSuspendCtrl.ucNetModeChange);
    }
    else
    {
...
{
    NAS_NORMAL_LOG3(WUEPS_PID_GMM, "Gmm_RcvMmcSysInfoInd_State_Distribute entered. ucRaiChgFlg, ucDrxLengthChgFlg, ucLaiChgFlg",
                                        ucRaiChgFlg, ucDrxLengthChgFlg, ucLaiChgFlg);
     ...
     && (GMM_TRUE == g_GmmGlobalCtrl.ucCvrgAreaLostFlg))
    {
        ...
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_REGISTERED_PLMN_SEARCH TO NO CELL AVAILABLE ucNeedChgServiceStatus is;",g_GmmGlobalCtrl.ucNeedChgServiceStatus);
    }
 ...
 */
    ...
    {
        NAS_NORMAL_LOG2(WUEPS_PID_GMM, "ucCellChgFlg is true:oldcellid is; newcellid is; ",g_GmmGlobalCtrl.SysInfo.ulCellId, ulNewCellId);
                                              ...
                                              )
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcRegisterInitiation_ServReqInit trigger RAU");
...
VOS_VOID Gmm_RcvMmcRegisterInitiation_DeregAtmpToAtch(VOS_VOID)
{
    ...
    */
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcRegisterInitiation_DeregAtmpToAtch trigger ATT");
...
VOS_VOID Gmm_RcvMmcRegisterInitiation_RegAtmpToUpdt(VOS_VOID)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_RcvMmcRegisterInitiation_RegAtmpToUpdt trigger RAU");
                                                  ...
                                                  VOS_UINT8 ucRaiChgFlg)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_ComNetModeChange_Netmode_I2II_Handling enter");
                                                            ...
                                                            VOS_UINT8 ucRaiChgFlg)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_ComNetModeChange_Netmode_II2I_Handling enter");
...
VOS_VOID Gmm_ComCnfHandle(VOS_VOID)
{
    ...
    NAS_NORMAL_LOG3(WUEPS_PID_GMM, "Gmm_ComCnfHandle g_GmmGlobalCtrl.ucSpecProc, enDetachType, ulMsgHoldMsk",g_GmmGlobalCtrl.ucSpecProc,g_GmmGlobalCtrl.stDetachInfo.enDetachType,g_GmmGlobalCtrl.MsgHold.ulMsgHoldMsk);
...
VOS_VOID NAS_GMM_ProcPsAcChgRegisterNetRaiChg()
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_ProcPsAcChgRegisterNetRaiChg trigger RAU");
...
{
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_ProcPsAcChgRegisterNetRaiNotChgT3312Expire trigger RAU");
...
VOS_VOID NAS_GMM_ProcPsAcChgRegisterNetRaiNotChgT3312NotExpire()
{
    ...
    if (NAS_MML_ROUTING_UPDATE_STATUS_UPDATED == NAS_MML_GetPsUpdateStatus())
    {
        ...
        else
        {
            ...
            else                                                                /* CS更新状态不是U1,或者Gs关联已经移除 */
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_ProcPsAcChgRegisterNetRaiNotChgT3312NotExpire: CS NOT U1,CS RegStatus ture trigger RAU");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_ProcPsAcChgRegisterNetRaiNotChgT3312NotExpire: NOT GU1 trigger RAU");
        /* 更新状态不是GU1,发起RAU */
        Gmm_RoutingAreaUpdateInitiate(GMM_UPDATING_TYPE_INVALID);
    }
}
...
)
{
    ...
    if (NAS_MML_RESTRICTION_BAR_TO_UNBAR == pstAcInfoChangeInd->enPsRestrictRegisterChange)
    {
        ...
        {                                                                           /* 小区改变                                 */
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcWasAcInfoChgInd_DeregAttNeeded: PS RESTRICTION_BAR_2_UNBAR trigger ATT");
            g_GmmAttachCtrl.ucAttachAttmptCnt = 0;
            Gmm_AttachInitiate(GMM_NULL_PROCEDURE);
        }
    }
...
)
{
    ...
    else
    {
        ...
        if ((VOS_TRUE == NAS_MML_GetSimCsRegStatus())
         ...
         && (GMM_FALSE == g_GmmGlobalCtrl.CsInfo.ucCsTransFlg))
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcWasAcInfoChgInd_RegNmlServ: CS REstriction bar2Unbar trigger RAU");
...
VOS_UINT8 NAS_GMM_GetAttachProcType(VOS_VOID)
{
...
VOS_VOID NAS_GMM_RcvMmCsConnectInd_RrcConnExist(VOS_VOID)
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmCsConnectInd_RrcConnExist: trigger RAU");
...
)
{
    ...
    */
    ...
    if ((GMM_REGISTERED_NORMAL_SERVICE == g_GmmGlobalCtrl.ucState)
     || (GMM_REGISTERED_ATTEMPTING_TO_UPDATE_MM == g_GmmGlobalCtrl.ucState))
    {
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvMmcVoiceDomainChangeNotify: trigger RAU");
