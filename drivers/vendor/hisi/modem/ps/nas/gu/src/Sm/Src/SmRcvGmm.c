...
VOS_VOID SM_RcvNwActPdpCntxtRejMsg(SM_NW_MSG_STRU *pMsgIe)
{
        ...
        == g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucState )
    {
        ...
        if ( 0 != g_SmPdpAddrApn.aPdpAddrlist[ucAddrIndex].stUnPackPdpApn.ulApnLength )
        {
            ...
            stMaintainPara.ucCnCause   = pMsgIe->SmCause;
 ...
 )
{
    ...
    {                                                                           /* ucNsapiCnt的个数为0                      */
        ...
        g_SmPdpAddrApn.aPdpAddrlist[ucAddrIndex].stUnPackPdpApn.ulApnLength = 0;
        PS_MEM_SET(g_SmPdpAddrApn.aPdpAddrlist[ucAddrIndex].stUnPackPdpApn.aucApnValue,
                   0x00,
                   sizeof(g_SmPdpAddrApn.aPdpAddrlist[ucAddrIndex].stUnPackPdpApn.aucApnValue));
    }
