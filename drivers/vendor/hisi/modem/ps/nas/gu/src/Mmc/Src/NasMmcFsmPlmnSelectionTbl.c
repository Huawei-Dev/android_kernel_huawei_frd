...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionInitActTbl[]             =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ...
                      NAS_MMC_RcvMsccCsgSpecSearchReq_PlmnSelection_Init),
#endif
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitWasPlmnSearchCnfActTbl[]        =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ...
                      NAS_MMC_RcvMsccCsgSpecSearchAbortReq_PlmnSelection),
#endif
    NAS_ACT_TBL_ITEM( WUEPS_PID_WRR,
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitEpsRegRsltIndActTbl[]         =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ID_MSCC_MMC_CSG_SPEC_SEARCH_REQ,
                      NAS_MMC_RcvMsccCsgSpecSearchReq_PlmnSelection_WaitEpsRegRsltInd),
#endif
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitEpsConnRelInd[]         =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ID_MSCC_MMC_CSG_SPEC_SEARCH_REQ,
                      NAS_MMC_RcvMsccCsgSpecSearchReq_PlmnSelection_WaitEpsConnRelInd),
#endif
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitEpsRegIndCsPsMode1ReCampLteActTbl[]         =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ID_MSCC_MMC_CSG_SPEC_SEARCH_REQ,
                      NAS_MMC_RcvMsccCsgSpecSearchReq_PlmnSelection_WaitEpsRegRsltIndCsPsMode1ReCampLte),
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitEpsRelIndCsPsMode1ReCampLteActTbl[]         =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ID_MSCC_MMC_CSG_SPEC_SEARCH_REQ,
                      NAS_MMC_RcvMsccCsgSpecSearchReq_PlmnSelection_WaitEpsRelIndCsPsMode1ReCampLte),
#endif
