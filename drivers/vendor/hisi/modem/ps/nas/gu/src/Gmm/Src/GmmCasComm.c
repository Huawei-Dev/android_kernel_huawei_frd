...
VOS_UINT32 GMM_SaveGsmSysInfoIndMsgPara(MMCGMM_GSM_SYS_INFO_IND_ST *pSysInfo)
{
    ...
    {                                                                           /* 设置RAI是否变化标志                      */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_SaveGsmSysInfoIndMsgPara RAI Changed");
    ...
    {                                                                           /* 设置LAI是否变化标志                      */
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_SaveGsmSysInfoIndMsgPara LAI Changed");
    ...
    {
        NAS_NORMAL_LOG2(WUEPS_PID_GMM, "GMM_SaveGsmSysInfoIndMsgPara usCellId Changed old=, new=", g_GmmGlobalCtrl.SysInfo.usGsmCellId, usCellIdNew);
    ...
    {/* 网络模式变更 */
        ...
        NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_SaveGsmSysInfoIndMsgPara ucNetModeChange=", gstGmmSuspendCtrl.ucNetModeChange);
    ...
    {/* 寻呼的类型为IMSI */
        ...
        {                                                                       /* 有信令或没有信令且还没建信令             */
            ...
            else
            {
                ...
                NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_RcvGsmPagingAtDeregInit: MSIDType IMSI trigger ATT");
