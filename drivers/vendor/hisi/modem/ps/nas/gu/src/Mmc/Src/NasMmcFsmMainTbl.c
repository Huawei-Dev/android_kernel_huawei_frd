...
NAS_ACT_STRU   g_astNasMmcInitialActTbl[]                   =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ...
                      NAS_MMC_RcvMsccCsgSpecSearchReq_L1Main),
#endif
    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
...
NAS_ACT_STRU   g_astNasMmcOnPlmnActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      ...
                      NAS_MMC_RcvTiAutonomousCsgIdSearchTimerExpired_L1Main),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MMC_PERIOD_CSG_ID_SEARCH_TIMER,
                      NAS_MMC_RcvTiPeriodCsgIdSearchTimerExpired_L1Main),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MMC_PERIOD_TRYING_CSG_ID_SEARCH,
                      NAS_MMC_RcvTiPeriodTryingCsgIdSearchExpired_L1Main),
    NAS_ACT_TBL_ITEM( WUEPS_PID_USIM,
                      USIMM_READFILE_CNF,
                      NAS_MMC_RcvUsimReadFileCnf_L1Main),
    NAS_ACT_TBL_ITEM( WUEPS_PID_USIM,
                      USIMM_QUERYFILE_CNF,
                      NAS_MMC_RcvUsimReadFileCnf_L1Main),
#endif
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ...
                      NAS_MMC_RcvMmcInterBgSearchReq_OnPlmn),
