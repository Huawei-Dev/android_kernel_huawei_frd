...
NAS_ERR_LOG_ALM_LEVEL_STRU g_astNasErrAlmLevelTb[] = {
    ...
    {NAS_ERR_LOG_ALM_1X_COMMON_INFO,                        NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_1X_OOS_REPORT,                         NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_1X_OOS_RECOVERY,                       NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_1X_OOS_SEARCH,                         NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_1X_CS_MO_CALL_EXCEPTION,               NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_1X_MT_SERVICE_EXCEPTION,               NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_1X_CS_CONVERSATION_EXCEPTION,          NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_CL_OOS_SEARCH,                         NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_HRPD_COMMON_INFO,                      NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_CDMA_PS_CALL_FAIL,                     NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_CDMA_PS_DISC_EXCEPTION,                NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_HRPD_UATI_FAIL,                        NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_HRPD_SESSION_FAIL,                     NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_HRPD_SESSION_EXCEP_DEACT,              NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},

    {NAS_ERR_LOG_ALM_HRPD_OR_LTE_OOS_REPORT,                NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_HRPD_OR_LTE_OOS_RECOVERY,              NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_HRPD_OOS_SEARCH,                       NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_XREG_FAIL_INFO,                        NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_XSMS_SND_FAIL,                         NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_XSMS_RCV_FAIL,                         NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
    {NAS_ERR_LOG_ALM_CL_LTE_COMMON_INFO,                    NAS_ERR_LOG_CTRL_LEVEL_CRITICAL},
};
...
NAS_ERR_LOG_ALM_REPORT_TYPE_STRU g_astNasErrAlmUnsoliReportTypeTb[] = {
    ...
    {NAS_ERR_LOG_ALM_1X_OOS_REPORT,                         NAS_ERR_LOG_FAULT_REPORT},
    {NAS_ERR_LOG_ALM_1X_OOS_RECOVERY,                       NAS_ERR_LOG_FAULT_REPORT},
    {NAS_ERR_LOG_ALM_1X_MT_SERVICE_EXCEPTION,               NAS_ERR_LOG_FAULT_REPORT},
    {NAS_ERR_LOG_ALM_HRPD_UATI_FAIL,                        NAS_ERR_LOG_FAULT_REPORT},
    {NAS_ERR_LOG_ALM_HRPD_SESSION_FAIL,                     NAS_ERR_LOG_FAULT_REPORT},
    {NAS_ERR_LOG_ALM_HRPD_SESSION_EXCEP_DEACT,              NAS_ERR_LOG_FAULT_REPORT},

    {NAS_ERR_LOG_ALM_HRPD_OR_LTE_OOS_REPORT,                NAS_ERR_LOG_FAULT_REPORT},
    {NAS_ERR_LOG_ALM_HRPD_OR_LTE_OOS_RECOVERY,              NAS_ERR_LOG_FAULT_REPORT},
    {NAS_ERR_LOG_ALM_XREG_FAIL_INFO,                        NAS_ERR_LOG_FAULT_REPORT},
    {NAS_ERR_LOG_ALM_XSMS_RCV_FAIL,                         NAS_ERR_LOG_FAULT_REPORT},
};
#endif
...
VOS_VOID NAS_MML_RegisterDumpCallBack( VOS_VOID )
{
    ...
    if (VOS_NULL_PTR == gpucGunasExcAddr)
    {
        NAS_ERROR_LOG(WUEPS_PID_MMC, "NAS_MML_RegisterDumpCallBack(): No memory allocated");
        return;
    }
