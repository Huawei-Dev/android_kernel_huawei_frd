                   ...
                   )
{
    ...
    if (VOS_NULL_PTR == pucTimerSta)
    {
        SMS_LOG1(PS_LOG_LEVEL_ERROR, "SMS_TimerStop: Invalid timer ID", ucTimerId);
        return SMS_FALSE;
    }
                    ...
                    )
{
    ...
    if (VOS_NULL_PTR == pucTimerSta)
    {
        SMS_LOG1(PS_LOG_LEVEL_ERROR, "SMS_TimerStart: Invalid timer ID", ucTimerId);
        return SMS_FALSE;
    }
