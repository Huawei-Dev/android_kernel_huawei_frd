...
const MM_CELL_FUN_TYPE        aMmEvent1[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvMmcStartReq_RrConnRelNotAllow,        /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent2[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvMmcAttachReq_RrConnRelNotAllow,       /* S30:  RR CONNECTION RELEASE NOT ALLOWED          */
...
const MM_CELL_FUN_TYPE        aMmEvent5[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Cell_S9_E5,                                  /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvMmcSysinfoInd_RrConnRelNotAllow,      /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent11[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvGmmGprsDetachIni_RrConnRelNotAllow,   /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent12[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvGmmGprsDetechCmpl_RrConnRelNotAllow,  /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent13[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvGmmNetworkDetachInd_RrConnRelNotAllow,/* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent14[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvGmmActionRsltInd_RrConnRelNotAllow,   /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent15[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvGmmLuInitiation_RrConnRelNotAllow,    /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent16[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvGmmAuthFailureInd_RrConnRelNotAllow,  /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent20[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvMmcModeChangeReq_RrConnRelNotAllow,   /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent21[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvMmcCoverageLostInd_RrConnRelNotAllow, /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent22[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvMmcDetachReq_RrConnRelNotAllow,       /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent23[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvMmcPowerOffReq_RrConnRelNotAllow,     /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent24[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvCcEstReq_RrConnRelNotAllow,           /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent33[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvRrRelInd_RrConnRelNotAllow,           /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent43[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvRrDataIndMmInfo_RrConnRelNotAllow,    /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent49[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvMmcRelReq_RrConnRelNotAllow,          /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                         /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent50[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvRrDataIndCc_RrConnRelNotAllow,        /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent53[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    Mm_Cell_S1_E53,                                 /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
...
const MM_CELL_FUN_TYPE        aMmEvent59[MM_STATE_MAX] = {
    ...
    Mm_Cell_S0_E59,                                 /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
...
const MM_CELL_FUN_TYPE        aMmEvent60[MM_STATE_MAX] = {
    ...
    Mm_Cell_S0_E60,                                 /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
...
const MM_CELL_FUN_TYPE        aMmEvent61[MM_STATE_MAX] = {
    ...
    Mm_Cell_S0_E61,                                 /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    Mm_Nop,                                         /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                        /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent62[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvSmsEstReq_RrConnRelNotAllow,          /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
...
const MM_CELL_FUN_TYPE        aMmEvent65[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvSsEstReq_RrConnRelNotAllow,           /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
...
const MM_CELL_FUN_TYPE        aMmEvent69[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvRrDataIndSs_RrConnRelNotAllow,        /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                         /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent70[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvRrDataIndSms_RrConnRelNotAllow,       /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
    Mm_Nop,                                         /* S32: MM_INTER_RAT_CHANGE */
...
const MM_CELL_FUN_TYPE        aMmEvent71[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    Mm_Cell_S9_E71,                                 /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent76[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    Mm_Cell_S25_E76,                                /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
...
const MM_CELL_FUN_TYPE        aMmEvent78[MM_STATE_MAX] = {
    ...
    Mm_Cell_S0_E78,                                 /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    Mm_Nop,                                         /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
...
const MM_CELL_FUN_TYPE        aMmEvent84[MM_STATE_MAX] = {
    ...
    Mm_Cell_S3_E84,                                 /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
...
const MM_CELL_FUN_TYPE        aMmEvent_T3242ExpiredProcTbl[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvT3242Expired_MmIdleNoCellAvailable,   /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
...
const MM_CELL_FUN_TYPE        aMmEvent_T3243ExpiredProcTbl[MM_STATE_MAX] = {
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvT3243Expired_MmIdleNoCellAvailable,   /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST_CONTROL_ACTIVE                         */
...
const MM_CELL_FUN_TYPE        aMmEvent92_LcsEstReqProcTbl[MM_STATE_MAX] = {
    NAS_MM_RcvLcsEstReq_Null,                       /* S0 : MM NULL                                     */
    NAS_MM_RcvLcsEstReq_MmIdleNoCellAvaliable,      /* S1 : MM IDLE NO CELL AVAILABLE                   */
    NAS_MM_RcvLcsEstReq_MmIdlePlmnSearch,           /* S2 : MM IDLE PLMN SEARCH                         */
    NAS_MM_RcvLcsEstReq_MmIdleNormalService,        /* S3 : MM IDLE NORMAL SERVICE                      */
    NAS_MM_RcvLcsEstReq_MmIdleLimitedService,       /* S4 : MM IDLE LIMITED SERVICE                     */
    NAS_MM_RcvLcsEstReq_MmIdleAttempToUpdate,       /* S5 : MM IDLE ATTEMPTING TO UPDATE                */
    NAS_MM_RcvLcsEstReq_MmIdleLauNeeded,            /* S6 : MM IDLE LOCATION UPDATE NEEDED              */
    Mm_Nop,                                         /* S7 : MM IDLE PLMN SEARCH, NORMAL SERVICE         */
    NAS_MM_RcvLcsEstReq_MmIdleNoImsi,               /* S8 : MM IDLE NO IMSI                             */
    NAS_MM_RcvLcsEstReq_WaitForOutgoingMmConn,      /* S9 : WAIT FOR OUTGOING MM CONNECTION             */
    NAS_MM_RcvLcsEstReq_MmConnectionActive,         /* S10: MM CONNECTION ACTIVE                        */
    NAS_MM_RcvLcsEstReq_WaitForNetworkCmd,          /* S11: WAIT FOR NETWORK COMMAND                    */
    NAS_MM_RcvLcsEstReq_WaitForRrConn,              /* S12: WAIT FOR RR CONNECTION (MM CONNECTION)      */
    NAS_MM_RcvLcsEstReq_WaitForReestReq,            /* S13: WAIT FOR REESTABLISH(WAIT FOR REEST REQ)    */
    NAS_MM_RcvLcsEstReq_WaitForReestCnf,            /* S14: WAIT FOR REESTABLISH(WAIT FOR EST_CNF)      */
    Mm_Nop,                                         /* S15: WAIT FOR RR ACTIVE                          */
    NAS_MM_RcvLcsEstReq_WaitForAdditionalMmConn,    /* S16: WAIT FOR ADDITIONAL OUTGOING MM CONNECTION  */
    NAS_MM_RcvLcsEstReq_LauPending,                 /* S17: LOCATION UPDATING PENDING                   */
    NAS_MM_RcvLcsEstReq_ImsiDetachPending,          /* S18: IMSI DETACH PENDING                         */
    NAS_MM_RcvLcsEstReq_WaitForAttach,              /* S19: WAIT FOR ATTACH                             */
    Mm_Nop,                                         /* S20: MM IDLE RECEIVING GROUPCALL(NORMAL SERVICE) */
    Mm_Nop,                                         /* S21: MM IDLE RECEIVING GROUPCALL(LIMITED SERVICE)*/
    NAS_MM_RcvLcsEstReq_WaitForRrConnLau,           /* S22: WAIT FOR RR CONNECTION (LOCATION UPDATING)  */
    NAS_MM_RcvLcsEstReq_LauInitiated,               /* S23: LOCATION UPDATING INITIATED                 */
    NAS_MM_RcvLcsEstReq_LauRejected,                /* S24: LOCATION UPDATE REJECTED                    */
    NAS_MM_RcvLcsEstReq_WaitForRrConnImsiDetach,    /* S25: WAIT FOR RR CONNECTION (IMSI DETACH)        */
    NAS_MM_RcvLcsEstReq_ImsiDetachInitiated,        /* S26: IMSI DETACH INITIATED                       */
    NAS_MM_RcvLcsEstReq_ProcCmServicePrompt,        /* S27: PROCESS CM SERVICE PROMPT                   */
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvLcsEstReq_RrConnRelNotAllow,          /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    NAS_MM_RcvLcsEstReq_TestContrlActive,           /* S31: TEST CONTROL ACTIVE                         */
    NAS_MM_RcvLcsEstReq_MmInterRatChange,           /* S32: MM INTER RAT CHANGE                         */
    NAS_MM_RcvLcsEstReq_MmIdleECallInactive,        /* S33: MM IDLE ECALL INACTIVE                      */
};

const MM_CELL_FUN_TYPE        aMmEvent93_LcsDataReqProcTbl[MM_STATE_MAX] = {
    Mm_Nop,                                         /* S0 : MM_NULL                                     */
    Mm_Nop,                                         /* S1 : MM IDLE NO CELL AVAILABLE                   */
    Mm_Nop,                                         /* S2 : MM IDLE PLMN SEARCH                         */
    Mm_Nop,                                         /* S3 : MM IDLE NORMAL SERVICE                      */
    ...
    Mm_Nop,                                         /* S8 : MM IDLE NO IMSI                             */
    Mm_Nop,                                         /* S9 : WAIT FOR OUTGOING MM CONNECTION             */
    NAS_MM_RcvLcsDataReq_MmConnectionActive,        /* S10: MM CONNECTION ACTIVE                        */
    Mm_Nop,                                         /* S11: WAIT FOR NETWORK COMMAND                    */
    Mm_Nop,                                         /* S12: WAIT FOR RR CONNECTION (MM CONNECTION)      */
    Mm_Nop,                                         /* S13: WAIT FOR REESTABLISH(WAIT FOR REEST REQ)    */
    Mm_Nop,                                         /* S14: WAIT FOR REESTABLISH(WAIT FOR EST_CNF)      */
    Mm_Nop,                                         /* S15: WAIT FOR RR ACTIVE                          */
    NAS_MM_RcvLcsDataReq_WaitForAdditionalMmConn,   /* S16: WAIT FOR ADDITIONAL OUTGOING MM CONNECTION  */
    Mm_Nop,                                         /* S17: LOCATION UPDATING PENDING                   */
    Mm_Nop,                                         /* S18: IMSI DETACH PENDING                         */
    Mm_Nop,                                         /* S19: WAIT FOR ATTACH                             */
    Mm_Nop,                                         /* S20: MM IDLE RECEIVING GROUPCALL(NORMAL SERVICE) */
    ...
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    Mm_Nop,                                         /* S30:  RR CONNECTION RELEASE NOT ALLOWED          */
    Mm_Nop,                                         /* S31: TEST CONTROL ACTIVE                         */
    NAS_MM_RcvLcsDataReq_MmInterRatChange,          /* S32: MM INTER RAT CHANGE                         */
    Mm_Nop,                                         /* S33: MM IDLE ECALL INACTIVE                      */
};

const MM_CELL_FUN_TYPE        aMmEvent94_LcsRelReqProcTbl[MM_STATE_MAX] = {
    Mm_Nop,                                         /* S0 : MM_NULL                                     */
    NAS_MM_RcvLcsRelReq_MmIdleNoCellAvaliable,      /* S1 : MM IDLE NO CELL AVAILABLE                   */
    NAS_MM_RcvLcsRelReq_MmIdlePlmnSearch,           /* S2 : MM IDLE PLMN SEARCH                         */
    NAS_MM_RcvLcsRelReq_MmIdleNormalService,        /* S3 : MM IDLE NORMAL SERVICE                      */
    NAS_MM_RcvLcsRelReq_MmIdleLimitedService,       /* S4 : MM IDLE LIMITED SERVICE                     */
    NAS_MM_RcvLcsRelReq_MmIdleAttempToUpdate,       /* S5 : MM IDLE ATTEMPTING TO UPDATE                */
    NAS_MM_RcvLcsRelReq_MmIdleLauNeeded,            /* S6 : MM IDLE LOCATION UPDATE NEEDED              */
    Mm_Nop,                                         /* S7 : MM IDLE PLMN SEARCH, NORMAL SERVICE         */
    NAS_MM_RcvLcsRelReq_MmIdleNoImsi,               /* S8 : MM IDLE NO IMSI                             */
    NAS_MM_RcvLcsRelReq_WaitForOutgoingMmConn,      /* S9 : WAIT FOR OUTGOING MM CONNECTION             */
    NAS_MM_RcvLcsRelReq_MmConnectionActive,         /* S10: MM CONNECTION ACTIVE                        */
    NAS_MM_RcvLcsRelReq_WaitForNetworkCmd,          /* S11: WAIT FOR NETWORK COMMAND                    */
    NAS_MM_RcvLcsRelReq_WaitForRrConn,              /* S12: WAIT FOR RR CONNECTION (MM CONNECTION)      */
    NAS_MM_RcvLcsRelReq_WaitForReestReq,            /* S13: WAIT FOR REESTABLISH(WAIT FOR REEST REQ)    */
    NAS_MM_RcvLcsRelReq_WaitForReestCnf,            /* S14: WAIT FOR REESTABLISH(WAIT FOR EST_CNF)      */
    Mm_Nop,                                         /* S15: WAIT FOR RR ACTIVE                          */
    NAS_MM_RcvLcsRelReq_WaitForAdditionalMmConn,    /* S16: WAIT FOR ADDITIONAL OUTGOING MM CONNECTION  */
    NAS_MM_RcvLcsRelReq_LauPending,                 /* S17: LOCATION UPDATING PENDING                   */
    NAS_MM_RcvLcsRelReq_ImsiDetachPending,          /* S18: IMSI DETACH PENDING                         */
    NAS_MM_RcvLcsRelReq_WaitForAttach,              /* S19: WAIT FOR ATTACH                             */
    Mm_Nop,                                         /* S20: MM IDLE RECEIVING GROUPCALL(NORMAL SERVICE) */
    Mm_Nop,                                         /* S21: MM IDLE RECEIVING GROUPCALL(LIMITED SERVICE)*/
    NAS_MM_RcvLcsRelReq_WaitForRrConnLau,           /* S22: WAIT FOR RR CONNECTION (LOCATION UPDATING)  */
    NAS_MM_RcvLcsRelReq_LauInitiated,               /* S23: LOCATION UPDATING INITIATED                 */
    NAS_MM_RcvLcsRelReq_LauRejected,                /* S24: LOCATION UPDATE REJECTED                    */
    NAS_MM_RcvLcsRelReq_WaitForRrConnImsiDetach,    /* S25: WAIT FOR RR CONNECTION (IMSI DETACH)        */
    NAS_MM_RcvLcsRelReq_ImsiDetachInitiated,        /* S26: IMSI DETACH INITIATED                       */
    NAS_MM_RcvLcsRelReq_ProcCmServicePrompt,        /* S27: PROCESS CM SERVICE PROMPT                   */
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvLcsRelReq_RrConnRelNotAllow,          /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST CONTROL ACTIVE                         */
    NAS_MM_RcvLcsRelReq_MmInterRatChange,           /* S32: MM INTER RAT CHANGE                         */
    Mm_Nop,                                         /* S33: MM IDLE ECALL INACTIVE                      */
};

const MM_CELL_FUN_TYPE        aMmEvent95_RrDataIndLcsProcTbl[MM_STATE_MAX] = {
    Mm_Nop,                                         /* S0 : MM_NULL                                     */
    Mm_Nop,                                         /* S1 : MM IDLE NO CELL AVAILABLE                   */
    Mm_Nop,                                         /* S2 : MM IDLE PLMN SEARCH                         */
    Mm_Nop,                                         /* S3 : MM IDLE NORMAL SERVICE                      */
    ...
    Mm_Nop,                                         /* S7 : MM IDLE PLMN SEARCH, NORMAL SERVICE         */
    Mm_Nop,                                         /* S8 : MM IDLE NO IMSI                             */
    NAS_MM_RcvRrDataIndLcs_WaitForOutgoingMmConn,   /* S9 : WAIT FOR OUTGOING MM CONNECTION             */
    NAS_MM_RcvRrDataIndLcs_MmConnectionActive,      /* S10: MM CONNECTION ACTIVE                        */
    NAS_MM_RcvRrDataIndLcs_WaitForNetworkCmd,       /* S11: WAIT FOR NETWORK COMMAND                    */
    Mm_Nop,                                         /* S12: WAIT FOR RR CONNECTION (MM CONNECTION)      */
    Mm_Nop,                                         /* S13: WAIT FOR REESTABLISH(WAIT FOR REEST REQ)    */
    Mm_Nop,                                         /* S14: WAIT FOR REESTABLISH(WAIT FOR EST_CNF)      */
    Mm_Nop,                                         /* S15: WAIT FOR RR ACTIVE                          */
    NAS_MM_RcvRrDataIndLcs_WaitForAdditionalMmConn, /* S16: WAIT FOR ADDITIONAL OUTGOING MM CONNECTION  */
    Mm_Nop,                                         /* S17: LOCATION UPDATING PENDING                   */
    Mm_Nop,                                         /* S18: IMSI DETACH PENDING                         */
    Mm_Nop,                                         /* S19: WAIT FOR ATTACH                             */
    Mm_Nop,                                         /* S20: MM IDLE RECEIVING GROUPCALL(NORMAL SERVICE) */
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvRrDataIndLcs_RrConnRelNotAllow,       /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST CONTROL ACTIVE                         */
    Mm_Nop,                                         /* S32: MM INTER RAT CHANGE                         */
    Mm_Nop,                                         /* S33: MM IDLE ECALL INACTIVE                      */
};

const MM_CELL_FUN_TYPE        aMmEvent96_RrLcsStateIndProcTbl[MM_STATE_MAX] = {
    NAS_MM_RcvRrLcsStateInd_Null,                   /* S0 : MM NULL                                     */
    NAS_MM_RcvRrLcsStateInd_MmIdleNoCellAvaliable,  /* S1 : MM IDLE NO CELL AVAILABLE                   */
    NAS_MM_RcvRrLcsStateInd_MmIdlePlmnSearch,       /* S2 : MM IDLE PLMN SEARCH                         */
    NAS_MM_RcvRrLcsStateInd_MmIdleNormalService,    /* S3 : MM IDLE NORMAL SERVICE                      */
    NAS_MM_RcvRrLcsStateInd_MmIdleLimitedService,   /* S4 : MM IDLE LIMITED SERVICE                     */
    NAS_MM_RcvRrLcsStateInd_MmIdleAttempToUpdate,   /* S5 : MM IDLE ATTEMPTING TO UPDATE                */
    NAS_MM_RcvRrLcsStateInd_MmIdleLauNeeded,        /* S6 : MM IDLE LOCATION UPDATE NEEDED              */
    Mm_Nop,                                         /* S7 : MM IDLE PLMN SEARCH, NORMAL SERVICE         */
    NAS_MM_RcvRrLcsStateInd_MmIdleNoImsi,           /* S8 : MM IDLE NO IMSI                             */
    NAS_MM_RcvRrLcsStateInd_WaitForOutgoingMmConn,  /* S9 : WAIT FOR OUTGOING MM CONNECTION             */
    NAS_MM_RcvRrLcsStateInd_MmConnectionActive,     /* S10: MM CONNECTION ACTIVE                        */
    NAS_MM_RcvRrLcsStateInd_WaitForNetworkCmd,      /* S11: WAIT FOR NETWORK COMMAND                    */
    NAS_MM_RcvRrLcsStateInd_WaitForRrConn,          /* S12: WAIT FOR RR CONNECTION (MM CONNECTION)      */
    NAS_MM_RcvRrLcsStateInd_WaitForReestReq,        /* S13: WAIT FOR REESTABLISH(WAIT FOR REEST REQ)    */
    NAS_MM_RcvRrLcsStateInd_WaitForReestCnf,        /* S14: WAIT FOR REESTABLISH(WAIT FOR EST_CNF)      */
    Mm_Nop,                                         /* S15: WAIT FOR RR ACTIVE                          */
    NAS_MM_RcvRrLcsStateInd_WaitForAdditionalMmConn,/* S16: WAIT FOR ADDITIONAL OUTGOING MM CONNECTION  */
    NAS_MM_RcvRrLcsStateInd_LauPending,             /* S17: LOCATION UPDATING PENDING                   */
    NAS_MM_RcvRrLcsStateInd_ImsiDetachPending,      /* S18: IMSI DETACH PENDING                         */
    NAS_MM_RcvRrLcsStateInd_WaitForAttach,          /* S19: WAIT FOR ATTACH                             */
    Mm_Nop,                                         /* S20: MM IDLE RECEIVING GROUPCALL(NORMAL SERVICE) */
    Mm_Nop,                                         /* S21: MM IDLE RECEIVING GROUPCALL(LIMITED SERVICE)*/
    NAS_MM_RcvRrLcsStateInd_WaitForRrConnLau,       /* S22: WAIT FOR RR CONNECTION (LOCATION UPDATING)  */
    NAS_MM_RcvRrLcsStateInd_LauInitiated,           /* S23: LOCATION UPDATING INITIATED                 */
    NAS_MM_RcvRrLcsStateInd_LauRejected,            /* S24: LOCATION UPDATE REJECTED                    */
    NAS_MM_RcvRrLcsStateInd_WaitForRrConnImsiDetach,/* S25: WAIT FOR RR CONNECTION (IMSI DETACH)        */
    NAS_MM_RcvRrLcsStateInd_ImsiDetachInitiated,    /* S26: IMSI DETACH INITIATED                       */
    NAS_MM_RcvRrLcsStateInd_ProcCmServicePrompt,    /* S27: PROCESS CM SERVICE PROMPT                   */
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvRrLcsStateInd_RrConnRelNotAllow,      /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    NAS_MM_RcvRrLcsStateInd_TestContrlActive,       /* S31: TEST CONTROL ACTIVE                         */
    NAS_MM_RcvRrLcsStateInd_MmInterRatChange,       /* S32: MM INTER RAT CHANGE                         */
    NAS_MM_RcvRrLcsStateInd_MmIdleECallInactive,    /* S33: MM IDLE ECALL INACTIVE                      */
};

const MM_CELL_FUN_TYPE        aMmEvent97_T3241ExpiredProcTbl[MM_STATE_MAX] = {
    Mm_Nop,                                         /* S0 : MM_NULL                                     */
    Mm_Nop,                                         /* S1 : MM IDLE NO CELL AVAILABLE                   */
    Mm_Nop,                                         /* S2 : MM IDLE PLMN SEARCH                         */
    Mm_Nop,                                         /* S3 : MM IDLE NORMAL SERVICE                      */
    ...
    Mm_Nop,                                         /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                         /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
    NAS_MM_RcvT3241Expired_RrConnRelNotAllow,       /* S30: RR CONNECTION RELEASE NOT ALLOWED           */
    Mm_Nop,                                         /* S31: TEST CONTROL ACTIVE                         */
    Mm_Nop,                                         /* S32: MM INTER RAT CHANGE                         */
    Mm_Nop,                                         /* S33: MM IDLE ECALL INACTIVE                      */
};
...
const MM_CELL_FUN_TYPE        aMmEvent98_GmmRadioAccessCapChangeInd[MM_STATE_MAX] = {
    Mm_Nop,                                                                     /* S0 : MM_NULL                                     */
    Mm_Nop,                                                                     /* S1 : MM IDLE NO CELL AVAILABLE                   */
    Mm_Nop,                                                                     /* S2 : MM IDLE PLMN SEARCH                         */
    NAS_MM_RcvGmmRadioAccessCapChangeInd_MmIdleNormalService,                   /* S3 : MM IDLE NORMAL SERVICE                      */
    Mm_Nop,                                                                     /* S4 : MM IDLE LIMITED SERVICE                     */
    Mm_Nop,                                                                     /* S5 : MM IDLE ATTEMPTING TO UPDATE                */
    Mm_Nop,                                                                     /* S6 : MM IDLE LOCATION UPDATE NEEDED              */
    Mm_Nop,                                                                     /* S7 : MM IDLE PLMN SEARCH, NORMAL SERVICE         */
    ...
    Mm_Nop,                                                                     /* S10: MM CONNECTION ACTIVE                        */
    Mm_Nop,                                                                     /* S11: WAIT FOR NETWORK COMMAND                    */
    NAS_MM_RcvGmmRadioAccessCapChangeInd_WaitForLauRrConnnection,               /* S12: WAIT FOR RR CONNECTION (MM CONNECTION)      */
    Mm_Nop,                                                                     /* S13: WAIT FOR REESTABLISH(WAIT FOR REEST REQ)    */
    Mm_Nop,                                                                     /* S14: WAIT FOR REESTABLISH(WAIT FOR EST_CNF)      */
    Mm_Nop,                                                                     /* S15: WAIT FOR RR ACTIVE                          */
    Mm_Nop,                                                                     /* S16: WAIT FOR ADDITIONAL OUTGOING MM CONNECTION  */
    ...
    Mm_Nop,                                                                     /* S20: MM IDLE RECEIVING GROUPCALL(NORMAL SERVICE) */
    Mm_Nop,                                                                     /* S21: MM IDLE RECEIVING GROUPCALL(LIMITED SERVICE)*/
    NAS_MM_RcvGmmRadioAccessCapChangeInd_WaitForLauRrConnnection,               /* S22: WAIT FOR RR CONNECTION (LOCATION UPDATING)  */
    Mm_Nop,                                                                     /* S23: LOCATION UPDATING INITIATED                 */
    Mm_Nop,                                                                     /* S24: LOCATION UPDATE REJECTED                    */
    NAS_MM_RcvGmmRadioAccessCapChangeInd_WaitForLauRrConnnection,               /* S25: WAIT FOR RR CONNECTION (IMSI DETACH)        */
    Mm_Nop,                                                                     /* S26: IMSI DETACH INITIATED                       */
    Mm_Nop,                                                                     /* S27: PROCESS CM SERVICE PROMPT                   */
    Mm_Nop,                                                                     /* S28: MM CONNECTION ACTIVE (GROUP TRANSMIT MODE)  */
    Mm_Nop,                                                                     /* S29: WAIT FOR RR CONNECTION (GROUP TRANSMIT MODE)*/
...
const MM_CELL_FUN_TYPE*       gaMmStateTable[] = {
    aMmEvent1,
    aMmEvent2,
    aMmEvent3,
    (MM_CELL_FUN_TYPE *)0,
    ...
    aMmEvent92_LcsEstReqProcTbl,                                                /* 92: ID_LCS_MM_EST_REQ */
    aMmEvent93_LcsDataReqProcTbl,                                               /* 93: ID_LCS_MM_DATA_REQ */
    aMmEvent94_LcsRelReqProcTbl,                                                /* 94: ID_LCS_MM_REL_REQ */
    aMmEvent95_RrDataIndLcsProcTbl,                                             /* 95: RRMM_DATA_IND(LCS) */
    aMmEvent96_RrLcsStateIndProcTbl,                                            /* 96: RRMM_LCS_STATE_IND */
    aMmEvent97_T3241ExpiredProcTbl,                                             /* 97: T3241 Expired */

    aMmEvent98_GmmRadioAccessCapChangeInd,
};
