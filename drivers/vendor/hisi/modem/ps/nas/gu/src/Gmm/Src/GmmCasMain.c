                ...
                VOS_UINT8            ucRaiChgFlg)
{
    ...
    NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_CasNetModeChangeByRau: may trigger RAU, Gmm state is", g_GmmGlobalCtrl.ucState);
    ...
    case GMM_REGISTERED_INITIATED:
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_CasNetModeChangeByRau: rai chg trigger ATT");
...
{
    NAS_NORMAL_LOG1(WUEPS_PID_GMM, "GMM_ProcedureByNetMode: may trigger RAU, NetModChangeType is", ucNetModChangeType);
    ...
    else if (GMM_NETMODE_CHG_III_II == ucNetModChangeType)
    {
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_GMM, "GMM_ProcedureByNetMode: netmode chg III2II, ps only trigger ATT");
