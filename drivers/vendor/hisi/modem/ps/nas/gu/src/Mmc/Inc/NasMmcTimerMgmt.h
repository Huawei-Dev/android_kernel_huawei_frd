...
#define TI_NAS_MMC_1_TICK_10_MS                     (10)                        /* 1 tick为10ms */
...
#define TI_NAS_MMC_WAIT_EPS_CONN_REL_IND_LEN        (11*1000)
...
#define TI_NAS_MMC_PERIOD_DELETE_FORBIDDEN_CSG_ID_TIMER_LEN        (60 * 1000)  /* 定时器时长为1分钟*/

#define TI_NAS_MMC_PERIOD_TRYING_CSG_ID_SEARCH_LEN                (10*1000)     /* 定时器时长10秒 */
...
#define TI_NAS_MMC_PERIOD_TRYING_CSG_ID_UNAVAILABLE_SEARCH_LEN   (1*1000)
...
enum NAS_MMC_TIMER_ID_ENUM
{
    ...
    TI_NAS_MMC_PERIOD_DELETE_FORBIDDEN_CSG_ID_TIMER      = 8264,                /* 周期删除禁止CSG ID信息的定时 */

    TI_NAS_MMC_AUTONOMOUS_CSG_ID_SEARCH_TIMER            = 8265,                /* 自主搜索CSG ID定时器 */
    TI_NAS_MMC_PERIOD_CSG_ID_SEARCH_TIMER                = 8266,                /* 周期搜索CSG ID定时器 */
    TI_NAS_MMC_PERIOD_TRYING_CSG_ID_SEARCH               = 8267,                /* 周期性尝试背景搜索CSG ID定时器 */
...
VOS_VOID NAS_MMC_GetTimerRemainLen(
    NAS_MMC_TIMER_ID_ENUM_UINT16        enTimerId,
