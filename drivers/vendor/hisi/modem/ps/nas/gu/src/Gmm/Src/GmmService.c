...
)
{
    if (VOS_FALSE == NAS_MML_IsPlmnSupportDam(NAS_MML_GetCurrCampPlmnId()))
    {
        ...
        */
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvRabmReestablishReq_AttemptToUpdate: trigger RAU");
...
)
{
     ...
     && (NAS_MML_NET_RAT_TYPE_GSM   == gstGmmSuspendCtrl.ucPreRat))
    {
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvRabmEstReq_SuspendWaitForSysinfo: trigger RAU");
...
VOS_VOID Gmm_ServiceReqRejectCasue9(VOS_VOID)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_ServiceReqRejectCasue9: trigger ATT");
...
VOS_VOID Gmm_ServiceReqRejectCasue10(VOS_VOID)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_GMM, "Gmm_ServiceReqRejectCasue10: trigger ATT");
...
)
{
     ...
     && (NAS_MML_NET_RAT_TYPE_GSM   == gstGmmSuspendCtrl.ucPreRat))
    {
        ...
        NAS_NORMAL_LOG(WUEPS_PID_GMM, "NAS_GMM_RcvSmsEstReq_SuspendWaitForSysinfo: trigger RAU");
        Gmm_RoutingAreaUpdateInitiate(GMM_UPDATING_TYPE_INVALID);
    }
