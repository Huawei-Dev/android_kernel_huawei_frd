...
VOS_VOID Mm_Cell_S3_E15(VOS_VOID *pMsg)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S3_E15: trigger lau");
...
VOS_VOID Mm_Cell_S4_E5(VOS_VOID *pMsg)
{
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
         ...
         || (MMCMM_FORBIDDEN_PLMN_FOR_GPRS == g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg))
        {
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S4_E5: lai change or user specific search trigger lau");
            
                /* LAI改变,或者用户发起的指定搜网时,发起LU过程 */
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S4_E5: LAI change or manual selection, trigger LAU");
    ...
    {                                                                           /* 非A+I模式                                */
        ...
        if (g_MmGlobalInfo.ucNtMod == g_MmGlobalInfo.ucNewNtMod)
        {
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S4_E5: NetMode unchange, cs U1 LAI Unchg and T3212 expired trigger periodic lau");
                   ...
                   && (VOS_FALSE == ucLaChgFlg))
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S4_E5: NetMode unchange, cs U1 LAI not change trigger imsi lau");
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S4_E5: U1,NAS_MM_IsRadioAccessCapNeedTriggerLau is true");
        
                    NAS_MM_ProcBufferedEmgCallOrLau_RcvSysinfo(ucLaChgFlg, MM_IE_LUT_NORMAL_LU);
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S4_E5: NetMode unchange, trigger normal lau");
...
VOS_VOID Mm_Cell_S4_E15(VOS_VOID *pMsg)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S4_E15: trigger lau");
...
VOS_VOID Mm_Cell_S5_E5(VOS_VOID *pMsg)
{
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
        ...
        {                                                                       /* RAC为0的场合                             */
            ...
            {
                NAS_NORMAL_LOG2(WUEPS_PID_MM, "Mm_Cell_S5_E5,trigger lau:NAS_MML_IsCampLaiInfoChanged; ucUserSpecificSearchFlg",NAS_MML_IsCampLaiInfoChanged(), ucUserSpecificSearchFlg);
                ...
                Mm_ComLuOnly();                                             /* LU REQ                                   */
                   ...
                   &&(MM_TRUE == g_MmGlobalInfo.MsCsInfo.ucCellChgFlg))
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "S5_E5,likeB,retry flg and cell change are both true trigger lau");
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "S5_E5,likeB,csfb delay lau is true");
    ...
    {                                                                           /* 非A+I                                    */
        ...
        if (g_MmGlobalInfo.ucNtMod != g_MmGlobalInfo.ucNewNtMod)
        {
            NAS_NORMAL_LOG2(WUEPS_PID_MM, "S5_E5,Netmode change ucNtMod is ;ucNewNtMod is ;",g_MmGlobalInfo.ucNtMod,g_MmGlobalInfo.ucNewNtMod);
             ...
             && (VOS_FALSE                              == ucLaChgFlg))
        {
            ...
            if (VOS_TRUE == ulIsTestCard)
            {
              ...
              || ((VOS_TRUE      == ucUserSpecificSearchFlg)
               && (MM_TIMER_STOP == ul3211Status)))
        {
            NAS_NORMAL_LOG2(WUEPS_PID_MM, "S5_E5,trigger lau cause:camp LA change = ; or user specific search flg = ;",NAS_MML_IsCampLaiInfoChanged(),ucUserSpecificSearchFlg);
            ...
            && (MM_TRUE == g_MmGlobalInfo.MsCsInfo.ucCellChgFlg))
        {
            NAS_NORMAL_LOG(WUEPS_PID_MM, "S5_E5, trigger lau cause ucRetryFlg and ucCellChgFlg");
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_MM, "S5_E5, trigger lau cause ucRetryFlg is true and state is not WAIT_FOR_RR_CONNECTION_LOCATION_UPDATING");
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
         ...
         || (MMCMM_FORBIDDEN_PLMN_FOR_GPRS == g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg))
        {
            ...
            {                                                               /* 如果LAI不变,更新状态为U1                 */
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S6_E5: gprs unsupport,LAI unchange,T3212 expired trigger lau");
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S6_E5: gprs unsupport,LAI unchange,cs NOT U1 trigger lau");
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S6_E5: gprs unsupport,NAS_MM_IsRadioAccessCapNeedTriggerLau is true");
                    g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_NORMAL_LU;   /* 设置LU类型                               */
                    Mm_ComLuOnly();
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S6_E5: gprs unsupport,LAI change trigger lau");
        ...
        else if (VOS_TRUE == NAS_MML_GetPsRestrictRegisterFlg())
        {
            ...
            {                                                                   /* 如果LAI不变,更新状态为U1                 */
                if (MM_TRUE == g_MmGlobalInfo.LuInfo.ucT3212ExpiredFlg)
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S6_E5: ps RestrictRegister,LAI unchange, T3212 expired trigger lau");
                    ...
                    NAS_MML_GetCsUpdateStatus())
                {
                    ...
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S6_E5: ps RestrictRegister,LAI unchange, cs NOT U1 trigger lau");
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S6_E5: ps RestrictRegister,LAI change, trigger lau");
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
                ...
                RcvXXEstReq.ulCallType))
            {
                  ...
                  && (MM_TRUE != ucMmConnFlg) )
                {
                    ...
                    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                        "Mm_Cell_S9_E14: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
                ...
                else
                {
                    ...
                    PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                        "Mm_Cell_S9_E14: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
    ...
    {                                                                           /* 结果为失败的场合                         */
        ...
        {                                                                       /* 如果类型为空的场合                       */
            ...
            case NAS_MML_REG_FAIL_CAUSE_ILLEGAL_ME:
                ...
                /* 记录流程和原因值 */
                Mm_ComSaveProcAndCauseVal(ucActionType, pstGmmActionRstInd->enCause);
            ...
            else
            {
                ...
                ***************************************************************/
                ...
                if(MM_STATUS_ATTACHED != g_MmSubLyrShare.MmShare.ucCsAttachState)
                {
                    ...
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E7: trigger LAU");
                    Mm_ComLuOnly();                                                                     /* 发送LU REQ                               */
                }
                else
                {
...
VOS_VOID Mm_Cell_S17_E8(VOS_VOID *pMsg)
{
    ...
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
        ...
        if ( MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState )
        {
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E8: lai change trigger lau");
        ...
        else
        {
            ...
            {                                                                   /* 如果LAI不变,更新状态为U1的场合           */
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E8: need attach trigger lau");
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E8: lai change or NOT U1 trigger lau");
    ...
    default:
        ...
        else if ( pCombinedAttachRjct->ulAttachAttCounter < 5)
        {
            ...
            else
            {
                ...
                /* 通过信元ucDelEplmnFlg去判断是否要删除EPLMN */
                if (VOS_TRUE == pCombinedAttachRjct->ucDelEplmnFlg)
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E8: ucDelEplmnFlg is False, call EPLMN update function");
        ...
        else if (NAS_MML_REG_FAIL_CAUSE_OTHER_CAUSE_REG_MAX_TIMES != pCombinedAttachRjct->enCause)
        {
            ...
            ***************************************************************/
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E8: PS fail, try LAU alone");
                Mm_ComLuOnly();
            }
            else
            {
...
VOS_VOID Mm_Cell_S17_E15(VOS_VOID *pMsg)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E15: trigger LAU");
    Mm_ComLuOnly();                                                             /* 进行LU过程                               */
}
        ...
        case NAS_MML_REG_FAIL_CAUSE_PROCEDURE_CONGESTION:
                  ...
                  || (MM_FALSE == g_MmGlobalInfo.ucLikeB))
            {
                ...
                ***************************************************************/
                ...
                if (NAS_MML_NET_RAT_TYPE_WCDMA == NAS_MML_GetCurrNetRatType())
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E18: trigger LAU");
                    Mm_ComLuOnly();
                }
                else
                {
...
VOS_VOID Mm_Cell_S17_E19(VOS_VOID *pMsg)
{
    ...
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
        ...
        if ( MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState )
        {
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E19: lai change trigger lau");
        ...
        else
        {
            ...
            {                                                                   /* 如果LAI不变,更新状态为U1的场合           */
                if (MM_ATT_NEED == g_MmGlobalInfo.ucAttFlg)
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E19: need att trigger lau");
                    g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_IMSI_ATTACH;     /* 设置LU类型                               */
                    Mm_ComLuOnly();                                             /* LU REQ                                   */
                }
                else
            ...
            {
                NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E19: lai change or NOT U1 trigger lau");
    ...
    default:
        ...
        else if(NAS_MML_REG_FAIL_CAUSE_OTHER_CAUSE_REG_MAX_TIMES != pstCombinedRauRjct->enCause)
        {
            ...
            ***************************************************************/
            ...
            /*PS尝试失败后，CS尝试单独进行一次位置更新A32D10820==>*/
            NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E19: PS fail try LAU");
            Mm_ComProcCauseClear();
            g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_NORMAL_LU;
            Mm_ComLuOnly();
            NAS_MM_SndMmcCsRegResultInd(MM_MMC_LU_PROC_TRUE,
    ...
    /* 通过信元ucDelEplmnFlg去判断是否要删除EPLMN */
    if (VOS_TRUE == pstCombinedRauRjct->ucDelEplmnFlg)
    {
        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E19: ucDelEplmnFlg is FALSE, call EPLMN update function");
                    ...
                    )
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S11_E50: Call NAS_MM_ResetCsPagingFlgAndT3240Len()");
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S17_E19: ps only,limited srv trigger lau");
...
VOS_VOID NAS_MM_ProcSmsEstReq_WaitForOutgoingMmConnection(VOS_VOID)
{
     ...
     || (NAS_MML_LOCATION_UPDATE_STATUS_UPDATED  != enCsUpdateStatus))
    {
        ...
        {
            NAS_NORMAL_LOG(WUEPS_PID_MM, "NAS_MM_ProcSmsEstReq_WaitForOutgoingMmConnection: trigger lau");
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 没有存在的MM连接 */
            ...
            if (RRMM_LCS_STATE_START == NAS_MM_GetRrLcsState())
            {
                ...
                Mm_ComSetMmState(RR_CONNECTION_RELEASE_NOT_ALLOWED);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S27_E68: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
                Mm_TimerStart(MM_TIMER_T3241);
            }
            else
            {
                ...
                Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S27_E68: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
                Mm_TimerStart(MM_TIMER_T3240);
            }
        }
        else
                    ...
                    )
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S11_E69: Call NAS_MM_ResetCsPagingFlgAndT3240Len()");
    NAS_MM_ResetCsPagingFlgAndT3240Len();
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 没有MM连接存在                           */
            ...
            if (RRMM_LCS_STATE_START == NAS_MM_GetRrLcsState())
            {
                ...
                Mm_ComSetMmState(RR_CONNECTION_RELEASE_NOT_ALLOWED);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S10_E63: MM STATUS is MM_RR_CONNECTION_RELEASE_NOT_ALLOWED.");
                Mm_TimerStart(MM_TIMER_T3241);
            }
            else
            {
                ...
                Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                PS_NAS_LOG(WUEPS_PID_MM, VOS_NULL, PS_LOG_LEVEL_NORMAL,
                    "Mm_Cell_S10_E63: MM STATUS is WAIT_FOR_NETWORK_COMMAND.");
                Mm_TimerStart(MM_TIMER_T3240);
            }
        }
    }
...
)
{
    ...
    */
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S3_E89: trigger PERIODIC LAU");
...
)
{
    ...
    */
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S5_E89: trigger lau");
...
VOS_VOID Mm_Cell_S1_E65(VOS_VOID *pRcvMsg)
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        if (VOS_TRUE == NAS_MML_IsLteOnlyMode(pstPrioRatList))
        {
            NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S1_E65: LTE ONLY mode, SS fail");
            Mm_SndSsRelInd(g_MmSsEstReq.ulTi, NAS_MMCM_REL_CAUSE_MM_INTER_ERR_NOT_SUPPORT_CS_CALL_S1_MODE_ONLY);
            return;
        }
        ...
        if (NAS_MML_NET_RAT_TYPE_LTE == NAS_MML_GetCurrNetRatType())
        {
            NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_Cell_S1_E65: Requset CSFB for SS service");
            NAS_MM_RcvSsEstReq_CSFB();
