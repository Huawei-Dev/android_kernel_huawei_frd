...
VOS_VOID NAS_CC_SetTiNonregularCustom(VOS_UINT8 ucTiNonregularCustom)
{
    NAS_CC_GetCustomCfgInfo()->ucTiNonregularCustom = ucTiNonregularCustom;

    return;
}

VOS_UINT8 NAS_CC_GetTiNonregularCustom(VOS_VOID)
{
    return NAS_CC_GetCustomCfgInfo()->ucTiNonregularCustom;
}

VOS_UINT8 NAS_CC_GetTiNonregularAddedFlg(VOS_VOID)
{
    return NAS_CC_GetCcCtx()->stMsCfgInfo.ucTiNonregularAddedFlg;
}

VOS_VOID NAS_CC_SetTiNonregularAddedFlg(VOS_UINT8 ucTiNonregularAddedFlg)
{
    NAS_CC_GetCcCtx()->stMsCfgInfo.ucTiNonregularAddedFlg = ucTiNonregularAddedFlg;
}


VOS_VOID NAS_CC_InitMsCfgInfo(VOS_VOID)
{
    NAS_CC_SetTiNonregularAddedFlg(VOS_FALSE);
