                        ...
                        )
{
    ...
    {                                                                           /* 消息中的取值合法，存储消息               */
        ...
        NAS_NORMAL_LOG(WUEPS_PID_MM, "Mm_RcvRrcPagingInd: Set ucCsPagingFlg to TRUE");
        NAS_MM_SetCsPaingFlg(VOS_TRUE);
                        ...
                        )
{
    ...
    else
    {
       ...
       NAS_NORMAL_LOG4(WUEPS_PID_MM, "ucT3213AttmptCnt is;,MMState is; ulIsGsmOnlyEstCnfRslt is; curr net rat type is;",
                        g_MmGlobalInfo.LuInfo.ucT3213AttmptCnt, g_MmGlobalInfo.ucState,ulIsGsmOnlyEstCnfRslt,NAS_MML_GetCurrNetRatType());
