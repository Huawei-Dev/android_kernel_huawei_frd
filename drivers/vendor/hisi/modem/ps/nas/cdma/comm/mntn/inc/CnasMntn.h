...
#define CNAS_INFO_LOG(Mod,String)   { \
    ...
    stPara.lPara3    = 0; \
    stPara.lPara4    = 0; \
    CNAS_MNTN_LogSave(Mod, String, (LOG_LEVEL_EN)PS_LOG_LEVEL_INFO, &stPara, __FILE__);\
    }
...
#define CNAS_NORMAL_LOG(Mod,String)   { \
    ...
    stPara.lPara3    = 0; \
    stPara.lPara4    = 0; \
    CNAS_MNTN_LogSave(Mod, String, (LOG_LEVEL_EN)PS_LOG_LEVEL_NORMAL, &stPara, __FILE__);\
    }
...
#define CNAS_WARNING_LOG(Mod,String)   { \
    ...
    stPara.lPara3    = 0; \
    stPara.lPara4    = 0; \
    CNAS_MNTN_LogSave(Mod, String, (LOG_LEVEL_EN)PS_LOG_LEVEL_WARNING, &stPara, __FILE__);\
    }
...
#define CNAS_ERROR_LOG(Mod,String)    { \
    ...
    stPara.lPara3    = 0; \
    stPara.lPara4    = 0; \
    CNAS_MNTN_LogSave(Mod, String, (LOG_LEVEL_EN)PS_LOG_LEVEL_ERROR, &stPara, __FILE__);\
    }
...
/* 勾消息时，消息内容的最大长度。勾消息时，我们上报的内容最大为4000，去掉消息头和消息ID(总共为24)，即为3976 */
#define CNAS_MNTN_MSG_MAX_SIZE                              (3976)
...
enum CNAS_MNTN_MSG_ID_ENUM
{
    ...
    ID_CNAS_MNTN_LOG_PC_REPLAY_FIXED_CONTEXT,                               /*_H2ASN_MsgChoice  CNAS_MNTN_LOG_PC_REPLAY_CONTEXT_STRU */
    ID_CNAS_MNTN_LOG_PC_REPLAY_PRE_CFG_PARA_SWITCH_ON,                    /*_H2ASN_MsgChoice  CNAS_MNTN_LOG_PC_REPLAY_CONTEXT_STRU */
...
typedef struct
{
    VOS_MSG_HEADER                                                              /* 消息头 */    /* _H2ASN_Skip */
    CNAS_MNTN_MSG_ID_ENUM_UINT32            enMsgId;                            /* 消息ID */    /* _H2ASN_Skip */
    VOS_UINT8                               aucDataCtx[4];                      /* 消息内容 */
}CNAS_MNTN_LOG_PC_REPLAY_CONTEXT_STRU;
