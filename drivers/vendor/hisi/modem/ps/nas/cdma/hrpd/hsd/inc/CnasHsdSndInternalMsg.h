...
enum CNAS_HSD_INTERNAL_MSG_TYPE_ENUM
{
    ...
    ID_CNAS_HSD_HSD_BG_SRCH_RSLT_CNF         = 0x000A, /* _H2ASN_MsgChoice CNAS_HSD_HSD_BG_SRCH_RSLT_CNF_STRU*/
...
enum CNAS_HSD_SYSTEM_ACQUIRED_RESULT_ENUM
{
    ...
    CNAS_HSD_SYSTEM_ACQUIRED_RESULT_SESSION_NORF            = 0x00000005,
    CNAS_HSD_SYSTEM_ACQUIRED_RESULT_BUTT                    = 0x00000006
};
...
}CNAS_HSD_HSD_BG_SRCH_RSLT_CNF_STRU;
...
extern VOS_VOID CNAS_HSD_SndBgSrcgRslt(
    CNAS_HSD_SYS_ACQ_SCENE_ENUM_UINT32  enCurAcqScene,
    CNAS_HSD_REACQ_FALG_ENUM_UINT32     enNeedSrchFlag
);
