...
extern TAF_PS_CAUSE_ENUM_UINT32 TAF_APS_MapEhsmCause(
...
extern TAF_PS_CAUSE_ENUM_UINT32 I1_TAF_APS_MapEhsmCause(
    EHSM_APS_CAUSE_ENUM_UINT32          enEhsmCause
);

#if (3 == MULTI_MODEM_NUMBER)
extern TAF_PS_CAUSE_ENUM_UINT32 I2_TAF_APS_MapEhsmCause(
    EHSM_APS_CAUSE_ENUM_UINT32          enEhsmCause
);
#endif
