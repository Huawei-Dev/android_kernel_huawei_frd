...
)
{
    ...
    {
        CNAS_WARNING_LOG(UEPS_PID_EHSM, "CNAS_EHSM_ValidateIpcpLen:IPCP length is illegal!");
    ...
    while (ucTmpLength > ucSum)
    {
        ...
        {
            CNAS_WARNING_LOG(UEPS_PID_EHSM, "CNAS_EHSM_ValidateIpcpLen:IPCP Opt length is 0!");
...
)
{
    ...
    {
        CNAS_WARNING_LOG(UEPS_PID_EHSM, "CNAS_EHSM_DecodeIpcpOptionContent:Lenth is illegal!");
    ...
    while (ulTempSum < (*pulSum + ulOptionLen))
    {
        switch (pucTmpMsg[ulTempSum])
        {
            ...
            case CNAS_EHSM_IPCP_OPTIONS_PRI_DNS_ADDR:
                ...
                {
                    CNAS_WARNING_LOG(UEPS_PID_EHSM, "CNAS_EHSM_DecodeIpcpContent:DNS Lenth is illegal!");
...
)
{
    ...
    {
        CNAS_WARNING_LOG(UEPS_PID_EHSM, "CNAS_EHSM_DecodeIpcpContent:IPCP length is illegal!");
...
)
{
    ...
    if (0 == ucPcoLength)
    {
        CNAS_WARNING_LOG(UEPS_PID_EHSM, "CNAS_EHSM_ValidatePcoLen:Pco length is 0!");
    ...
    {
        CNAS_WARNING_LOG(UEPS_PID_EHSM, "CNAS_EHSM_ValidatePcoLen:Pco length is between (1,4)!");
...
)
{
    ...
    {
        CNAS_WARNING_LOG(UEPS_PID_EHSM, "CNAS_EHSM_DecodePcoContent:Pco Configaration Proctocol error!");
...
)
{
    ...
    {
        /*返回消息检测失败*/
        CNAS_WARNING_LOG(UEPS_PID_EHSM,  "CNAS_EHSM_DecodeNwPco:CNAS_EHSM_ValidatePcoLen failed!");
