...
enum CNAS_EHSM_MNTN_MSG_ID_ENUM
{
    ...
    ID_CNAS_EHSM_MNTN_LOG_ERROR_INFO_IND                = CNAS_EHSM_MSG_ID_BASE + 0X0004,     /*_H2ASN_MsgChoice  CNAS_EHSM_MNTN_LOG_CTX_INFO_STRU */
...
typedef struct
{
    VOS_MSG_HEADER                                                              /* _H2ASN_Skip */
    CNAS_EHSM_MNTN_MSG_ID_ENUM_UINT32                       enMsgId;            /* _H2ASN_Skip */
    CNAS_EHSM_ERROR_INFO_TOTAL_STRU                         stErrorInfo;
}CNAS_EHSM_MNTN_LOG_ERROR_INFO_STRU;
