...
)
{
    ...
    NAS_MEM_CPY_S(pstMsg->aucSectorId, HSD_HSM_SUBNET_ID_MAX_LENGTH, pstCasOhmMsg->aucSectorId, CAS_CNAS_SUBNET_ID_MAX_LENGTH);
    NAS_MEM_CPY_S(pstMsg->aucSecondaryColorCode, HSD_HSM_SECOND_COLORCODE_MAX_LENGTH, pstCasOhmMsg->aucSecondaryColorCode, CAS_CNAS_SECOND_COLORCODE_MAX_LENGTH);
