...
extern VOS_VOID CNAS_HSD_RcvSysAcqRsltCnf_Initial_SessionNoRf(
    CNAS_HSD_HSD_SYSTEM_ACQUIRED_RSLT_CNF_STRU             *pstSysAcqRslt
);
...
extern VOS_UINT32 CNAS_HSD_RcvBgSrchRsltCnf_Idle(
    VOS_UINT32                          ulEventType,
    struct MsgCB                       *pstMsg
);

extern VOS_UINT32 CNAS_HSD_RcvBgSearchReq_Idle(
    VOS_UINT32                          ulEventType,
    struct MsgCB                       *pstMsg
);
