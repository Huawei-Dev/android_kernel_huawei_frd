...
)
{
    ...
    if (VOS_NULL_PTR != pActFun )
    {
        ...
        CNAS_INFO_LOG3(UEPS_PID_EHSM,"CNAS_EHSM_FSM_ProcessEvent,prestate, eventtype,retValue", ulCurState, ulEventType, ulRet);
        return ulRet;
    }
...
)
{
    ...
    switch ( enMsgPrio )
    {
        ...
        case CNAS_EHSM_MSG_COMPARE_PRIO_RSLT_STORE :
            CNAS_EHSM_SaveCacheMsg(ulEventType,(VOS_VOID *) pstMsg, enAbortType);
            return VOS_TRUE;
