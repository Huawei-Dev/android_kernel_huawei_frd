...
CNAS_HSM_APS_ERR_CODE_MAP_STRU g_astHsmApsErrCodeMapTbl[] =
{
    ...
    {CAS_CNAS_HRPD_CONN_OPEN_RSLT_SRCHING_NETWORK,{0,0,0},           HSM_APS_CAUSE_CAN_NOT_EST_CONN},
    {CAS_CNAS_HRPD_CONN_OPEN_RSLT_OHM_NOT_CURRENT,{0,0,0},           HSM_APS_CAUSE_OHM_NOT_CURRENT},
};
...
CNAS_HSM_EHSM_ERR_CODE_MAP_STRU g_astHsmEhsmErrCodeMapTbl[] =
{
    ...
    {CAS_CNAS_HRPD_CONN_OPEN_RSLT_SRCHING_NETWORK,{0,0,0},           EHSM_HSM_RSLT_CAN_NOT_EST_CONN},

    {CAS_CNAS_HRPD_CONN_OPEN_RSLT_OHM_NOT_CURRENT,{0,0,0},           EHSM_HSM_RSLT_OHM_NOT_CURRENT},
...
{
    {TI_CNAS_HSM_WAIT_SCP_ACTIVE_CNF,                               VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_UATI_REQUEST_WAIT_SNP_DATA_CNF,                    VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_SESSION_CLOSE_WAIT_SNP_DATA_CNF,                   VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_UATI_COMPLETE_WAIT_SNP_DATA_CNF,                   VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_MO_KEEP_ALIVE_WAIT_SNP_DATA_CNF,                   VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_MT_KEEP_ALIVE_WAIT_SNP_DATA_CNF,                   VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_HARDWARE_ID_RSP_WAIT_SNP_DATA_CNF,                 VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_WAIT_UATI_ASSIGN,                                  VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_ADDRESS_TIMER,                                     VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_KEEP_ALIVE_TIMER,                                  VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_WAIT_HRPD_CONN_CLOSE_IND,                          VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_WAIT_HRPD_CONN_OPEN_IND,                           VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_WAIT_SCP_DEACTIVE_CNF,                             VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_UATI_AND_SESSION_ACT_PROTECT_TIMER,                VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_WAIT_PA_RAT_MODE_NTF,                              VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_WAIT_CARD_READ_CNF,                                VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_WAIT_KEEP_ALIVE_RSP,                               VOS_TIMER_PRECISION_0},
    {TI_CNAS_HSM_WAIT_UATI_CMPL_SND_IND,                            VOS_TIMER_PRECISION_0}
};
...
)
{
    ...
    /* Return No precision by default，默认场景为VOS_TIMER_PRECISION_0 */
    return VOS_TIMER_PRECISION_0;
}
...
VOS_UINT32 CNAS_HSM_IsInUatiProcedure(VOS_VOID)
{
    ...
    if ((CNAS_HSM_SS_UATI_REQUEST_WAIT_SNP_DATA_CNF      == enSubSta)
     ...
     || (CNAS_HSM_SS_UATI_REQUEST_WAIT_UATI_CMPL_SND_IND == enSubSta))
    {
        return VOS_TRUE;
    }
...
)
{
    ...
    switch(enConnOpenIndRslt)
    {
        ...
        case CAS_CNAS_HRPD_CONN_OPEN_RSLT_SRCHING_NETWORK:
            enConnOpenIndRsltConvert = HSM_HSD_HRPD_CONN_OPEN_RSLT_SRCHING_NETWORK;
            break;
