...
)
{
    ...
    /* 迁移到 CNAS_HSD_SWITCH_ON_STA_WAIT_HRM_START_CNF状态,并启动保护定时器TI_CNAS_HSD_WAIT_HRM_START_CNF */
    CNAS_HSD_SetCurrFsmState(CNAS_HSD_SWITCH_ON_STA_WAIT_HRM_START_CNF);
    CNAS_HSD_StartTimer(TI_CNAS_HSD_WAIT_HRM_START_CNF, TI_CNAS_HSD_WAIT_HRM_START_CNF_LEN);
...
)
{
    ...
    /* 迁移到 CNAS_HSD_SWITCH_ON_STA_WAIT_HSM_START_CNF状态,并启动保护定时器TI_CNAS_HSD_WAIT_HSM_START_CNF */
...
)
{
    ...
    /* 迁移到 CNAS_HSD_SWITCH_ON_STA_WAIT_HSM_START_CNF状态,并启动保护定时器TI_CNAS_HSD_WAIT_EHSM_START_CNF */
    CNAS_HSD_SetCurrFsmState(CNAS_HSD_SWITCH_ON_STA_WAIT_HSM_START_CNF);
