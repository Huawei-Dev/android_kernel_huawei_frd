...
/* 该消息在迭代15不再由HRUP发送，移至Network lost原因值中，后续需要作适应修改 */
    ...
    NAS_ACT_TBL_ITEM(UEPS_PID_MSCC,
                     ID_MSCC_HSD_ENABLE_LTE_NTF,
                     CNAS_HSD_RcvMsccEnableLteNtf_PreProc),
    ...
    NAS_ACT_TBL_ITEM( MSP_PID_DIAG_APP_AGENT,
                      ...
                      CNAS_HSD_RcvAcpuOmErrlogRptReq_PreProc),
#endif

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_CNAS_HSD_SYS_ACQ_NO_RF_PROTECT_TIMER,
                      CNAS_HSD_RcvTiSysAcqNoRfProtectTimerExpired_PreProc),
