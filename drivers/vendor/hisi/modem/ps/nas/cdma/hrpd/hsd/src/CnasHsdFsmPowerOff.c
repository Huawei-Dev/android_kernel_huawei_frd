...
)
{
    ...
    /* 通知HRM关机 */
    CNAS_HSD_SndHrmPowerOffReq();

    /* 迁移到 CNAS_HSD_POWER_OFF_STA_WAIT_HRM_POWEROFF_CNF状态,并启动保护定时器TI_CNAS_HSD_WAIT_HRM_POWEROFF_CNF */
    CNAS_HSD_SetCurrFsmState(CNAS_HSD_POWER_OFF_STA_WAIT_HRM_POWEROFF_CNF);
    CNAS_HSD_StartTimer(TI_CNAS_HSD_WAIT_HRM_POWEROFF_CNF, TI_CNAS_HSD_WAIT_HRM_POWEROFF_CNF_LEN);
...
VOS_UINT32 CNAS_HSD_RcvHrmPowerOffCnf_PowerOff_WaitHrmPowerOffCnf(
    VOS_UINT32                          ulEventType,
    struct MsgCB                       *pstMsg
)
{
...
VOS_UINT32  CNAS_HSD_RcvTiWaitHrmPowerOffCnfExpired_PowerOff_WaitHrmPowerOffCnf(
    VOS_UINT32                          ulEventType,
    struct MsgCB                       *pstMsg
)
{
    /* 异常打印 */
    CNAS_WARNING_LOG(UEPS_PID_HSD, "CNAS_HSD_RcvTiWaitHrmPowerOffCnfExpired_PowerOff_WaitHluPowerOffCnf:wait hlu power off expired");
