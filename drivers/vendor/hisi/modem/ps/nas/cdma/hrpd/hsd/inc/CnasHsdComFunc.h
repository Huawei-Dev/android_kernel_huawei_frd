...
#define CNAS_HSD_CHINA_MAINLAND_MCC_HEX                  (0x00000604)        /* 大陆MCC */
#define CNAS_HSD_CHINA_MACAO_MCC_HEX                     (0x00050504)        /* 澳门MCC */
...
extern VOS_VOID CNAS_HSD_ConvertNasPlmnToSimFormat(
    VOS_UINT32                          ulNasPlmnNum,
    NAS_MSCC_PIF_PLMN_ID_STRU          *pastNasPlmn,
    CNAS_CAS_HRPD_PLMN_STRU            *pastSimPlmn
);

extern VOS_VOID  CNAS_HSD_ConvertToSimFormat(
    NAS_MSCC_PIF_PLMN_ID_STRU           *pstNasPlmn,
    CNAS_CAS_HRPD_PLMN_STRU             *pstSimPlmn
);

extern CNAS_CAS_HRPD_BSR_TYPE_ENUM_UINT8  CNAS_HSD_ConvertBsrType(
...
extern VOS_UINT32 CNAS_HSD_IsCurFreqInCTCCCustomizeFreqNvim(
    VOS_UINT16                          usFreq
);

extern VOS_UINT32 CNAS_HSD_IsNeedRecordHrpdCustomChannels(
    CAS_CNAS_HRPD_OVERHEAD_MSG_IND_STRU                    *pstCasOhmMsg
);

extern VOS_UINT32 CNAS_HSD_AddCurFreqToHrpdCustomChannels(
    VOS_UINT16                          usFreq
);

extern VOS_VOID CNAS_HSD_AddNewCTCCFreqListIntoAcqRec(VOS_VOID);

extern VOS_VOID CNAS_HSD_RecordHrpdCustomChannelsProc(
    CAS_CNAS_HRPD_OVERHEAD_MSG_IND_STRU                    *pstCasOhmMsg
);
