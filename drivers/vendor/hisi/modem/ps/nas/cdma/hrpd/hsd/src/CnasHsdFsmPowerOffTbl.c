...
/* CNAS_HSD_POWER_OFF_STA_WAIT_HRM_POWEROFF_CNF动作表 */
NAS_ACT_STRU g_astCnasHsdPoweroffWaitHrmPowerOffCnfActTbl[] =
{
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSD_POWEROFF_CNF,
                      CNAS_HSD_RcvHrmPowerOffCnf_PowerOff_WaitHrmPowerOffCnf),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_CNAS_HSD_WAIT_HRM_POWEROFF_CNF,
                      CNAS_HSD_RcvTiWaitHrmPowerOffCnfExpired_PowerOff_WaitHrmPowerOffCnf)
};
...
NAS_STA_STRU g_astCnasHsdPowerOffStaTbl[] =
{
    ...
    /*****************定义HLU关机状态转移表**********************/
    NAS_STA_TBL_ITEM( CNAS_HSD_POWER_OFF_STA_WAIT_HRM_POWEROFF_CNF,
                      g_astCnasHsdPoweroffWaitHrmPowerOffCnfActTbl),
