...
enum HSM_HSD_SESSION_NEG_RSLT_ENUM
{
    ...
    HSM_HSD_SESSION_NEG_RSLT_NO_RF                          = 0x04,
    HSM_HSD_SESSION_NEG_RSLT_ENUM_BUTT                      = 0x05
};
...
enum HSM_HSD_HRPD_CONN_OPEN_RSLT_ENUM
{
    ...
    HSM_HSD_HRPD_CONN_OPEN_RSLT_SRCHING_NETWORK             = 0x09,
    HSM_HSD_HRPD_CONN_OPEN_RSLT_ENUM_BUTT                   = 0x0A
};
