...
VOS_VOID CNAS_HSM_ReadHrpdSessionInfoExNvim(VOS_VOID)
{
    ...
    CNAS_HSM_SetRegLteSuccFlag(stHrpdSessionInfoEx.ucLteRegSuccFlg);
}
...
VOS_VOID CNAS_HSM_WriteHrpdSessionInfoExNvim(VOS_VOID)
{
    ...
    stHrpdSessionInfoEx.ucLteRegSuccFlg = CNAS_HSM_GetRegLteSuccFlag();
...
VOS_VOID CNAS_HSM_ReadHrpdSessionCtrlCfgNvim(VOS_VOID)
{
    ...
    CNAS_HSM_SetClearKATimerInConnOpenFlg(stHrpdSessionCtrlCfg.ucClearKATimerInConnOpenFlg);

    CNAS_HSM_SetRecoverEhrpdAvailFlg(stHrpdSessionCtrlCfg.ucRecoverEhrpdAvailFlg);
