...
NAS_ACT_STRU g_astCnasEhsmPreProActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_RRM,
                      ...
                      CNAS_EHSM_RcvRrmStatusInd_PreProc),

    NAS_ACT_TBL_ITEM( UEPS_PID_HSM,
                      ID_HSM_EHSM_SUSPEND_IND,
                      CNAS_EHSM_RcvHsmSuspendInd_PreProc),

    NAS_ACT_TBL_ITEM( UEPS_PID_HSM,
                      ID_HSM_EHSM_SESSION_INFO_IND,
                      CNAS_EHSM_RcvHsmSessionInfoInd_PreProc),

    NAS_ACT_TBL_ITEM( PS_PID_ESM,
                      ID_ESM_EHSM_SYNC_PDN_INFO_IND,
                      CNAS_EHSM_RcvEsmSyncPdnInfoInd_PreProc),

#ifdef __PS_WIN32_RECUR__
    NAS_ACT_TBL_ITEM( UEPS_PID_EHSM,
                      ID_CNAS_MNTN_LOG_PC_REPLAY_FIXED_CONTEXT,
                      CNAS_EHSM_RestorePcReplayFixedContext_PreProc),
#endif
};
