...
enum CNAS_HSD_MNTN_MSG_ID_ENUM
{
    ...
    ID_CNAS_HSD_MNTN_LOG_DRX_TIMER_STATUS_IND,                                              /*_H2ASN_MsgChoice  CNAS_HSD_LOG_DRX_TIMER_STATUS_IND_STRU */
...
#define CNAS_HSD_MAX_LOG_MSG_STATE_NUM                      (100)
...
}CNAS_HSD_MNTN_WHITE_LIST_MSG_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                           ucHsdFsmId;    /* 对应模块状态机ID  */
    VOS_UINT8                           ucHsdState;    /* 对应模块的s当前状态  */
}CNAS_HSD_MSG_STATE_STRU;


typedef struct
{
    CNAS_HSD_MSG_STATE_STRU             stMsgState[CNAS_HSD_MAX_LOG_MSG_STATE_NUM];
    VOS_UINT32                          ulLatestIndex;
}CNAS_HSD_LOG_MSG_STATUS_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                           aucReserve[3];
}CNAS_HSD_LOG_DRX_TIMER_STATUS_IND_STRU;
...
extern VOS_UINT32 CNAS_HSD_MNTN_IsNeedRecordForRcvMsg(
    VOS_UINT32                          ulSenderPid,
    VOS_UINT32                          ulReceiverPid,
    VOS_UINT32                          ulMsgName
);

extern VOS_UINT32 CNAS_HSD_MNTN_IsNeedRecordForSndMsg(
    VOS_UINT32                          ulSenderPid,
    VOS_UINT32                          ulReceiverPid,
    VOS_UINT32                          ulMsgName
);

extern CNAS_HSD_LOG_MSG_STATUS_STRU* CNAS_HSD_GetMntnMsgLog(VOS_VOID);

extern VOS_VOID CNAS_HSD_AddLogMsgState(
...
extern VOS_VOID CNAS_HSD_LogMsgInfo(
    MSG_HEADER_STRU                    *pstMsgHeader
);

extern VOS_VOID  CNAS_HSD_LogDrxTimerStatus(
