...
extern TAF_VOID I1_TAF_InitMsgDigestFiveCtxt(TAF_MSG_DIGEST_FIVE_CTX *pstMdCtxt);
extern VOS_VOID I1_TAF_UpdateMsgDigestFiveCtxt(
    TAF_MSG_DIGEST_FIVE_CTX            *pstMdCtxt,
    VOS_UINT8                          *pucInBuf,
    VOS_UINT32                          ulInLen
);
extern VOS_VOID I1_TAF_EndMsgDigestFive(
    VOS_UINT8                           hash[],
    TAF_MSG_DIGEST_FIVE_CTX            *pstMdCtxt
);

#if (3 == MULTI_MODEM_NUMBER)
extern TAF_VOID I2_TAF_InitMsgDigestFiveCtxt(TAF_MSG_DIGEST_FIVE_CTX *pstMdCtxt);
extern VOS_VOID I2_TAF_UpdateMsgDigestFiveCtxt(
    TAF_MSG_DIGEST_FIVE_CTX            *pstMdCtxt,
    VOS_UINT8                          *pucInBuf,
    VOS_UINT32                          ulInLen
);
extern VOS_VOID I2_TAF_EndMsgDigestFive(
    VOS_UINT8                           hash[],
    TAF_MSG_DIGEST_FIVE_CTX            *pstMdCtxt
);
