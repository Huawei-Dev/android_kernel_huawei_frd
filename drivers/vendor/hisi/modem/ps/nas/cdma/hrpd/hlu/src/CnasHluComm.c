...
)
{
    ...
    else
    {
        ...
        CNAS_WARNING_LOG2(UEPS_PID_HLU, "CNAS_HLU_DecodeLoc:Invalid LocationType "
...
{
    CNAS_HLU_BLOB_STRU                  stBLOBCtx = {0};
...
)
{
    ...
    if (VOS_NULL_PTR == pucData)
    {
        CNAS_ERROR_LOG(UEPS_PID_HLU,
                       "CNAS_HLU_ProcHrmDataInd: mem alloc "
                       "mem alloc fail.");
        return;
    }
    ...
    switch (ucMsgId)
    {
        case CNAS_HLU_HRPD_LOC_REQUEST:
        {
            ...
            CNAS_HLU_SndMsgToHrm(CNAS_HLU_HRPD_LOC_NOTIFICATION);
        ...
        case CNAS_HLU_HRPD_LOC_ASSIGNMENT:
        {
            ...
            if (pstMsgData->usMsgBitLen >= CNAS_HLU_LOC_ASSIGN_MSG_MIN_BIT_LEN)
            {
                ...
                if (VOS_OK == ulRetVal)
                {
                    CNAS_HLU_SndMsgToHrm(CNAS_HLU_HRPD_LOC_COMPLETE);
            ...
            {
                CNAS_ERROR_LOG(UEPS_PID_HLU,
                               "CNAS_HLU_ProcHrmDataInd: LOCAssignment message "
        ...
        case CNAS_HLU_HRPD_BLOB_REQUEST:
        {
            ...
            CNAS_HLU_SndMsgToHrm(CNAS_HLU_HRPD_BLOB_NOTIFICATION);
        ...
        case CNAS_HLU_HRPD_BLOB_ASSIGNMENT:
        {
            ...
            if ((CNAS_HLU_BLOB_ASSG_MSG_BIT_LEN(ucBlobLen)) == pstMsgData->usMsgBitLen)
            {
                ...
                if (VOS_OK == ulRetVal)
                {
                    ...
                    CNAS_HLU_SndMsgToHrm(CNAS_HLU_HRPD_BLOB_COMPLETE);
            ...
            {
                CNAS_ERROR_LOG(UEPS_PID_HLU,
                               "CNAS_HLU_ProcHrmDataInd: BLOBAssignment message "
                               "received with invalid msg bit length.");
            }
            break;
        }
        default:
        {
            CNAS_WARNING_LOG(UEPS_PID_HLU, "CNAS_HLU_ProcHrmDataInd: Incorrect "
