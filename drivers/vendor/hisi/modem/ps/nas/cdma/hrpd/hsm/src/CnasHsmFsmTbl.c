...
NAS_ACT_STRU g_astCnasHsmSessionActWaitScpActiveCnfActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_IND,
                      CNAS_HSM_RcvHrmDataInd_SessionAct_WaitScpActiveCnf),
...
NAS_ACT_STRU g_astCnasHsmSessionActWaitPaRatModeNtfActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_IND,
                      CNAS_HSM_RcvHrmDataInd_SessionAct_WaitPaRatModeNtf),
...
NAS_ACT_STRU g_astCnasHsmSessionDeactWaitSessionCloseSnpDataCnfActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_CNF,
                      CNAS_HSM_RcvHrmDataCnf_SessionDeact_WaitSessionCloseSnpDataCnf),
...
NAS_ACT_STRU g_astCnasHsmSessionDeactWaitConnCloseIndActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HSD,
                      ID_HSD_HSM_SUSPEND_IND,
                      CNAS_HSM_RcvHsdSuspendInd_SessionDeact_WaitConnCloseInd),
};
...
NAS_ACT_STRU g_astCnasHsmSetupUatiRequestWaitSnpDataCnfActTbl[] =
{
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_CNF,
                      CNAS_HSM_RcvHrmDataCnf_UatiReq_WaitUatiReqSnpDataCnf),
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_IND,
                      CNAS_HSM_RcvHrmHrpdSnpDataInd_UatiReq_WaitUatiReqSnpDataCnf),
...
NAS_ACT_STRU g_astCnasHsmSetupUatiWaitUATIAssignActTbl[] =
{
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_IND,
                      CNAS_HSM_RcvHrmDataInd_UatiReq_WaitUatiAssign),
...
/* DSDS2.0 setup态需要等到uati cmpl消息发送给cttf后再退状态机 */
NAS_ACT_STRU g_astCnasHsmSetupUatiWaitUatiCmplSndIndActTbl[] =
{
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_UATI_CMPL_SND_IND,
                      CNAS_HSM_RcvHrmUatiCmplSndInd_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_CNF,
                      CNAS_HSM_RcvHrmDataCnf_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_CNAS_HSM_WAIT_UATI_CMPL_SND_IND,
                      CNAS_HSM_RcvTiWaitUatiCmplSndIndTimerExpire_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_HSD,
                      ID_HSD_HSM_POWEROFF_REQ,
                      CNAS_HSM_RcvHsdPowerOffReq_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_HSD,
                      ID_HSD_HSM_SUSPEND_IND,
                      CNAS_HSM_RcvHsdSuspendInd_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_HSD,
                      ID_HSD_HSM_POWER_SAVE_REQ,
                      CNAS_HSM_RcvHsdPowerSaveReq_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_IND,
                      CNAS_HSM_RcvHrmDataInd_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_HSM,
                      ID_CNAS_HSM_HSM_SESSION_CLOSE_IND,
                      CNAS_HSM_RcvHsmSessionCloseInd_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_HALMP,
                      ID_CAS_CNAS_HRPD_NETWORK_LOST_IND,
                      CNAS_HSM_RcvCasHrpdNetworkLostInd_UatiReq_WaitUatiCmplSndInd),
...
NAS_ACT_STRU g_astCnasHsmOpenUatiWaitUatiCmplSndIndActTbl[] =
{
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_UATI_CMPL_SND_IND,
                      CNAS_HSM_RcvHrmUatiCmplSndInd_UatiReq_WaitUatiCmplSndInd),
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HSD,
                      ID_HSD_HSM_OVERHEAD_MSG_IND,
                      CNAS_HSM_RcvHsdOverHeadMsgInd_UatiReq_WaitUatiCmplSndInd),
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_EHSM,
                      ID_EHSM_HSM_EHRPD_NOT_AVAILABLE_IND,
                      CNAS_HSM_RcvEhsmEhrpdNotAvailableInd_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_HSCP,
                      ID_CAS_CNAS_HRPD_PA_RAT_MODE_NTF,
                      CNAS_HSM_RcvCasPaRatModeNtf_UatiReq_WaitUatiCmplSndInd),
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HSP,
                      ID_CAS_CNAS_HRPD_PAGE_IND,
                      CNAS_HSM_RcvCasHrpdPageInd_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( WUEPS_PID_TAF,
                      ID_APS_HSM_DISC_REQ,
                      CNAS_HSM_RcvApsDiscReq_UatiReq_WaitUatiCmplSndInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_EHSM,
                      ID_EHSM_HSM_DISC_REQ,
                      CNAS_HSM_RcvEhsmDiscReq_UatiReq_WaitUatiCmplSndInd),
};
...
NAS_ACT_STRU g_astCnasHsmOpenConnMnmtWaitConnOpenIndActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_IND,
                      CNAS_HSM_RcvHrmDataInd_ConnMnmt_WaitConnOpenInd),
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HALMP,
                      ...
                      CNAS_HSM_RcvCasHrpdCasStatusInd_ConnMnmt_WaitConnOpenInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_EHSM,
                      ID_EHSM_HSM_EHRPD_NOT_AVAILABLE_IND,
                      CNAS_HSM_RcvEhsmEhrpdNotAvailableInd_ConnMnmt_WaitConnOpenInd),
};
...
NAS_ACT_STRU g_astCnasHsmOpenConnMnmtWaitConnCloseIndActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HRM,
                      ID_HRM_HSM_DATA_IND,
                      CNAS_HSM_RcvHrmDataInd_ConnMnmt_WaitConnCloseInd),
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_HALMP,
                      ID_CAS_CNAS_HRPD_CAS_STATUS_IND,
                      CNAS_HSM_RcvCasHrpdCasStatusInd_ConnMnmt_WaitConnCloseInd),
...
NAS_STA_STRU g_astCnasHsmFsmStaTbl[] =
{
    ...
    /* DSDS2.0 再setup态发送了uati cmpl后要等到申请资源成功后再退出状态机发起session协商 */
    NAS_MUTI_STA_TBL_ITEM( CNAS_HSM_L1_STA_SETUP,
                           CNAS_HSM_SS_UATI_REQUEST_WAIT_UATI_CMPL_SND_IND,
                           g_astCnasHsmSetupUatiWaitUatiCmplSndIndActTbl ),
    ...
    NAS_MUTI_STA_TBL_ITEM( CNAS_HSM_L1_STA_OPEN,
                           CNAS_HSM_SS_UATI_REQUEST_WAIT_UATI_CMPL_SND_IND,
                           g_astCnasHsmOpenUatiWaitUatiCmplSndIndActTbl ),
