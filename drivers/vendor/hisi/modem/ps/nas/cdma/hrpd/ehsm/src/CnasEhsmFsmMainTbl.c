...
NAS_ACT_STRU g_astCnasEhsmMainInactiveActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_TAF,
                      ...
                      CNAS_EHSM_RcvApsPdnActivateReq_Inactive),
    ...
    NAS_ACT_TBL_ITEM( UEPS_PID_RRM,
                      ...
                      CNAS_EHSM_RcvRrmStatusInd_Inactive),

    NAS_ACT_TBL_ITEM( MSPS_PID_PPPC,
                      ID_CTTF_CNAS_EHRPD_DETACH_IND,
                      CNAS_EHSM_RcvCttfEhrpdDetachInd_Inactive),
    NAS_ACT_TBL_ITEM( PS_PID_ESM,
                      ID_ESM_EHSM_CLEAR_ALL_BEARER_NOTIFY,
                      CNAS_EHSM_RcvEsmClearAllBearerNotify_Inactive),

    NAS_ACT_TBL_ITEM( MSPS_PID_PPPC,
                      ID_CTTF_CNAS_EHRPD_RECONN_IND,
                      CNAS_EHSM_RcvCttfEhrpdReconnInd_Inactive),


    NAS_ACT_TBL_ITEM( UEPS_PID_HSM,
                      ID_HSM_EHSM_SUSPEND_IND,
                      CNAS_EHSM_RcvHsmSuspendInd_Inactive),
...
NAS_ACT_STRU g_astCnasEhsmMainActiveActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( MSPS_PID_PPPC,
                      ID_CTTF_CNAS_EHRPD_RECONN_IND,
                      CNAS_EHSM_RcvCttfEhrpdReconnInd_Active),
};
...
NAS_ACT_STRU g_astCnasEhsmMainSuspendActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM( MSPS_PID_PPPC,
                      ID_CTTF_CNAS_EHRPD_DETACH_IND,
                      CNAS_EHSM_RcvCttfEhrpdDetachInd_Suspend),

    NAS_ACT_TBL_ITEM( PS_PID_ESM,
                      ID_ESM_EHSM_CLEAR_ALL_BEARER_NOTIFY,
                      CNAS_EHSM_RcvEsmClearAllBearer_Suspend),

    NAS_ACT_TBL_ITEM( MSPS_PID_PPPC,
                      ID_CTTF_CNAS_EHRPD_RECONN_IND,
                      CNAS_EHSM_RcvCttfEhrpdReconnInd_Suspend),

    NAS_ACT_TBL_ITEM( MSPS_PID_PPPC,
                      ID_CTTF_CNAS_EHRPD_PDN_DISC_IND,
                      CNAS_EHSM_RcvCttfEhrpdPdnDiscInd_Suspend),
};
