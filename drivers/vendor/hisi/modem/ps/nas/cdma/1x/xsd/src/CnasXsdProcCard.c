...
)
{
    ...
    else
    {
        ...
        if (VOS_TRUE == ulRslt)
        {
            CNAS_XSD_LogPrlSourceType(CNAS_CCB_PRL_TYPE_EPRL_FILE);
            CNAS_CCB_SetPrlSrcType(CNAS_CCB_PRL_TYPE_EPRL_FILE);
            return;
        }
...
)
{
    ...
    {
        CNAS_XSD_LogPrlSourceType(CNAS_CCB_PRL_TYPE_PRL_FILE);
        CNAS_CCB_SetPrlSrcType(CNAS_CCB_PRL_TYPE_PRL_FILE);
    }
