...
enum CNAS_XSD_SYSTEM_ACQUIRED_RESULT_ENUM
{
    ...
    CNAS_XSD_SYSTEM_ACQUIRED_RESULT_NO_FREQ                 = 0x00000003,
    CNAS_XSD_SYSTEM_ACQUIRED_RESULT_BUTT                    = 0x00000004
};
...
typedef struct
{
    ...
    VOS_UINT8                                               ucOocToalTimerExpiredFlg;/* OOC场景下总阶段定时器超时标记 */
    VOS_UINT8                                               aucRsv[2];
...
typedef struct
{
    ...
    CNAS_XSD_INTERNAL_MSG_TYPE_ENUM_UINT16                  enMsgId; /* _H2ASN_Skip */
    VOS_UINT16                                              usOpId;
    CNAS_XSD_OOS_SYS_ACQ_STRTEGY_CFG_STRU                   stOocCfgInfo;
...
VOS_VOID CNAS_XSD_SndSysAcqRslt(
    ...
    CNAS_XSD_SYS_ACQ_SCENE_ENUM_UINT32                      enCurAcqScene,
    VOS_UINT8                                               ucImmediateSysAcq,
    VOS_UINT8                                               ucOocTotalTimerExpiredFlg
);
