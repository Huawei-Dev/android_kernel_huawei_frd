...
enum XSD_XREG_PIF_MSG_TYPE_ENUM
{
    ...
    ID_XREG_XSD_REG_SUCCESS_IND         = 0x0008, /* _H2ASN_MsgChoice XREG_XSD_REG_SUCCESS_IND_STRU*/ /**< @sa XREG_REG_SUCCESS_IND_STRU */
     ...
     ID_XSD_XREG_NORMAL_SERVICE_IND     = 0x0009, /* _H2ASN_MsgChoice XSD_XREG_NORMAL_SERVICE_IND_STRU*/ /**< @sa XSD_XREG_NORMAL_SERVICE_IND_STRU */
...
/** ****************************************************************************
 * Name        : XSD_XREG_NORMAL_SERVICE_IND_STRU
 * Description : Start request
 *******************************************************************************/
typedef struct
{
    ...
    VOS_UINT32                          ulMcc;
}XSD_XREG_NORMAL_SERVICE_IND_STRU;
