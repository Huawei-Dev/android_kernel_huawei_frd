...
NAS_ACT_STRU g_stCnasXccMtCallingWaitLmmEsrEndIndActTbl[] =
{
    NAS_ACT_TBL_ITEM(PS_PID_MM,
                     ID_LMM_XCC_ESR_END_IND,
                     CNAS_XCC_RcvLmmEsrEndInd_MtCalling_WaitLmmEsrEndInd),

    NAS_ACT_TBL_ITEM(VOS_PID_TIMER,
                     TI_CNAS_XCC_WAIT_ESR_END_IND,
                     CNAS_XCC_RcvTiWaitLmmEsrEndIndExpired_MtCalling_WaitLmmEsrEndInd),

    NAS_ACT_TBL_ITEM(UEPS_PID_XCC,
                     ID_CNAS_XCC_XCC_POWER_DOWN_IND,
                     CNAS_XCC_RcvXccPowerDownInd_MtCalling_WaitLmmEsrEndInd),
};
...
NAS_STA_STRU g_astCnasXccMtCallingStaTbl[] =
{
    ...
    NAS_STA_TBL_ITEM( CNAS_XCC_MT_CALLING_STA_WAIT_LMM_ESR_END_IND,
                      g_stCnasXccMtCallingWaitLmmEsrEndIndActTbl ),
