...
{
    {CAS_CNAS_1X_TERMINATE_REASON_MS_END,                    TAF_XCC_CAUSE_CAS_MS_END},
    ...
    {CAS_CNAS_1X_TERMINATE_REASON_INTERCEPT,                 TAF_XCC_CAUSE_INTERCEPT},
    {CAS_CNAS_1X_TERMINATE_REASON_NO_RF,                     TAF_XCC_CAUSE_NO_RF},
...
CNAS_XCC_ERRLOG_CAUSE_MAP_STRU           g_astCnasXccErrLogCauseMapTbl[] =
{
    {TAF_XCC_CAUSE_LOCK,                                    NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_LOCK},
    {TAF_XCC_CAUSE_NO_SERVICE,                              NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_NO_SERVICE},
    {TAF_XCC_CAUSE_INTERCEPT,                               NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_INTERCEPT},
    {TAF_XCC_CAUSE_REORDER,                                 NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_REORDER},
    {TAF_XCC_CAUSE_NW_NORMAL_RELEASE,                       NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_NORMAL_RELEASE},
    {TAF_XCC_CAUSE_SO_REJ,                                  NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_SO_REJ},
    {TAF_XCC_CAUSE_MAX_ACCESS_PROBES,                       NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_MAX_ACCESS_PROBES},
    {TAF_XCC_CAUSE_ACCESS_IN_PROGRESS,                      NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_ACCESS_IN_PROGRESS},
    {TAF_XCC_CAUSE_ACCESS_FAIL,                             NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_ACC_FAIL},
    {TAF_XCC_CAUSE_NOT_ACCEPT_BY_BS,                        NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_NOT_ACCEPT_BY_BS},
    {TAF_XCC_CAUSE_ACCT_BLOCK,                              NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_ACCT_BLOCK},
    {TAF_XCC_CAUSE_SIGNAL_FADE_IN_ACH,                      NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_SIGNAL_FADE},
    {TAF_XCC_CAUSE_CHANNEL_ASSIGN_TIMEOUT,                  NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_CHANNEL_ASSIGN_TIMEROUT},
    {TAF_XCC_CAUSE_RELEASE_TIME_OUT,                        NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_RELEASE_TIMEOUT},
    {TAF_XCC_CAUSE_RETRY_FAIL,                              NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_RETRY_FAIL},
    {TAF_XCC_CAUSE_NO_RF,                                   NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_NO_RF},
    {TAF_XCC_CAUSE_ACCESS_DENYIED,                          NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_ACCESS_DENYIED},
    {TAF_XCC_CAUSE_NDSS,                                    NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_NDSS},
    {TAF_XCC_CAUSE_SIGNAL_FADE_IN_TCH,                      NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_SIGNAL_FADE_IN_TCH},
};
...
{
    CS0005E_Details                     stCS0005Detail = {0};
    c_f_dsch                            stMsgFDsch = {U_c_f_dsch_NONE};
...
)
{
     ...
     || (CAS_CNAS_1X_RX_TCH_EXT_FLASH_WITH_INFORMATION_MSG == pstRejInfo->enRejRxTchMsgType))
    {
        ...
        pstMSRejectOrder->REJECTED_RECORD         = 0x00;
    }
...
)
{
    ...
    VOS_UINT32                          ulRslt;
    c_r_dsch                            stMsgRDsch = {U_c_r_dsch_NONE};
...
{
    CS0005E_Details                     stCS0005Detail = {0};
    c_f_csch_mini6                      stMsgFCsch = {U_c_f_csch_mini6_NONE};
    VOS_INT32                           lDecodeRslt;
...
)
{
    ...
    c_r_csch_mini6                                          stMsgRCsch = {U_c_r_csch_mini6_NONE};
    VOS_UINT32                                              ulRslt;
...
VOS_UINT32 CNAS_XCC_IsNeedNtfLmmVoiceCall( VOS_VOID )
{
    CNAS_XCC_SERVICE_TYPE_ENUM_UINT32           enServiceType;
    VOS_UINT32                                  ulIsSyscfgSupportLte;
    ...
    ulIsSyscfgSupportLte                    = CNAS_CCB_IsSyscfgSupportLte();
    ucIsAlreadyNtfLmmCallStart              = CNAS_XCC_GetAlreadyNtfLmmCallStartFlag();

    CNAS_NORMAL_LOG1(UEPS_PID_XCC, "CNAS_XCC_IsNeedNtfLmmVoiceCall: Curr Version Type is", CNAS_CCB_IsVersionSrlte());

    if ((CNAS_CCB_VERSION_SRLTE             == CNAS_CCB_IsVersionSrlte())
     && (VOS_TRUE                           == ulIsSyscfgSupportLte)
     && (CNAS_XCC_SERVICE_TYPE_VOICE_CALL   == enServiceType)
     && (VOS_FALSE                          == ucIsAlreadyNtfLmmCallStart))
    {
        return VOS_TRUE;
    }
...
VOS_VOID CNAS_XCC_ProcSameServiceExistedCollisionErrLogInfo(
    VOS_UINT8                                               ucIndex,
    CAS_CNAS_1X_SERVICE_OPTION_ENUM_UINT16                  enSo
)
{
    ...
    enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_BUTT;
    enService         = CNAS_XCC_ConvertSoTo1xErrLogServiceType(enSo);

    /*相同业务类型被叫不记录 */
    if (VOS_TRUE == CNAS_XCC_IsCurServiceMo(ucIndex))
    {
        if (NAS_ERR_LOG_1X_MT_SERVICE_TYPE_VOICE_CALL== enService)
        {
            enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_EXIST_MO_VOICE;
        }
        /* 存在数据主叫，收到数据被叫的场景，不上报异常*/
        else if (NAS_ERR_LOG_1X_MT_SERVICE_TYPE_SMS == enService)
        {
            enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_EXIST_MO_CSMS;
        }
        else if (NAS_ERR_LOG_1X_MT_SERVICE_TYPE_AGPS_CALL == enService)
        {
            enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_EXIST_MO_AGPS;
        }
        else
        {
            return;
        ...
        NAS_ERRLOG_CCB_SavePagingServiceType(enService);

        NAS_ERRLOG_CCB_SaveReceivedPagingTimer(enService, VOS_GetSlice());

        NAS_ERRLOG_CCB_SaveMtServiceExceptionCause(enService, enErrLogCallCause);

        CNAS_XCC_Report1xMtServiceExceptionErrLogInfo(enService);

        NAS_ERRLOG_CCB_Init1xMtServiceExceptionRecord(enService);
    }
}



VOS_VOID CNAS_XCC_ProcVoiceServiceExistedCollisionErrLogInfo(
    VOS_UINT8                                               ucIndex,
    NAS_ERR_LOG_1X_SERVICE_TYPE_ENUM_UINT32                 enPagingService 
)
{
    NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_ENUM_UINT32   enErrLogCallCause;
    ...
    {
        enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_EXIST_MT_VOICE;
    }

    NAS_ERRLOG_CCB_SavePagingServiceType(enPagingService);

    NAS_ERRLOG_CCB_SaveReceivedPagingTimer(enPagingService, VOS_GetSlice());

    NAS_ERRLOG_CCB_SaveMtServiceExceptionCause(enPagingService, enErrLogCallCause);

    CNAS_XCC_Report1xMtServiceExceptionErrLogInfo(enPagingService);

    NAS_ERRLOG_CCB_Init1xMtServiceExceptionRecord(enPagingService);

}


VOS_VOID CNAS_XCC_ProcCdataServiceExistedCollisionErrLogInfo(
    VOS_UINT8                                               ucIndex,
    NAS_ERR_LOG_1X_SERVICE_TYPE_ENUM_UINT32                 enPagingService 
)
{
    ...
    if (VOS_TRUE == CNAS_XCC_IsCurServiceMo(ucIndex))
    {
        enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_EXIST_MO_CDATA;
    }
    else
    {
        enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_EXIST_MT_CDATA;
    }
...
VOS_VOID CNAS_XCC_ProcCsmsServiceExistedCollisionErrLogInfo(
    VOS_UINT8                                               ucIndex,
    NAS_ERR_LOG_1X_SERVICE_TYPE_ENUM_UINT32                 enPagingService 
)
{
    ...
    {
        enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_EXIST_MT_CSMS;
    }
...
VOS_VOID CNAS_XCC_ProcAgpsServiceExistedCollisionErrLogInfo(
    VOS_UINT8                                               ucIndex,
    NAS_ERR_LOG_1X_SERVICE_TYPE_ENUM_UINT32                 enPagingService 
)
{
    ...
    {
        enErrLogCallCause = NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_EXIST_MT_AGPS;
    }
...
VOS_VOID CNAS_XCC_Report1xMtServiceExceptionErrLogInfo(
...
)
{
    ...
    NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_STRU                st1xMtServiceException;
    NAS_ERRLOG_CCB_1X_MT_SERVICE_EXCEPTION_STRU            *pst1xMtServiceException = VOS_NULL_PTR;

    /* 查询对应Alarm Id是否需要记录异常信息 */
    usLevel       = NAS_GetErrLogAlmLevel(NAS_ERR_LOG_ALM_1X_MT_SERVICE_EXCEPTION);
    ulIsLogRecord = CNAS_XCC_IsErrLogNeedRecord(usLevel);
    ...
    NAS_MEM_SET_S(&st1xMtServiceException, sizeof(st1xMtServiceException), 0x00, sizeof(st1xMtServiceException));
    ...
    st1xMtServiceException.ulCcCause     = pst1xMtServiceException->ast1xMtExceptionRecord[ucIndex].enCcCause;
    st1xMtServiceException.ulPagingTimer = pst1xMtServiceException->ast1xMtExceptionRecord[ucIndex].ulPagingTimer;
    st1xMtServiceException.ulPagingType  = pst1xMtServiceException->ast1xMtExceptionRecord[ucIndex].enPagingType;
    st1xMtServiceException.ulXccState    = pst1xMtServiceException->ast1xMtExceptionRecord[ucIndex].ulXccState;

    /* 填充OM_ERR_LOG_HEADER_STRU stHeader */
    CNAS_COMM_BULID_ERRLOG_HEADER_INFO(&st1xMtServiceException.stHeader,
                                       CNAS_CCB_GetCdmaModeModemId(),
                                       NAS_ERR_LOG_ALM_1X_MT_SERVICE_EXCEPTION,
                                       usLevel,
                                       VOS_GetSlice(),
                                       (sizeof(st1xMtServiceException) - sizeof(OM_ERR_LOG_HEADER_STRU)));

    /* 上报异常信息 */
    NAS_ERRLOG_CCB_SndAcpuOmFaultErrLogInd(&st1xMtServiceException,
                                           sizeof(st1xMtServiceException),
                                           FAULT_ID_1X_MT_CALL_FAIL,
                                           NAS_ERR_LOG_ALM_1X_MT_SERVICE_EXCEPTION,
                                           UEPS_PID_XCC);
...
VOS_UINT32 CNAS_XCC_IsErrLogNeedRecord(
    VOS_UINT16                          usLevel
)
{
    ...
    if ((VOS_TRUE == NAS_ERRLOG_CCB_GetXccMainActiveReportFlag())
     && (VOS_TRUE == NAS_ERRLOG_CCB_GetCdma1xMtServiceExceptionActiveReportFlag())
     && (NAS_ERRLOG_CCB_GetXccMainActiveReportLevel() >= ucReportAlarmLevel)
...
NAS_ERR_LOG_1X_MT_SERVICE_EXCEPTION_CAUSE_ENUM_UINT32  CNAS_XCC_MapXccCauseToErrLogCause(
     TAF_XCC_CAUSE_ENUM_UINT32          enXccCause
)
{
    VOS_UINT32                          ulCnt;

    for (ulCnt = 0; ulCnt < (sizeof(g_astCnasXccErrLogCauseMapTbl)/sizeof(CNAS_XCC_ERRLOG_CAUSE_MAP_STRU)); ulCnt++)
    {
        if (g_astCnasXccErrLogCauseMapTbl[ulCnt].enXccCause == enXccCause)
        {
            return g_astCnasXccErrLogCauseMapTbl[ulCnt].enErrLogCallCause;
        }
    }

    return NAS_ERR_LOG_CALL_S_UNKNOWN;
}


NAS_ERR_LOG_1X_SERVICE_TYPE_ENUM_UINT32  CNAS_XCC_ConvertSoTo1xErrLogServiceType(
    CAS_CNAS_1X_SERVICE_OPTION_ENUM_UINT16                  enSo
)
{
    switch (enSo)
    {
        ...
        case CAS_CNAS_1X_SO_32944_VOICE_ENCRYPT:
#endif
            return NAS_ERR_LOG_1X_MT_SERVICE_TYPE_VOICE_CALL;

        case CAS_CNAS_1X_SO_7_PPP_PKT_DATA:
        case CAS_CNAS_1X_SO_33_PPP_PKT_DATA_CDMA2K:

            return NAS_ERR_LOG_1X_MT_SERVICE_TYPE_DATA_CALL;

        case CAS_CNAS_1X_SO_6_SMS_RS1:
        case CAS_CNAS_1X_SO_14_SMS_RS2:

            return NAS_ERR_LOG_1X_MT_SERVICE_TYPE_SMS;

        case CAS_CNAS_1X_SO_35_LOC_SERV:
        case CAS_CNAS_1X_SO_36_LOC_SERV:

            return NAS_ERR_LOG_1X_MT_SERVICE_TYPE_AGPS_CALL;

        default:

            return NAS_ERR_LOG_1X_MT_SERVICE_TYPE_BUTT;
    }
}
#endif
