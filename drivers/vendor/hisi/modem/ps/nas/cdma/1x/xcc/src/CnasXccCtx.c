...
VOS_UINT8 CNAS_XCC_IsCurServiceMo(
    VOS_UINT8                           ucIndex
)
{
    CNAS_XCC_CTX_STRU                  *pstXccCtxAddr = VOS_NULL_PTR;
    ...
    return (pstXccCtxAddr->astFsmEntity[ucIndex].stCallInfoCtx.ucIsMoCall);
}


VOS_UINT8 CNAS_XCC_GetAlreadyNtfLmmCallStartFlag( VOS_VOID )
{
    return CNAS_XCC_GetCtxAddr()->ucIsAlreadyNtfLmmCallStart;
}

VOS_VOID CNAS_XCC_SetAlreadyNtfLmmCallStartFlag(
    VOS_UINT8                           ucIsAlreadyNtfLmmCallStart
)
{
    CNAS_XCC_GetCtxAddr()->ucIsAlreadyNtfLmmCallStart = ucIsAlreadyNtfLmmCallStart;
    return ;
}
/*lint -restore*/
