...
)
{
    ...
    if (CAS_CNAS_1X_EST_RSLT_SUCCESS != pstEstCnf->enEstRslt)
    {
        ...
        CNAS_XREG_ErrLogRpt(pstCurrRegReq->enRegType, pstEstCnf->enEstRslt);
#endif
...
#if (FEATURE_PTM == FEATURE_ON)
    CNAS_XREG_ErrLogRpt(pstCurrRegReq->enRegType, NAS_ERR_LOG_XREG_WAIT_EST_RSLT_TIMEOUT);
#endif
...
#if (FEATURE_PTM == FEATURE_ON)
    CNAS_XREG_ErrLogRpt(pstCurrRegReq->enRegType, NAS_ERR_LOG_XREG_WAIT_XREG_ABORT_IND);
#endif
...
#if (FEATURE_PTM == FEATURE_ON)
    CNAS_XREG_ErrLogRpt(pstCurrRegReq->enRegType, NAS_ERR_LOG_XREG_WAIT_XREG_ABORT_IND_TIMEOUT);
#endif
...
#if (FEATURE_PTM == FEATURE_ON)
    CNAS_XREG_ErrLogRpt(pstCurrRegReq->enRegType, NAS_ERR_LOG_XREG_POWER_OFF_WAIT_EST_CNF_TIMEOUT);
#endif
