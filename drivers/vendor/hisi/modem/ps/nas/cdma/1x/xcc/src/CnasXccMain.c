...
)
{
    ...
    CNAS_INFO_LOG3(UEPS_PID_XCC, "CNAS_XCC_FsmProcessEvent, prestate, eventtype,retValue", ulCurState, ulEventType, ulRslt);
...
)
{
    ...
    CNAS_XCC_FSM_ENTITY_LIST_STRU                           stFsmEntityList = {0};
