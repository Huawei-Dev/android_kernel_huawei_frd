...
#define NAS_MML_CHINA_MAINLAND_MCC_HEX                  (0x00000604)                   /* 大陆MCC */
#define NAS_MML_AI_SAVE_POWER_AREA_CHINA_MAINLAND       (0x00)                  /* 低功耗适用区域中国大陆 */
...
#define NAS_MML_MAX_CUSTOM_SUPPLEMENT_OPLMN_NUM         (16)                     /* 用户配置的补充Oplmn的个数 */
...
#define NAS_MML_ATT_HPPLMN_DEFAULT_TIMER_LEN_R99        (60)                    /* 60min */
#define NAS_MML_ATT_HPPLMN_DEFAULT_TIMER_LEN_R97        (30)                    /* 30min */
...
#define NAS_MML_MAX_CSG_REJ_CAUSE_NUM                       (10)

#define NAS_MML_EFACSGL_MAX_RECORD_NUM                      (255)
#define NAS_MML_EFACSGL_ONE_RECORD_MAX_BYTE_NUM             (255)
#define NAS_MML_EFACSGL_CSG_LIST_TAG_VALUE                  (0xA0)
#define NAS_MML_EFACSGL_PLMN_TAG_VALUE                      (0x80)
#define NAS_MML_EFACSGL_CSG_INFORMATION_TAG_VALUE           (0x81)
#define NAS_MML_EFACSGL_NORMAL_LENGTH_VALUE                 (0x7F)
#define NAS_MML_EFACSGL_SPECIAL_LENGTH_VALUE                (0x81)
#define NAS_MML_EFACSGL_CSG_INFORMATION_MIN_LENGTH          (6)
#define NAS_MML_EFACSGL_HNB_NAME_TAG_VALUE                  (0x80)
#define NAS_MML_EFACSGL_TEXT_CSG_TYPE_TAG_VALUE             (0x89)
#define NAS_MML_EFACSGL_GRAPHICS_CSG_TYPE_TAG_FIRST_VALUE   (0x80)
#define NAS_MML_EFACSGL_GRAPHICS_CSG_TYPE_TAG_SECOND_VALUE  (0x81)
#define NAS_MML_MAX_USIMM_FILE_RECORD_NUM                   (255)
#define NAS_MML_MAX_USIMM_FILE_RECORD_LEN                   (255)
#define NAS_MML_CSGID_TLV_LEN                               (8)
#define NAS_MML_PLMN_TLV_LEN                                (5)
#define NAS_MML_USIM_PLMN_LEN                               (3)
#define NAS_MML_PLMN_AND_CSGID_TLV_LEN                      (13)
#define NAS_MML_EFACSGL_CSG_ID_MIN_LENGTH                   (4)
#define NAS_MML_EFACSGL_INVALID_BIT_VALUE                   (0xFF)
#define NAS_MML_CSG_FILE_RECORD_INVALID_VALUE               (0xFF)
#define NAS_MML_CSG_INDICATION_FROM_OTHER_SOURCES           (0x00)
#define NAS_MML_MINIMUM_TLV_LEN                              (2)
#define NAS_MML_EFOCSGL_CSG_DISP_INDICATOR_TAG_VALUE         (0x82)
#define NAS_MML_READ_SIMFILE_ONCE_MAXNUM                     (10)
...
{
    NAS_MML_HOME_NODEB_NAME_INDICATION_USE_HNBN_SYS_INFO      = 0,  /* home nodeb name从空口中获取  */
...
enum NAS_MML_CELL_TYPE_ENUM
{
    NAS_MML_CELL_TYPE_MACRO      = 0,          /* 小区类型是宏小区 */
    NAS_MML_CELL_TYPE_HYBRID     = 1,          /* 小区类型为混合小区 */
    NAS_MML_CELL_TYPE_CSG        = 2,          /* 小区类型为CSG小区 */
    NAS_MML_CELL_TYPE_BUTT
};
typedef VOS_UINT8 NAS_MML_CELL_TYPE_ENUM_UINT8;



enum NAS_MML_CSG_LIST_TYPE_ENUM
{
    NAS_MML_CSG_LIST_TYPE_ALLOWED_CSG_LIST                  = 0,  /* CSG List是Allowed CSG List */
    NAS_MML_CSG_LIST_TYPE_OPERATOR_CSG_LIST                 = 1,  /* CSG List是Operator CSG List */
    NAS_MML_CSG_LIST_TYPE_UE_BASE_OPERATOR_CSG_LIST          = 2,  /* CSG List是UE Base Operator CSG List */

    NAS_MML_CSG_LIST_TYPE_BUTT
};
typedef VOS_UINT8 NAS_MML_CSG_LIST_TYPE_ENUM_UINT8;
...
enum NAS_MML_CSFB_SERVICE_STATUS_ENUM
{
    ...
    NAS_MML_CSFB_SERVICE_STATUS_MO_NORMAL_LCS_EXIST,           /* 目前在CSFB的MO的正常业务流程中 */
...
enum    NAS_MML_READ_SIM_FILES_CNF_ENUM
{
    ...
    NAS_MML_READ_ALLOWED_CSG_LIST_FILE_ID_FLG                = 0x200000,
    NAS_MML_READ_ALLOWED_CSG_TYPE_FILE_ID_FLG                = 0x400000,
    NAS_MML_READ_ALLOWED_CSG_HOME_NODEB_NAME_FILE_ID_FLG     = 0x800000,
    NAS_MML_READ_OPERATOR_CSG_LIST_FILE_ID_FLG               = 0x1000000,
    NAS_MML_READ_OPERATOR_CSG_TYPE_FILE_ID_FLG               = 0x2000000,
    NAS_MML_READ_OPERATOR_CSG_HOME_NODEB_NAME_FILE_ID_FLG    = 0x4000000,
...
enum NAS_MML_MO_LCS_STATUS_ENUM
{
    /* csfb lcs MOLR */
    NAS_MML_CSFB_MO_LCS_SETUP_START,                                            /* csfb lcs MOLR建立开始 */
    NAS_MML_CSFB_MO_LCS_SETUP_SUCC,                                             /* csfb lcs MOLR建立成功 */
    NAS_MML_CSFB_MO_LCS_SETUP_FAIL,                                             /* csfb lcs MOLR建立失败 */

    /* mo lcs MOLR */
    NAS_MML_MO_LCS_SETUP_START,                                                 /* GU下lcs MOLR建立开始 */
    NAS_MML_MO_LCS_SETUP_SUCC,                                                  /* GU下lcs MOLR建立成功 */
    NAS_MML_MO_LCS_SETUP_FAIL,                                                  /* GU下lcs MOLR建立失败 */

    NAS_MML_LCS_STATUS_BUTT
};
typedef VOS_UINT8 NAS_MML_MO_LCS_STATUS_ENUM_UINT8;
...
{
    NAS_MML_TIMER_STATUS_STOP,                                                  /* 保护定时器已经停止 */
    NAS_MML_TIMER_STATUS_RUNNING,                                               /* 保护定时器正在运行 */
    NAS_MML_TIMER_STATUS_BUTT
};
typedef VOS_UINT8 NAS_MML_TIMER_STATUS_ENUM_UINT8;
...
}NAS_MML_USIM_REFRESH_INFO_STRU;
...
typedef struct
{
    ...
    NAS_MML_USIM_REFRESH_INFO_STRU              stUsimRefreshInfo;
...
typedef struct
{
    ...
    NAS_MML_TIMER_STATUS_ENUM_UINT8                 enMtCsfbPagingTimerStatus;  /* 被叫CSFB保护定时器运行状态 */
    VOS_UINT8                                       ucCellNotSupportCsmoFlg;    /* 标识当前小区是否支持CSMO标志*/
    NAS_MML_TIMER_STATUS_ENUM_UINT8                 enDelayNetworkSearchTimerStatus;  /* 紧急呼结束后不搜网定时器运行状态 */
...
typedef struct
{
    ...
    VOS_UINT8                                   aucHplmnPeriFile[NAS_MML_HPLMN_PERI_FILE_LEN];    /* 6f31文件为0XFF时的原始内容  */
...
typedef struct
{
    NAS_MML_PLMN_RAT_PRIO_STRU          stNotifyNwCsPrioRatList;                /* 通知网络CS域的接入技术以及优先级 */
    NAS_MML_PLMN_RAT_PRIO_STRU          stNotifyNwPsPrioRatList;                /* 通知网络PS域的接入技术以及优先级 */
}NAS_MML_MS_NOTIFY_NW_INFO;
...
typedef struct
{
    ...
    NAS_MML_MS_NOTIFY_NW_INFO           stMsNotifyNwCapInfo;
...
typedef struct
{
    ...
    VOS_UINT8                           ucRoamingImsSupportFlag; /**< 漫游网络下是否允许IMS注册使能项，VOS_TRUE:支持 VOS_FALSE:不支持 */
    VOS_UINT8                           aucReserved[1];
...
typedef struct
{
    ...
    NAS_MML_SYS_CFG_INFO_STRU                               stSysCfgInfo;
...
{
    VOS_UINT8                           ucImsiPlmnListNum;
    VOS_UINT8                           ucOplmnListNum;
    VOS_UINT8                           aucResv[2];
    NAS_MML_PLMN_ID_STRU                astImsiPlmnList[NAS_MML_MAX_USER_CFG_IMSI_PLMN_NUM];
    NAS_MML_PLMN_ID_STRU                astOPlmnList[NAS_MML_MAX_CUSTOM_SUPPLEMENT_OPLMN_NUM];
}NAS_MML_CUSTOM_SUPPLEMENT_OPLMN_INFO_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                           aucReserved[3];
    VOS_UINT16                          ausCause[NAS_MML_MAX_CSG_REJ_CAUSE_NUM];
}NAS_MML_CSG_FORBIDDEN_PLMN_CFG_STRU;


typedef struct
{
    VOS_UINT32                          usCsgAutonomousSrchFirstSrchTimeLen;    /* CSG自主搜网定时器第一次的时长，单位: 豪秒 */
    VOS_UINT8                           ucCsgAutonomousSrchFirstSrchTimeCount;  /* CSG自主搜网定时器第一次的次数 */
    VOS_UINT8                           ucReserved1;
    VOS_UINT32                          usCsgAutonomousSrchSecondSrchTimeLen;   /* CSG自主搜网定时器第二次的时长，单位: 豪秒 */
    VOS_UINT8                           ucCsgAutonomousSrchSecondSrchTimeCount; /* CSG自主搜网定时器第二次的次数 */
    VOS_UINT8                           ucReserved2;
}NAS_MML_CSG_AUTONOMOUS_SEARCH_CFG_STRU;
...
typedef struct
{
    ...
    NAS_MML_CSG_FORBIDDEN_PLMN_CFG_STRU stCsgForbiddenPlmnCfg;

    /* PSF和ASF定时器相关信息 */
    VOS_UINT32                                    ulCsgPeriodicSearchLen;    /* CSG周期性搜网时长，单位:毫秒 */
    NAS_MML_CSG_AUTONOMOUS_SEARCH_CFG_STRU        stCsgAutonomousSrchCfg;    /* CSG自主搜网相关配置 */
...
typedef struct
{
    ...
    VOS_UINT8                                               ucCause18EnableLteSupportFlg;
...
}NAS_MML_EXTEND_T3240_LEN_CFG_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                                               ucRsv4;
    VOS_UINT8                                               ucRsv5;
}NAS_MML_OOS_BG_NETWORK_SEARCH_CUSTOM_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                           ucReserve1;
    VOS_UINT8                           ucReserve2;
}NAS_MML_AI_MODEM_TIME_CFG_STRU;

typedef struct
{
    VOS_UINT8                           ucOosSrchSleepCnt;                      /* 低功耗场景二阶段睡眠次数到达后，才进行OOS搜网 */
    VOS_UINT8                           ucHighPrioSrchSleepCnt;                 /* 低功耗场景二阶段睡眠次数到达后，才进行高接入技术背景搜网 */
    VOS_UINT8                           ucReserve1;
    VOS_UINT8                           ucReserve2;
...
}NAS_MML_AI_MODEM_NAS_PLMN_SRCH_CFG_STRU;
...
typedef struct
{
    ...
    NAS_MML_AI_MODEM_TIME_CFG_STRU              stTimeCfg;
    NAS_MML_AI_MODEM_NAS_PLMN_SRCH_CFG_STRU     stNasSrchCfg;
}NAS_MML_AI_MODEM_CFG_STRU;
...
typedef struct
{
    ...
    NAS_MML_OOS_BG_NETWORK_SEARCH_CUSTOM_STRU               stOosBgNetworkSearchCustom;

    NAS_MML_FORB_LA_WITH_VALID_PERIOD_CFG_INFO_LIST_STRU    stForbLaWithValidPeriodCfg;

    NAS_MML_ATT_CFG_STRU                                    stAttCfg;

    NAS_MML_CLEAR_CKSN_CFG_STRU                             stCleanCksnCfg;

    NAS_MML_EXTEND_T3240_LEN_CFG_STRU                       stExtendT3240LenCfg;

    NAS_MML_CUSTOM_SUPPLEMENT_OPLMN_INFO_STRU               stSupplementOplmnInfo;
    NAS_MML_AI_MODEM_CFG_STRU                               stAiModemCfg;
...
typedef struct
{
    ...
    NAS_MML_CELL_TYPE_ENUM_UINT8        enCellType;                /* 小区类型 */
    VOS_UINT8                           aucReserved[3];
...
typedef struct
{
    ...
    VOS_UINT8                                               ucHomeNodebNameIndication; /* 用于指示EFhnbn的记录号*/
    VOS_UINT8                                               aucReserved[2];
...
typedef struct
{
    ...
    VOS_UINT32                                              ulCsgId;
    NAS_MML_HOME_NODEB_NAME_INDICATION_ENUM_UINT8           enHomeNodebNameIndication;              /* 当前驻留CSG小区的HNB来源 */
    NAS_MML_CSG_ID_HOME_NODEB_NAME_STRU                     stCsgIdHomeNodeBName;
    VOS_UINT8                                               aucReserve[1];
...
typedef struct
{
    ...
    VOS_UINT8                                       ucEpsEmcAttachFlg;          /* EPS紧急ATTACH标志 */
...
typedef struct
{
    ...
    VOS_UINT32                          ulPsRelCause;                           /* 这个标志只在W模下有效，在收到rel_ind时记录，在收到系统消息，收到resume_ind消息，收到搜网消息时清除 */
...
typedef struct
{
    ...
    VOS_UINT8                                               ucImsNormalCallExistFlg;  /* VOS_TRUE:存在IMS normal call;VOS_FALSE:不存在IMS normal call */
    NAS_MML_PERSISTENT_BEARER_STATE_ENUM_UINT8              enPersistentBearerState;
    VOS_UINT8                                               ucImsEmcCallExistFlg;     /* VOS_TRUE:存在IMS emergency call;VOS_FALSE:不存在IMS emergency call */
    VOS_UINT8                                               aucReserved[3];
...
typedef struct
{
    NAS_MML_PLMN_WITH_RAT_STRU          stPlmnWithRat;
    VOS_UINT32                          ulCsgId;
}NAS_MML_PLMN_CSG_ID_WITH_RAT_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                           ucReserved;
    VOS_UINT8                          *pucValue;
}NAS_MML_TLV_INFO_STRU;


typedef struct
{
    VOS_UINT32                          ulUsedLen;                                  /* 已经使用的长度 */
    VOS_UINT8                           aucEf[NAS_MML_MAX_USIMM_FILE_RECORD_LEN];   /* 码流内容 */
    VOS_UINT8                           ucReserved;
}NAS_MML_RECORD_STREAM_STRU;


typedef struct
{
    VOS_UINT32                          ulTotalRecordNum;                                   /* EFACSGL总记录数 */
    VOS_UINT32                          ulRecordLen;                                        /* EFACSGL记录长度 */
    NAS_MML_RECORD_STREAM_STRU         *apstCsgListRecordInfo[NAS_MML_MAX_PLMN_CSG_ID_NUM]; /* EFACSGL记录码流 */
}NAS_MML_ACSGL_RECORD_STREAM_STRU;


typedef struct
{
    VOS_UINT8                          ucTotalRecordNum;    /* 总记录数 */
    VOS_UINT8                          ucRecordLen;         /* 每条记录长度 */
    VOS_UINT8                          ucReadRecordNum;     /* 已经读取的记录数 */
    VOS_UINT8                          ucReserved;
}NAS_MML_CSG_FILE_RECORD_STRU;


typedef struct
{
    NAS_MML_CSG_FILE_RECORD_STRU        stCsgListRecordInfo;
    NAS_MML_CSG_FILE_RECORD_STRU        stCsgTypeRecordInfo;
    NAS_MML_CSG_FILE_RECORD_STRU        stCsgHomeNodeBNameRecordInfo;
}NAS_MML_CSG_FILES_RECORD_INFO_STRU;


typedef struct
{
    VOS_UINT32                                              ulCsgId;
    VOS_UINT8                                               ucHNodeBIndication;
    VOS_UINT8                                               ucCsgTypeIndication;
    VOS_UINT8                                               aucRsv[2];
}NAS_MML_EFACSGL_RECORD_CSG_INFO_STRU;


typedef struct
{
    NAS_MML_PLMN_ID_STRU                                    stPlmnId;               /* PLMNID */
    VOS_UINT8                                               ucCsgNum;               /* 该记录中有多少个CSG */
    VOS_UINT8                                               aucRsv[3];
    NAS_MML_EFACSGL_RECORD_CSG_INFO_STRU                    astCSGInfo[NAS_MML_MAX_PLMN_CSG_ID_NUM];
}NAS_MML_EFACSGL_RECORD_PLMN_INFO_STRU;


typedef struct
{
    VOS_UINT8                                               ucPlmnNum;               /* 该记录中有多少个PLMN */
    VOS_UINT8                                               aucRsv[3];
    NAS_MML_EFACSGL_RECORD_PLMN_INFO_STRU                   astRecordPlmnInfo[NAS_MML_MAX_PLMN_CSG_ID_NUM];
}NAS_MML_EFACSGL_RECORD_INFO_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                          ulCsgIdForbiddenPeriod;          /* 记录惩罚时间，该列表每次使用前需要判断是否有网络禁止时间到 */
...
typedef struct
{
    ...
    NAS_MML_CSG_ID_FORBIDDEN_PERIOD_INFO_STRU               astForbiddenCsgIdPeriodInfo[NAS_MML_MAX_PLMN_CSG_ID_NUM];
...
typedef struct
{
    ...
    NAS_MML_PLMN_WITH_CSG_ID_LIST_STRU                      stUeBasedOperatorCsgList;
    NAS_MML_CSG_ID_WITH_FORBIDDEN_PERIOD_LIST_STRU          stForbiddenCsgList;
    NAS_MML_ACSGL_RECORD_STREAM_STRU                        stAllowedCsgListRecordsStream;  /* 保存卡文件EFACSGL的码流 */
    NAS_MML_EFACSGL_RECORD_INFO_STRU                        stAllowedCsgListRecordInfo;     /* 写卡编解码使用的结构 */
    NAS_MML_CSG_FILES_RECORD_INFO_STRU                      stAllowedCsgListFilesInfo;      /* EFACSGL相关的卡文件的信息 */
    NAS_MML_CSG_FILES_RECORD_INFO_STRU                      stOperatorCsgListFilesInfo;     /* EFOCSGL相关的卡文件的信息 */
...
extern VOS_UINT8 NAS_MML_GetCause18EnableLteSupportFlg(VOS_VOID);
...
VOS_VOID NAS_MML_SetUsimRefreshFlag(
    VOS_UINT32                           ulUsimRefreshFlag
);
USIMM_REFRESH_TYPE_ENUM_UINT32 NAS_MML_GetUsimRefreshType(VOS_VOID);
VOS_VOID NAS_MML_SetUsimRefreshType(
    USIMM_REFRESH_TYPE_ENUM_UINT32       enRefreshType
);
