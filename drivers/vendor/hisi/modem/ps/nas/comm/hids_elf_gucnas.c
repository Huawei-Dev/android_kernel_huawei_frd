...
typedef struct
{
    ...
    union
    {
        NAS_MSCC_L1_STA_ENUM_UINT32                         enL1State;
        NAS_MSCC_SWITCH_ON_STA_ENUM_UINT32                  enSwitchOnState;
        NAS_MSCC_POWER_OFF_STA_ENUM_UINT32                  enPowerOffState;
        NAS_MSCC_SYSACQ_STA_ENUM_UINT32                     enSysAcqState;
#if (FEATURE_ON == FEATURE_UE_MODE_CDMA)
        NAS_MSCC_BSR_STA_ENUM_UINT32                        enBsrState;
#endif
        NAS_MSCC_SYSCFG_STA_ENUM_UINT32                     enSysCfgState;
#if ((FEATURE_ON == FEATURE_UE_MODE_CDMA) && (FEATURE_ON == FEATURE_LTE))
        NAS_MSCC_CL_INTERSYS_STA_ENUM_UINT32                enCLInterSysState;
#endif
    }uCurFsmState;
...
typedef struct
{
    ...
    VOS_UINT8                           ucReserve;
    NAS_MMC_TIMER_ID_ENUM_UINT16        enMmcTimerId;
    VOS_UINT32                          ulLen;              /* 定时器时长 */
}NAS_MMC_ELF_TIMER_INFO_STRU;


void ELF_NAS_ENUM_NV(void)
{
    enum NAS_NVIM_LC_RAT_COMBINED_ENUM                      enNAS_NVIM_LC_RAT_COMBINED_ENUM;
    enum NAS_MSCC_NVIM_SYS_PRI_CLASS_ENUM                   enNAS_MSCC_NVIM_SYS_PRI_CLASS_ENUM;
}
...
void ELF_NAS_ENUM_MSCC_PIF(void)
{
    ...
    enum NAS_MSCC_PIF_IMS_REG_RESULT_ENUM                   enNAS_MSCC_PIF_IMS_REG_RESULT_ENUM;
    enum NAS_MSCC_PIF_IMS_DEREG_RESULT_ENUM                 enNAS_MSCC_PIF_IMS_DEREG_RESULT_ENUM;
    ...
    enum NAS_MSCC_PIF_CSG_SPEC_SEARCH_RESULT_ENUM           enNAS_MSCC_PIF_CSG_SPEC_SEARCH_RESULT_ENUM;

    enum NAS_MSCC_PIF_1X_CAS_MAIN_STATE_ENUM                enNAS_MSCC_PIF_1X_CAS_MAIN_STATE_ENUM;
    enum NAS_MSCC_PIF_1X_CAS_SUB_STATE_ENUM                 enNAS_MSCC_PIF_1X_CAS_SUB_STATE_ENUM;
    enum NAS_MSCC_PIF_1X_SERVICE_TYPE_ENUM                  enNAS_MSCC_PIF_1X_SERVICE_TYPE_ENUM;

    enum NAS_MSCC_PIF_OPER_RESULT_ENUM                      enNAS_MSCC_PIF_OPER_RESULT_ENUM;
}
...
void ELF_NAS_ENUM_MMC_LMM(void)
{
    ...
    enum MMC_LMM_PLMN_SRCH_TYPE_ENUM                        enMMC_LMM_PLMN_SRCH_TYPE_ENUM;
    enum MMC_LMM_PLMN_SRCH_RLT_ENUM                         enMMC_LMM_PLMN_SRCH_RLT_ENUM;
    enum MMC_LMM_CELL_TYPE_ENUM                             enMMC_LMM_CELL_TYPE_ENUM;
    enum MMC_LMM_CSG_LIST_SRCH_RLT_ENUM                     enMMC_LMM_CSG_LIST_SRCH_RLT_ENUM;
}
...
void ELF_NAS_ENUM_MSCC(void)
{
    ...
    enum NAS_MSCC_MLPL_MATCH_LVL_ENUM                       enNAS_MSCC_MLPL_MATCH_LVL_ENUM;
    ...
    enum NAS_MSCC_L1_STA_ENUM                               enNAS_MSCC_L1_STA_ENUM;
    enum NAS_MSCC_SWITCH_ON_STA_ENUM                        enNAS_MSCC_SWITCH_ON_STA_ENUM;
    enum NAS_MSCC_POWER_OFF_STA_ENUM                        enNAS_MSCC_POWER_OFF_STA_ENUM;
#if (FEATURE_ON == FEATURE_UE_MODE_CDMA)
    enum NAS_MSCC_BSR_STA_ENUM                              enNAS_MSCC_BSR_STA_ENUM;
#endif
    enum NAS_MSCC_SYSACQ_STA_ENUM                           enNAS_MSCC_SYSACQ_STA_ENUM;
    enum NAS_MSCC_SYSCFG_STA_ENUM                           enNAS_MSCC_SYSCFG_STA_ENUM;
#if ((FEATURE_ON == FEATURE_UE_MODE_CDMA) && (FEATURE_ON == FEATURE_LTE))
    enum NAS_MSCC_CL_INTERSYS_STA_ENUM                      enNAS_MSCC_CL_INTERSYS_STA_ENUM;
#endif
    ...
    enum NAS_MSCC_PIF_1X_OOS_CAUSE_ENUM                     enNAS_MSCC_PIF_1X_OOS_CAUSE_ENUM;

    enum MSCC_MMA_MSPL_MLPL_INFO_SOURCE_ENUM                enMSCC_MMA_MSPL_MLPL_INFO_SOURCE_ENUM;
    enum NAS_MSCC_PIF_PRL_SOURCE_TYPE_ENUM                  enNAS_MSCC_PIF_PRL_SOURCE_TYPE_ENUM;
}


void ELF_NAS_ENUM_MMC(void)
{
    enum NAS_MMC_TIMER_STATUS_ENUM                          enNAS_MMC_TIMER_STATUS_ENUM;
    enum NAS_MMC_TIMER_ID_ENUM                              enNAS_MMC_TIMER_ID_ENUM;
}
...
void ELF_NAS_ENUM_CNAS_COMMON(void)
{
    ...
    enum CNAS_CCB_PRL_SOURCE_TYPE_ENUM                      enCNAS_CCB_PRL_SOURCE_TYPE_ENUM;

    enum CNAS_CCB_ESN_MEID_TYPE_ENUM                        enCNAS_CCB_ESN_MEID_TYPE_ENUM;
}
...
void ELF_NAS_ENUM_XCC_LMM(void)
{
    enum XCC_LMM_PIF_MSG_TYPE_ENUM                          enXCC_LMM_PIF_MSG_TYPE_ENUM;
    enum LMM_XCC_ESR_RSLT_ENUM                              enLMM_XCC_ESR_RSLT_ENUM;
    enum XCC_LMM_CALL_TYPE_ENUM                             enXCC_LMM_CALL_TYPE_ENUM;
}
...
void ELF_NAS_ENUM_HSD_HRM(void)
{
    enum HSD_HRM_PIF_MSG_TYPE_ENUM                          enHSD_HRM_PIF_MSG_TYPE_ENUM;
    enum HRM_HSD_START_RSLT_ENUM                            enHRM_HSD_START_RSLT_ENUM;
    enum HRM_HSD_POWEROFF_RSLT_ENUM                         enHRM_HSD_POWEROFF_RSLT_ENUM;
}


void ELF_NAS_ENUM_HRM_PIF(void)
{
    enum CNAS_HRM_DATA_REQ_TYPE_ENUM                        enCNAS_HRM_DATA_REQ_TYPE_ENUM;
    enum HRM_HLU_DATA_CNF_RSLT_ENUM                         enHRM_HLU_DATA_CNF_RSLT_ENUM;
}


void ELF_NAS_ENUM_HSM_HRM(void)
{
    enum HSM_HRM_PIF_MSG_TYPE_ENUM                          enHSM_HRM_PIF_MSG_TYPE_ENUM;
    enum HRM_HSM_DATA_CNF_RSLT_ENUM                         enHRM_HSM_DATA_CNF_RSLT_ENUM;
    enum HSM_HRM_SESSION_TYPE_ENUM                          enHSM_HRM_SESSION_TYPE_ENUM;
}


void ELF_NAS_ENUM_HLU_HRM(void)
{
    enum HLU_HRM_PIF_MSG_TYPE_ENUM                          enHLU_HRM_PIF_MSG_TYPE_ENUM;
    enum HRM_HLU_DATA_CNF_RSLT_ENUM                         enHRM_HLU_DATA_CNF_RSLT_ENUM;
}
...
void ELF_NAS_ENUM_XSD(void)
{
    ...
    enum CNAS_XSD_OOC_SCAN_STRATEGY_ENUM                    enCNAS_XSD_OOC_SCAN_STRATEGY_ENUM;
...
void ELF_NAS_ENUM_HSM(void)
{
    ...
    enum CNAS_HSM_HRPD_CONN_STATUS_ENUM                     enCNAS_HSM_HRPD_CONN_STATUS_ENUM;
    ...
    enum CNAS_HSM_SESSION_TYPE_ENUM                         enCNAS_HSM_SESSION_TYPE_ENUM;

    enum CNAS_HSM_ATI_TYPE_ENUM                             enCNAS_HSM_ATI_TYPE_ENUM;

    enum CNAS_HSM_RCV_OHM_SCENE_ENUM                        enCNAS_HSM_RCV_OHM_SCENE_ENUM;

    enum CNAS_HSM_SESSION_RELEASE_TYPE_ENUM                 enCNAS_HSM_SESSION_RELEASE_TYPE_ENUM;
}


void ELF_NAS_ENUM_HRM(void)
{
    enum CNAS_HRM_INTERNAL_MSG_TYPE_ENUM                    enCNAS_HRM_INTERNAL_MSG_TYPE_ENUM;
    enum CNAS_HRM_DSDS_TYPE_ENUM                            enCNAS_HRM_DSDS_TYPE_ENUM;
    enum CNAS_HRM_RES_APPLY_STATE_ENUM                      enCNAS_HRM_RES_APPLY_STATE_ENUM;
    enum CNAS_HRM_RES_OCCUPY_TYPE_ENUM                      enCNAS_HRM_RES_OCCUPY_TYPE_ENUM;
}
...
void ELF_NAS_ENUM_EHSM(void)
{
    ...
    enum CNAS_EHSM_ERROR_CODE_ENUM                          enCNAS_EHSM_ERROR_CODE_ENUM;
}
#endif
...
void ELF_NAS_ENUM_LIST(void)
{
    ...
    ELF_NAS_ENUM_HSD_HRM();

    ELF_NAS_ENUM_HRM_PIF();

    ELF_NAS_ENUM_HSM_HRM();

    ELF_NAS_ENUM_HLU_HRM();
...
void ELF_NAS_STRU_TraceTable_XSD(void)
{
    ...
    XSD_MSCC_1X_UE_STATUS_IND_STRU                          stXSD_MSCC_1X_UE_STATUS_IND_STRU;
    XSD_MSCC_1X_NO_SERVICE_IND_STRU                         stXSD_MSCC_1X_NO_SERVICE_IND_STRU;
    XSD_MSCC_PRL_HEADER_INFO_IND_STRU                      stXSD_MSCC_PRL_HEADER_INFO_IND_STRU;
    ...
    XSD_XREG_NORMAL_SERVICE_IND_STRU                        stXSD_XREG_NORMAL_SERVICE_IND_STRU;
    ...
    CNAS_XSD_LOG_DRX_TIMER_STATUS_IND                       stCNAS_XSD_LOG_DRX_TIMER_STATUS_IND;
    CNAS_XSD_LOG_1X_AVOID_SYS_ACQ_STRU                      stCNAS_XSD_LOG_1X_AVOID_SYS_ACQ_STRU;
    ...
    CNAS_PRL_MNTN_MULTI_MATCHED_GEO_INFO_STRU               stCNAS_PRL_MNTN_MULTI_MATCHED_GEO_INFO_STRU;
    CNAS_PRL_MNTN_MULTI_MATCHED_GEO_LIST_INFO_STRU          stCNAS_PRL_MNTN_MULTI_MATCHED_GEO_LIST_INFO_STRU;

    CNAS_MNTN_ELF_LOG_XSD_FSM_INFO_STRU                     stCNAS_MNTN_ELF_LOG_XSD_FSM_INFO_STRU;

    CNAS_MNTN_LOG_PC_REPLAY_CONTEXT_STRU                    stCNAS_MNTN_LOG_FIXED_CONTEXT_MSG_STRU;
...
void ELF_NAS_STRU_TraceTable_XCC(void)
{
    ...
    /******************* 发送模块：XCC，接收模块：LMM Begin  *******************/
    XCC_LMM_CALL_START_NTF_STRU                             stXCC_LMM_CALL_START_NTF_STRU;
    XCC_LMM_CALL_END_NTF_STRU                               stXCC_LMM_CALL_END_NTF_STRU;
    LMM_XCC_ESR_END_IND_STRU                                stLMM_XCC_ESR_END_IND_STRU;
    /******************* 发送模块：XCC，接收模块：LMM End  *******************/
}
...
void ELF_NAS_STRU_TraceTable_HLU(void)
{
    ...
    /******************* 发送模块：HLU，接收模块：HRM Begin  *******************/
    HLU_HRM_DATA_REQ_STRU                                   stHLU_HRM_DATA_REQ_STRU;
    HLU_HRM_DATA_CANCEL_NTF_STRU                            stHLU_HRM_DATA_CANCEL_NTF_STRU;
    /******************* 发送模块：HLU，接收模块：HRM Begin  *******************/
...
void ELF_NAS_STRU_TraceTable_EHSM(void)
{
    ...
    CNAS_EHSM_MNTN_LOG_ERROR_INFO_STRU                      stCNAS_EHSM_MNTN_LOG_ERROR_INFO_STRU;
...
void ELF_NAS_STRU_TraceTable_HSM(void)
{
    ...
    /******************* 发送模块：HSM，接收模块：HRM Begin  *******************/
    HSM_HRM_SESSION_BEGIN_NTF_STRU                          stHSM_HRM_SESSION_BEGIN_NTF_STRU;
    HSM_HRM_SESSION_END_NTF_STRU                            stHSM_HRM_SESSION_END_NTF_STRU;
    HSM_HRM_DATA_REQ_STRU                                   stHSM_HRM_DATA_REQ_STRU;
    HSM_HRM_DATA_CANCEL_NTF_STRU                            stHSM_HRM_DATA_CANCEL_NTF_STRU;
    /******************* 发送模块：HSM，接收模块：HRM Begin  *******************/
...
void ELF_NAS_STRU_TraceTable_HSD(void)
{
    ...
    HSD_MSCC_STOP_BG_SEARCH_IND_STRU                        stHSD_MSCC_STOP_BG_SEARCH_IND_STRU;
    /******************* 发送模块：HSD，接收模块：MSCC End  *******************/

    /******************* 发送模块：HSD，接收模块：HRM Begin  *******************/
    HSD_HRM_START_REQ_STRU                                  stHSD_HRM_START_REQ_STRU;
    HSD_HRM_POWEROFF_REQ_STRU                               stHSD_HRM_POWEROFF_REQ_STRU;
    /******************* 发送模块：HSD，接收模块：HRM Begin  *******************/

}


void ELF_NAS_STRU_TraceTable_HRM(void)
{
    /******************* 发送模块：HRM，接收模块：HSD Begin  *******************/
    HRM_HSD_START_CNF_STRU                                  stHRM_HSD_START_CNF_STRU;
    HRM_HSD_POWEROFF_CNF_STRU                               stHRM_HSD_POWEROFF_CNF_STRU;
    /******************* 发送模块：HRM，接收模块：HSD End  *******************/

    /******************* 发送模块：HRM，接收模块：HSM Begin  *******************/
    HRM_HSM_DATA_IND_STRU                                   stHRM_HSM_DATA_IND_STRU;
    HRM_HSM_DATA_CNF_STRU                                   stHRM_HSM_DATA_CNF_STRU;
    HRM_HSM_UATI_CMPL_SND_IND_STRU                          stHRM_HSM_UATI_CMPL_SND_IND_STRU;
    /******************* 发送模块：HRM，接收模块：HSM End  *******************/

    /******************* 发送模块：HRM，接收模块：HLU Begin  *******************/
    HRM_HLU_DATA_IND_STRU                                   stHRM_HLU_DATA_IND_STRU;
    HRM_HLU_DATA_CNF_STRU                                   stHRM_HLU_DATA_CNF_STRU;
    /******************* 发送模块：HRM，接收模块：HLU End  *******************/

    /******************* 发送模块：HRM，接收模块：HRM Begin  *******************/
    CNAS_HRM_HRM_LOG_CTX_STRU                               stCNAS_HRM_HRM_LOG_CTX_STRU;
...
void ELF_NAS_STRU_TraceTable_MSCC(void)
{
    ...
    MSCC_HSD_ENABLE_LTE_NTF_STRU                           stMSCC_HSD_ENABLE_LTE_NTF_STRU;
    ...
    MSCC_MMC_CSG_SPEC_SEARCH_REQ_STRU                       stMSCC_MMC_CSG_SPEC_SEARCH_REQ_STRU;
    MSCC_MMC_CSG_SPEC_SEARCH_ABORT_REQ_STRU                 stMSCC_MMC_CSG_SPEC_SEARCH_ABORT_REQ_STRU;
    MSCC_MMC_CURR_GEO_INFO_NTF_STRU                         stMSCC_MMC_CURR_GEO_INFO_NTF_STRU;
    MSCC_MMC_EPLMN_INFO_NTF_STRU                            stMSCC_MMC_EPLMN_INFO_NTF_STRU;
    ...
    MSCC_MMA_IMS_REG_CNF_STRU                               stMSCC_MMA_IMS_REG_CNF_STRU;
    ...
    MSCC_MMA_1X_UE_STATUS_IND_STRU                          stMSCC_MMA_1X_UE_STATUS_IND_STRU;
    ...
    MSCC_MMA_CSG_SPEC_SEARCH_CNF_STRU                       stMSCC_MMA_CSG_SPEC_SEARCH_CNF_STRU;
    MSCC_MMA_CSG_SPEC_SEARCH_ABORT_CNF_STRU                 stMSCC_MMA_CSG_SPEC_SEARCH_ABORT_CNF_STRU;
    MSCC_MMA_CSG_ID_HOME_NODEB_NAME_IND_STRU                stMSCC_MMA_CSG_ID_HOME_NODEB_NAME_IND_STRU;
    MSCC_MMA_IMS_DOMAIN_CFG_SET_CNF_STRU                    stMSCC_MMA_IMS_DOMAIN_CFG_SET_CNF_STRU;
    MSCC_MMA_PRL_HEADER_INFO_IND_STRU                       stMSCC_MMA_PRL_HEADER_INFO_IND_STRU;
    MSCC_MMA_MSPL_MLPL_HEADER_INFO_STRU                     stMSCC_MMA_MSPL_MLPL_HEADER_INFO_STRU;
    ...
    MSCC_XSD_LTE_HRPD_CONN_INFO_IND_STRU                    stMSCC_XSD_LTE_HRPD_CONN_INFO_IND_STRU;
    ...
    MSCC_XSD_NORMAL_SERVICE_IND_STRU                        stMSCC_XSD_NORMAL_SERVICE_IND_STRU;
    ...
    NAS_MSCC_PIF_1X_UE_STATUS_IND_STRU                      stNAS_MSCC_PIF_1X_UE_STATUS_IND_STRU;
    NAS_MSCC_MSCC_POWER_SAVE_REQ_STRU                       stNAS_MSCC_MSCC_POWER_SAVE_REQ_STRU;
...
void ELF_NAS_STRU_TraceTable_MMC(void)
{
    ...
    MMC_MSCC_CSG_SPEC_SEARCH_CNF_STRU                       stMMC_MSCC_CSG_SPEC_SEARCH_CNF_STRU;
    MMC_MSCC_CSG_SPEC_SEARCH_ABORT_CNF_STRU                 stMMC_MSCC_CSG_SPEC_SEARCH_ABORT_CNF_STRU;
    MMC_MSCC_CSG_ID_HOME_NODEB_NAME_IND_STRU                stMMC_MSCC_CSG_ID_HOME_NODEB_NAME_IND_STRU;
    /******************* 发送模块：MMC，接收模块：MSCC End  *******************/

    /******************* 发送模块：MMC，接收模块：LMM Begin  *******************/
    MMC_LMM_CL_INTERSYS_START_NTF_STRU                      stMMC_LMM_CL_INTERSYS_START_NTF_STRU;
    MMC_LMM_CSG_WHITE_LIST_NOTIFY_STRU                      stMMC_LMM_CSG_WHITE_LIST_NOTIFY_STRU;
    MMC_LMM_CSG_LIST_SEARCH_REQ_STRU                        stMMC_LMM_CSG_LIST_SEARCH_REQ_STRU;
    MMC_LMM_CSG_BG_SEARCH_REQ_STRU                          stMMC_LMM_CSG_BG_SEARCH_REQ_STRU;
    /******************* 发送模块：MMC，接收模块：LMM End  *******************/

    /******************* 发送模块：MMC，接收模块：GAS Begin  *******************/
    RRMM_CSG_LIST_SEARCH_REQ_STRU                           stRRMM_GAS_CSG_LIST_SEARCH_REQ_STRU;
    RRMM_CSG_BG_SEARCH_REQ_STRU                             stRRMM_GAS_CSG_BG_SEARCH_REQ_STRU;
    /******************* 发送模块：MMC，接收模块：GAS End  *******************/

    /******************* 发送模块：MMC，接收模块：WRR Begin  *******************/
    RRMM_CSG_LIST_SEARCH_REQ_STRU                           stRRMM_WRR_CSG_LIST_SEARCH_REQ_STRU;
    RRMM_CSG_BG_SEARCH_REQ_STRU                             stRRMM_WRR_CSG_BG_SEARCH_REQ_STRU;
    /******************* 发送模块：MMC，接收模块：WRR End  *******************/

    /******************* 发送模块：MMC，接收模块：MMC Begin  *******************/
    NAS_MMC_ELF_TIMER_INFO_STRU                                 stNAS_MMC_TIMER_INFO_STRU;
    /******************* 发送模块：MMC，接收模块：MMC End  *******************/

}


void ELF_NAS_STRU_TraceTable_LMM(void)
{
    /******************* 发送模块：LMM，接收模块：MMC Begin  *******************/
    LMM_MMC_CSG_LIST_SEARCH_CNF_STRU                        stLMM_MMC_CSG_LIST_SEARCH_CNF_STRU;
    LMM_MMC_CSG_BG_SEARCH_CNF_STRU                          stLMM_MMC_CSG_BG_SEARCH_CNF_STRU;
    LMM_MMC_CSG_ID_HOME_NODEB_NAME_IND_STRU                 stLMM_MMC_CSG_ID_HOME_NODEB_NAME_IND_STRU;
    /******************* 发送模块：LMM，接收模块：MMC End  *******************/
}
