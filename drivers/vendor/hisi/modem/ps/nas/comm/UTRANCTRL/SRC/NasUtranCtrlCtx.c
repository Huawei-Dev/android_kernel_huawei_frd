...
)
{
    ...
    pstPlmnSearchCtrl->enRoamingZone = NAS_UTRANCTRL_ROAM_ZONE_UNKNOWN;
...
)
{
    ...
    NAS_NORMAL_LOG4( WUEPS_PID_MMC, "NAS_UTRANCTRL_SaveCurEntryMsg: ulSenderPid, ulReceiverPid, ulLength, ulMsgName", pstMsgHeader->ulSenderPid, pstMsgHeader->ulReceiverPid, pstMsgHeader->ulLength, pstMsgHeader->ulMsgName);
...
NAS_UTRANCTRL_UTRAN_MODE_ENUM_UINT8 NAS_UTRANCTRL_GetCurrUtranMode(VOS_VOID)
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_GetCurrUtranMode(): Not support UTRAN, return NAS_UTRANCTRL_UTRAN_MODE_BUTT");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_GetCurrUtranMode(): Only support WCDMA, return NAS_UTRANCTRL_UTRAN_MODE_FDD");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_GetCurrUtranMode(): Only support TDS, return NAS_UTRANCTRL_UTRAN_MODE_TDD");
        return NAS_UTRANCTRL_UTRAN_MODE_TDD;
    }

    if (NAS_UTRANCTRL_UTRAN_SWITCH_MODE_FDD_ONLY == NAS_UTRANCTRL_GetCurUtranSwitchMode())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_GetCurrUtranMode(): return NAS_UTRANCTRL_UTRAN_MODE_FDD");
        return NAS_UTRANCTRL_UTRAN_MODE_FDD;
    }

    if (NAS_UTRANCTRL_UTRAN_SWITCH_MODE_TDD_ONLY == NAS_UTRANCTRL_GetCurUtranSwitchMode())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_GetCurrUtranMode(): return NAS_UTRANCTRL_UTRAN_MODE_TDD");
        return NAS_UTRANCTRL_UTRAN_MODE_TDD;
    }
...
)
{
    ...
    NAS_NORMAL_LOG1(WUEPS_PID_MMC, "NAS_UTRANCTRL_SetCurrUtranMode(): enUtranMode", enUtranMode);
...
{
    NAS_NORMAL_LOG1(WUEPS_PID_MMC, "NAS_UTRANCTRL_GetPreUtranMode(): enPreUtranMode", NAS_UTRANCTRL_GetUtranCtrlCtx()->stMsCfgInfo.stCustomCfg.enPreUtranMode);
...
)
{
    ...
    NAS_NORMAL_LOG1(WUEPS_PID_MMC, "NAS_UTRANCTRL_SetPreUtranMode(): enUtranMode", enUtranMode);
...
{
    NAS_NORMAL_LOG1( WUEPS_PID_MMC, "NAS_UTRANCTRL_GetCurrEntryMsgAddr: ulEventType", NAS_UTRANCTRL_GetUtranCtrlCtx()->stCurFsm.stEntryMsg.ulEventType);
...
NAS_UTRANCTRL_ROAM_ZONE_ENUM_UINT8 NAS_UTRANCTRL_GetRoamingZone(VOS_VOID)
{
    return (NAS_UTRANCTRL_GetUtranCtrlCtx()->stPlmnSearchCtrl.enRoamingZone);
}


VOS_VOID NAS_UTRANCTRL_SetRoamingZone(
    NAS_UTRANCTRL_ROAM_ZONE_ENUM_UINT8       enRoamingZone
)
{
    NAS_UTRANCTRL_GetUtranCtrlCtx()->stPlmnSearchCtrl.enRoamingZone = enRoamingZone;
}
...
)
{
    ...
    NAS_NORMAL_LOG1(WUEPS_PID_MMC, "NAS_UTRANCTRL_SetCurUtranSwitchMode(): enCurUtranSwitchMode", ucSwitchMode);
}
...
{
    NAS_NORMAL_LOG1(WUEPS_PID_MMC, "NAS_UTRANCTRL_GetCurUtranSwitchMode(): enCurUtranSwitchMode", (NAS_UTRANCTRL_GetUtranCtrlCtx()->stMsCfgInfo.stCustomCfg.enCurUtranSwitchMode));
...
)
{
    ...
    NAS_NORMAL_LOG4( WUEPS_PID_MMC, "NAS_UTRANCTRL_SaveBufferUtranSndMmcMsg: ulSenderPid, ulReceiverPid, ulLength, ulMsgName", pstMsgHeader->ulSenderPid, pstMsgHeader->ulReceiverPid, pstMsgHeader->ulLength, pstMsgHeader->ulMsgName);
...
{
    NAS_NORMAL_LOG1( WUEPS_PID_MMC, "NAS_UTRANCTRL_GetBufferUtranSndMmcMsgAddr: ulEventType", NAS_UTRANCTRL_GetUtranCtrlCtx()->stMainCtrlInfo.stBufferUtranSndMmcMsg.ulEventType);
