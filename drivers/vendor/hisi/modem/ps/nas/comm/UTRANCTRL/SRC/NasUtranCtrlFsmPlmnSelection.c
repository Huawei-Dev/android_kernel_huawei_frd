...
{
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvWasPlmnSrchCnf_PlmnSelection_Init: Save Entry MSG and suspend WCDMA");
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvMmcInterSkipSearchWasIndMsg_PlmnSelection_Init: Save Entry MSG");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvMmcInterSkipSearchWasIndMsg_PlmnSelection_Init: TI_NAS_UTRANCTRL_WAIT_WAS_PLMN_SEARCH_CNF runing, snd STOP SEARCH REQ");
    ...
    /* 在跳过WCDMA时候，如果内存中加载的是TD，可以不用加载WCDMA再挂起WCDMA，而是直接去搜索TD */
    if ( (VOS_TRUE == NAS_DYNLOAD_GetEnableDynloadTWFlg())
      && (VOS_RATMODE_TDS == enRatInCached) )
    {    
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvMmcInterSkipSearchWasIndMsg_PlmnSelection_Init, curr load is tdscdma");
    ...
    if (VOS_TRUE == NAS_DYNLOAD_GetEnableDynloadTWFlg())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvMmcInterSkipSearchWasIndMsg_PlmnSelection_Init, load wcdma");
        (VOS_VOID)NAS_DYNLOAD_LoadAS(NAS_DYNLOAD_LOAD_RATCOMB_TYPE_T_W, VOS_RATMODE_WCDMA);
    }
#endif

    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvMmcInterSkipSearchWasIndMsg_PlmnSelection_Init: Suspend WRR");
...
)
{
    ...
    /* 在跳过TDS时候，如果内存中加载的是WCDMA，可以不用加载TD再挂起TD，而是直接去搜索WCDMA */
    if ( (VOS_TRUE == NAS_DYNLOAD_GetEnableDynloadTWFlg())
      && (VOS_RATMODE_WCDMA == enRatInCached) )
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvMmcInterSkipSearchTdsIndMsg_PlmnSelection_Init, curr load is wcdma");
    ...
    if (VOS_TRUE == NAS_DYNLOAD_GetEnableDynloadTWFlg())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvMmcInterSkipSearchTdsIndMsg_PlmnSelection_Init, load tds");
...
{
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvTdPlmnSrchCnf_PlmnSelection_Init: Save Entry MSG and suspend TDS");
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitWasPlmnStopCnfSearchTD: Stop TI_NAS_UTRANCTRL_WAIT_WAS_PLMN_STOP_CNF");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitWasPlmnStopCnfSearchTD: Build PLMN SEARCH CNF FAIL and enter NAS_UTRANCTRL_FSM_MAIN");
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitWasPlmnStopCnfSearchTD: Suspend WRR and enter NAS_UTRANCTRL_PLMN_SELECTION_STA_WAIT_WAS_SUSPEND_CNF");
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitTdPlmnStopCnfSearchW: Stop TI_NAS_UTRANCTRL_WAIT_TD_PLMN_STOP_CNF");
    ...
    if ( VOS_TRUE == NAS_UTRANCTRL_GetAbortFlg_PlmnSelection())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitTdPlmnStopCnfSearchW: Build PLMN SEARCH CNF FAIL and enter NAS_UTRANCTRL_FSM_MAIN");
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitTdPlmnStopCnfSearchW: Suspend TDS and enter NAS_UTRANCTRL_PLMN_SELECTION_STA_WAIT_TD_SUSPEND_CNF");
...
VOS_UINT32 NAS_UTRANCTRL_IsNeedBuildSearchCnfMsg_WaitSuspendCnf()
{
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_IsNeedBuildSearchCnfMsg_WaitSuspendCnf: SenderPid is VOS_PID_TIMER, return TRUE");
        return VOS_TRUE;
    }

    if (pstEntryMsg->ulEventType == NAS_UTRANCTRL_BuildEventType(WUEPS_PID_MMC, MMCMMC_INTER_SKIP_SEARCH_W_IND))
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_IsNeedBuildSearchCnfMsg_WaitSuspendCnf: MMCMMC_INTER_SKIP_SEARCH_W_IND, return TRUE");
        return VOS_TRUE;
    }

    if (pstEntryMsg->ulEventType == NAS_UTRANCTRL_BuildEventType(WUEPS_PID_MMC, MMCMMC_INTER_SKIP_SEARCH_TDS_IND))
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_IsNeedBuildSearchCnfMsg_WaitSuspendCnf: MMCMMC_INTER_SKIP_SEARCH_TDS_IND, return TRUE");
        return VOS_TRUE;
    }

    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_IsNeedBuildSearchCnfMsg_WaitSuspendCnf: return FALSE");
    return VOS_FALSE;
}
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitWasSuspendCnf: Stop TI_NAS_UTRANCTRL_WAIT_WAS_SUSPEND_CNF");
    /* 停止保护定时器 */
...
#endif
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitWasSuspendCnf: No Abort, send PLMN SEARCH to TDS");
    ...
    if (VOS_TRUE == NAS_UTRANCTRL_IsNeedBuildSearchCnfMsg_WaitSuspendCnf())
    {
        ...
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitWasSuspendCnf: Buld SEARCH CNF MSG");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitWasSuspendCnf: Get buffered MSG to MMC FSM");
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitTdSuspendCnf: Stop TI_NAS_UTRANCTRL_WAIT_TD_SUSPEND_CNF");
    /* 停止保护定时器 */
...
#endif
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitTdSuspendCnf: No Abort, send PLMN SEARCH to WRR");
    ...
    if (VOS_TRUE == NAS_UTRANCTRL_IsNeedBuildSearchCnfMsg_WaitSuspendCnf())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitTdSuspendCnf: Buld SEARCH CNF MSG");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitTdSuspendCnf: Get buffered MSG to MMC FSM");
...
{
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvMmcInterSkipSearchWasIndMsg_PlmnSelection_WaitWasPlmnSearchCnf: Send PLMN SEARCH STOP REQ");
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitWasPlmnStopCnf: Stop TI_NAS_UTRANCTRL_WAIT_WAS_PLMN_STOP_CNF");
    /* 停止保护定时器 */
    NAS_UTRANCTRL_StopTimer(TI_NAS_UTRANCTRL_WAIT_WAS_PLMN_STOP_CNF);
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitWasPlmnStopCnf: Build PLMN SEARCH CNF FAIL MSG and enter NAS_UTRANCTRL_FSM_MAIN");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitWasPlmnStopCnf: Suspend WRR and enter NAS_UTRANCTRL_PLMN_SELECTION_STA_WAIT_WAS_SUSPEND_CNF");
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitWasPlmnStopCnf: Suspend WRR and enter NAS_UTRANCTRL_PLMN_SELECTION_STA_WAIT_WAS_SUSPEND_CNF_BACK_TD");
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitTdPlmnStopCnf: Stop TI_NAS_UTRANCTRL_WAIT_TD_PLMN_STOP_CNF");
        ...
        && (MMCMMC_INTER_SKIP_SEARCH_W_IND == pstMsgHeader->ulMsgName) ) )
    {
        ...
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitTdPlmnStopCnf: Build PLMN SEARCH CNF FAIL MSG and enter NAS_UTRANCTRL_FSM_MAIN");
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmPlmnStopCnf_PlmnSelection_WaitTdPlmnStopCnf: Suspend TDS and enter NAS_UTRANCTRL_PLMN_SELECTION_STA_WAIT_TD_SUSPEND_CNF_BACK_W");
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitWasSuspendCnfBackTD: Stop TI_NAS_UTRANCTRL_WAIT_WAS_SUSPEND_CNF");
    /* 停止保护定时器 */
    NAS_UTRANCTRL_StopTimer(TI_NAS_UTRANCTRL_WAIT_WAS_SUSPEND_CNF);
    ...
    if (VOS_TRUE == NAS_UTRANCTRL_GetRcvMmcAbortFsmReqMsgFlg_PlmnSelection())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitWasSuspendCnfBackTD: Receive MMC ABORT FSM MSG, exit MMC FSM");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitWasSuspendCnfBackTD: Build PLMN SEARCH CNF FAIL MSG");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitWasSuspendCnfBackTD: Get buffer MSG and sent to MMC FSM");
...
)
{
    ...
    NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitTdSuspendCnfBackW: Stop TI_NAS_UTRANCTRL_WAIT_TD_SUSPEND_CNF");
    ...
    if (VOS_TRUE == NAS_UTRANCTRL_GetRcvMmcAbortFsmReqMsgFlg_PlmnSelection())
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitTdSuspendCnfBackW: Receive MMC ABORT FSM MSG, exit MMC FSM");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitTdSuspendCnfBackW: Build PLMN SEARCH CNF FAIL MSG");
    ...
    {
        NAS_NORMAL_LOG(WUEPS_PID_MMC, "NAS_UTRANCTRL_RcvRrmmSuspendCnf_PlmnSelection_WaitTdSuspendCnfBackW: Get buffer MSG and sent to MMC FSM");
