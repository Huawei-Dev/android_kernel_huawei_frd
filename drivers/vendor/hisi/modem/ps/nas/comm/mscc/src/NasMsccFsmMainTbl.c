...
NAS_ACT_STRU g_astNasMsccMainActiveActTbl[] =
{
   ...
   NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
    ...
    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MSCC_1X_BSR_LTE_TIMER,
                      NAS_MSCC_RcvTi1xBsrLteTimerExpired_Main_Active),
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ...
                      NAS_MSCC_RcvMmaCdmaMoCallRedialSysAcqNtf_Main_Active),
#endif

    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ID_NAS_MSCC_MSCC_POWER_SAVE_REQ,
                      NAS_MSCC_RcvMsccPowerSaveReq_Main_Active),
};
