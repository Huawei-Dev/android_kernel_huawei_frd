...
enum NAS_MSCC_INTERNAL_MSG_TYPE_ENUM
{
    ...
    ID_NAS_MSCC_MSCC_POWER_SAVE_REQ                                          ,/* _H2ASN_MsgChoice NAS_MSCC_MSCC_POWER_SAVE_REQ_STRU*/
...
enum NAS_MSCC_SYSTEM_ACQUIRED_RESULT_ENUM
{
    ...
    NAS_MSCC_SYSTEM_ACQUIRED_RESULT_SRCH_NO_RF              = 0x00000004,   /* 搜网NO RF, 对于HRPD来说，是系统捕获时出现NO RF，对于LTE来说，是搜网阶段出现NO RF */
    NAS_MSCC_SYSTEM_ACQUIRED_RESULT_REG_NO_RF               = 0x00000005,   /* 注册NO RF，对于HRPD来说，是session协商出现NO RF, 对于LTE来说，是注册阶段出现NO RF */
    NAS_MSCC_SYSTEM_ACQUIRED_RESULT_BUTT                    = 0x00000006
};
...
enum NAS_MSCC_BSR_RESULT_ENUM
{
    ...
    NAS_MSCC_BSR_RESULT_SRCH_NO_RF,     /* 搜网NO RF, 对于HRPD来说，是系统捕获时出现NO RF，对于LTE来说，是搜网阶段出现NO RF */
    NAS_MSCC_BSR_RESULT_REG_NO_RF,      /* 注册NO RF，对于HRPD来说，是session协商出现NO RF, 对于LTE来说，是注册阶段出现NO RF */
...
}NAS_MSCC_MSCC_POWER_SAVE_REQ_STRU;
...
VOS_VOID NAS_MSCC_SndInternalPowerSaveReq(
    VOS_UINT16                              usRatNum,
    NAS_MSCC_PIF_NET_RAT_TYPE_ENUM_UINT8   *penRat
);
