...
enum NAS_MSCC_BUILD_SYS_ACQ_LIST_SCENE_ENUM
{
    ...
    NAS_MSCC_BUILD_SYS_ACQ_LIST_SCENE_QUICK_SEARCH_HRPD_MRUO,           /* 数据业务触发的HRPD下MRU0快搜 */

    NAS_MSCC_BUILD_SYS_ACQ_LIST_SCENE_ENUM_LTE_HISTORY_PLUS_LTE_LOST,    /* 按LTE历史搜加LTE丢网构表 */
    NAS_MSCC_BUILD_SYS_ACQ_LIST_SCENE_ENUM_AVAILABLE_TIMER_EXPIRED_SRLTE_1X_TCH,  /* 增加available定时器超时，1X处于TCH态 */
