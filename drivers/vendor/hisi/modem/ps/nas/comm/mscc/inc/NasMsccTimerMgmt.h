...
#define TI_NAS_MSCC_WAIT_IMSA_IMS_WITH_WIFI_VOICE_AVAIL_IND_LEN        (50*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)
...
#define TI_NAS_MSCC_WAIT_XSD_POWER_SAVE_CNF_LEN              (13*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)

#define TI_NAS_MSCC_WAIT_CL_POWER_SAVE_CNF_LEN               (22*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)
...
#define TI_NAS_MSCC_AVAILABL_TIMER_WAIT_APP_ATTACH_PS_LEN     (5 * NAS_MSCC_THOUSAND_MILLISECOND_UNIT)
...
#define TI_NAS_MSCC_DEFAULT_PHASE_TWO_BSR_TIMER_LEN                            (10*60*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)

#define TI_NAS_MSCC_DEFAULT_PHASE_TWO_BSR_TIMER_LEN_WITH_UNMATCHED_MSPL_REC    (10*60*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)
...
#define TI_NAS_MSCC_WAIT_CARD_READ_CNF_LEN                   (15*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)
...
#define TI_NAS_MSCC_WAIT_HSD_BG_SEARCH_CNF_LEN               (182*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)

#define TI_NAS_MSCC_WAIT_HSD_STOP_BG_SEARCH_CNF_LEN          (8*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)
...
#define TI_NAS_MSCC_WAIT_IMSA_REG_CNF_LEN                   (3*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)
#define TI_NAS_MSCC_WAIT_IMSA_DEREG_CNF_LEN                 (3*NAS_MSCC_THOUSAND_MILLISECOND_UNIT)

#define NAS_MSCC_TIMER_TICK                                   (10)

#define TI_NAS_MSCC_DEFAULT_DATA_CALL_ON_1X_BSR_LTE_TIMER_LEN    (120)
...
/* 等待3GPP RF资源可用指示的保护定时器时长-默认值10S */
#define TI_NAS_MSCC_WAIT_MMC_RF_AVAILABLE_IND_LEN                   (10)

#define NAS_MSCC_DEFAULT_BSR_PHASE_ONE_HISTORY_SRCH_MAX_TIMES         (5)

#define NAS_MSCC_DEFAULT_BSR_PHASE_ONE_PREF_BAND_SRCH_MAX_TIMES       (1)

#define NAS_MSCC_DEFAULT_BSR_PHASE_TWO_HISTORY_SRCH_MAX_TIMES         (5)

#define NAS_MSCC_DEFAULT_BSR_PHASE_TWO_PREF_BAND_SRCH_MAX_TIMES       (255)
...
enum NAS_MSCC_TIMER_ID_ENUM
{
    ...
    TI_NAS_MSCC_WAIT_MMC_RF_AVAILABLE_IND,                              /* 等待MMC RF资源可用指示的保护定时器 */

    TI_NAS_MSCC_1X_BSR_LTE_TIMER,                                       /* 1x下BSR LTE的保护定时器 */

    TI_NAS_MSCC_WAIT_IMSA_REG_CNF,
    TI_NAS_MSCC_WAIT_IMSA_DEREG_CNF,
