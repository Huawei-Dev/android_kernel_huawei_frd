...
NAS_ACT_STRU        g_astNasMsccSysAcqInitActTbl[]   =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ...
                      NAS_MSCC_RcvMmaCdmaMoCallRedialSysAcqNtf_SysAcq_Init)
};
...
NAS_ACT_STRU        g_astNasMsccSysAcqWaitHsdAcqCnfActTbl[]   =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ID_MMA_MSCC_CDMA_MO_CALL_REDIAL_SYS_ACQ_NTF,
                      NAS_MSCC_RcvMmaCdmaMoCallRedialSysAcqNtf_SysAcq_WaitHsdSysAcqCnf),


    NAS_ACT_TBL_ITEM( UEPS_PID_HSD,
                      ID_HSD_MSCC_DATA_CALL_REDIAL_SYS_ACQ_CNF,
                      NAS_MSCC_RcvHsdDataCallRedialAcqCnf_SysAcq_WaitHsdSysAcqCnf ),
...
NAS_ACT_STRU        g_astNasMsccSysAcqWaitMmcPlmnSrchCnfActTbl[]   =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ID_MMA_MSCC_CDMA_MO_CALL_REDIAL_SYS_ACQ_NTF,
                      NAS_MSCC_RcvMmaCdmaMoCallRedialSysAcqNtf_SysAcq_WaitMmcPlmnSrchCnf ),
...
/* NAS_MSCC_SYSACQ_STA_WAIT_MMC_RF_AVAILABLE_IND Action Table */
NAS_ACT_STRU        g_astNasMsccSysAcqWaitMmcRfAvailableIndActTbl[]   =
{
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ID_MMC_MSCC_RF_AVAILABLE_IND,
                      NAS_MSCC_RcvMmcRfAvailableInd_SysAcq_WaitMmcRfAvailableInd),

    NAS_ACT_TBL_ITEM( UEPS_PID_MSCC,
                      ID_NAS_MSCC_MSCC_ABORT_FSM_REQ,
                      NAS_MSCC_RcvMsccAbortFsmReq_SysAcq_WaitMmcRfAvailableInd ),

    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MSCC_WAIT_MMC_RF_AVAILABLE_IND,
                      NAS_MSCC_RcvTiWaitMmcRfAvailableIndExpired_SysAcq_WaitMmcRfAvailableInd)
...
NAS_STA_STRU        g_astNasMsccSysAcqStaTbl[]   =
{
    ...
    NAS_STA_TBL_ITEM( NAS_MSCC_SYSACQ_STA_WAIT_MMC_RF_AVAILABLE_IND,
                      g_astNasMsccSysAcqWaitMmcRfAvailableIndActTbl ),
