...
NAS_ACT_STRU g_astNasMsccPreProActTbl[] =
{
    ...
    NAS_ACT_TBL_ITEM(WUEPS_PID_MMA,
                     ID_MMA_MSCC_CSG_SPEC_SEARCH_REQ,
                     NAS_MSCC_RcvMmaCsgSpecSearchReq_PreProc),

    NAS_ACT_TBL_ITEM(WUEPS_PID_MMA,
                     ID_MMA_MSCC_CSG_SPEC_SEARCH_ABORT_REQ,
                     NAS_MSCC_RcvMmaCsgSpecSearchAbortReq_PreProc),

    NAS_ACT_TBL_ITEM(WUEPS_PID_MMC,
                     ID_MMC_MSCC_CSG_SPEC_SEARCH_CNF,
                     NAS_MSCC_RcvMmcCsgSpecSearchCnf_PreProc),

    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ID_MMC_MSCC_CSG_SPEC_SEARCH_ABORT_CNF,
                      NAS_MSCC_RcvMmcCsgSpecSearchAbortCnf_PreProc),
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ID_MMC_MSCC_CSG_ID_HOME_NODEB_NAME_IND,
                      NAS_MSCC_RcvMmcCsgIdHomeNodeBNameInd_PreProc),
#endif
    NAS_ACT_TBL_ITEM(WUEPS_PID_MMA,
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ...
                      NAS_MSCC_RcvMmcMmssLteUnavailableInd_PreProc),
    ...
    NAS_ACT_TBL_ITEM(WUEPS_PID_MMA,
                     ID_MMA_MSCC_IMS_REG_REQ,
                     NAS_MSCC_RcvMmaImsRegReq_PreProc),

    NAS_ACT_TBL_ITEM(WUEPS_PID_MMA,
                     ID_MMA_MSCC_IMS_DEREG_REQ,
                     NAS_MSCC_RcvMmaImsDeregReq_PreProc),
    ...
    NAS_ACT_TBL_ITEM(WUEPS_PID_MMA,
                     ID_MMA_MSCC_IMS_DOMAIN_CFG_SET_REQ,
                     NAS_MSCC_RcvMmaImsDomainCfgSetReq_PreProc),

    NAS_ACT_TBL_ITEM(PS_PID_IMSA,
                     ID_IMSA_MSCC_IMS_DOMAIN_CFG_SET_CNF,
                     NAS_MSCC_RcvImsaImsDomainCfgSetCnf_PreProc),

    NAS_ACT_TBL_ITEM(WUEPS_PID_MMA,
                     ID_MMA_MSCC_ROAM_IMS_SUPPORT_SET_REQ,
                     NAS_MSCC_RcvMmaRoamImsSupportSetReq_PreProc),

    NAS_ACT_TBL_ITEM(PS_PID_IMSA,
                     ID_IMSA_MSCC_ROAM_IMS_SUPPORT_SET_CNF,
                     NAS_MSCC_RcvImsaRoamImsSupportSetCnf_PreProc),

    NAS_ACT_TBL_ITEM(WUEPS_PID_MMA,
                     ID_MMA_MSCC_AP_AREA_LOST_IND,
                     NAS_MSCC_RcvMmaApAreaLostInd_PreProc),

    NAS_ACT_TBL_ITEM(WUEPS_PID_MMC,
                     ID_MMC_MSCC_PS_REG_CN_RSLT_IND,
                     NAS_MSCC_RcvMmcPsRegCnRsltInd_PreProc),
    NAS_ACT_TBL_ITEM(PS_PID_IMSA,
                     ID_IMSA_MSCC_REG_CNF,
                     NAS_MSCC_RcvImsaRegCnf_PreProc),

    NAS_ACT_TBL_ITEM(PS_PID_IMSA,
                     ID_IMSA_MSCC_DEREG_CNF,
                     NAS_MSCC_RcvImsaDeregCnf_PreProc),

    NAS_ACT_TBL_ITEM(VOS_PID_TIMER,
                     TI_NAS_MSCC_WAIT_IMSA_REG_CNF,
                     NAS_MSCC_RcvTiWaitImsaRegCnfExpired_PreProc),

    NAS_ACT_TBL_ITEM(VOS_PID_TIMER,
                     TI_NAS_MSCC_WAIT_IMSA_DEREG_CNF,
                     NAS_MSCC_RcvTiWaitImsaDeregCnfExpired_PreProc),
    ...
    NAS_ACT_TBL_ITEM(UEPS_PID_XSD,
                     ID_XSD_MSCC_PRL_HEADER_INFO_IND,
                     NAS_MSCC_RcvXsdPrlHeaderInfo_PreProc),
#endif
    ...
    NAS_ACT_TBL_ITEM(MSP_PID_DIAG_APP_AGENT,
                     ...
                     NAS_MSCC_RcvOmErrLogReportReq_PreProc),
#endif

    NAS_ACT_TBL_ITEM( UEPS_PID_HSD,
                      ID_HSD_MSCC_SYSTEM_ACQUIRE_END_IND,
                      NAS_MSCC_RcvHsdSysAcqEndInd_PreProc),
#endif
   NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ID_MMC_MSCC_PLMN_SELECTION_RLST_IND,
                      NAS_MSCC_RcvMmcPlmnSelectionRsltInd_PreProc),
