...
#define NAS_MSCC_SYS_ACQ_CUSTOM_PLMN_NUM                (16)

#define NAS_MSCC_INVALID_SID                                (-1)
#define NAS_MSCC_INVALID_NID                                (-1)

#define NAS_MSCC_MAX_BSR_PHASE_NUM                          (2)
...
#define NAS_MSCC_MAX_LOG_MSG_STATE_NUM                      (200)
...
enum NAS_MSCC_SYS_ACQ_SCENE_ENUM
{
    ...
    NAS_MSCC_SYS_ACQ_SCENE_HRPD_LOST_NO_RF,              /* hrpd no rf丢网 */
    ...
    NAS_MSCC_SYS_ACQ_SCENE_QUICK_SEARCH_HRPD_MRUO,                                  /* 数据业务触发的HRPD下MRU0快搜 */

    NAS_MSCC_SYS_ACQ_SCENE_LTE_HISTORY_PLUS_LTE_LOST,         /* 先做LTE历史搜，再HRPD+LTE全频搜 */

    NAS_MSCC_SYS_ACQ_SCENE_AVAILABLE_TIMER_EXPIRED_SRLTE_1X_TCH,    /* SRLTE下，只做LTE历史搜 */
...
enum NAS_MSCC_SYS_ACQ_STATUS_ENUM
{
    ...
    NAS_MSCC_SYS_ACQ_STATUS_SEARCHED_UNREGISTERED,          /* the system is searched success and not register */
...
enum NAS_MSCC_CL_SYS_ACQ_DSDS_STRATEGY_SCENE_ENUM
{
    NAS_MSCC_CL_SYS_ACQ_DSDS_STRATEGY_SCENE_SWITCH_ON                 = 0,        /* 开机 */

    NAS_MSCC_CL_SYS_ACQ_DSDS_STRATEGY_SCENE_SWITCH_ON_AND_SYSCFG_SET  = 1,        /* 开机和syscfg设置场景 */

    NAS_MSCC_CL_SYS_ACQ_DSDS_STRATEGY_SCENE_ANY                       = 0xFE,     /* CL系统捕获的任意场景 */

    NAS_MSCC_CL_SYS_ACQ_DSDS_STRATEGY_SCENE_BUTT
};
typedef VOS_UINT8 NAS_MSCC_CL_SYS_ACQ_DSDS_STRATEGY_SCENE_ENUM_UINT8;


enum NAS_MSCC_LTE_CAPABILITY_STATUS_ENUM
{
    NAS_MSCC_LTE_CAPABILITY_STATUS_DISABLE_NOTIFIED_AS,         /* LTE特性不可用,已通知接入层 */
    NAS_MSCC_LTE_CAPABILITY_STATUS_REENABLE_NOTIFIED_AS,        /* LTE特性恢复可用,已通知接入层 */
    NAS_MSCC_LTE_CAPABILITY_STATUS_BUTT                         /* 无效值 */
};
typedef VOS_UINT32 NAS_MSCC_LTE_CAPABILITY_STATUS_ENUM_UINT32;

/*****************************************************************************
 枚举名    : NAS_MSCC_DISABLE_LTE_REASON_ENUM
 枚举说明  : Disable Lte原因枚举定义
*****************************************************************************/
enum NAS_MSCC_DISABLE_LTE_REASON_ENUM
{
    NAS_MSCC_DISABLE_LTE_REASON_PS_USER_DETACH,                  /* 用户detach EPS域导致disable LTE */
    NAS_MSCC_DISABLE_LTE_REASON_PS_USIM_INVALID,                 /* LTE注册导致PS卡无效导致disable LTE */
    NAS_MSCC_DISABLE_LTE_REASON_UIM_CARD_SWITCH_ON,              /* 开机是UIM卡导致disable LTE */
    NAS_MSCC_DISABLE_LTE_REASON_SIM_CARD_SWITCH_ON,              /* 开机是SIM卡导致disable LTE */
    NAS_MSCC_DISABLE_LTE_REASON_BUTT
};
typedef VOS_UINT32  NAS_MSCC_DISABLE_LTE_REASON_ENUM_UINT32;




enum NAS_MSCC_BSR_LTE_NORF_TYPE_ENUM
{
    NAS_MSCC_BSR_LTE_NORF_TYPE_SRCH,                        /* BSR LTE搜网NO RF */
    NAS_MSCC_BSR_LTE_NORF_TYPE_ATTACH,                      /* BSR LTE注册NO RF */
    NAS_MSCC_BSR_LTE_NORF_TYPE_BUTT                         /* 无效值 */
};
typedef VOS_UINT8 NAS_MSCC_BSR_LTE_NORF_TYPE_ENUM_UINT8;


enum NAS_MSCC_BSR_HRPD_NORF_TYPE_ENUM
{
    NAS_MSCC_BSR_HRPD_NORF_TYPE_SYNC,                        /* BSR HRPD同步NO RF */
    NAS_MSCC_BSR_HRPD_NORF_TYPE_NEG,                         /* BSR HRPD协商NO RF */
    NAS_MSCC_BSR_HRPD_NORF_TYPE_BUTT                         /* 无效值 */
};
typedef VOS_UINT8 NAS_MSCC_BSR_HRPD_NORF_TYPE_ENUM_UINT8;



enum NAS_MSCC_HRPD_SESSION_TYPE_ENUM
{
    NAS_MSCC_HRPD_SESSION_TYPE_HRPD          = 0x00,
    NAS_MSCC_HRPD_SESSION_TYPE_EHRPD         = 0x01,
    NAS_MSCC_HRPD_SESSION_TYPE_BUTT          = 0x02
};
typedef VOS_UINT8 NAS_MSCC_HRPD_SESSION_TYPE_ENUM_UINT8;

/** ****************************************************************************
 * Name        : NAS_MSCC_BSR_SRCH_TYPE_ENUM_UINT8
 *
 * Description : MSCC的BSR搜索类型
 *******************************************************************************/
enum NAS_MSCC_SRCH_BSR_TYPE_ENUM
{
    NAS_MSCC_BSR_SRCH_TYPE_HISTORY      = 0x00,
    NAS_MSCC_BSR_SRCH_TYPE_PREF_BAND    = 0x01,
    NAS_MSCC_BSR_SRCH_TYPE_ENUM_BUTT    = 0x02
};
typedef VOS_UINT8 NAS_MSCC_BSR_SRCH_TYPE_ENUM_UINT8;
...
typedef struct
{
    ...
    VOS_UINT32                                              ulDataCallSwitchTo1x;          /* 数据业务切换到1X标记 */

    VOS_UINT8                                               ucCurBsrPhase;                  /* 当前BSR的阶段澹:从0开始 */
    VOS_UINT8                                               ucCurBsrHistroySrchTimes;       /* 当前BSR阶段的历史频点搜网次数 */
    VOS_UINT8                                               ucCurBsrPrefBandSrchTimes;      /* 当前BSR阶段的pref band搜网次数 */
    NAS_MSCC_BSR_SRCH_TYPE_ENUM_UINT8                       enCurBsrSrchType;               /* 当前BSR的搜索类型 */
    NAS_MSCC_HRPD_SESSION_TYPE_ENUM_UINT8                   enCurHrpdSessionType;           /* 当前HRPD的session类型,NEG成功时有效 */
    VOS_UINT8                                               aucRsv[3];
}NAS_MSCC_BSR_CTRL_CTX_STRU;
...
typedef struct
{
    ...
    NAS_MSCC_PIF_PLMN_ID_STRU           astEquPlmnAddr[MSCC_MMC_MAX_EPLMN_ID_NUM];/* 当前EquPLMN列表 */
}NAS_MSCC_EQUPLMN_INFO_STRU;



typedef struct
{
    NAS_MSCC_NO_CARD_INIT_SEARCH_LOC_STRU                   stNoCardInitSearchLoc;        /* 无卡初搜的LOC信息 */

    VOS_UINT8                                               ucAllowSrchLteFlg;            /* 是否允许搜索lte */
    NAS_MSCC_PIF_PLMN_PRIORITY_CLASS_ENUM_UINT8             enLteSysPriClass;             /* LTE允许搜索的系统的PRI CLASS */
    NAS_MSCC_1X_SERVICE_CL_SYSTEM_ACQUIRE_PHASE_ENUM_UINT8  enCur1xServiceSysAcqPhaseNum; /* 当前处于1x有服务时哪个捕获阶段 */
    VOS_UINT8                                               ucMoCallConnecting;           /* 1X主叫业务建立中标记； 1X主叫业务建立中为true，1X主叫业务成功和结束为false */

    VOS_UINT32                                              ulCallBackEnableFlg;
    VOS_UINT8                                               ucIsEmcCallExist;
    VOS_UINT8                                               ucVolteEmcSrvAcqExistFlag;     /* 当前有紧急呼IMS重拨触发的搜网请求 */
    VOS_UINT8                                               aucRsv[2];

    VOS_UINT32                                              ulEpsAttachAllow;              /* LTE下EPS域允许attach标记,VOS_TRUE:EPS域允许attach,VOS_FALSE:EPS域不允许attach */
    VOS_UINT32                                              ulPrioSrchLastRatFlag;         /* 优先搜上次驻留的RAT系统标志 */
    NAS_MSCC_EQUPLMN_INFO_STRU                              stEplmnListInClMode;           /* CL模式下的EPLMN列表 */
...
typedef struct
{
    NAS_MSCC_PIF_NET_RAT_TYPE_ENUM_UINT8                    enLastCampOnLTEOrDoRat;  /* 这里仅记录RAT时LTE或DO驻留标志 */
    VOS_UINT8                                               aucReserved[3];
}NAS_MSCC_LAST_SYS_INFO_STRU;
...
typedef struct
{
    ...
    NAS_MSCC_LAST_SYS_INFO_STRU                             stLastSysInfo;      /* 上次驻留的系统信息 */
...
typedef struct
{
    ...
    VOS_UINT8                                               ucReAcqLteUpOnNoRfFinishFlg;  /* LTE NO RF时重新尝试LTE完成标记 */
    VOS_UINT8                                               ucPwrSaveLteUpOnReAcqLteNoRf; /* lte no rf时重新尝试lte需要power save lte标记 */
    VOS_UINT8                                               ucLteNoRfFlg;
    VOS_UINT8                                               ucHrpdNoRfFlg;
    VOS_UINT8                                               ucWaitQuickSrchDoCnf;      /* 等待快搜DO回复标记 */
    VOS_UINT8                                               aucRsv[3];
...
typedef struct
{
    ...
    VOS_UINT8                           ucSrlte1xBsrLteEnableFlag;          /* SRLTE下，1x数据连接态BSR lte控制开关 */
    VOS_UINT8                           ucRsv;
} NAS_MSCC_1X_SERVICE_CL_SYSTEM_ACQUIRE_CTRL_STRU;
...
typedef struct
{
    NAS_MSCC_1X_SERVICE_CL_SYSTEM_ACQUIRE_CTRL_STRU         stClSysAcqCtrlInfo;
...
typedef struct
{
    VOS_UINT8                                               ucReAcqLteWithNoRfEnable;               /* lte no rf时重新捕获lte是使能 */
    NAS_MSCC_CL_SYS_ACQ_DSDS_STRATEGY_SCENE_ENUM_UINT8      enReAcqLteWithNoRfScene;                /* lte no rf时重新捕获lte的搜索场景 */
    VOS_UINT8                                               ucReAcqLteWithNoRfDelayTime;            /* lte no rf时重新捕获lte的delay时间,单位秒 */
    VOS_UINT8                                               aucRsv[1];
}NAS_MSCC_CL_SYSTEM_ACQUIRE_DSDS_STRATEGY_STRU;
...
typedef struct
{
    ...
    NAS_MSCC_BSR_LTE_NORF_TYPE_ENUM_UINT8                   enBsrLteNoRfType;
    NAS_MSCC_BSR_HRPD_NORF_TYPE_ENUM_UINT8                  enBsrHrpdNoRfType;
...
typedef struct
{
    ...
    VOS_UINT32                          ulBsrTimerLenWithNoMatchedMsplRec;  /* MSPL表中没有匹配的记录，BSR时长 */
    VOS_UINT32                          ulBsrTimerLen;                      /* MSPL表中有匹配的记录，BSR时长 */
}NAS_MSCC_SYS_ACQ_BSR_TIMER_INFO_STRU;
...
typedef struct
{
    ...
    NAS_MSCC_SYS_ACQ_BSR_TIMER_INFO_STRU                    astBsrTimerInfo[NAS_MSCC_MAX_BSR_PHASE_NUM];
}NAS_MSCC_SYS_ACQ_BSR_CTRL_STRU;
...
typedef struct
{
    ...
    NAS_MSCC_SYS_ACQ_BSR_CTRL_STRU      stBsrTimerCtrl;
...
typedef struct
{
    ...
    NAS_MSCC_CL_SYSTEM_ACQUIRE_DSDS_STRATEGY_STRU           stClSysAcqDsdsStrategy;     /* CL系统捕获DSDS策略NV信息 */

    NAS_MSCC_TEST_CONFIG_STRU                               stTestConfig;
...
typedef struct
{
    NAS_MSCC_PIF_1X_CAS_MAIN_STATE_ENUM_UINT8               enUe1xMainState;
    NAS_MSCC_PIF_1X_CAS_SUB_STATE_ENUM_UINT8                enUe1xSubState;
    NAS_MSCC_PIF_1X_SERVICE_TYPE_ENUM_UINT8                 enUe1xServiceType;
    VOS_UINT8                                               aucReserved[1];
}NAS_MSCC_UE_STATUS_INFO_STRU;
...
typedef struct
{
    ...
    NAS_MSCC_BSR_CTRL_CTX_STRU                              stBsrCtrl;                             /* BSR控制上下文信息 */
    NAS_MSCC_MNTN_CTX_STRU                                  stMntnInfo;
    NAS_MSCC_UE_STATUS_INFO_STRU                            stUeStatusInfo;                        /* UE状态信息 */
}NAS_MSCC_CTX_STRU;
