...
enum TAF_XCC_CAUSE_ENUM
{
    ...
    TAF_XCC_CAUSE_EMC_CALL_BACK_MODE                            = (TAF_XCC_CAUSE_XCC_INT_BEGIN + 24),   /* 紧急呼Call Back模式 */

    TAF_XCC_CAUSE_EXIST_VOICE_CALL                              = (TAF_XCC_CAUSE_XCC_INT_BEGIN + 25),
    TAF_XCC_CAUSE_CAS_MS_END                                    = (TAF_XCC_CAUSE_XCC_INT_BEGIN + 26),
