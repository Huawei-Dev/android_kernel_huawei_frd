...
enum MSCC_MMA_HRPD_SERVICE_STATUS_ENUM
{
    ...
    MSCC_MMA_HRPD_SERVICE_STATUS_POWER_SAVE             = 2,              /* HRPD was power saved bye mscc */
...
enum  MSCC_MMA_CL_SYSTEM_ACQUIRE_FAIL_REASON_ENUM
{
...
typedef VOS_UINT32  MSCC_MMA_CL_SYSTEM_ACQUIRE_FAIL_REASON_ENUM_UINT32;


enum MSCC_MMA_MSPL_MLPL_INFO_SOURCE_ENUM
{
    MSCC_MMA_MSPL_MLPL_INFO_SOURCE_CARD     = 0x00,     /* mspl和mlpl来自读取卡文件 */
    MSCC_MMA_MSPL_MLPL_INFO_SOURCE_NV       = 0x01,     /* mspl和mlpl来自读取nv */
    MSCC_MMA_MSPL_MLPL_INFO_SOURCE_DEFAULT  = 0x02,     /* mspl和mlpl来自读取代码中预置的固定值 */
    MSCC_MMA_MSPL_MLPL_INFO_SOURCE_BUTT     = 0x03
};
typedef VOS_UINT8 MSCC_MMA_MSPL_MLPL_INFO_SOURCE_ENUM_UINT8;
...
typedef struct
{
    ...
    MSCC_MMA_ACQ_SYS_TYPE_ENUM_UINT32                       enAcqSysType;
    MSCC_MMA_SYSTEM_ACQUIRE_RESULT_ENUM_UINT32              enResult;
    MSCC_MMA_CL_SYSTEM_ACQUIRE_FAIL_REASON_ENUM_UINT32      enCLSysAcqFailReason;    /* 指示多模搜网时失败的原因 */
...
typedef NAS_MSCC_PIF_IMS_REG_REQ_STRU MMA_MSCC_IMS_REG_REQ_STRU;


typedef NAS_MSCC_PIF_IMS_REG_CNF_STRU MSCC_MMA_IMS_REG_CNF_STRU;


typedef NAS_MSCC_PIF_IMS_DEREG_REQ_STRU MMA_MSCC_IMS_DEREG_REQ_STRU;


typedef NAS_MSCC_PIF_IMS_DEREG_CNF_STRU MSCC_MMA_IMS_DEREG_CNF_STRU;


typedef NAS_MSCC_PIF_IMS_SWITCH_STATE_IND_STRU MSCC_MMA_IMS_SWITCH_STATE_IND_STRU;


typedef NAS_MSCC_PIF_AP_AREA_LOST_IND_STRU MMA_MSCC_AP_AREA_LOST_IND_STRU;





typedef NAS_MSCC_PIF_IMS_DOMAIN_CFG_SET_CNF_STRU MSCC_MMA_IMS_DOMAIN_CFG_SET_CNF_STRU;


typedef NAS_MSCC_PIF_ROAM_IMS_SUPPORT_SET_CNF_STRU MSCC_MMA_ROAM_IMS_SUPPORT_SET_CNF_STRU;
...
typedef NAS_MSCC_PIF_CSG_SPEC_SEARCH_REQ_STRU MMA_MSCC_CSG_SPEC_SEARCH_REQ_STRU;


typedef NAS_MSCC_PIF_CSG_SPEC_SEARCH_CNF_STRU MSCC_MMA_CSG_SPEC_SEARCH_CNF_STRU;


typedef NAS_MSCC_PIF_CSG_SPEC_SEARCH_ABORT_CNF_STRU MSCC_MMA_CSG_SPEC_SEARCH_ABORT_CNF_STRU;


typedef NAS_MSCC_PIF_CSG_ID_HOME_NODEB_NAME_IND_STRU MSCC_MMA_CSG_ID_HOME_NODEB_NAME_IND_STRU;

typedef NAS_MSCC_PIF_CSG_SPEC_SEARCH_ABORT_REQ_STRU MMA_MSCC_CSG_SPEC_SEARCH_ABORT_REQ_STRU;
...
/** ****************************************************************************
 * Name        : MSCC_MMA_1X_UE_STATUS_IND_STRU
 * Description : UE STATE indication
 *******************************************************************************/
typedef NAS_MSCC_PIF_1X_UE_STATUS_IND_STRU MSCC_MMA_1X_UE_STATUS_IND_STRU;
/** ****************************************************************************
 * Name        : XSD_MSCC_PRL_HEADER_INFO_IND_STRU
 * Description : PRL HEADER INFO
 *******************************************************************************/
typedef NAS_MSCC_PRL_HEADER_INFO_IND_STRU                   MSCC_MMA_PRL_HEADER_INFO_IND_STRU;
...
}NAS_MSCC_MMA_MSPL_HEADER_INFO_STRU;
...
}NAS_MSCC_MMA_MLPL_HEADER_INFO_STRU;


typedef struct
{
    MSCC_MSG_HEADER_STRU                                    stMsgHeader;        /*_H2ASN_Skip*/
    MSCC_MMA_MSPL_MLPL_INFO_SOURCE_ENUM_UINT8               enInfoSource;       /* MSPL和MLPL信息从哪里获取  */
    VOS_UINT8                                               aucRsv[3];
    NAS_MSCC_MMA_MSPL_HEADER_INFO_STRU                      stMsplInfo;         /* MSPL文件头信息 */
    NAS_MSCC_MMA_MLPL_HEADER_INFO_STRU                      stMlplInfo;         /* MLPL文件头信息 */
}MSCC_MMA_MSPL_MLPL_HEADER_INFO_STRU;
