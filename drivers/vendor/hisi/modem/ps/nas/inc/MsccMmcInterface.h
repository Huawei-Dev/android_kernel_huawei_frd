...
#define MSCC_MMC_MAX_PLMN_ID_NUM             (17)

#define MSCC_MMC_MAX_EPLMN_ID_NUM             (16)
...
enum MSCC_MMC_MMSS_LTE_UNAVIALBLE_REASON_ENUM
{
    ...
    MSCC_MMC_MMSS_LTE_UNAVIALBLE_REASON_NO_RF               = 7, /* Lte搜网NO RF导致Lte不可用*/
    MSCC_MMC_MMSS_LTE_UNAVIALBLE_REASON_REG_NO_RF           = 8, /* Lte注册NO RF导致Lte不可用*/
...
typedef NAS_MSCC_PIF_CSG_SPEC_SEARCH_REQ_STRU MSCC_MMC_CSG_SPEC_SEARCH_REQ_STRU;


typedef NAS_MSCC_PIF_CSG_SPEC_SEARCH_CNF_STRU MMC_MSCC_CSG_SPEC_SEARCH_CNF_STRU;

typedef NAS_MSCC_PIF_CSG_SPEC_SEARCH_ABORT_CNF_STRU MMC_MSCC_CSG_SPEC_SEARCH_ABORT_CNF_STRU;


typedef NAS_MSCC_PIF_CSG_ID_HOME_NODEB_NAME_IND_STRU MMC_MSCC_CSG_ID_HOME_NODEB_NAME_IND_STRU;

typedef NAS_MSCC_PIF_CSG_SPEC_SEARCH_ABORT_REQ_STRU MSCC_MMC_CSG_SPEC_SEARCH_ABORT_REQ_STRU;
...
/*****************************************************************************
 结构名    : MSCC_MMC_CURR_GEO_INFO_NTF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ID_MSCC_MMC_CURR_GEO_INFO_NTF对应的结构体，
             当1X/DO获取当前地理信息后，会用该消息通知mmc,mmc透传到CSS获取该地理信息的预置频点和频段
*****************************************************************************/
typedef struct
{
    MSCC_MSG_HEADER_STRU                stMsgHeader;                              /* _H2ASN_Skip */
    ...
    NAS_MSCC_PIF_PLMN_ID_STRU           astPlmnId[MSCC_MMC_MAX_PLMN_ID_NUM];
}MSCC_MMC_CURR_GEO_INFO_NTF_STRU;


/*****************************************************************************
 结构名    : MSCC_MMC_EPLMN_INFO_NTF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ID_MSCC_MMC_EPLMN_INFO_NTF对应的结构体，当DO驻留后,通知LMM当前相同MCC的满足MSPL优先级要求的PLMN信息
*****************************************************************************/
typedef struct
{
    MSCC_MSG_HEADER_STRU                stMsgHeader;                              /* _H2ASN_Skip */
    ...
    NAS_MSCC_PIF_PLMN_ID_STRU           astEplmnList[MSCC_MMC_MAX_EPLMN_ID_NUM];
}MSCC_MMC_EPLMN_INFO_NTF_STRU;
