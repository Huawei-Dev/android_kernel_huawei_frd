...
#define NAS_EMMC_SetCsfbSuppForDualRxUEsFlg(Flag)             (((NAS_EMMC_GetEmmcInfoAddr())->enCsfbSuppForDualRxUEsFlg) = (Flag))
#define NAS_EMMC_GetCsfbSuppForDualRxUEsFlg()                 ((NAS_EMMC_GetEmmcInfoAddr())->enCsfbSuppForDualRxUEsFlg)
...
typedef struct
{
    ...
    PS_BOOL_ENUM_UINT8                  enCsfbSuppForDualRxUEsFlg;
    VOS_UINT8                           aucRsv[2];
    /* 保存等效PLMN列表 */
