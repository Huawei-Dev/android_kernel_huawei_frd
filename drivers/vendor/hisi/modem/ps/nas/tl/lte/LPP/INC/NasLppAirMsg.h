...
typedef LOC_COM_ELLIPSOID_POINT_WITH_ALTITUDE_AND_UNCERTAINTY_ELLIPSOID_STRU LPP_ELLIP_POINT_WITH_ALTITUDE_UNCERTAIN_ELLIPSOID_STRU;
...
typedef struct
{
    ...
    */
    ...
    LPP_GNSS_BAD_SIGNAL_ELEMENT_STRU            astGNSSBadSignalListArray[LPP_MAX_BAD_SIGNAL_ELEMENT_LEN];
