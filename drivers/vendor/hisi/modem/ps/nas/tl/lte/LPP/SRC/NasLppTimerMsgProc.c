...
VOS_VOID  NAS_LPP_TimerInit( VOS_VOID )
{
    ...
    NAS_LPP_TimerReg(TI_NAS_LPP_MODEM_ORIG_WAIT_GNSS_LOC_CNF, NAS_LPP_RcvModemOrigWaitGnssLocCnfTimer,   NAS_LPP_MODEM_ORIG_WAIT_GNSS_LOC_CNF_TIMER_LEN  );
...
VOS_VOID  NAS_LPP_RcvModemOrigWaitGnssLocCnfTimer( VOS_UINT8 ucSessionIndx,VOS_UINT8 ucSessionTransIndx , VOS_UINT8 ucUpReqTechType, VOS_VOID *pRcvMsg)
{
    NAS_LPP_NORM_LOG("NAS_LPP_RcvModemOrigWaitGnssLocCnfTimer enter");
    TLPS_PRINT2LAYER_INFO(NAS_LPP_RcvModemOrigWaitGnssLocCnfTimer_ENUM, LNAS_LPP_Func_Enter);

    /* 没有收到standalone的位置测量信息，直接将流程标识置位即可*/
