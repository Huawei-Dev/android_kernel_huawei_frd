...
static NAS_EMMC_COMM_ACT_STRU                     g_astEmmcRsvMsgProcMap[] =
{
    ...
    #endif
    {ID_MMC_LMM_CL_INTERSYS_START_NTF          ,  WUEPS_PID_MMC,      NAS_EMMC_RcvMmcIntersysStartNTF             },
    /*========== EMM_MSG ==========*/
    ...
    #if (FEATURE_ON == FEATURE_CSG)
    {ID_LRRC_LMM_CSG_BG_SEARCH_CNF             ,  PS_PID_ERMM  ,      NAS_EMMC_RcvRrcCsgBgPlmnSearchCnf           },
