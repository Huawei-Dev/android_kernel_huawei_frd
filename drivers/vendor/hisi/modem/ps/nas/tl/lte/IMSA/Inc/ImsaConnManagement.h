...
#define TI_IMSA_WAIT_WIFI_PDP_ACTIVE_CNF_LEN            (15000)                 /* 等待wifi回复active cnf定时器 */
#define TI_IMSA_WAIT_WIFI_PDP_READY_IND_LEN             (5000)                  /* 等待wifi上报READY IND定时器 */
