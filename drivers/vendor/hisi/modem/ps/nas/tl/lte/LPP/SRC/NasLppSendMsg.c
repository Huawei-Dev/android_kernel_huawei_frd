...
)
{
    ...
    {
        TLPS_PRINT2LAYER_INFO(NAS_LPP_SndLppLrrcLocationInfo_ENUM, LNAS_LPP_SEND_RRC_LOC_INFO);
        ...
        {
            NAS_LPP_FREE_MSG(pstLppLrrcGnssDataInfo);
            return;
        }
    }
    else
...
)
{
    ...
    stLppMsgIdentity.enUplinkMsgType = NAS_LPP_UPLINK_MSG_TYPE_NEED_ACK_CNF;
