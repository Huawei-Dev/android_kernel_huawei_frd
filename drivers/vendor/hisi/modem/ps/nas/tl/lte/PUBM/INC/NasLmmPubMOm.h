...
enum NAS_LMM_OM_TAU_START_TYPE_ENUM
{
    ...
    NAS_LMM_OM_TAU_START_TYPE_RESUME_PS                         = 33,   /* SRLTE结束发起TAU,恢复PS */
   

    NAS_LMM_OM_TAU_START_TYPE_NORF                              = 34,   /*NORF*/
    NAS_LMM_OM_TAU_START_TYPE_RF_RECOVER                        = 35,   /*RF RECOVER*/
	NAS_LMM_OM_TAU_START_TYPE_OTHERS                            = 36,   /*OTHERS*/
...
typedef struct
{
    ...
    VOS_UINT8                           ucDamFlag;       /* DAM特性开关，1开启，0关闭，只使用[0]位置 */
