...
#define IMSA_CALL_TIMER_LEN_VEDIO_BEAR_LOST_MOD_CALL (3*1000)
...
*****************************************************************************/
/*****************************************************************************
 结构名    : IMSA_CALL_REL_REASON_TRANS_STRU
 结构说明  : 将IMSA挂断电话原因值转换成IMS原因值得表结构
*****************************************************************************/
typedef struct
{
    IMSA_CALL_NO_SRV_CAUSE_ENUM_UINT32  enImsaErr;
    IMSA_IMS_CALL_REL_CAUSE_ENUM_UINT8  enImsErr;
    VOS_UINT8                           aucRsv[3];
} IMSA_CALL_REL_REASON_TRANS_STRU;
...
#define IMSA_CallGetNonRegRejCtrlAddr()         (&pgstImsaEntity->stImsaCallManager.stNonRegRejCtrl)
#define IMSA_CallGetNonRegRejCauseListAddr()    (&pgstImsaEntity->stImsaCallManager.stNonRegRejCtrl.stNonRegRejCauseList)
...
extern VOS_VOID IMSA_CallProcTimeoutNormalTCall(const VOS_VOID *pTimerMsg);
...
extern VOS_VOID IMSA_CallEntityUpdateCallDisplayNameByAscii(const VOS_CHAR *pcAddress,
...
extern VOS_UINT32 IMSA_CallSendImsMsgDial
(
    VOS_UINT32 ulCallId,
...
extern VOS_UINT32 IMSA_ImsCallStateNtfInHo(VOS_VOID);


extern VOS_VOID IMSA_CallProcTimeoutVideoMediaLost(const VOS_VOID *pTimerMsg);
extern VOS_VOID IMSA_ClearVideoLostModCallTypeCtrInfo(VOS_VOID);
extern VOS_UINT32 IMSA_CallSndSpmModifyStatusIndWithCallIndex
(
    VOS_UINT32                          ulIndex,
    MN_CALL_TYPE_ENUM_U8                enCurrCallType,
    MN_CALL_TYPE_ENUM_U8                enExpectCallType
);
extern VOS_UINT32 IMSA_IsExistVideoCall(VOS_UINT32 *pulIndex);
extern VOS_VOID IMSA_SetVideoCallModifySource(IMSA_VIDEO_CALL_MODIFY_SOURCE_ENUM_UINT8  enVideoCallModifySource);
extern VOS_VOID IMSA_CallSpmModifyMsgSave
(
    const SPM_IMSA_CALL_MODIFY_REQ_STRU  *pstAppMsg
);
extern VOS_UINT32 IMSA_CallIsCurrentCallInProcessing(VOS_UINT32 ulCallId);
