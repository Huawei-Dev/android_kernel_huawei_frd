...
VOS_VOID NAS_LPP_EncodeGnssSignalIds
(
...
VOS_VOID NAS_LPP_EncodeGnssTimeModelListSupport
(
...
VOS_VOID NAS_LPP_EncodeGnssDifferentialCorrectionsSupport
(
...
VOS_VOID NAS_LPP_EncodeRealTimeIntegritySupport
(
...
VOS_VOID NAS_LPP_EncodeDataBitAssistanceSupport
(
...
VOS_VOID NAS_LPP_EncodeAuxiliaryInformationSupport
(
...
VOS_VOID NAS_LPP_EncodeAGNSSIEsProvideCapabilitiesLocationCoordinateTypes
(
...
VOS_VOID NAS_LPP_EncodeAGNSSIEsProvideCapabilitiesLocationVelocityTypes
(
...
)
{
    ...
    {
        if((pstOrbitModelID->aucOrbitModelIDList[ucCount] > 8)||(pstOrbitModelID->aucOrbitModelIDList[ucCount] < 1))
        {
            NAS_LPP_ASN_FAIL_Message(NAS_LPP_ORBITMODELID_ERROR,
                                     NAS_LPP_INTEGER_VALUE_OUT_OF_RANGE,
                                    *pusBitPos, __LINE__, 0);
    ...
    for(ucCount = 0;ucCount < pstOrbitModelID->ucOrbitModelIDCount;ucCount++)
    {
        ucValue = pstOrbitModelID->aucOrbitModelIDList[ucCount] - 1;
        NAS_LPP_EncodeBitsLess8( pucEncodeOutMsg,  pusBitPos, 3, ucValue);
    }
...
)
{
    ...
    {
        if((pstClockModelID->aucClockModelIDList[ucCount] > 8)||(pstClockModelID->aucClockModelIDList[ucCount] < 1))
        {
            NAS_LPP_ASN_FAIL_Message(NAS_LPP_CLOCKMODELID_ERROR,
                                     NAS_LPP_INTEGER_VALUE_OUT_OF_RANGE,
                                    *pusBitPos, __LINE__, 0);
    ...
    for(ucCount = 0;ucCount < pstClockModelID->ucClockModelIDCount;ucCount++)
    {
        ucValue = pstClockModelID->aucClockModelIDList[ucCount] - 1;
        NAS_LPP_EncodeBitsLess8( pucEncodeOutMsg,  pusBitPos, 3, ucValue);
    }
...
)
{
    ...
    NAS_LPP_EncodeEncodeLongData(pucEncodeOutMsg, pusBitPos, 23,
                                  pstEllipsoidPoint->ulDegreesLatitude);
...
)
{
    ...
    /*编码degreesLongitude*/
    NAS_LPP_EncodeEncodeLongData(pucEncodeOutMsg, pusBitPos, 24, (VOS_UINT32)(pstEllipsoidPointWithCircle->lDegreesLongitude + 8388608));
...
)
{
    ...
    if ( (pstPolygonPoints->lDegreesLongitude > 8388607)
       ||(pstPolygonPoints->lDegreesLongitude < -8388608)
    ...
    /*编码degreesLongitude*/
    NAS_LPP_EncodeEncodeLongData(pucEncodeOutMsg, pusBitPos, 24, (VOS_UINT32)(pstPolygonPoints->lDegreesLongitude + 8388608));
...
)
{
    ...
    if ( (pstEllipsoidPointWithAltitude->lDegreesLongitude > 8388607)
       ||(pstEllipsoidPointWithAltitude->lDegreesLongitude < -8388608)
    ...
    /*编码degreesLongitude*/
    NAS_LPP_EncodeEncodeLongData(pucEncodeOutMsg, pusBitPos, 24,
                                 (VOS_UINT32)(pstEllipsoidPointWithAltitude->lDegreesLongitude + 8388608));
...
)
{
    ...
    if ( (pstTempStru->ucConfidence > 100)
       ...
       ||(pstEllipPointAndUncertEllip->lDegreesLongitude > 8388607)
       ||(pstEllipPointAndUncertEllip->lDegreesLongitude < -8388608)
    ...
    /*编码degreesLongitude*/
    NAS_LPP_EncodeEncodeLongData(pucEncodeOutMsg, pusBitPos, 24, (VOS_UINT32)(pstEllipPointAndUncertEllip->lDegreesLongitude + 8388608));
...
)
{
    ...
    if((pstEllipsoidArc->lDegreesLongitude > 8388607)
     || (pstEllipsoidArc->lDegreesLongitude < -8388608)
    ...
    /*编码degreesLongitude*/
    NAS_LPP_EncodeEncodeLongData(pucEncodeOutMsg, pusBitPos, 24,
                                 (VOS_UINT32)(pstEllipsoidArc->lDegreesLongitude + 8388608));
...
)
{
    ...
    /*编码gnss-TOD-msec*/
    if(pstMeasRefTime->ulGNSSTodMsec > 3599999)
    {
