...
)
{
    ...
    #if  ( (FEATURE_MULTI_MODEM == FEATURE_ON) && ( (2 == MULTI_MODEM_NUMBER) || (3 == MULTI_MODEM_NUMBER) ) )
    /* two or three modems */
    ...
    #endif
    #if  ( (FEATURE_MULTI_MODEM == FEATURE_ON) && (3 == MULTI_MODEM_NUMBER) )
    /* three modems */
    if ( MODEM_ID_2 == usModemId )
    {
