...
)
{
    ...
    NAS_LCS_DecodeLatitude(     &pucMsgTmp[ulSum],
                                ...
                                &pstLocationEstimate->u.stEllipsoidPoint.ulDegreesLatitude);
    ulSum += 3;
...
)
{
    ...
    /* 译码经度 */
    NAS_LCS_DecodeLongitude(    &pucMsgTmp[ulSum],
                                &pstLocationEstimate->u.stEllipsoidPointWithUncertaintyCircle.lDegreesLongitude);
    ulSum += 3;
...
)
{
    ...
    /* 译码经度 */
    NAS_LCS_DecodeLongitude(    &pucMsgTmp[ulSum],
                                &pstLocationEstimate->u.stEllipsoidPointWithAltitudeAndUncertaintyEllipsoid.lDegreesLongitude);
    ulSum += 3;
...
)
{
    ...
    /* 译码经度 */
    NAS_LCS_DecodeLongitude(    &pucMsgTmp[ulSum],
                                &pstLocationEstimate->u.stEllipsoidArc.lDegreesLongitude);
    ulSum += 3;
...
)
{
    ...
    /* 译码经度 */
    NAS_LCS_DecodeLongitude(    &pucMsgTmp[ulSum],
                                &pstLocationEstimate->u.stEllipsoidPointWithAltitude.lDegreesLongitude);
    ulSum += 3;
...
)
{
    ...
    for (i = 0; i < ucPointsNum; i++)
    {
        ...
        /* 译码经度 */
        NAS_LCS_DecodeLongitude(    &pucMsgTmp[ulSum],
                                    &pstLocationEstimate->u.stPolygon.astPolygonArray[i].lDegreesLongitude);
        ulSum += 3;
    }
