...
#define IMSA_INTRA_MSG_MAX_NUM          (10)
...
enum    IMSA_INTRA_MSG_ID_ENUM
{
    ...
    ID_IMSA_REG_REREG_REQ               = 0x002,                /* _H2ASN_MsgChoice IMSA_REG_REREG_REQ_STRU */
    ...
    ID_IMSA_CONN_HO_REQ                 = 0x102,                 /* 请求发起切换PDN连接 */
    ...
    ID_IMSA_CONN_HO_CNF                 = 0x113,                /* 给SER模块回复PDN切换结果 */
    ...
    /* SRV 给DOMAIN模块的消息 */
    ID_IMSA_DOMAIN_SRV_STATUS_IND       = 0x230,                /* _H2ASN_MsgChoice IMSA_DOMAIN_SRV_STATUS_IND_STRU */
    ID_IMSA_DOMAIN_SRV_READY_IND        = 0x231,                /* _H2ASN_MsgChoice IMSA_DOMAIN_SRV_READY_IND_STRU */
    ID_IMSA_DOMAIN_SWITCH_RESULT_IND    = 0x232,                /* _H2ASN_MsgChoice IMSA_DOMAIN_SWITCH_RESULT_IND_STRU */
    ID_IMSA_DOMAIN_BEARER_REL_IND       = 0x233,                /* _H2ASN_MsgChoice IMSA_DOMAIN_BEARER_REL_IND_STRU */
...
enum IMSA_REG_RESULT_ENUM
{
    ...
    IMSA_REG_RESULT_FAIL_REREG_FAIL     = 10,   /**< 周期注册，被网侧拒绝 */
...
enum IMSA_REG_ADDR_PARAM_ENUM
{
    ...
    IMSA_REG_ADDR_PARAM_NO_REG_EMC_CALL,  /**< 无卡紧急呼，不发起注册，只配置地址对 */
...
/*****************************************************************************
    枚举名    : IMSA_CONN_TYPE_ENUM_UINT32
    枚举说明  : IMS建链类型
*****************************************************************************/
...
/*****************************************************************************
    枚举名    : IMSA_CONN_RELEASE_TYPE_ENUM
    枚举说明  : IMS链路释放类型
*****************************************************************************/
enum IMSA_CONN_RELEASE_TYPE_ENUM
{
    IMSA_CONN_RELEASE_TYPE_ENUM_NORMAL      = 0,    /* 正常释放 */
    IMSA_CONN_RELEASE_TYPE_ENUM_LOCAL       = 1,    /* 本地释放，不需要交互信令 */
    IMSA_CONN_RELEASE_TYPE_ENUM_SPEEDUP     = 2,
    IMSA_CONN_RELEASE_TYPE_BUTT
};
typedef VOS_UINT8 IMSA_CONN_RELEASE_TYPE_ENUM_UINT8;
...
enum IMSA_DOMAIN_MODE_ENUM
{
/* 指定IMSA具有的域能力 */
   IMSA_IMS_DOMAIN_MODE_NULL          = 0x00,   /*  空闲模式  */
   IMSA_IMS_DOMAIN_MODE_WIFI_ONLY     = 0x01,   /* WIFI ONLY MOde  */
   IMSA_IMS_DOMAIN_MODE_CELLULAR_ONLY = 0x02,   /*  Cellular ONLY */
   IMSA_IMS_DOMAIN_MODE_DUAL          = 0x03,   /* Dual Domain Mode */

   IMSA_IMS_DOMAIN_MODE_BUTT
};
typedef VOS_UINT8 IMSA_DOMAIN_MODE_ENUM_UINT8;



enum IMSA_REG_BEARER_TYPE_ENUM
{
/* 指定IMSA具有的域能力 */
   IMSA_REG_BEARER_TYPE_NULL          = 0x00,   /* No Bearer  */
   IMSA_REG_BEARER_TYPE_WIFI          = 0x01,   /* WIFI PDN  */
   IMSA_REG_BEARER_TYPE_LTE           = 0x02,   /* LTE PDP */
   IMSA_REG_BEARER_TYPE_BUTT
};
typedef VOS_UINT8 IMSA_REG_BEARER_TYPE_ENUM_UINT8;





enum IMSA_IMS_DOMAIN_ENUM
{
/* 指定IMSA具有的域能力 */
   IMSA_IMS_DOMAIN_NULL          = 0x00,
   IMSA_IMS_DOMAIN_WIFI          = 0x01,
   IMSA_IMS_DOMAIN_LTE           = 0x02,
   IMSA_IMS_DOMAIN_LTE_WIFI      = 0x03,

   IMSA_IMS_DOMAIN_BUTT
};

typedef VOS_UINT8 IMSA_IMS_DOMAIN_ENUM_UINT8;


enum IMSA_IMS_VOLTECTRLVOWIFI_ENUM
{
/* 指定IMS中VoLTE域对VoWIFI域能力的配置影响 */
   IMSA_IMS_VOLTECTRLVOWIFI_INIT          = 0x00,  /* 初始化为VoWIFI和VoLTE彼此间无关系 */
   IMSA_IMS_VOLTECTRLVOWIFI_NORMAL        = 0x01,  /* VoWIFI受VoLTE影响,当前VoWIFI可用 */
   IMSA_IMS_VOLTECTRLVOWIFI_LIMITED       = 0x02,  /* VoWIFI受VoLTE影响,当前VoWIFI不可用 */

   IMSA_IMS_VOLTECTRLVOWIFI_BUTT
};

typedef VOS_UINT8 IMSA_IMS_VOLTECTRLVOWIFI_ENUM_UINT8;


 
 enum IMSA_IMS_DOMAIN_PREFR_CFG_ENUM
 {
    IMSA_IMS_DOMAIN_PREFER_CELLULAR_ONLY               = 0x00,    /* 指定Cellular ONLY */
    IMSA_IMS_DOMAIN_PREFER_WIFI_ONLY                   = 0x01,    /* 指定WIFI ONLY */
    IMSA_IMS_DOMAIN_PREFER_CELLULAR_PREFER             = 0x02,    /* 指定Cellular Prefer */
    IMSA_IMS_DOMAIN_PREFER_WIFI_PREFER                 = 0x03,    /* 指定Wifi Prefer */

    IMSA_IMS_DOMAIN_PREFER_BUTT
 };
 typedef VOS_UINT8 IMSA_IMS_DOMAIN_PREFR_CFG_ENUM_UINT8;


enum IMSA_DOMAIN_FSM_L2_STATE_NUM
{
   IMSA_DOMAIN_FSM_L2_STATE_NULL                      = 0x00,    /*  空闲模式  */
   IMSA_DOMAIN_FSM_L2_STATE_LTE_DOMAIN_TRYING         = 0x01,    /* LTE域尝试建立 */
   IMSA_DOMAIN_FSM_L2_STATE_LTE_DOMAIN                = 0x02,    /* 当前域为LTE域 */
   IMSA_DOMAIN_FSM_L2_STATE_WIFI_DOMAIN_TRYING        = 0x03,    /* WIFI域尝试建立 */
   IMSA_DOMAIN_FSM_L2_STATE_WIFI_DOMAIN               = 0x04,    /* 当前域为Wifi域 */
   IMSA_DOMAIN_FSM_L2_STATE_L2W_SWITCH                = 0x05,    /* LTE域到WIFI域转换 */
   IMSA_DOMAIN_FSM_L2_STATE_W2L_SWITCH                = 0x06,    /* WIFI域到LTE域转换 */
   IMSA_DOMAIN_FSM_L2_STATE_DISABLING                 = 0x07,    /* 域disable状态 */
   IMSA_DOMAIN_FSM_L2_STATE_LTE_DISABLING             = 0x08,    /* LTE域disable状态 */
   IMSA_DOMAIN_FSM_L2_STATE_WIFI_DISABLING            = 0x09,    /* WIFI域disable状态 */

   IMSA_DOMAIN_FSM_L2_STATE_BUTT
};
typedef VOS_UINT8 IMSA_DOMAIN_FSM_L2_STATE_NUM_UINT8;

#if 0
enum IMSA_IMS_HO_TYPE_ENUM
{
   IMSA_IMS_HO_TYPE_W2L_SWITCH               = 0x00,    /* 指定WIFI to LTE的SWITCH */
   IMSA_IMS_HO_TYPE_L2W_SWITCH               = 0x01,    /* 指定LTE to WIFI的SWITCH */
   IMSA_IMS_HO_TYPE_NO_SWITCH                = 0x02,    /* 指定没有SWITCH */

   IMSA_IMS_HO_TYPE_SWITCH_BUTT
};
typedef VOS_UINT8 IMSA_IMS_HO_TYPE_ENUM_UINT8;
#endif

/*****************************************************************************
    枚举名    : WIFI/LTE_QUALITY_LEVEL_ENUM
    枚举说明  : WIFI质量等级枚举
*****************************************************************************/
enum IMSA_WIRELESS_QUALITY_LEVEL_ENUM
{
    IMSA_WIRELESS_QUALITY_LEVEL_BAD         = 0x00,
    IMSA_WIRELESS_QUALITY_LEVEL_NORMAL      = 0x01,
    IMSA_WIRELESS_QUALITY_LEVEL_GOOD        = 0x02,

    IMSA_WIRELESS_QUALITY_LEVEL_BUTT
};
typedef VOS_INT8 IMSA_WIRELESS_QUALITY_LEVEL_ENUM_INT8;



/*****************************************************************************
    枚举名    : IMSA_DOMAIN_SERVICE_STATUS_ENUM
    枚举说明  : SRV模块服务状态
*****************************************************************************/

enum IMSA_DOMAIN_SERVICE_STATUS_ENUM
{
    IMSA_DOMAIN_SERVICE_STATUS_NORMAL_SERVICE    = 0,
    IMSA_DOMAIN_SERVICE_STATUS_NO_SERVICE     = 1,
    IMSA_DOMAIN_SERVICE_STATUS_BUTT
};

typedef VOS_UINT32 IMSA_DOMAIN_SERVICE_STATUS_ENUM_UINT32;

/*****************************************************************************
    枚举名    : IMSA_DOMAIN_SWITCH_TYPE_ENUM
    枚举说明  : SWITCH域类型
*****************************************************************************/

enum IMSA_DOMAIN_SWITCH_TYPE_ENUM
{
    IMSA_DOMAIN_SWITCH_TYPE_NO_SWITCH      = 0,
    IMSA_DOMAIN_SWITCH_TYPE_L2W_SWITCH     = 1,
    IMSA_DOMAIN_SWITCH_TYPE_W2L_SWITCH     = 2,
    IMSA_DOMAIN_SWITCH_TYPE_SWITCH_BUTT
};
typedef VOS_UINT8 IMSA_DOMAIN_SWITCH_TYPE_ENUM_UINT8;
/*****************************************************************************
    枚举名    : IMSA_DOMAIN_SWITCH_RESULT_ENUM
    枚举说明  : SWITCH域结果
*****************************************************************************/
enum IMSA_DOMAIN_SWITCH_RESULT_ENUM
{
    IMSA_DOMAIN_SWITCH_RESULT_SUCCESS      = 0,
    IMSA_DOMAIN_SWITCH_RESULT_FAILURE      = 1,
    IMSA_DOMAIN_SWITCH_RESULT_BUTT
};
typedef VOS_UINT8 IMSA_DOMAIN_SWITCH_RESULT_ENUM_UINT8;
...
enum IMSA_CONN_RESULT_ENUM
{
    ...
    IMSA_CONN_RESULT_FAIL_WIFI_READY_IND_TIMEOUT    = 9,   /**< CONN模块命令执行失败，由于WIFI下发送READY IND超时 */

    IMSA_CONN_RESULT_FAIL_HO_NEW_PDN_SETUP_FAIL     = 10,


    IMSA_CONN_RESULT_FAIL_OHTERS                = 11,    /**< CONN模块命令执行失败，由于其他原因 */
...
enum    IMSA_EMC_CALL_TYPE_ENUM
{
    ...
    IMSA_EMC_CALL_TYPE_NO_REG           = 1,                        /**< 无卡紧急呼 */
...
enum    IMSA_CALL_NO_SRV_CAUSE_ENUM
{
    ...
    IMSA_CALL_NO_SRV_CAUSE_AREA_LOST,                                           /* 丢网导致的无服务 */

    IMSA_CALL_NO_SRV_CAUSE_IMS_EMC_BAR,                                        /* 紧急接入被罢 */
    IMSA_CALL_NO_SRV_CAUSE_IMS_EMC_NOT_SUPPORT,                                /* 网络不支持紧急呼 */
...
/*****************************************************************************
    枚举名    : IMSA_DOMAIN_NO_SRV_CAUSE_ENUM
    枚举说明  : IMSA DOMAIN无服务促使原因值
*****************************************************************************/
enum    IMSA_DOMAIN_NO_SRV_CAUSE_ENUM
{
    IMSA_DOMAIN_NO_SRV_CAUSE_HIFI_EXCEPTION           = 0,
    IMSA_DOMAIN_NO_SRV_CAUSE_NON_SRVCC_RAT_CHANGE,
    IMSA_DOMAIN_NO_SRV_CAUSE_NW_NOT_SUPPORT_IMS_VOICE,
    IMSA_DOMAIN_NO_SRV_CAUSE_MEDIA_PDP_RELEASE,
    IMSA_DOMAIN_NO_SRV_CAUSE_SIP_PDP_ERR,
    IMSA_DOMAIN_NO_SRV_CAUSE_REG_ERR,
    IMSA_DOMAIN_NO_SRV_CAUSE_POWER_OFF,
    IMSA_DOMAIN_NO_SRV_CAUSE_WAIT_RETRY,

    IMSA_DOMAIN_NO_SRV_CAUSE_BUTT
};
typedef VOS_UINT32 IMSA_DOMAIN_NO_SRV_CAUSE_ENUM_UINT32;
...
/*****************************************************************************
 枚举名    : IMSA_CALL_NORM_SRV_EXTEND_INFO_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : Service模块通知Call模块Norm Service时新增扩展信息
*****************************************************************************/
enum IMSA_CALL_NORM_SRV_EXTEND_INFO_ENUM
{
    IMSA_CALL_NORM_SRV_EXTEND_INFO_NONE           = 0,  /* 没有扩展信息 */
    IMSA_CALL_NORM_SRV_EXTEND_INFO_VIDEO_PDP_LOST = 1,  /* 视频承载被释放 */

    IMSA_CALL_NORM_SRV_EXTEND_INFO_BUTT
};
typedef VOS_UINT32 IMSA_CALL_NORM_SRV_EXTEND_INFO_ENUM_UINT32;
...
/*****************************************************************************
 结构名    : IMSA_REG_REREG_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : IMSA_REG_REREG_REQ_STRU消息结构定义
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    VOS_UINT32                           ulMsgId;           /**< 消息Id */
    IMSA_REG_TYPE_ENUM_UINT8             enReregType;       /**< 去注册的实体类型 */
    IMSA_REG_BEARER_TYPE_ENUM_UINT8      enRegBearerType;   /** <重新注册承载类型> */
    VOS_UINT8                            aucRsv[2];
}IMSA_REG_REREG_REQ_STRU;
...
typedef struct
{
    ...
    IMSA_IMS_DOMAIN_ENUM_UINT8               enConnRatType;      /* 域选的接入类型 */
    VOS_UINT8                               aucRsv[3];
...
/*****************************************************************************
 结构名    : IMSA_CONN_HO_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : IMSA_CONN_HO_REQ_STRU消息结构定义
*****************************************************************************/
 typedef struct
 {
     VOS_MSG_HEADER
     ...
     IMSA_CONN_TYPE_ENUM_UINT32              enConnType;/*Normal;Emc */

     IMSA_DOMAIN_SWITCH_TYPE_ENUM_UINT8      enConnHoType;/* 0:No switch;1:L2W_SWITCH;2:W2L_SWITCH */

     IMSA_IMS_DOMAIN_ENUM_UINT8               enConnRatType; /*NULL;WIFI;LTE;WIFI_LTE */
     VOS_UINT8                               enOrgPdnRlsFlag; /*  指定切换成功以后，原来域的PDN处理方式;
                                                                                                                  VOS_TRUE:  如果网侧没有释放，主动发起释放
                                                                                                                  VOS_FALSE:  切换完毕后，本地释放资源，不再与TAF APS/MAPCON发生信令交互 */
     VOS_UINT8                               aucRsv;

} IMSA_CONN_HO_REQ_STRU;


/*****************************************************************************
 结构名    : IMSA_CONN_HO_CNF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : IMSA_CONN_HO_CNF_STRU消息结构定义
*****************************************************************************/
typedef struct
{
     VOS_MSG_HEADER
     VOS_UINT32                              ulMsgId;            /* 消息ID */
     IMSA_CONN_RESULT_ENUM_UINT32            enHoResult;
     IMSA_CONN_TYPE_ENUM_UINT32              enConnType;/*Normal;Emc */
     IMSA_CONN_SIP_PDP_TYPE_ENUM_UINT32      enSipPdpType;   /*0信令，1数据*/
     IMSA_DOMAIN_SWITCH_TYPE_ENUM_UINT8      enConnHoType;/* 0:No switch;1:L2W_SWITCH;2:W2L_SWITCH */
...
typedef struct
{
    ...
    IMSA_IMS_DOMAIN_ENUM_UINT8               enConnRatType;      /* 域选的接入类型 */
    VOS_UINT8                                aucRsv[3];
    IMSA_CONN_MEDIA_PDP_TYPE_ENUM_UINT32     enRelMediaPdpType;       /* 用于标识释放媒体PDP类型,0 语音承载, 1 视频承载 */
...
typedef struct
{
    ...
    IMSA_CALL_NORM_SRV_EXTEND_INFO_ENUM_UINT32  enNormSrvExtendInfo;/**< 通知有服务时携带扩展信息 */
...
/*****************************************************************************
 结构名    : IMSA_DOMAIN_SRV_STATUS_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : IMSA_DOMAIN_SRV_STATUS_IND_STRU消息结构定义
*****************************************************************************/
...
typedef struct
{
    VOS_MSG_HEADER
    VOS_UINT32                                  ulMsgId;            /**< 消息Id */
    IMSA_DOMAIN_SERVICE_STATUS_ENUM_UINT32      enDomainSrvStatus;    /**<服务类型 */
    IMSA_DOMAIN_NO_SRV_CAUSE_ENUM_UINT32        enNoSrvCause;       /**< 通知无服务时指示原因  */
    IMSA_DOMAIN_MODE_ENUM_UINT8                 enCurrentDomain;    /* 当前驻留的域,只有Normal Service才使用 */
    VOS_UINT8                                   aucRsv[3];
} IMSA_DOMAIN_SRV_STATUS_IND_STRU;


/*****************************************************************************
 结构名    : IMSA_DOMAIN_SRV_READY_IND_STRU
 指定当前状态可以进行IMS域转换。
 协议表格  :
 ASN.1描述 :
 结构说明  : IMSA_DOMAIN_SRV_READY_IND_STRU消息结构定义
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    VOS_UINT32                                  ulMsgId;            /**< 消息Id */
} IMSA_DOMAIN_SRV_READY_IND_STRU;

/*****************************************************************************
 结构名    : IMSA_DOMAIN_SWITCH_RESULT_IND_STRU
 指定当前SWITCH已经完成。
 协议表格  :
 ASN.1描述 :
 结构说明  : IMSA_DOMAIN_SWITCH_RESULT_IND_STRU消息结构定义
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    VOS_UINT32                                  ulMsgId;            /**< 消息Id */
    IMSA_DOMAIN_SWITCH_TYPE_ENUM_UINT8          enSwitchType;       /*指定域切换类型 */
    IMSA_DOMAIN_SWITCH_RESULT_ENUM_UINT8        enSwitchResult;     /* 域转换的结果 */
    VOS_UINT8                                   aucRsv[2];
} IMSA_DOMAIN_SWITCH_RESULT_IND_STRU;



/*****************************************************************************
 结构名    : IMSA_DOMAIN_BEARER_REL_IND_STRU
 指定当前承载出现异常。
 协议表格  :
 ASN.1描述 :
 结构说明  : IMSA_DOMAIN_BEARER_REL_IND_STRU消息结构定义
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    VOS_UINT32                                  ulMsgId;            /**< 消息Id */
    IMSA_IMS_DOMAIN_ENUM_UINT8                   enNewPdnConnType;       /*  PDN类型 */
    VOS_UINT8                                   aucRsv[3];
} IMSA_DOMAIN_BEARER_REL_IND_STRU;
...
extern VOS_UINT32 IMSA_IsImsCallTransactionExist(VOS_VOID);
...
extern VOS_UINT32 IMSA_CONN_IsEmcConnExist(VOS_VOID);
...
extern VOS_UINT32 IMSA_RegAddrApMacAddr
(
    IMSA_REG_TYPE_ENUM_UINT8 ulRegType,
    IMSA_IMS_NW_ACCESS_TYPE_ENUM_UINT8 enNwAccessType,
    const VOS_CHAR *pacApMacAddr
);

extern VOS_VOID IMSA_SRV_DomainEnable
(
    IMSA_IMS_DOMAIN_ENUM_UINT8          enDomain
);

extern VOS_VOID IMSA_SRV_DomainDisable
(
    IMSA_IMS_DOMAIN_ENUM_UINT8          enDomain,
    VOS_UINT8                          ucOrignalPdnRlsFlag
);
...
extern IMSA_IMS_DOMAIN_ENUM_UINT8 IMSA_GetCurrentDomain(VOS_VOID);
extern VOS_VOID IMSA_SRV_SaveServiceChangeInd
(
...
/* IMSA不单独回复OCCUPY_CNF，当收到OCCUPY_REQ时才回复OCCUPY_CNF */
...
extern VOS_VOID IMSA_SRV_DeregProcReceivedUsimReadfileCnf
(
    VOS_VOID
);

extern VOS_VOID IMSA_SRV_RegProcReceivedUsimReadfileCnf
(
    VOS_VOID
);
...
extern VOS_UINT32 IMSA_IsVoiceCallWaitResReady(VOS_VOID);
