...
{
    ID_NAS_LPP_OM_MSG_ASN_FAIL              = 1,                             /* _H2ASN_MsgChoice NAS_LPP_ASN_FAIL_STRU */
    /* 定时器使用区间，需保留 */
    ...
    ID_NAS_LPP_OM_MTA_LOC_INFO_IND,                                                     /* _H2ASN_MsgChoice NAS_LPP_OM_MTA_LOC_INFO_CNF_STRU */
...
typedef struct
{
    ...
    VOS_UINT32                              ulGnssIndex;
    VOS_UINT32                              ulGnssId;

    VOS_UINT32                              ulSignalIndex;
    VOS_UINT32                              ulSignalID;
    VOS_UINT32                              ulGNSSCodePhaseAmbiguity;

    VOS_UINT32                              ulGNSSMeasListIndex;
    MTA_LPP_GNSS_SAT_MEAS_ELEMENT_STRU      stGNSSSatMeasList;
}NAS_LPP_OM_MTA_LOC_INFO_CNF_STRU;
...
extern VOS_VOID  NAS_LPP_OmMtaLocInfoCnf
(
