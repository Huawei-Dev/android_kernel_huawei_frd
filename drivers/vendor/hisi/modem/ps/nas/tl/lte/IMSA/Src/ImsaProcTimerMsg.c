...
const IMSA_TIMER_EVT_FUNC_TBL_STRU    g_astImsaTimerEvtFuncTbl[] =
{
    ...
    {TI_IMSA_WAIT_DEREG_TIMER,
        IMSA_ProcTimerMsgWaitDeregTimerExp},
    {TI_IMSA_WAIT_READFILE_CNF_TIMER,
        IMSA_ProcTimerMsgWaitReadfileCnfTimerExp},
    ...
    {TI_IMSA_CALL_NORMAL_TCALL,
        IMSA_CallProcTimeoutNormalTCall},
    ...
    {TI_IMSA_CALL_VEDIO_PDP_LOST_MODIFY_CALL,
        IMSA_CallProcTimeoutVideoMediaLost},
    {TI_IMSA_SMS_TR1M,
    ...
    {TI_IMSA_WAIT_WIFI_PDP_ACTIVE_CNF,
        IMSA_CONN_ProcTimerOutActiveCnf},
    {TI_IMSA_WAIT_WIFI_PDP_READY_IND,
        IMSA_CONN_ProcTimerOutReadyInd},
    {TI_IMSA_WAIT_WIFI_PDP_DEACTIVE_CNF,
        IMSA_CONN_ProcTimerOutDeactcnf},
    {TI_IMSA_DOMAIN_TIMER1_WIFI,
        VOS_NULL_PTR},
    {TI_IMSA_DOMAIN_TIMER1_LTE,
        VOS_NULL_PTR},
