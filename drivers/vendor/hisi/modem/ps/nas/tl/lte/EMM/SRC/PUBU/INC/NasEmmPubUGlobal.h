...
#define NAS_EMM_SET_XCC_MSG_HEADER(pMsg,MsgLenthNoHeader)\
        {\
            (pMsg)->ulSenderCpuId       = VOS_LOCAL_CPUID;\
            (pMsg)->ulSenderPid         = PS_PID_MM;\
            (pMsg)->ulReceiverCpuId     = VOS_LOCAL_CPUID;\
            (pMsg)->ulReceiverPid       = UEPS_PID_XCC;\
            (pMsg)->ulLength            = (MsgLenthNoHeader);\
        }
...
#define NAS_EMM_GetEmmInfoDamParaPlmnListAddr()      (&((NAS_EMM_GetEmmInfoDamParaAddr())->stDamPlmnList))
#define NAS_EMM_GetEmmInfoDamSwitchFlag()            ((NAS_EMM_GetEmmInfoDamParaAddr())->ucDamFlag)
...
#define NAS_LMM_GetDsdsOptimizeFlag()                    (g_DsdsOptimize)
#define NAS_LMM_GetSrlteFlag()                    (g_ulNasSrlteFlag)

#define NAS_LMM_GetT3402DefaultFlag()             (g_ulNasT3402DefaultFlag)
#define NAS_LMM_GetUiccResetClearFlag()            (g_ulUiccResetClearFlag)
...
extern VOS_UINT32                              g_DsdsOptimize;

extern VOS_UINT32                       g_ulNasSrlteFlag;

extern VOS_UINT32                              g_ulNasT3402DefaultFlag;

extern VOS_UINT32                       g_ulUiccResetClearFlag;
...
extern VOS_UINT32 NAS_EMM_IsNeedIgnoreAuthRej(VOS_VOID);
...
extern VOS_VOID NAS_EMM_SndRrmRegisterInd
(
    RRM_PS_TASK_TYPE_ENUM_UINT16       enTaskType
);
extern VOS_UINT32 NAS_EMM_IsSupportSrlte(VOS_VOID);
extern VOS_VOID  NAS_LMM_WritePsLocForUiccReset
(
    NAS_NV_ITEM_OP_TYPE_ENUM_UINT32     enOpType
);
