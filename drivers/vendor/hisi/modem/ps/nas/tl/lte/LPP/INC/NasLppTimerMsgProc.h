...
extern VOS_VOID  NAS_LPP_RcvModemOrigWaitGnssLocCnfTimer( VOS_UINT8 ucSessionIndx,VOS_UINT8 ucSessionTransIndx , VOS_UINT8 ucUpReqTechType, VOS_VOID *pRcvMsg);
/*****************************************************************************
  9 OTHERS
*****************************************************************************/
