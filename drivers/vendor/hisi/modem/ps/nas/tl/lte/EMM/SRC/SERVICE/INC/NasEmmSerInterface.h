...
enum    NAS_EMM_XCC_CALL_FLAG_ENUM
{
    NAS_EMM_XCC_CALL_FLAG_INVALID     = 0,
    NAS_EMM_XCC_CALL_FLAG_VALID       = 1,

    NAS_EMM_XCC_CALL_FLAG_VALID_BUTT
};
typedef VOS_UINT8  NAS_EMM_XCC_CALL_FLAG_ENUM_UINT8;
enum    NAS_EMM_XCC_ESR_FLAG_ENUM
{
    NAS_EMM_XCC_ESR_FLAG_INVALID     = 0,
    NAS_EMM_XCC_ESR_FLAG_VALID       = 1,

    NAS_EMM_XCC_ESR_FLAG_VALID_BUTT
};
typedef VOS_UINT8  NAS_EMM_XCC_ESR_FLAG_ENUM_UINT8;

enum    NAS_EMM_ESR_CAUSE_TYEP_ENUM
{
    NAS_EMM_ESR_CAUSE_TYPE_CL_CALL        = 0,
    NAS_EMM_ESR_CAUSE_TYPE_GUL_CALL       = 1,

    NAS_EMM_ESR_CAUSE_TYPE_BUTT
};
typedef VOS_UINT8  NAS_EMM_ESR_CAUSE_TYEP_ENUM_UINT8;
