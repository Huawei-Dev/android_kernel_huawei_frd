...
VOS_VOID NAS_EMM_SndCommonProcedureFailRestartEmmProcess(VOS_VOID)
{
    ...
    switch(NAS_EMM_CUR_MAIN_STAT)
    {
        ...
        case EMM_MS_DEREG_INIT:
            ...
            break;
        case EMM_MS_REG:
            if(EMM_SS_REG_IMSI_DETACH_WATI_CN_DETACH_CNF == enSubState)
            {
                NAS_LMM_StopStateTimer(     TI_NAS_EMM_T3421);
        ...
        case EMM_MS_SER_INIT:
            ...
            break;
        default:
            NAS_EMM_PUBU_LOG_INFO(" NAS_EMM_SndCommonProcedureFailRestartEmmProcess enter");
            TLPS_PRINT2LAYER_INFO(NAS_EMM_SndCommonProcedureFailRestartEmmProcess_ENUM,LNAS_FUNCTION_LABEL2);
            break;
    }
    ...
    *pulIsDelBuff = VOS_TRUE;
    ...
    switch (pstRrcMmDataCnf->enSendRslt)
    {
        ...
        case LRRC_LMM_SEND_RSLT_FAILURE_RLF:
            NAS_EMM_SndCommonProcedureFailRestartEmmProcess();
            break;
