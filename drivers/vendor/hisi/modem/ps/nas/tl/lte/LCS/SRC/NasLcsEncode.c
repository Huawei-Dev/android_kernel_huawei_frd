...
)
{
    ...
    *pusIeLen = 0;
    ...
    /* 编码信元mo-lr */
    (VOS_VOID)NAS_LCS_EncodeMolrType(pucEncodeOutMsg + usSum, &usTmpLen, NAS_LCS_MOLR_ASSISTANCE_DATA);
    usSum = usSum + usTmpLen;
...
)
{
    ...
    *pusIeLen = 0;
    ...
    /* 编码信元mo-lr type */
    (VOS_VOID)NAS_LCS_EncodeMolrType(pucEncodeOutMsg + usSum, &usTmpLen, NAS_LCS_MOLR_LOCATION_ESTIMATE);
    usSum = usSum + usTmpLen;
    ...
    /* 编码LCS QOS */
    (VOS_VOID)NAS_LCS_EncodeLcsQos(pucEncodeOutMsg + usSum, &usTmpLen, pstMolrPara);
    usSum = usSum + usTmpLen;

    (VOS_VOID)NAS_LCS_EncodeClentExtId(pucEncodeOutMsg + usSum, &usTmpLen, pstMolrPara);
    usSum = usSum + usTmpLen;

    /* 编码信元SupportGADShapes */
    (VOS_VOID)NAS_LCS_EncodeSuppGADShapes(pucEncodeOutMsg + usSum, &usTmpLen, pstMolrPara);
    usSum = usSum + usTmpLen;
