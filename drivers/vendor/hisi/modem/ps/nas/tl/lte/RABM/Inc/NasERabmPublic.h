...
/*****************************************************************************
    枚举名    : NAS_ERABM_XCC_CALL_FLAG_ENUM
    枚举说明  : XCC CALL状态:没有电话，有电话
*****************************************************************************/
enum    NAS_ERABM_XCC_CALL_FLAG_ENUM
{
    NAS_ERABM_XCC_CALL_FLAG_INVALID     = 0,
    NAS_ERABM_XCC_CALL_FLAG_VALID       = 1,

    NAS_ERABM_XCC_CALL_FLAG_VALID_BUTT
};

typedef VOS_UINT32   NAS_ERABM_XCC_CALL_FLAG_ENUM_UINT32;
...
extern NAS_ERABM_XCC_CALL_FLAG_ENUM_UINT32     g_ulErabmXccCallFlg;

#define   NAS_ERABM_GetXccCallFlg()                  (g_ulErabmXccCallFlg)
#define   NAS_ERABM_SetXccCallFlg(enXccCallFlg)  (NAS_ERABM_GetXccCallFlg() = (enXccCallFlg))
