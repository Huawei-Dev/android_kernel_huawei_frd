...
#define IMSA_MAX_SIPURI_LEN                     (128)
...
#define IMSA_CONN_RNIC_ID_MAX_NUM               (11)
#define IMSA_VOICE_QCI                          (1)
#define IMSA_VIDEO_QCI                          (2)

#define WUEPS_PID_MAPCON                        (0x1FF)
...
/*****************************************************************************
 枚举名    : IMSA_CONN_STATUS_ENUM_UINT8
 结构说明  : UE的链接状态类型
*****************************************************************************/
...
enum IMSA_CONN_PDN_HO_STATE_ENUM
{
    IMSA_CONN_PDN_HO_STATE_IDLE               = 0,            /**< 不存在切换 */
    IMSA_CONN_PDN_HO_STATE_HOING              = 1,            /**< 正在进行切换 */
    IMSA_CONN_PDN_HO_STATE_AFTER_HOSUCC       = 2,            /**< 切换成功后处理 */
    IMSA_CONN_PDN_HO_STATE_AFTER_HOFAIL       = 3,            /**< 切换失败后处理 */
    IMSA_CONN_PDN_HO_STATE_BUTT
};
typedef VOS_UINT8  IMSA_CONN_PDN_HO_STATE_ENUM_UINT8;
...
/*****************************************************************************
 枚举名    : IMSA_REALISIM_STATE_ENUM
 结构说明  : 识别插入的是ISIM卡还是USIM卡
*****************************************************************************/
enum IMSA_REALISIM_STATE_ENUM
{
    IMSA_REALISIM_STATE_OFF             = 0,            /* USIM模拟ISIM */
    IMSA_REALISIM_STATE_ON              = 1,            /* 真实ISIM */
    IMSA_REALISIM_STATE_BUTT
};

typedef VOS_UINT8 IMSA_REALISIM_STATE_ENUM_UINT8;
...
enum IMSA_NRM_SRV_CON_SAT_STATUE_ENMUM
{
    ...
    IMSA_NRM_SRV_CON_SAT_STATUE_FAIL_CONN_FORBIDDEN      = 7,    /**< 不满足获取普通服务的条件, 原因为IMS信令承载建立被禁 */
...
enum IMSA_SRV_STATUS_ENUM
{
   ...
   IMSA_SRV_STATUS_HO_DEREG             = 0x40,    /**< HO&DEREG */
   IMSA_SRV_STATUS_HO_REG               = 0x41,    /**< HO&REG */
...
/*****************************************************************************
    枚举名    : IMSA_VIDEO_CALL_MODIFY_SOURCE_ENUM
    枚举说明  : 视频电话降语音的发起模块
*****************************************************************************/
enum IMSA_VIDEO_CALL_MODIFY_SOURCE_ENUM
{
    IMSA_VIDEO_CALL_MODIFY_SOURCE_NONE = 0,
    IMSA_VIDEO_CALL_MODIFY_SOURCE_SPM  = 1,
    IMSA_VIDEO_CALL_MODIFY_SOURCE_IMSA = 2,
    IMSA_VIDEO_CALL_MODIFY_SOURCE_IMS  = 3,

    IMSA_VIDEO_CALL_MODIFY_SOURCE_BUTT
};
typedef VOS_UINT8 IMSA_VIDEO_CALL_MODIFY_SOURCE_ENUM_UINT8;

/*****************************************************************************
    枚举名    : IMSA_VIDEO_BEARER_LOST_STATE_ENUM
    枚举说明  : 视频电话降语音的发起模块
*****************************************************************************/
enum IMSA_VIDEO_BEARER_LOST_STATE_ENUM
{
    IMSA_VIDEO_BEARER_LOST_STATE_NONE     = 0,
    IMSA_VIDEO_BEARER_LOST_WAIT_TIMER_OUT = 1,
    IMSA_VIDEO_BEARER_LOST_WAIT_IMS_OK    = 2,

    IMSA_VIDEO_BEARER_LOST_STATE_BUTT
};
typedef VOS_UINT8 IMSA_VIDEO_BEARER_LOST_STATE_ENUM_UINT8;
...
typedef struct
{
    ...
    IMSA_IMS_NW_ACCESS_TYPE_ENUM_UINT8  enNwAccessType;       /* 保存WIFI网络的类型 */
    VOS_CHAR                            acApMacAddr[IMSA_IMS_AP_MAC_LEN+1];  /* 保存MAC地址 */
    VOS_CHAR                            aucRsv2[2];
...
typedef struct
{
    ...
    VOS_UINT8                           ucNwRejReRegCtrl;       /**< 网侧notify事件中携带reject时，需要重新注册的开关 */
    VOS_UINT8                           ucNwDeactiveReRegCtrl;  /**< 网侧notify事件中携带deactive时，需要重新注册的开关 */
    VOS_UINT8                           aucRsv[2];
    VOS_UINT32                          ulNwDeactReRegTimerLen; /**< 网侧去注册UE后，重新发起注册时间间隔，单位为s */
...
typedef struct
{
    ...
    VOS_UINT8                           ucVolteCtrlVowifiFlag;
...
typedef struct
{
    ...
    IMSA_REALISIM_STATE_ENUM_UINT8       enISIMState;               /* 用于识别是模拟ISIM还是真实ISIM*/
    VOS_UINT8                            aucRsv[3];
...
typedef struct
{
    ...
    VOS_UINT8                           ucEncryptFlag;          /**< 是否支持语音加密 */
    VOS_UINT8                           ucNonSrvccRatChgFlag;

    IMSA_CALL_ECONF_SUMMARY_STRU        stEconfCalllist[IMSA_IMS_ECONF_CALLED_MAX_NUM];    /* 增强多方通话的成员列表 */

    VOS_UINT8                           ucInviteUnSendFlag;      /* 0 = have send invite,1 = have not send invite */
    VOS_CHAR                            acDisplayName[IMSA_IMS_DISPLAY_NAME_STRING_SZ + 1]; /* 保存Display name */
    VOS_UINT8                           aucRsv2[2];
...
typedef struct
{
    VOS_UINT8                               ucNonRegRejFeatureFlag; /* 非注册被拒特性控制开关 */
    VOS_UINT8                               aucRsv[3];
    IMSA_NV_NON_REG_REJ_CAUSE_LIST_STRU     stNonRegRejCauseList;   /* 非注册被拒原因值列表 */
}IMSA_NON_REG_REJ_CTRL_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                           ucACBFlag;              /**< F项目ACB Enabled时CSFB的开关 */

    IMSA_VIDEO_BEARER_LOST_STATE_ENUM_UINT8   enVideoLostModCallTypeSta;
    IMSA_VIDEO_CALL_MODIFY_SOURCE_ENUM_UINT8  enVideoCallModifySource;
    ...
    IMSA_TIMER_STRU                     stVideoPdpLostModifyCallTimer; /* 视频承载被释放后, 主动把视频降语音定时器 */

    IMSA_NON_REG_REJ_CTRL_STRU          stNonRegRejCtrl;        /* 非注册被拒定制原因值列表 */
...
typedef struct
{
    VOS_UINT8                           ucNvReadSipUriFlag;     /* 记录NV配置的是否需要读取到了卡中的Sip Uri的标志 */
    VOS_UINT8                           ucReadSipUriFlag;       /* 记录是否读取到了卡中的Sip Uri的标志      */
    VOS_CHAR                            acSipUri[IMSA_IMS_ALPHA_STRING_SZ+1];  /* 从卡中读到的SIP URI       */
    VOS_UINT8                           ucRsv;
}IMSA_SMS_SIP_URI_STRU;

typedef struct
{
   VOS_UINT8   ucWifiImsSupportFlag;         /* WIFI IMS使能项：TRUE:支持；FALSE：不支持 */
   ...
   VOS_UINT8   ucVolteCtrlVowifiFlag;        /*不支持VoLTE则不支持VoWifi: TRUE，如果不支持VoLTE能力的LTE网络，则不支持VoWIFI；FALSE: LTE网络是否具备VoLTE能力与是否支持VoWIFI无关 */
...
typedef struct
{
  ...
  IMSA_PS_SERVICE_STATUS_ENUM_UINT8     enImsaPsServiceStatus;      /**< 当前网络的PS服务状态:无服务,受限服务,正常服务 */
  VOS_UINT8                             ucRcv[3];
  IMSA_WIFI_AP_MAC_STRU                 stApMac1;  /* MAC1是已配给SDK的，初始从IMS_PDN_ACTIVATE_CNF获得 */
  IMSA_WIFI_AP_MAC_STRU                 stApMac2;  /* MAC2是当前测量的AP MAC，从WIFI信号质量里获得 */
} IMSA_WIFI_NETWORK_INFO_STRU;
...
{
/**************************** 双模域选择和域转换处理*****************************/
  IMSA_IMS_DOMAIN_PREFR_CFG_ENUM_UINT8  enImsDomainPrefer;    /* 指定优先IMS域的设置 */
  IMSA_IMS_DOMAIN_ENUM_UINT8                  enImsaAvailDomain;    /* 指定可用的Domain:驻留网络是否可用 */
  IMSA_IMS_DOMAIN_ENUM_UINT8                  enImsaTryedDomain;  /* 指定已经尝试接入过的Domain */
  IMSA_IMS_VOLTECTRLVOWIFI_ENUM_UINT8        enImsaVolteCtrlVowifiStatus;  /* VoLTE控制VoWIFI的状态标识 */
  VOS_UINT8                             ucLteQualityCfgFlag;  /* true/false */
  IMSA_WIRELESS_QUALITY_LEVEL_ENUM_INT8     enWifiQuality;        /* Wifi信号强度 */
  IMSA_WIRELESS_QUALITY_LEVEL_ENUM_INT8     enLteQuality;         /* LTE信号强度 */
  IMSA_DOMAIN_FSM_L2_STATE_NUM_UINT8    enDomainFsmL2State;    /* 指定域转换状态 */

  VOS_UINT32                            ulCurrentSenderPid;         /* 指定当前处理消息的来源 */
  VOS_UINT32                            ulCurrentMsgId;             /* 指定当前处理消息ID */
  VOS_UINT8                             ucMsgDelayProcessFlag;      /* 指定当前处理是否需要延迟： FALSE 不延迟处理; TRUE 延迟处理 */
  VOS_UINT8                             ucHoFailReturn2OrgPdnFlag;  /* 切换失败以后是否可以回到原来PDN: FALSE 不能回到原域; TRUE 可以回到原域 */
  VOS_UINT8                             ucOrgPdnRlsFlag;            /* 域切换成功以后是否需要释放原域的PDN: FALSE 不需要释放； TRUE 释放 */
  VOS_UINT8                             ucDomainSelectFlag;         /* 指示是否发生了域选行为:TRUE, 发生域选行为; FALSE: 没有发生域选行为;指示收到Ready_ind消息是否已经发起了域操作,使用同样的标识 */

//  IMSA_DOMAIN_SWITCH_C1_STRU             stDomainSwitchC1; /* 域选择先决条件判断 */
//  IMSA_DOMAIN_SWITCH_C2_STRU             stDomainSwitchC2; /* 域选择判决算法 */

  IMSA_TIMER_STRU                       stTimer1WifiDomain;        /* 用于控制WIFI域的惩罚定时器 */
  IMSA_TIMER_STRU                       stTimer1LteDomain;         /* 用于控制LTE域的惩罚定时器 */
  VOS_UINT8                             ucInitTimer1Len;           /* 初始Timer1的时长，单位为秒 */
  VOS_UINT8                             ucMaxTimer1Len;            /* 最大的Timer1的时长，单位为秒　*/
  VOS_UINT8                             ucPunishTimeInWifiDomain;     /* WIFI域选失败惩罚时间倍数　*/
  VOS_UINT8                             ucPunishTimeInLteDomain;      /* LTE域选失败惩罚时间倍数　*/
// 定义触发域选择或者域切换的事件
  VOS_UINT32                            bitWifiPowerOffEvent:1;
  VOS_UINT32                            bitWifiQualityEvent:1;
  VOS_UINT32                            bitLteQualityEvent:1;
  VOS_UINT32                            bitPeriodTimerEvent:1;
  VOS_UINT32                            bitDomainCfgEvent:1;
  VOS_UINT32                            bitServiceChangeIndEvent:1;
  VOS_UINT32                            bitRsvTrigDelayEvent:27;


}IMSA_DOMAIN_MANAGER_STRU;
...
typedef struct
{
    ...
    IMSA_STATUS_ENUM_UINT8            enImsaCellularStatus; /* Cellular开关机状态:未开机、开机过程中、已开机、关机过程中 */
    IMSA_STATUS_ENUM_UINT8            enImsaWifiStatus;     /* WIFI开关机状态:未开机、开机过程中、已开机、关机过程中 */
    IMSA_DOMAIN_MODE_ENUM_UINT8        enImsaDomainMode;           /* 指定整机开机域模式：结合NV值和开关机状态确认整机开机域模式 */
/* 指定UE Domain能力:从NV值获得 */
    VOS_UINT8                         bitCapImsDomainWifi:1;   /* 0 不支持，1支持 */
    VOS_UINT8                         bitCapImsDomainLTE:1;    /* 0 不支持，1支持 */
    VOS_UINT8                         bitCapImsDomainGSM:1;    /* 0 不支持，1支持 */
    VOS_UINT8                         bitCapImsDomainUtran:1;  /* 0 不支持，1支持 */
    VOS_UINT8                         bitCapImsDomainRsv:4;      /* 保留 */

    VOS_UINT8                         ucInternalImsStackStartFlag; /* 指示是否是由于内部消息启动IMS Stack */
    VOS_UINT8                         ucRcvServiceChangeIndFlag;   /* 0:没有受到; 1:收到消息 */

    /* 用于域切换时的SRV内部状态判决 */
    IMSA_DOMAIN_MODE_ENUM_UINT8       enImsaSrvCurrentDomain;      /* 指定SRV内部保存的当前域状态，用于切换过程中，Domain处于切换过程中，但是SRV已经完成切换时的域判决 */
    IMSA_DOMAIN_SWITCH_TYPE_ENUM_UINT8 enSwitchType;               /*　记录切换类型 */
    VOS_UINT8                         ucHoFailReturn2OrgPdnFlag;   /* 切换失败以后是否可以回到原来PDN: FALSE 不能回到原域; TRUE 可以回到原域 */
    VOS_UINT8                         ucOrgPdnRlsFlag;             /* 域切换成功,disable域以后是否需要释放原域的PDN: FALSE 不需要释放； TRUE 释放 */
    /*增加保留字节，结构体对齐*/
    VOS_UINT8                         ucReserve;
    IMSA_DOMAIN_MANAGER_STRU           stImsaDomainManager;   /* 双域管理：域选择，域转换  */
    VOS_UINT8                         ucDomainRegSrvStatusFlag;    /* 指定Domain是否注册了SRV状态事件，如果注册，SRV进入CONN&REG, CONN&DEREG会上报事件给Domain */
    ...
    /* 新增加的VoWIFI NV控制参数和网络参数单元 -> 开始 */
    IMSA_VOWIFI_PARA_STRU                stVowifiPara;      /** VoWIFI 参数配置 */
    IMSA_WIFI_NETWORK_INFO_STRU          stWifiNetInfo;      /** Wifi 网络环境参数 */
    /* 新增加的VoWIFI NV控制参数和网络参数单元 -> 结束 */
    ...
    IMSA_TIMER_STRU                     stWaitDeregTimer;    /**< 等待IMS去注册结果定时器 */
    IMSA_TIMER_STRU                     stWaitReadfileCnfTimer; /**< 等待读卡结果定时器 */
    ...
    VOS_UINT8                          ucNoRegEmcCallFlag;           /**< 记录是否在进行无卡紧急呼流程 */
    VOS_UINT8                           ucIsImsConnForbidden;/**< 用于记录LTE IMS信令承载建立是否被禁, 0:不禁止; 1:禁止 */
    VOS_UINT8                           ucPsServStatusChangeFlag;/*用于记录当前服务状态是否发生由非normal service到Normal service的服务变更，0:发生，1:未发生*/
    ...
    VOS_UINT8                           ucAreaLostNotRelCallFlag;      /**< 丢网后主动挂断电话的NV,VOS_TRUE:挂断*/
    VOS_UINT8                           ucMediaLostNotRelCallFlag;     /**< 媒体承载释放后挂断电话的NV，VOS_TRUE:挂断 */
    VOS_UINT8                           ucNonSrvccNotRelCallFlag;       /**< 非SRVCC得异系统变化导致的挂断电话*/

    IMSA_SMS_SIP_URI_STRU               stImsaSipUri;

    VOS_UINT8                           ucTempForbExpDelayTimeLen;
    VOS_UINT8                           auRsv[3];
    VOS_UINT8                           ucUeImsSmsCapInitRegFlag;        /* 网侧不支持IMS语音时，短信触发IMS注册的开关*/
    VOS_UINT8                           aucRsv[3];
...
typedef struct
{
    ...
    VOS_UINT8                           ucRnicId;           /**< 与此承载关联的IMS网卡号，LTE下初始分配与PdpId关联，切换承载建立时，IP地址不变，使用WIFI配置的标识*/
...
/*****************************************************************************
 结构名称: IMSA_WIFI_PDP_CNTXT_INFO_STRU
 结构说明: WIFI下承载信息
*****************************************************************************/
typedef struct
{
    IMSA_PDP_STATE_ENUM_UINT8           enPdpState;         /**< 承载状态 */
    IMSA_WIFI_IP_TYPE_ENUM_INT8         enPdnType;          /**< 承载IP类型 */
    VOS_UINT8                           ucIsEmergency;      /**< 0:非紧急承载； 1:紧急 */
    VOS_UINT8                           ucRnicId;           /**< 与此承载关联的IMS网卡号，切换承载建立时，IP地址不变，使用LTE配置的标识,[0,10] */

    IMSA_WIFI_IP_ADDRESS_STRU           stPdpAddr;          /**< 承载IP地址 */
    IMSA_WIFI_PDP_APN_STRU              stApn;              /**< 承载APN信息 */

    IMSA_WIFI_PDP_IPV4_DNS_STRU         stPdpIpv4Dns;       /**< 承载IPV4 DNS信息 */
    IMSA_WIFI_PDP_IPV4_PCSCF_STRU       stPdpIpv4Pcscf;     /**< 承载IPV4 P-CSCF信息 */
    IMSA_WIFI_PDP_IPV6_DNS_STRU         stPdpIpv6Dns;       /**< 承载IPV6 DNS信息 */
    IMSA_WIFI_PDP_IPV6_PCSCF_STRU       stPdpIpv6Pcscf;     /**< 承载IPV6 P-CSCF信息 */

    IMSA_WIFI_AP_MAC_STRU               stApMac;            /**< wifi MAC地址 */

}IMSA_WIFI_PDP_CNTXT_INFO_STRU;
...
/*****************************************************************************
 结构名    : IMSA_WIFI_NORMAL_CONN_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : WIFI的链接管理上下文
*****************************************************************************/
typedef struct
{
    ...
    IMSA_TIMER_STRU                     stWaitActiveCnf;    /**< 等待激活响应的定时器 */
    IMSA_TIMER_STRU                     stWaitReadyInd;     /**< 等待ReadyInd的定时器 */
    IMSA_TIMER_STRU                     stWaitDeactiveCnf;  /**< 等待去激活响应的定时器 */
    IMSA_SEL_SDF_PARA_STRU              stSelSdfPara;       /**< 选中拨号的SDF信息 */

    IMSA_WIFI_PDP_CNTXT_INFO_STRU       stSipSignalPdp;     /**< SIP信令承载信息 */

}IMSA_WIFI_NORMAL_CONN_STRU;

typedef struct
{
    VOS_UINT8                           ucRnicId;            /**< RNIC承载号 */
    VOS_UINT8                           ucPdpId;            /**< 承载号 */
    VOS_UINT8                           ucWifiPdnId;         /* WIFI PDN ID */
    IMSA_IMS_DOMAIN_ENUM_UINT8          enPdnConnType;       /* PDN类型 */
...
typedef struct
{
    IMSA_CONN_PDN_HO_STATE_ENUM_UINT8    enPdnHoState; /* 0:没有切换；1:正在切换；2：切换成功后处理; 3:切换失败后处理 */
    IMSA_IMS_HO_TYPE_ENUM_UINT8          enPdnHoType; /* 切换类别：1: L2W; 0: W2L；0xFF：初始值 */
    IMSA_IMS_DOMAIN_ENUM_UINT8            enNewPdnConnType; /* 新域PDN类型 */
    VOS_UINT8                            ucOriginalDomainPdnRlsFlag; /* 指定切换成功以后，原来域的PDN处理方式：VOS_TRUE: 如果网络侧没有释放，主动发起释放；VOS_FALSE: 切换完毕，本地释放资源，不再与TAF APS/MAPCON发生信令交互 */
    VOS_UINT8                            ucNewSignalPdnSetupEvent; /* 指示是否收到切换域信令PDN建立指示：VOS_FALSE:没有收到指示；VOS_TRUE：已经收到指示；FF：初始值，没有设置标志 */
    VOS_UINT8                            ucNewVoicePdnSetupEvent;  /* 指示是否收到切换域语音PDN建立指示：VOS_FALSE:没有收到指示；VOS_TRUE：已经收到指示；FF：初始值，没有设置标志*/
    VOS_UINT8                            ucNewVideoPdnSetupEvent;  /* 指示是否收到切换域视频PDN建立指示：VOS_FALSE:没有收到指示；VOS_TRUE：已经收到指示；FF：初始值，没有设置标志*/
    VOS_UINT8                            ucOldPdnRelIndEvent; /* 指定是否收到原域PDN释放指示：VOS_FALSE没有收到指示；VOS_TRUE：已经收到指示；FF：初始值，没有设置标志*/
    VOS_UINT32                          ulSipSignalPdpNum;  /**< SIP信令承载数 */
    union
    {
        IMSA_PDP_CNTXT_INFO_STRU            astSipSignalPdpArray[IMSA_CONN_MAX_NORMAL_SIP_SIGNAL_PDP_NUM];  /**< SIP信令承载信息 */
...
typedef struct
{
    ...
    IMSA_WIFI_NORMAL_CONN_STRU          stWifiNormalConn;   /**< WIFI下的普通链接 */
    IMSA_CONN_HO_EVENT_STRU             stConnHoEvent;
...
{
    IMSA_VOICE_RTP_RX_DATA_IND_STRU           *pstRxRtpDataInd;        /* 缓存的发送给HIFI的语音包 */
...
/*****************************************************************************
 结构名称   :IMSA_NON_REG_REJ_NV_INFO_STRU
 协议表格   :
 ASN.1 描述 :
 结构说明   :非注册流程 NV配置可维可测
*****************************************************************************/
typedef struct
{
    ...
    IMSA_NON_REG_REJ_CTRL_STRU              stNonRegRejCtrl;
}IMSA_NON_REG_REJ_NV_INFO_STRU;
...
typedef struct
{
    VOS_MSG_HEADER
    VOS_UINT32                              ulMsgId;
    VOS_UINT32                              ulNvReadResult;

    IMSA_NV_IMS_RAT_SUPPORT_STRU            stNvRatSupport;
}IMSA_RAT_SUPPORT_NV_INFO_STRU;

/*****************************************************************************
 结构名称   :IMSA_IMSA_CONFIG_NV_INFO_STRU
 协议表格   :
 ASN.1 描述 :
 结构说明   :非注册流程 NV配置可维可测
*****************************************************************************/
...
/*****************************************************************************
 结构名称   :IMSA_OM_NO_REG_CAUSE_INFO
 协议表格   :
 ASN.1 描述 :
 结构说明   :不发起注册原因可维可测
*****************************************************************************/
typedef struct
{
    ...
    VOS_UINT8                                   aucRsv[3];
}IMSA_OM_NO_REG_CAUSE_INFO;

/*****************************************************************************
 结构名称   :IMSA_OM_SERVICE_STATE_CHANGE_INFO
 协议表格   :
 ASN.1 描述 :
 结构说明   :服务状态可维可测
*****************************************************************************/
typedef struct
{
    ...
    VOS_UINT8                                   ucRsv;
}IMSA_OM_SERVICE_STATE_CHANGE_INFO;
...
#define IMSA_CONN_GetHoEventAddr()          (&pgstImsaEntity->stImsaConnManager.stConnHoEvent)
...
#define IMSA_CONN_GetWifiNormalConnAddr()   (&pgstImsaEntity->stImsaConnManager.stWifiNormalConn)
#define IMSA_CONN_GetWifiNormalConnStatus() (IMSA_CONN_GetWifiNormalConnAddr()->enImsaConnStatus)
#define IMSA_CONN_GetWifiNormalConnSelSdfParaAddr()   (&(IMSA_CONN_GetWifiNormalConnAddr()->stSelSdfPara))
...
#define IMSA_GetWifiNetInfoAddress()        (&pgstImsaEntity->stImsaControlManager.stWifiNetInfo)
...
#define IMSA_GetWifiPsServiceStatus()           (pgstImsaEntity->stImsaControlManager.stWifiNetInfo.enImsaPsServiceStatus)


#define IMSA_GetIsimStatus()                (pgstImsaEntity->stImsaControlManager.enImsaIsimStatus)
#define IMSA_SetDeregCause(DeregCause)    (pgstImsaEntity->stImsaControlManager.enDeregCause = (DeregCause))
...
#define IMSA_SetIsImsConnForbiddenFlag(ucIsConnForbidden)  (pgstImsaEntity->stImsaControlManager.ucIsImsConnForbidden = (ucIsConnForbidden))
#define IMSA_GetIsImsConnForbiddenFlag()                   (pgstImsaEntity->stImsaControlManager.ucIsImsConnForbidden)

#define IMSA_GetWifiNetInfoAddress()        (&pgstImsaEntity->stImsaControlManager.stWifiNetInfo)
#define IMSA_GetVoWifiParaAddress()         (&pgstImsaEntity->stImsaControlManager.stVowifiPara)

#define IMSA_GetDomainMode()                (pgstImsaEntity->stImsaControlManager.enImsaDomainMode)
#define IMSA_SetDomainMode(enDomainMode)    (pgstImsaEntity->stImsaControlManager.enImsaDomainMode) = (enDomainMode)
...
#define IMSA_GetWifiImsSupportFlag()               (pgstImsaEntity->stImsaControlManager.stImsaConfigPara.ucWifiImsSupportFlag)

#define IMSA_Domain_GetDomainManagerAddr()  (&pgstImsaEntity->stImsaControlManager.stImsaDomainManager)

#define IMSA_GetHoSupportInNonActSrvFlag()    (pgstImsaEntity->stImsaControlManager.stVowifiPara.ucHoSupportInNonActSrvFlag)
#define IMSA_GetHoSupportInUnstableSrvFlag()  (pgstImsaEntity->stImsaControlManager.stVowifiPara.ucHoSupportInUnstableSrvFlag)
#define IMSA_GetL2WHoInActSrvFlag()           (pgstImsaEntity->stImsaControlManager.stVowifiPara.ucL2WHoInActSrvFlag)
#define IMSA_GetW2LHoInActSrvFlag()           (pgstImsaEntity->stImsaControlManager.stVowifiPara.ucW2LHoInActSrvFlag)
#define IMSA_GetVolteCtrlVoWifiFlag()         (pgstImsaEntity->stImsaControlManager.stImsaConfigPara.ucVolteCtrlVowifiFlag)

#define IMSA_GetPowerState()                (pgstImsaEntity->stImsaControlManager.enPowerState)

#define IMSA_SRV_GetNoRegEmcFlag()         (pgstImsaEntity->stImsaControlManager.ucNoRegEmcCallFlag)

#define IMSA_GetUeSmsCapInitRegFlag()       (pgstImsaEntity->stImsaControlManager.ucUeImsSmsCapInitRegFlag)
...
#define IMSA_REG_GetNwRejReRegCtrl()        (pgstImsaEntity->stImsaRegManager.ucNwRejReRegCtrl)
#define IMSA_REG_GetNwDeactiveReRegCtrl()   (pgstImsaEntity->stImsaRegManager.ucNwDeactiveReRegCtrl)

/* 新增入参 */
#define IMSA_SRV_SndCallSrvStatusInd(enSrvType, enCallSrvStatus,enNoSrvCause,enNormSrvExtInfo)\
    {\
        if (IMSA_SRV_TYPE_NORMAL == (enSrvType))\
        {\
            IMSA_SRV_SndNrmCallSrvStatusInd((enCallSrvStatus),(enNoSrvCause),(enNormSrvExtInfo));\
        }\
        else\
        {\
...
#define IMSA_SMS_GetSipUriEntityAddress()   (&pgstImsaEntity->stImsaControlManager.stImsaSipUri)
...
#define IMSA_GetImsDomainPrefer()           (pgstImsaEntity->stImsaControlManager.stImsaDomainManager.enImsDomainPrefer)
