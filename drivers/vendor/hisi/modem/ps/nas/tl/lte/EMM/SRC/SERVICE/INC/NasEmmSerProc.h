...
#define NAS_EMM_SER_GetXccEsrFlg()                      (g_stEmmSERCtrlTbl.enXccEsrFlg)
#define NAS_EMM_SER_SaveXccEsrFlg(XccEsrFlg)            ( NAS_EMM_SER_GetXccEsrFlg() = (XccEsrFlg))
#define NAS_EMM_SER_GetXccCallOpid()                    (g_ulXccCallOpid)
#define NAS_EMM_SER_SaveXccCallOpid(ulOpid)             ( NAS_EMM_SER_GetXccCallOpid()  = (ulOpid))
#define NAS_EMM_SER_GetXccCallFlg()                     (g_stEmmSERCtrlTbl.enXccCallFlg)
#define NAS_EMM_SER_SaveXccCallFlg(XccCallFlg)          ( NAS_EMM_SER_GetXccCallFlg() = (XccCallFlg))
/*****************************************************************************
  3 Massage Declare
*****************************************************************************/
...
typedef struct
{
    ...
    NAS_EMM_XCC_ESR_FLAG_ENUM_UINT8         enXccEsrFlg;
    NAS_EMM_XCC_CALL_FLAG_ENUM_UINT8        enXccCallFlg;
...
extern VOS_UINT16        g_ulXccCallOpid;
/*****************************************************************************
  8 Fuction Extern
*****************************************************************************/
...
extern VOS_UINT32  NAS_EMM_MsRegPreProcXccCallStartNtfMsg( VOS_VOID);
extern VOS_UINT32 NAS_EMM_PreProcXccCallStartNtf(MsgBlock  *pMsg);
extern VOS_UINT32 NAS_EMM_MsRegSsNormalOrAttemptUpdateMmMsgXccCallStartNtf
(
    VOS_UINT32                          ulMsgId,
    VOS_VOID                           *pMsgStru
);
extern VOS_UINT32 NAS_EMM_MsSerInitMsgXccCallStartNtf
(
    VOS_UINT32                          ulMsgId,
    VOS_VOID                           *pMsgStru
);
extern VOS_VOID NAS_EMM_XCC_SendEsrEndInd
(
    LMM_XCC_ESR_RSLT_ENUM_UINT8 enEsrRslt
);
extern VOS_VOID NAS_EMM_ERABM_SendCallStartInd(VOS_VOID);
extern VOS_VOID NAS_EMM_ERABM_SendCallEndInd(VOS_VOID);
extern VOS_VOID NAS_EMM_MsSerInitSsWaitCnSerCnfMsgSrlteTimer3417ExtExp(VOS_VOID);
extern VOS_VOID NAS_EMM_MsSerInitSsWaitCnSerCnfSrlteProcMsgRrcRelInd(VOS_VOID);
extern VOS_UINT32 NAS_EMM_SndSrlteExtendedServiceReqFailProc(VOS_VOID);
extern VOS_VOID NAS_EMM_SndImsaEmcEstFailInd(LRRC_LNAS_EST_RESULT_ENUM_UINT32 enEstResult);
extern VOS_VOID  NAS_EMM_EmcPndReqSerTAURejProc(VOS_VOID);
