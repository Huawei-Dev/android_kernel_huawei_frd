...
,LNAS_FUNCTION_LABEL1);
    ...
    else if (MMC_LMM_PLMN_SRCH_USER_LIST == ulMmcPlmnType)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_MmcPlmnReqTypeCheck: LIST PLMN! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_MmcPlmnReqTypeCheck_ENUM
,LNAS_FUNCTION_LABEL2);
        ulPlmnType = LRRC_LNAS_PLMN_SEARCH_USER_LIST;
    }
...
,LNAS_FUNCTION_LABEL11);
    ...
    else if (MMC_LMM_PLMN_SRCH_INTER_LIST_FULL_BAND == ulMmcPlmnType)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_MmcPlmnReqTypeCheck: PREF_BAND PLMN! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_MmcPlmnReqTypeCheck_ENUM
,LNAS_FUNCTION_LABEL12);
        ulPlmnType = LRRC_LNAS_PLMN_SRCH_INTER_LIST_FULL_BAND;
    }
    else if (MMC_LMM_PLMN_SRCH_INTER_LIST_PREF_BAND == ulMmcPlmnType)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_MmcPlmnReqTypeCheck: PREF_BAND PLMN! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_MmcPlmnReqTypeCheck_ENUM
,LNAS_FUNCTION_LABEL13);
        ulPlmnType = LRRC_LNAS_PLMN_SRCH_INTER_LIST_PREF_BAND;
    }
    else
    {
...
,LNAS_FUNCTION_LABEL1);
    ...
    else if(LRRC_LNAS_PLMN_SEARCH_RLT_USER_LIST_SUCC == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: LIST SUCC! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM
,LNAS_FUNCTION_LABEL2);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_USER_LIST_SUCC;
    }
...
,LNAS_FUNCTION_LABEL3);
    ...
    else if (LRRC_LNAS_PLMN_SEARCH_RLT_USER_LIST_FAIL == ulPlmnRslt)
    {
...
,LNAS_FUNCTION_LABEL4);
    ...
    else if (LRRC_LNAS_PLMN_SRCH_RLT_USER_LIST_REJ == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: LIST REJ! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM
,LNAS_FUNCTION_LABEL5);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_USER_LIST_REJ;
    }
...
,LNAS_FUNCTION_LABEL12);
    ...
    else if (LRRC_LNAS_PLMN_SEARCH_RLT_USER_LIST_NO_RF == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: LIST NO RF! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM
,LNAS_FUNCTION_LABEL13);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_USER_LIST_NO_RF;
    }
...
#endif
    else if (LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_SUCC == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: INTER_LIST SUCC! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL20);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_SUCC;
    }
    else if (LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_FAIL == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: INTER LIST FAIL! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL21);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_FAIL;
    }
    else if (LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_NO_RF == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: INTER LIST NO_RF! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL22);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_NO_RF;
    }
    else if (LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_REJ == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: INTER LIST REJ! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL23);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_REJ;
    }
    else if (LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_SUCC == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: INTER LIST PREF BAND SUCC! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL24);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_SUCC;
    }
    else if (LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_FAIL == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: INTER LIST PREF BAND FAIL! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL25);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_FAIL;
    }
    else if (LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_NO_RF == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: INTER LIST PREF BAND NO RF! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL26);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_NO_RF;
    }
    else if (LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_REJ == ulPlmnRslt)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_LMM_RrcPlmnCnfTypeCheck: INTER LIST PREF BAND REJ! ");
        TLPS_PRINT2LAYER_INFO(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL27);
        ulMmcPlmnRslt = MMC_LMM_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_REJ;
    }
    else
    {
        NAS_LMM_EMMC_LOG_ERR(" NAS_LMM_MmcPlmnReqTypeCheck: Input Plmn Rslt is Err! ");
        TLPS_PRINT2LAYER_ERROR(NAS_LMM_RrcPlmnCnfTypeCheck_ENUM,LNAS_FUNCTION_LABEL28);
    ...
    if (MMC_LMM_PLMN_SRCH_USER_CSG_SPEC == pstRcvMsg->enSrchType)
    {
        ...
        if (NAS_LMM_NULL < stTaList.ulTaNum)
        {
           ...
           TLPS_PRINT2LAYER_INFO1(  NAS_EMMC_SendRrcPlmnSrchReq_ENUM,
            ...
            pstPlmnReqMsg->stForbTaList.ulTaNum                 = stTaList.ulTaNum;
            for (i = 0; i < stTaList.ulTaNum; i++)
            {
                pstPlmnReqMsg->stForbTaList.astForbTa[i].enRat  = LRRC_LNAS_RAT_TYPE_LTE;
                NAS_LMM_MEM_CPY_S( &pstPlmnReqMsg->stForbTaList.astForbTa[i].stPlmnId,
                                   sizeof(LRRC_LNAS_PLMN_ID_STRU),
                                   &stTaList.astTa[i].stPlmnId,
                                   sizeof(LRRC_LNAS_PLMN_ID_STRU));
                NAS_LMM_MEM_CPY_S( &pstPlmnReqMsg->stForbTaList.astForbTa[i].stTac,
                                   sizeof(LRRC_LNAS_TAC_STRU),
                                   &stTaList.astTa[i].stTac,
                                   sizeof(LRRC_LNAS_TAC_STRU));
            }
        }
...
,LNAS_FUNCTION_LABEL1);
    ...
    if (LRRC_LNAS_PLMN_SEARCH_RLT_USER_LIST_FAIL == pstRcvMsg->enRlst)
    {
        NAS_LMM_EMMC_LOG_NORM(" NAS_EMMC_SendMmcPlmnSrchCnf:LIST FAIL!");
        TLPS_PRINT2LAYER_INFO(NAS_EMMC_SendMmcPlmnSrchCnf_ENUM
,LNAS_FUNCTION_LABEL2);
        pstPlmnCnfMsg->enRlst           = MMC_LMM_PLMN_SRCH_RLT_USER_LIST_SUCC;
...
,LNAS_NULL_PTR);
    ...
    pstPlmnCnfMsg->enRlst               = MMC_LMM_PLMN_SRCH_RLT_USER_LIST_REJ;
...
,LNAS_FUNCTION_LABEL1);
    ...
    if (MMC_LMM_CELL_TYPE_CSG == pstSysInfoIndMsg->stLteSysInfo.enCellType)
    {
        ulCsgId = pstRcvMsg->ulCsgId;
    }
...
,LNAS_EMM_ALLOC_FAIL);
    ...
    pstLrrcMsg->ulBgPlmnSearchType = pstMmcMsg->enBgType;
    /* 填充消息内容 */
    pstLrrcMsg->ulPlmnIdNum = pstMmcMsg->ulPlmnIdNum;
    pstLrrcMsg->enRat       = pstMmcMsg->enRat;
    NAS_LMM_MEM_CPY_S(  pstLrrcMsg->astPlmnIdList,
                        sizeof(LRRC_LNAS_PLMN_ID_STRU) * LRRC_LNAS_MAX_EQUPLMN_NUM,
                        pstMmcMsg->astPlmnIdList,
                        sizeof(MMC_LMM_PLMN_ID_STRU) * MMC_LMM_MAX_EQUPLMN_NUM);
...
,LNAS_EMM_ALLOC_FAIL);
    ...
    {
    case LRRC_LMM_BG_SPEC_SRCH_RLT_SUCC:
        pstMmcMsg->enRlst = MMC_LMM_BG_SPEC_SRCH_RLT_SUCCESS;
        break;
    case LRRC_LMM_BG_SPEC_SRCH_RLT_FAIL:
        pstMmcMsg->enRlst = MMC_LMM_BG_SPEC_SRCH_RLT_FAIL;
        break;
    case LRRC_LMM_BG_SPEC_SRCH_RLT_ABORT:
        pstMmcMsg->enRlst = MMC_LMM_BG_SPEC_SRCH_RLT_ABORT;
        break;
    case LRRC_LMM_BG_SPEC_SRCH_RLT_NO_RF:
        pstMmcMsg->enRlst = MMC_LMM_BG_SPEC_SRCH_RLT_NO_RF;
        break;
    case LRRC_LMM_BG_HISTORY_SRCH_RLT_SUCCESS:
        pstMmcMsg->enRlst = MMC_LMM_BG_HISTORY_SRCH_RLT_SUCCESS;
        break;
    case LRRC_LMM_BG_HISTORY_SRCH_RLT_FAIL:
        pstMmcMsg->enRlst = MMC_LMM_BG_HISTORY_SRCH_RLT_FAIL;
        break;
    case LRRC_LMM_BG_HISTORY_SRCH_RLT_ABORT:
        pstMmcMsg->enRlst = MMC_LMM_BG_HISTORY_SRCH_RLT_ABORT;
        break;
    case LRRC_LMM_BG_HISTORY_SRCH_RLT_NO_RF:
        pstMmcMsg->enRlst = MMC_LMM_BG_HISTORY_SRCH_RLT_NO_RF;
        break;
    default:
...
)
{
    ...
    /* 构造消息头 */
    NAS_EMMC_COMP_ERMM_MSG_HEADER(pstLrrcMsg, (sizeof(LRRC_LMM_CSG_BG_SEARCH_REQ_STRU) - NAS_EMMC_LEN_VOS_MSG_HEADER));
