...
enum EMM_ERABM_MSG_TYPE_ENUM
{
    ...
    ID_EMM_ERABM_CALL_START_NTF          = (0x0b+EMM_ERABM_MSG_ID_HEADER),/* _H2ASN_MsgChoice EMM_ERABM_CALL_START_NTF_STRU */
    ID_EMM_ERABM_CALL_END_NTF            = (0x0c+EMM_ERABM_MSG_ID_HEADER),/* _H2ASN_MsgChoice EMM_ERABM_CALL_END_NTF_STRU */
...
/*****************************************************************************
 结构名    : EMM_ERABM_CALL_START_NTF_STRU
 结构说明  : EMM_ERABM_CALL_START_NTF_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                          /*_H2ASN_Skip*/
    EMM_ERABM_MSG_TYPE_ENUM_UINT32       enMsgId;           /*_H2ASN_Skip*/            /* 消息头*/
    VOS_UINT8                            aucMsg[4];          /* 保留字*/
}EMM_ERABM_CALL_START_NTF_STRU;
/*****************************************************************************
 结构名    : EMM_ERABM_CALL_END_NTF_STRU
 结构说明  : EMM_ERABM_CALL_END_NTF_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                          /*_H2ASN_Skip*/
