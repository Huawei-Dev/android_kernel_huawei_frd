...
NAS_LPP_FSM_ACT_STRU g_astLppMsIdleSsWaitUplinkAckDataCnfTbl[] =
{
...
NAS_LPP_FSM_STRU  g_astNasLppFsm[] =
{
    ...
    {NAS_LPP_COMP_STATE(LPP_MS_IDLE,LPP_SS_WAIT_INTRA_DATA_CNF_OF_UP_LPP_ACK),  NAS_LPP_STATE_TBL_SIZE(g_astLppMsIdleSsWaitUplinkAckDataCnfTbl),g_astLppMsIdleSsWaitUplinkAckDataCnfTbl},
