...
extern VOS_VOID NAS_EMM_MsESRWtRrcRelMsgCnNotReAttachDetatchReq(VOS_VOID);

extern VOS_UINT32 NAS_EMM_MsDrgSsAptToAttachMsgRrmPsStatusInd( VOS_UINT32  ulMsgId,
                                                    VOS_VOID   *pMsgStru );
extern VOS_UINT32 NAS_EMM_MsDrgSsNormalSrvMsgRrmPsStatusInd(VOS_UINT32  ulMsgId,
                                                    VOS_VOID   *pMsgStru );
extern VOS_UINT32 NAS_EMM_MsRegSsSomeMsgRrmPsStatusInd( VOS_UINT32  ulMsgId,
                                                    VOS_VOID   *pMsgStru );
/*****************************************************************************
  9 OTHERS
*****************************************************************************/
