...
NAS_EMM_ACT_STRU    g_astEmmMsDeregSsNormalServiceTable[] =
{
    ...
    NAS_EMM_ACT_TBL_ITEM(UEPS_PID_RRM,
                    ID_RRM_PS_STATUS_IND,
                    NAS_EMM_MsDrgSsNormalSrvMsgRrmPsStatusInd),
    /*============= TAU ===========================================*/
    /*============= SERVICE =======================================*/
    /*============= GUTI ==========================================*/
    /*============= IDEN ==========================================*/
...
NAS_EMM_ACT_STRU    g_astEmmMsDeregSsAttempToAttachTable[] =
{
    ...
    NAS_EMM_ACT_TBL_ITEM(UEPS_PID_RRM,
                    ID_RRM_PS_STATUS_IND,
                    NAS_EMM_MsDrgSsAptToAttachMsgRrmPsStatusInd),
    /*============= TAU ===========================================*/
    /*============= SERVICE =======================================*/
    /*============= GUTI ==========================================*/
    /*============= IDEN ==========================================*/
...
NAS_EMM_ACT_STRU    g_astEmmMsRegSsNormalServiceTable[] =
{
    ...
    NAS_EMM_ACT_TBL_ITEM(UEPS_PID_RRM,
                    ID_RRM_PS_STATUS_IND,
                    NAS_EMM_MsRegSsSomeMsgRrmPsStatusInd),
    /*============= SERVICE =======================================*/
    ...
    NAS_EMM_ACT_TBL_ITEM(UEPS_PID_XCC,
                    ID_XCC_LMM_CALL_START_NTF,
                    NAS_EMM_MsRegSsNormalOrAttemptUpdateMmMsgXccCallStartNtf),
...
NAS_EMM_ACT_STRU    g_astEmmMsSerInitSsWaitCnSerCnfTable[] =
{
    ...
    NAS_EMM_ACT_TBL_ITEM(UEPS_PID_XCC,
                    ID_XCC_LMM_CALL_START_NTF,
                    NAS_EMM_MsSerInitMsgXccCallStartNtf),
...
)
{
    ...
    else if (NAS_LMM_FORB_TAI_ROAM_LIST == ulInfoType)
    {
        ...
        for (i = 0; i < pstLmmInfo->u.stForbRoamTaiList.ulTaNum; i++)
        {
            pstLmmInfo->u.stForbRoamTaiList.astTa[i].enRat = MMC_LMM_RAT_LTE;
            NAS_LMM_MEM_CPY_S( &(pstLmmInfo->u.stForbRoamTaiList.astTa[i].stPlmnId),
                               sizeof(MMC_LMM_PLMN_ID_STRU),
                               &(pstForbRoamTaiList->astTa[i].stPlmnId),
                               sizeof(MMC_LMM_PLMN_ID_STRU));
            NAS_LMM_MEM_CPY_S( &(pstLmmInfo->u.stForbRoamTaiList.astTa[i].stTac),
                               sizeof(NAS_LMM_TAC_STRU),
                               &(pstForbRoamTaiList->astTa[i].stTac),
                               sizeof(NAS_LMM_TAC_STRU));
        }
    ...
    else if (NAS_LMM_FORB_TAI_RPOS_LIST == ulInfoType)
    {
        ...
        for (i = 0; i < pstLmmInfo->u.stForbRposTaiList.ulTaNum; i++)
        {
            pstLmmInfo->u.stForbRposTaiList.astTa[i].enRat = MMC_LMM_RAT_LTE;

            NAS_LMM_MEM_CPY_S( &(pstLmmInfo->u.stForbRposTaiList.astTa[i].stPlmnId),
                               sizeof(MMC_LMM_PLMN_ID_STRU),
                               &(pstForbRposTaiList->astTa[i].stPlmnId),
                               sizeof(MMC_LMM_PLMN_ID_STRU));
            NAS_LMM_MEM_CPY_S( &(pstLmmInfo->u.stForbRposTaiList.astTa[i].stTac),
                               sizeof(NAS_LMM_TAC_STRU),
                               &(pstForbRposTaiList->astTa[i].stTac),
                               sizeof(NAS_LMM_TAC_STRU));
        }
