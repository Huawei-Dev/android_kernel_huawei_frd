...
VOS_UINT32 NAS_EMM_RcvLppMsgEstReq(MsgBlock *  pMsg)
{
    ...
    if ((ulCurEmmStat == NAS_LMM_PUB_COMP_EMMSTATE(EMM_MS_REG, EMM_SS_REG_NORMAL_SERVICE))
        ...
        || (ulCurEmmStat == NAS_LMM_PUB_COMP_EMMSTATE(EMM_MS_REG, EMM_SS_REG_LIMITED_SERVICE)))
    {
...
)
{
    ...
    pstEmmLppCellChangeInd->ulDlFreq        = ulDlFreq;
    ...
    pstEmmLppCellChangeInd->aulLteBand[0]   = pulLteBand[0];
    pstEmmLppCellChangeInd->aulLteBand[1]   = pulLteBand[1];
