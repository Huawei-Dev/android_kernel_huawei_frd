...
/*****************************************************************************
结构名称    :NAS_BACKOFF_FOBID_TIMER_STATE_ENUM
使用说明    :惩罚定时器状态枚举
*****************************************************************************/
...
/*****************************************************************************
结构名称    :NAS_BACKOFF_OM_LOG_MSG_ENUM
使用说明    :Back-off算法维测消息
*****************************************************************************/
...
{
    NAS_BACKOFF_SUCCESS                                         = 0,         /*ESM 模块函数返回成功*/
    NAS_BACKOFF_FAILURE                                            ,         /*ESM 模块函数返回失败*/
    NAS_BACKOFF_MSG_DISCARD                                        ,         /*丢弃消息*/
    NAS_BACKOFF_MSG_HANDLED                                                 /*消息已处理 */
};
enum NAS_BACKOFF_SIM_RPM_ENUM
{
    NAS_BACKOFF_SIM_RPM_DISABLE         = 0X00,       /* 关闭 */
    NAS_BACKOFF_SIM_RPM_ENABLE          = 0X01,       /* 打开 */
...
typedef struct
{
    ...
    VOS_UINT32                          bitOpSimRpmFlag  :1;  /* Rpm开关是否打开     */
    VOS_UINT32                          bitOpRsv         :30; /* 保留                */

    NAS_BACKOFF_SIM_RPM_ENUM_UINT8      enSimRpmFlag;         /* 卡中控制RPM特性开关 */
...
typedef struct
{
    ...
    NAS_BACKOFF_TIMER_PARA_ENUM_UINT8   enPara;      /* Timer类型   */
...
typedef struct
{
    ...
    VOS_UINT8                               ucBackOffShareEntityFlag; /* 是否公用一个实体；0 否；1 是 */
    VOS_UINT8                               ucRsv[2];               /* 保留 */
...
{
    MSG_HEADER_STRU                          stMsgHeader;     /*_H2ASN_Skip*/
    NAS_BACKOFF_TIMER_RUN_STA_ENUM_UINT32    enTimerStatus;   /* 定时器状态*/

    NAS_BACKOFF_TIMER_PARA_ENUM_UINT8        enTimerId;       /* 定时器ID*/
    VOS_UINT8                                usRsv[3];
