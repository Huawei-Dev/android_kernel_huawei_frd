...
/* gaojishan-fast-dorm-cfg */
    ...
    ID_LRRC_LPDCP_DATA_EX_CNF             = (LPDCP_LRRC_MSG_HDR + 0x0c),

    ID_LRRC_LPDCP_REQ_END                 = (LRRC_LPDCP_MSG_HDR + 0x0a),
    ID_LRRC_LPDCP_IND_END                 = (LPDCP_LRRC_MSG_HDR + 0x0d)
};
...
typedef LRRC_LPDCP_DATA_CNF_STRU LRRC_LPDCP_DATA_EX_CNF_STRU;
