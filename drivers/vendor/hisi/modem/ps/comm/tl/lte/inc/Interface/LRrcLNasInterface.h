...
/* NAS数据最大长度 */
#define LRRC_LNAS_MAX_DATA_LENGTH         2048
...
#define LRRC_LMM_MAX_RX_ANT_NUM                              4
...
enum LRRC_LNAS_PLMN_SEARCH_TYPE_ENUM
{
    ...
    LRRC_LNAS_PLMN_SEARCH_USER_LIST       = 2,                /* PLMN列表的搜索   */
    ...
    LRRC_LNAS_PLMN_SRCH_INTER_LIST_FULL_BAND = 10,               /*内部触发的list搜索,使用FULL Band进行搜索 */
    LRRC_LNAS_PLMN_SRCH_INTER_LIST_PREF_BAND = 11,               /*内部触发的list搜索,使用Prefer Band进行搜索 */
...
/*****************************************************************************
 ...
 枚举说明  : PLMN搜索类型取值
*****************************************************************************/
enum LRRC_LNAS_BG_PLMN_TYPE_ENUM
{
    LRRC_LNAS_BG_PLMN_SRCH_HISTORY   = 0,          /*指定plmn的history搜网*/
    LRRC_LNAS_BG_PLMN_SRCH_SPEC      = 1,          /*指定plmn的全band搜网*/
    LRRC_LNAS_BG_PLMN_SRCH_BUTT
};
typedef VOS_UINT32 LRRC_LNAS_BG_PLMN_TYPE_ENUM_UINT32;
/*****************************************************************************
...
enum LRRC_LNAS_PLMN_SEARCH_RLT_ENUM
{
    ...
    LRRC_LNAS_PLMN_SEARCH_RLT_USER_LIST_SUCC    = 1,                /* PLMN List搜索成功      */
    LRRC_LNAS_PLMN_SEARCH_RLT_SPEC_FAIL   = 2,                /* 指定PLMN ID搜索失败    */
    LRRC_LNAS_PLMN_SEARCH_RLT_USER_LIST_FAIL    = 3,                /* PLMN List搜索失败      */
/* lishangfeng bg begin */
    LRRC_LNAS_PLMN_SRCH_RLT_USER_LIST_REJ       = 4,                /* 驻留态下列表搜网被非出服务区流程打断 */
/* lishangfeng bg end */

    LRRC_LNAS_PLMN_SEARCH_RLT_SPEC_NO_RF   = 5,/* 新增 */
    LRRC_LNAS_PLMN_SEARCH_RLT_USER_LIST_NO_RF   = 6,/* 新增 */
    ...
    LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_SUCC  = 19,
    LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_FAIL  = 20,
    LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_NO_RF = 21,
    LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_FULL_BAND_REJ   = 22,

    LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_SUCC  = 23,
    LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_FAIL  = 24,
    LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_NO_RF = 25,
    LRRC_LNAS_PLMN_SRCH_RLT_INTER_LIST_PREF_BAND_REJ   = 26,
...
enum LRRC_LNAS_EST_RESULT_ENUM
{
    ...
    LRRC_EST_ACCESS_BARRED_IMS_EMC_CALL      = 17,                              /* 紧急接入被bar     */
    LRRC_EST_NOT_SUPPORT_IMS_EMC_CALL        = 18,                              /* 不支持IMS紧急呼叫 */
...
{
    LRRC_LMM_BG_SPEC_SRCH_RLT_SUCC               = 0,                /* bg spec指定的PLMN搜索成功 */
    LRRC_LMM_BG_SPEC_SRCH_RLT_FAIL               = 1,                /* bg spec实际发起了搜网，但是搜索失败 */
    LRRC_LMM_BG_SPEC_SRCH_RLT_ABORT              = 2,                /* bg spec没有发起搜网，因为当前状态不允许，搜索被终止 */
    LRRC_LMM_BG_SPEC_SRCH_RLT_NO_RF              = 3,                /* bg spec搜网过程中无资源可用 */
    LRRC_LMM_BG_HISTORY_SRCH_RLT_SUCCESS         = 4,                /* bg history指定的PLMN搜索成功 */
    LRRC_LMM_BG_HISTORY_SRCH_RLT_FAIL            = 5,                /* bg history实际发起了搜网，但是搜索失败 */
    LRRC_LMM_BG_HISTORY_SRCH_RLT_ABORT           = 6,                /* bg history没有发起搜网，因为当前状态不允许，搜索被终止 */
    LRRC_LMM_BG_HISTORY_SRCH_RLT_NO_RF           = 7,                /* bg history搜网过程中无资源可用 */
    LRRC_LMM_BG_SRCH_RLT_BUTT
};
typedef VOS_UINT32  LRRC_LMM_BG_SRCH_RLT_ENUM_UINT32;

/*****************************************************************************
 枚举名    : LRRC_LMM_BG_SRCH_HRPD_RLT_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : LMM BG搜索HRPD结果
*****************************************************************************/
enum LRRC_LMM_BG_SRCH_HRPD_RLT_ENUM
{
    LRRC_LMM_BG_SRCH_HRPD_RLT_SUCCESS    = 0,                /* 指定的PLMN搜索成功 */
    LRRC_LMM_BG_SRCH_HRPD_RLT_FAIL       = 1,                /* 实际发起了搜网，但是搜索失败 */
    LRRC_LMM_BG_SRCH_HRPD_RLT_ABORT      = 2,                /* 没有发起搜网，因为当前状态不允许，搜索被终止 */
    LRRC_LMM_BG_SRCH_HRPD_RLT_BUTT
};
typedef VOS_UINT32  LRRC_LMM_BG_SRCH_HRPD_RLT_ENUM_UINT32;
/*****************************************************************************
...
enum LRRC_LNAS_CALL_TYPE_ENUM
{
    ...
    LRRC_LNAS_CALL_TYPE_IMS_EMERGENCY_CALL           = 5,            /* IMS_EMERGENCY call */
...
typedef struct
{
    ...
    LRRC_LNAS_RAT_TYPE_ENUM_UINT8         enRat;
...
typedef struct
{
    ...
    PS_BOOL_ENUM_UINT8                  enCsfbSuppForDualRxUEsFlg;  /* PS_TRUE:支持，PS_FALSE:不支持*/
...
typedef struct
{
    ...
    VOS_UINT32                          ulPlmnIdNum;        /* PLMN ID个数 */
    LRRC_LNAS_PLMN_ID_STRU              astPlmnIdList[LRRC_LNAS_MAX_EQUPLMN_NUM];       /* PlMN标识 */
    LRRC_LNAS_RAT_TYPE_ENUM_UINT8       enRat;              /* 支持的接入技术 */

    LRRC_LNAS_BG_PLMN_TYPE_ENUM_UINT32    ulBgPlmnSearchType;
...
typedef struct
{
    ...
    VOS_UINT8                                       aucRev[3];
    VOS_INT16                                       asRsrpRx[LRRC_LMM_MAX_RX_ANT_NUM];       /* 1/8db精度 */
    VOS_INT32                                       alSINRRx[LRRC_LMM_MAX_RX_ANT_NUM];       /* 1db精度 */
} LRRC_LMM_RX_ANT_INFO_STRU;
...
typedef struct
{
    ...
    VOS_INT16                           sRssi;                /**/
    VOS_INT16                           sRsd;                 /*填充字段*/
    VOS_INT16                           sRsrp;                /*范围(-141,-44)*8,99为无效*/
    VOS_INT16                           sRsrq;                /*范围(-40,-6),99为无效*/
    VOS_INT32                           lSinr;
    LRRC_LMM_CQI_INFO_STRU              stCQI;
    LRRC_LMM_RX_ANT_INFO_STRU           stRxAntInfo;
...
typedef struct
{
    ...
    LRRC_LMM_BG_SRCH_HRPD_RLT_ENUM_UINT32   enRslt;
