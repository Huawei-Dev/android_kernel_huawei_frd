...
enum LPP_LRRC_MSG_ID_ENUM
{
    ...
    ID_LRRC_LPP_LOC_REQUIREMENT_IND                 = (LRRC_LPP_MSG_HDR + 0x05),/* _H2ASN_MsgChoice LRRC_LPP_LOC_REQUIREMENT_IND_STRU */
...
/*****************************************************************************
 枚举名    : LRRC_LPP_LOC_REPORT_TYPE_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : LRRC请求LPP报位置的上报方式
*****************************************************************************/
enum LRRC_LPP_LOC_REPORT_TYPE_ENUM
{
    LRRC_LPP_LOC_REPORT_TYPE_PERIOD,    /* 周期性上报 */
    LRRC_LPP_LOC_REPORT_TYPE_ONCE,      /* 上报一次 */
    LRRC_LPP_LOC_REPORT_TYPE_BUTT
};
typedef VOS_UINT8  LRRC_LPP_LOC_REPORT_TYPE_ENUM_UINT8;

 /*****************************************************************************
  枚举名    : LRRC_LPP_LOC_REQUIREMENT_CMD_ENUM
  协议表格  :
  ASN.1描述 :
  枚举说明  : LRRC指示LPP位置信息的启停
 *****************************************************************************/
enum LRRC_LPP_LOC_REQUIREMENT_CMD_ENUM
{
    LRRC_LPP_LOC_REQUIREMENT_CMD_REL,    /* 停止位置信息需求 */
    LRRC_LPP_LOC_REQUIREMENT_CMD_SETUP,  /* 启动位置信息需求 */
    LRRC_LPP_LOC_REQUIREMENT_CMD_BUTT
};
typedef VOS_UINT8   LRRC_LPP_LOC_REQUIREMENT_CMD_ENUM_UINT8;
...
/*****************************************************************************
 结构名称   : LRRC_LPP_LOC_REQUIREMENT_IND_STRU
 协议表格   :
 ASN.1 描述 :
 结构说明   : LRRC请求LPP主动上报位置信息
*****************************************************************************/
typedef struct
{
    ...
    LRRC_LPP_LOC_REPORT_TYPE_ENUM_UINT8             enLocReportType;    /* 位置报告方式 */
    LRRC_LPP_LOC_REQUIREMENT_CMD_ENUM_UINT8         enLocRequirementCmd;/* 位置需求的启停 */
    VOS_UINT8                                       aucRsv[2];          /* 保留项 */
}LRRC_LPP_LOC_REQUIREMENT_IND_STRU;
