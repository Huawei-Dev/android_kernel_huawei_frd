 ...
 *
 * For reliable type signaling message, it's always to response with confirm;
 * for best effort type signaling message, it depends on @enNeedRslt.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
 ...
 *
 * usOpId: It's the identity of Data-Req signal, it needs to be unique
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
 ...
 *
 * ATTENTION:
 * For the air-message has been transmitted or being transmitting, it can not
 * cancel it any more. Air-Message has not been transmitted at all, it can be
 * canceled.
 *******************************************************************************/
typedef struct
{
