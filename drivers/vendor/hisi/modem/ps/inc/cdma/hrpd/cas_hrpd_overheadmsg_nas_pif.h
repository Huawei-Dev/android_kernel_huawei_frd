...
#define CAS_CNAS_HRPD_OHM_SPM_MAX_CHANNEL_NUM               ( 64 )
...
enum CAS_HRPD_OVERHEADMSG_NAS_PIF_MSG_TYPE_ENUM
{
    ...
    ID_CAS_HRPD_OVERHEADMSG_NAS_PIF_MSG_TYPE_ENUM_BUTT      = 0x9102
};
...
/** ****************************************************************************
 * Name        : CAS_CNAS_HRPD_CHN_REC_STRU
 *
 * Description :
 *******************************************************************************/
typedef struct
...
} CAS_CNAS_HRPD_CHN_REC_STRU;

/** ****************************************************************************
 * Name        : CAS_CNAS_HRPD_OHM_SPM_CHANNEL_STRU
 *
 * Description :
 *******************************************************************************/
typedef struct
{
    ...
    VOS_UINT8                           aucReserve[3];
    CAS_CNAS_HRPD_CHN_REC_STRU          astChannelRec[CAS_CNAS_HRPD_OHM_SPM_MAX_CHANNEL_NUM];
} CAS_CNAS_HRPD_OHM_SPM_CHANNEL_STRU;
...
typedef struct
{
    ...
    CAS_CNAS_HRPD_OHM_SPM_CHANNEL_STRU                      stSpmChannel;
