 ...
 * -  BC for Broadcast Channel as defined in C.S0054
 ...
 * meanwhile set type with Beat Effort. When the connection is opened, it will
...
enum CTTF_HRPD_SNP_DATA_FAIL_REASON_ENUM
{
    ...
    CTTF_HRPD_SNP_DATA_FAIL_REASON_AC_CHANNEL_NOT_EXIST                         = 0x00000001, /**< access channel not exist but to transmit an ac-only message */
    ...
    CTTF_HRPD_SNP_DATA_FAIL_REASON_LINK_ACQUIRED                                = 0x00000004, /**< received LinkAcquired indication */
    CTTF_HRPD_SNP_DATA_FAIL_REASON_CONN_CLOSE                                   = 0x00000005, /**< received ConnectionClosed indication */
    CTTF_HRPD_SNP_DATA_FAIL_REASON_CONN_INIT                                    = 0x00000006, /**< received ConnectionInitiated indication */
    CTTF_HRPD_SNP_DATA_FAIL_REASON_RELEASE_ALL                                  = 0x00000007, /**< received release-all message */
    CTTF_HRPD_SNP_DATA_FAIL_REASON_FORCE_CLEAR_TX_AC_CHAN_DATA                  = 0x00000008, /**< received Clear-Tx-Ac-Chan-Data-Req to forced clear type ac-only and ac-or-rtc
messages that transmits on access channel */
    CTTF_HRPD_SNP_DATA_FAIL_REASON_MAX_TIMES_ATTEMPT                            = 0x00000009, /**< maximum number of attempts for sending a reliable-delivery packet of a message */
    CTTF_HRPD_SNP_DATA_FAIL_REASON_ENUM_BUTT                                    = 0x0000000A
};
 ...
 *
 * Description : This is an ENUM for operation result between Air-Message
 * Sender and SNP in HRPD.
 *******************************************************************************/
 ...
 * an integer number of bits in length. The receiver shall ignore the value of
 * the Reserved fields.
 *******************************************************************************/
typedef struct
{
 ...
 *
 * Description : Message delivered to/from other protocols. Messages are always
 * an integer number of octets in length. The receiver shall ignore the value
...
typedef struct
{
    ...
    PS_BOOL_ENUM_UINT8                  enMemFreeInd;  /**< indicates if the TTF_MEM can be freed or not by SIG, PS_TRUE: can be freed by SIG. PS_FALSE: can not be freed by SIG. */
