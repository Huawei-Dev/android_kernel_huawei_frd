 ...
 * The values greater than 0xFF are user-defined, e.g. AN EAP failure.
 * Refer to section 6.4.2.4.1 of Technical Requirements for CDMA/GSM/WCDMA/LTE FDD/TD-LTE
 * Multi-mode Mobile Terminal of China Telecom(Single Card Slot):
 * a) AT received EAP-Failure from AN, AN EAP failure;
 * b) except a), included AT EAP failure, EAP timerout, LCP timerout, LCP terminate
 *    and unspecific failure.
 *******************************************************************************/
enum CNAS_CTTF_EHRPD_ERROR_CODE_ENUM
{
    ...
    CNAS_CTTF_EHRPD_ERROR_CODE_AN_EAP_FAILURE                                   = 0x0100, /**< AT received EAP-Failure from AN in EAP authentication. */
    CNAS_CTTF_EHRPD_ERROR_CODE_AT_EAP_FAILURE                                   = 0x0101, /**< AT local EAP authentication failure in EAP authentication. */
    CNAS_CTTF_EHRPD_ERROR_CODE_EAP_TIMEROUT                                     = 0x0102, /**< AT hasn`t received AN EAP message in EAP authentication. */
    CNAS_CTTF_EHRPD_ERROR_CODE_LCP_TIMEROUT                                     = 0x0103, /**< AT hasn`t received AN ack in LCP negotiation. */
    CNAS_CTTF_EHRPD_ERROR_CODE_LCP_TERMINATE                                    = 0x0104, /**< LCP terminate in LCP negotiation and EAP authentication. */
    CNAS_CTTF_EHRPD_ERROR_CODE_UNSPECIFIC_FAILURE                               = 0x0105, /**< Unspecific failure except above failure in LCP negotiation and EAP authentication. */
    CNAS_CTTF_EHRPD_ERROR_CODE_VSNCP_TIMEROUT                                   = 0x0106, /**< AT hasn`t received AN ack in VSNDCP negotiation. */
    CNAS_CTTF_EHRPD_ERROR_CODE_PARA_ERROR                                       = 0x0107, /**< CNAS attach req para error  */

    CNAS_CTTF_EHRPD_ERROR_CODE_ACCESS_AUTH_FAILURE                              = 0x0108, /**< ACCESS AUTH FAILURE  */
...
typedef struct
{
    ...
    VOS_UINT8                                               ucRetry;            /* 0-第一次尝试，1-第二次尝试，2-第三次尝试， */
