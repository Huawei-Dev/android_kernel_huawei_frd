...
MOUDULES:= tlnas tlas ll2 tas lcs_nas backoff_nas

# process
.PHONY: lps tlnas tlas ll2 tas lcs_nas backoff_nas
lps: $(MOUDULES)
...
backoff_nas:
	$(MAKE)  $(OBB_JOBS)  -f MODEM_CORE/makefile_backoff_nas.mk INSTANCE_ID=$(INSTANCE_ID)

CLEAN_MOUDULES:= clean-tlnas clean-tlas clean-ll2 clean-tas clean-lcs_nas clean-backoff_nas

.PHONY: clean clean-tlnas clean-tlas clean-ll2 clean-tas clean-lcs_nas clean-backoff_nas

clean : clean-tlnas clean-tlas clean-ll2 clean-tas clean-lcs_nas clean-backoff_nas
...
clean-backoff_nas:
	$(MAKE)  $(OBB_JOBS)  -f MODEM_CORE/makefile_backoff_nas.mk clean INSTANCE_ID=$(INSTANCE_ID)
