...
OBC_LOCAL_MOUDLE_NAME	?=backoff_nas
endif

ifeq ($(INSTANCE_ID) ,INSTANCE_1)
OBC_LOCAL_MOUDLE_NAME	?=backoff_nas1
endif

ifeq ($(INSTANCE_ID) ,INSTANCE_2)
OBC_LOCAL_MOUDLE_NAME	?=backoff_nas2
endif
...
PS_LTE_NAS_SRC  := $(PS_NAS_SRC_DIR)/tl/lte/COMM/SRC/BACKOFF
...
OBC_LOCAL_INC_DIR :=\
		...
		$(PS_COMM_DIR)/comm/ccore/MEMCTRL/Inc \
		...
		$(PS_NAS_SRC_DIR)/tl/lte/COMM/INC/BACKOFF \
