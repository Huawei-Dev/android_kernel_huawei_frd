...
MOUDULES += gas was_public was_private gttf wttf_public wttf_private ascomm asn1
endif
...
# process
.PHONY: gups nas gas was_public was_private gttf wttf_public wttf_private pscomm ascomm bastet bstopenssl encodix asn1
gups: $(MOUDULES)
...
asn1:
	$(MAKE)  -f MODEM_CORE/makefile_asn1.mk	INSTANCE_ID=$(INSTANCE_ID)
...
ifneq ($(wildcard $(BALONG_TOPDIR)/modem/ps/as/gu/was),)
ifeq ($(INSTANCE_ID),INSTANCE_0)
CLEAN_MOUDULES += clean-gas clean-was_public clean-was_private clean-gttf clean-wttf_public clean-wttf_private clean-ascomm clean-asn1
endif
ifeq ($(INSTANCE_ID),INSTANCE_1)
...
.PHONY: clean-gups clean-nas clean-gas clean-was_public clean-was_private clean-gttf clean-wttf_public \
        clean-wttf_private clean-pscomm clean-ascomm clean-bastet clean-bstopenssl clean-encodix clean-asn1
...
clean-asn1:
	$(MAKE)  -f MODEM_CORE/makefile_asn1.mk clean  INSTANCE_ID=$(INSTANCE_ID)
