...
OBC_LOCAL_INC_DIR += \
	...
	$(BALONG_TOPDIR)/modem/config/errlog \
...
OBC_LOCAL_INC_DIR += \
    ...
    $(BALONG_TOPDIR)/modem/ps/nas/comm/ErrLog/INC \
    ...
    $(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/inc \
...
OBC_LOCAL_SRC_FILE := \
	...
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/comm/mntn/src/CnasMntnDump.c \
	...
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/1x/xcc/src/CnasXccSndLmm.c \
	...
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hlu/src/CnasHluSndHrm.c \
	...
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hsd/src/CnasHsdSndHrm.c\
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hsd/src/CnasHsdFsmBgSrch.c\
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hsd/src/CnasHsdFsmBgSrchTbl.c\
	...
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hsm/src/CnasHsmSndHrm.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmCommFunc.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmCtx.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmMain.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmProcCas.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmProcHlu.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmProcHsd.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmProcHsm.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmProcTtf.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmSndCas.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmSndHlu.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmSndHsd.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmSndHsm.c \
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/hrm/src/CnasHrmSndTtf.c \
	...
	$(BALONG_TOPDIR)/modem/ps/nas/cdma/hrpd/ehsm/src/CnasEhsmSndRrm.c \
