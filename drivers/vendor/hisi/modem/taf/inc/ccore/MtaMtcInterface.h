...
enum MTA_MTC_MSG_ID_ENUM
{
    ...
    ID_MTA_MTC_SET_SENSOR_REQ           = 0x0007,                               /* _H2ASN_MsgChoice MTA_MTC_SET_SENSOR_REQ_STRU*/
    ID_MTA_MTC_SET_SCREEN_REQ           = 0x0008,                               /* _H2ASN_MsgChoice MTA_MTC_SET_SCREEN_REQ_STRU*/
    ...
    ID_MTC_MTA_SET_SENSOR_CNF           = 0x0009,                               /* _H2ASN_MsgChoice MTC_MTA_SET_SENSOR_CNF_STRU*/
    ID_MTC_MTA_SET_SCREEN_CNF           = 0x000a,                               /* _H2ASN_MsgChoice MTC_MTA_SET_SCREEN_CNF_STRU*/
...
{
    MSG_HEADER_STRU                     stMsgHeader;                            /*_H2ASN_Skip*/
    MTA_MTC_SENSOR_STAT_ENUM_UINT8      enSensorStat;                           /* Sensor Hub状态 */
    VOS_UINT8                           aucReserved[3];
} MTA_MTC_SET_SENSOR_REQ_STRU;


typedef struct
{
    MSG_HEADER_STRU                     stMsgHeader;                            /*_H2ASN_Skip*/
    MTA_MTC_SCREEN_STAT_ENUM_UINT8      enScreenStat;                           /* Sensor状态 */
    VOS_UINT8                           aucReserved[3];
} MTA_MTC_SET_SCREEN_REQ_STRU;
