...
enum SM_TAF_CAUSE_ENUM
{
    ...
    *---------------------------------------------------------------------*/
    ...
    /* X模 C2L后，ip地址不一致，APS内部原因值 */
    SM_TAF_CAUSE_SM_IP_ADDRESS_CHANGE                       = (SM_TAF_CAUSE_SM_SECTION_BEGIN + 8),
	SM_TAF_CAUSE_SM_BACKOFF_ALG_NOT_ALLOWED                 = (SM_TAF_CAUSE_SM_SECTION_BEGIN + 9),
