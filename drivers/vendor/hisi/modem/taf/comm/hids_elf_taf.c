...
void ELF_TAF_ENUM_TAF_SDC(void)
{
    ...
    enum TAF_SDC_CELL_TYPE_ENUM                             enTAF_SDC_CELL_TYPE_ENUM;
    enum TAF_SDC_RPT_SRVSTA_ENUM                            enTAF_SDC_RPT_SRVSTA_ENUM;
    enum TAF_SDC_SERVICE_DOMAIN_ENUM                        enTAF_SDC_SERVICE_DOMAIN_ENUM;
}
...
void ELF_TAF_ENUM_APP_MMA(void)
{
    ...
    enum TAF_MMA_CDMA_LOC_INFO_RAT_MODE_ENUM                enTAF_MMA_CDMA_LOC_INFO_RAT_MODE_ENUM;
...
void ELF_TAF_ENUM_AT(void)
{
    ...
    enum AT_IMSA_ROAMING_IMS_SUPPORT_ENUM                   enAT_IMSA_ROAMING_IMS_SUPPORT_ENUM;
...
void ELF_TAT_ENUM_AT_MTA(void)
{
    ...
    enum AT_MTA_CLEAR_FREQ_FLG_ENUM                         enAT_MTA_CLEAR_FREQ_FLG_ENUM;
    enum TAF_MTA_TIMER_ID_ENUM                              enTAF_MTA_TIMER_ID_ENUM;
    enum TAF_MTA_TIMER_STATUS_ENUM                          enTAF_MTA_TIMER_STATUS_ENUM;
    enum AT_MTA_XCPOSR_CFG_ENUM                             enAT_MTA_XCPOSR_CFG_ENUM;
}
...
void ELF_TAT_ENUM_OM_ERR(void)
{
    ...
    enum NAS_ERR_LOG_ALM_ID_ENUM                            enNAS_ERR_LOG_ALM_ID_ENUM;
    enum ERR_LOG_FAULT_ID_ENUM                              enERR_LOG_FAULT_ID_ENUM;
}


void ELF_TAT_ENUM_VC(void)
{
    enum VCVOICE_WORK_TYPE_ENUM                             enVCVOICE_WORK_TYPE_ENUM;
    enum VC_VOICE_MSG_ID_ENUM                               enVC_VOICE_MSG_ID_ENUM;
}
...
void ELF_TAT_ENUM_NAS_RRC(void)
{
    enum RRC_NAS_CSG_SEARCH_RLT_ENUM                        enRRC_NAS_CSG_SEARCH_RLT_ENUM;
}

void ELF_TAT_ENUM_MTC(void)
{
    enum MTA_MTC_SENSOR_STAT_ENUM                                     enMTA_MTC_SENSOR_STAT_ENUM;
    enum MTA_MTC_SCREEN_STAT_ENUM                                     enMTA_MTC_SCREEN_STAT_ENUM;
}
...
void ELF_TAF_STRU_TraceTable_MMA(void)
{
    ...
    TAF_MMA_LOG_ROAMING_SWITCH_CTRL_INFO_IND_STRU           stTAF_MMA_LOG_ROAMING_SWITCH_CTRL_INFO_IND_STRU;
    TAF_MMA_LOG_SYS_CFG_RELATED_CTX_STRU                    stTAF_MMA_LOG_SYS_CFG_RELATED_CTX_STRU;
    ...
    MMA_MSCC_IMS_REG_REQ_STRU                               stMMA_MSCC_IMS_REG_REQ_STRU;
    MMA_MSCC_IMS_DEREG_REQ_STRU                             stMMA_MSCC_IMS_DEREG_REQ_STRU;
    ...
    MMA_MSCC_CSG_SPEC_SEARCH_REQ_STRU                       stMMA_MSCC_CSG_SPEC_SEARCH_REQ_STRU;
    MMA_MSCC_CSG_SPEC_SEARCH_ABORT_REQ_STRU                 stMMA_MSCC_CSG_SPEC_SEARCH_ABORT_REQ_STRU;
    ...
    TAF_MMA_CSG_SPEC_SEARCH_CNF_STRU                        stTAF_MMA_CSG_SPEC_SEARCH_CNF_STRU;
    TAF_MMA_QRY_CAMP_CSG_ID_INFO_CNF_STRU                   stTAF_MMA_QRY_CAMP_CSG_ID_INFO_CNF_STRU;

    TAF_MMA_PRLID_QRY_CNF_STRU                              stTAF_MMA_PRLID_QRY_CNF_STRU;
    ...
    TAF_MMA_ROAMING_MODE_SWITCH_IND_STRU                    stTAF_MMA_ROAMING_MODE_SWITCH_IND_STRU;
    TAF_MMA_CTCC_ROAMING_NW_INFO_REPORT_IND_STRU            stTAF_MMA_CTCC_ROAMING_NW_INFO_REPORT_IND_STRU;
    TAF_MMA_CTCC_ROAMING_NW_INFO_QRY_CNF_STRU               stTAF_MMA_CTCC_ROAMING_NW_INFO_QRY_CNF_STRU;
    TAF_MMA_CTCC_OOS_COUNT_SET_CNF_STRU                     stTAF_MMA_CTCC_OOS_COUNT_SET_CNF_STRU;
    /******************* 发送模块：MMA，接收模块：AT End  *******************/


    /******************* 发送模块：MMA，接收模块：MTA Begin  *******************/
    NAS_MTA_CS_SERVICE_CONN_STATUS_CHG_IND_STRU             stNAS_MTA_CS_SERVICE_CONN_STATUS_CHG_IND_STRU;
    /******************* 发送模块：MMA，接收模块：MTA End  *******************/
...
void ELF_TAF_STRU_TraceTable_TAF(void)
{
    ...
    TAF_MMA_CTCC_ROAMING_NW_INFO_QRY_REQ_STRU               stTAF_MMA_CTCC_ROAMING_NW_INFO_QRY_REQ_STRU;
    TAF_MMA_CTCC_OOS_COUNT_SET_REQ_STRU                     stTAF_MMA_CTCC_OOS_COUNT_SET_REQ_STRU;
    TAF_MMA_CSG_SPEC_SEARCH_REQ_STRU                        stTAF_MMA_CSG_SPEC_SEARCH_REQ_STRU;
    TAF_MMA_QRY_CAMP_CSG_ID_INFO_REQ_STRU                   stTAF_MMA_QRY_CAMP_CSG_ID_INFO_REQ_STRU;

    TAF_MMA_CLOCINFO_PARA_STRU                              stTAF_MMA_CLOCINFO_PARA_STRU;

    TAF_MMA_PRLID_QRY_REQ_STRU                              stTAF_MMA_PRLID_QRY_REQ_STRU;
    ...
    TAF_CALL_MSG_CALL_EVT_STRU                                                  stTAF_CALL_MSG_CALL_EVT_STRU;
...
void ELF_TAF_STRU_TraceTable_AT(void)
{
    ...
    AT_IMSA_MSG_STRU                                        stAT_IMSA_ROAMING_IMS_QRY_REQ_STRU;
    ...
    AT_ELF_MTA_CLEAR_HISTORY_FREQ_REQ_STRU                  stAT_MTA_CLEAR_HISTORY_FREQ_REQ_STRU;
    AT_ELF_MTA_SET_XCPOSR_REQ_STRU                          stAT_ELF_MTA_SET_XCPOSR_REQ_STRU;
    AT_ELF_MTA_RESERVE_STRU                                 stAT_ELF_MTA_RESERVE_STRU;
    AT_ELF_MTA_SET_XCPOSRRPT_REQ_STRU                       stAT_ELF_MTA_SET_XCPOSRRPT_REQ_STRU;
    AT_ELF_MTA_SET_SENSOR_REQ_STRU                          stAT_ELF_MTA_SET_SENSOR_REQ_STRU;
    AT_ELF_MTA_SET_SCREEN_REQ_STRU                          stAT_ELF_MTA_SET_SCREEN_REQ_STRU;
...
void ELF_TAF_STRU_TraceTable_MTA(void)
{
    ...
    MTA_ELF_AT_QRY_XCPOSR_CNF_STRU                          stMTA_ELF_AT_QRY_XCPOSR_CNF_STRU;
    MTA_ELF_AT_QRY_XCPOSRRPT_CNF_STRU                       stMTA_ELF_AT_QRY_XCPOSRRPT_CNF_STRU;
    MTA_ELF_AT_SET_SENSOR_CNF_STRU                          stMTA_ELF_AT_SET_SENSOR_CNF_STRU;
    MTA_ELF_AT_SET_SCREEN_CNF_STRU                          stMTA_ELF_AT_SET_SCREEN_CNF_STRU;
    ...
    MTA_MTC_SET_SENSOR_REQ_STRU                             stMTA_MTC_SET_SENSOR_REQ_STRU;
    MTA_MTC_SET_SCREEN_REQ_STRU                             stMTA_MTC_SET_SCREEN_REQ_STRU;
    /*******************  发送模块：MTA，接收模块：MTC      End   *******************/

    /*******************  发送模块：MTA，接收模块：TIMER    Begin   *******************/
    TAF_MTA_ELF_TIMER_INFO_STRU                             stTAF_MTA_ELF_TIMER_INFO_STRU;
...
void ELF_TAF_STRU_TraceTable_MTC(void)
{
    ...
    MTC_MTA_SET_SENSOR_CNF_STRU                             stMTC_MTA_SET_SENSOR_CNF_STRU;
    MTC_MTA_SET_SCREEN_CNF_STRU                             stMTC_MTA_SET_SCREEN_CNF_STRU;
...
void ELF_TAF_STRU_TraceTable_GAS(void)
{
    ...
    /*******************  发送模块：GAS，接收模块：MMC      Begin  *******************/
    RRMM_CSG_LIST_SEARCH_CNF_STRU                           stRRMM_CSG_LIST_SEARCH_CNF_STRU;
    RRMM_CSG_BG_SEARCH_CNF_STRU                             stRRMM_CSG_BG_SEARCH_CNF_STRU;
    /*******************  发送模块：GAS，接收模块：MMC      End  *******************/
}
...
void ELF_TAF_STRU_TraceTable_WRR(void)
{
    ...
    /*******************  发送模块：WRR，接收模块：MTA  End   *******************/

    /*******************  发送模块：WRR，接收模块：MMC      Begin  *******************/
    RRMM_CSG_LIST_SEARCH_CNF_STRU                           stRRMM_CSG_LIST_SEARCH_CNF_STRU;
    RRMM_CSG_BG_SEARCH_CNF_STRU                             stRRMM_CSG_BG_SEARCH_CNF_STRU;
    /*******************  发送模块：WRR，接收模块：MMC      End  *******************/
}
...
void ELF_TAF_STRU_TraceTable_ERRC(void)
{
    ...
    LRRC_MTA_CAMPED_RESTRICTED_BAND_IND_STRU                stLRRC_MTA_CAMPED_RESTRICTED_BAND_IND_STRU;
...
void ELF_TAF_STRU_TraceTable_DIAG_APP_AGENT(void)
{
    ...
    OM_NAS_ELF_ERR_LOG_RPT_CNF_STRU                         stOM_NAS_ELF_ERR_LOG_RPT_CNF_STRU;
    OM_NAS_ELF_INFO_ERR_LOG_CDMA_IND_STRU                   stOM_NAS_ELF_INFO_ERR_LOG_CDMA_IND_STRU;
...
void ELF_TAF_STRU_TraceTable_IMSA(void)
{
    /*******************  发送模块：IMSA，接收模块：AT     Begin   *******************/
    IMSA_AT_ROAMING_IMS_QRY_CNF_STRU                        stIMSA_AT_ROAMING_IMS_QRY_CNF_STRU;
    /*******************  发送模块：IMSA，接收模块：AT     End   *******************/
}


void ELF_TAF_STRU_TraceTable_VC(void)
{
    /*******************  发送模块：VC，接收模块：AT     Begin   *******************/
    VCVOICE_SET_TTYMODE_IND_STRU                        stVCVOICE_SET_TTYMODE_IND_STRU;
    /*******************  发送模块：VC，接收模块：AT     End   *******************/
}
...
void ELF_TAF_STRU_TraceTable(void)
{
    ...
    ELF_TAF_STRU_TraceTable_ERRC();

    ELF_TAF_STRU_TraceTable_WCOM();

    ELF_TAF_STRU_TraceTable_VC();

    ELF_TAF_STRU_TraceTable_OTA();

    ELF_TAF_STRU_TraceTable_IMSA();
}
