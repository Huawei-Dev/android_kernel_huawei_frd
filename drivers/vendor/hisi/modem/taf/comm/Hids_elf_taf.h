...
}AT_ELF_MTA_CLEAR_HISTORY_FREQ_REQ_STRU;
...
}AT_ELF_MTA_SET_XCPOSR_REQ_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                                       aucReserved[3];
}AT_ELF_MTA_SET_XCPOSRRPT_REQ_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                                       aucReserved[3];
}MTA_ELF_AT_QRY_XCPOSR_CNF_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                                       aucReserved[3];
}MTA_ELF_AT_QRY_XCPOSRRPT_CNF_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                                          ulRptLen;      /* 故障主动上报的内容长度,如果ulRptLen为0,aucContent内容长度也为0 */
    NAS_INFO_CLT_CLOUD_FREQ_BAND_EVENT_STRU             stContent; /* 故障主动上报的内容 */
} OM_NAS_ELF_ERR_LOG_RPT_CNF_STRU;
...
}OM_NAS_ELF_INFO_ERR_LOG_CDMA_IND_STRU;
...
}AT_ELF_MTA_SET_SENSOR_REQ_STRU;

typedef struct
{
    MN_ELF_APP_REQ_MSG_STRU
    AT_MTA_SET_SCREEN_REQ_STRU          stScreenStat;
}AT_ELF_MTA_SET_SCREEN_REQ_STRU;
...
typedef struct
{
    ...
    AT_MTA_MSG_TYPE_ENUM_UINT32                     ulMsgId;
    AT_APPCTRL_STRU                                 stAppCtrl;
    MTA_AT_SET_SENSOR_CNF_STRU                      stMtaAtSetSenorCnf;
}MTA_ELF_AT_SET_SENSOR_CNF_STRU;
...
typedef struct
{
    ...
    AT_MTA_MSG_TYPE_ENUM_UINT32                     ulMsgId;
    AT_APPCTRL_STRU                                 stAppCtrl;
    MTA_AT_SET_SCREEN_CNF_STRU                      stMtaAtSetScreenCnf;
}MTA_ELF_AT_SET_SCREEN_CNF_STRU;
