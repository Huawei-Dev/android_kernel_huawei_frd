...
{
    {AT_FREQLOCK_MODE_TYPE_GSM          ,"01"},
    {AT_FREQLOCK_MODE_TYPE_WCDMA        ,"02"},
    {AT_FREQLOCK_MODE_TYPE_TDSCDMA      ,"03"},
    {AT_FREQLOCK_MODE_TYPE_LTE          ,"04"},
};

AT_FREQLOCK_GSM_BAND_TBL_STRU    g_astFreqLockGsmBandTbl[] =
{
    {AT_FREQLOCK_BAND_TYPE_GSM_850     ,"00"},
    {AT_FREQLOCK_BAND_TYPE_GSM_900     ,"01"},
    {AT_FREQLOCK_BAND_TYPE_GSM_1800    ,"02"},
    {AT_FREQLOCK_BAND_TYPE_GSM_1900    ,"03"},
};
