...
VOS_UINT32 AT_SetEvdoSysEvent(VOS_UINT8 ucIndex)
{
    ...
    PS_MEM_SET(&stSysEvent, 0x00, sizeof(AT_MTA_EVDO_SYS_EVENT_SET_REQ_STRU));
...
VOS_UINT32 AT_SetDoSigMask(VOS_UINT8 ucIndex)
{
    ...
    PS_MEM_SET(&stSigMask, 0x00, sizeof(AT_MTA_EVDO_SIG_MASK_SET_REQ_STRU));
...
)
{
    ...
    PS_MEM_SET(pucData, '\0', ulDataLen);
