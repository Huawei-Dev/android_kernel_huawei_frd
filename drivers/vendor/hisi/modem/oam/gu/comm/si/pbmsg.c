                                        ...
                                        VOS_UINT8 ucRecord,SI_PB_RECORD_STRU *pstRecord)
{
    ...
    /*lint -e534*/
    VOS_MemCpy_s(gstPBReqUnit.aucXDNContent, ucCopyLen, pstRecord->AlphaTag, ucCopyLen);
    /*lint +e534*/
                                            ...
                                            VOS_UINT8              *pucFreeANRRecord)
{
        ...
        &&(0 != pstRecord->AdditionNumber[i].NumberLength))
    {
        ...
        /*lint -e534*/
        VOS_MemCpy_s(gstPBReqUnit.stSPBReq.aucIAPContent, gstIAPContent.ucRecordLen,
                                    ...
                                    SI_PB_SPB_UPDATE_STRU   *pstPBFid)
{
    ...
    for(i = 0; i < gstPBConfigInfo.ucAnrMaxNum; i++)
    {
        ...
        /*lint -e534*/
        VOS_MemCpy_s(gstPBReqUnit.stSPBReq.aucANRContent[i],
        ...
        /*lint -e534*/
        VOS_MemSet_s(gstPBReqUnit.stSPBReq.aucANRContent[i]+1, 12, (VOS_CHAR)0xFF, 12);
        /*lint +e534*/
        ...
        if(pstRecord->AdditionNumber[i].NumberLength > SI_PB_NUM_LEN)
        {
            ...
            {
                /*lint -e534*/
                VOS_MemSet_s(gstPBReqUnit.stSPBReq.aucANRExtContent[i], SI_PB_EXT_LEN, (VOS_CHAR)0xFF, SI_PB_EXT_LEN);
                /*lint +e534*/
                                    ...
                                    SI_PB_SPB_UPDATE_STRU    *pstPBFid)
{
    ...
    /*lint -e534*/
    VOS_MemSet_s(gstPBReqUnit.stSPBReq.aucEMLContent, SI_PB_EMAIL_MAX_LEN, (VOS_CHAR)0xFF, gstEMLContent.ucRecordLen);
    /*lint +e534*/
    ...
    /*lint -e534*/
    VOS_MemCpy_s(gstPBReqUnit.stSPBReq.aucEMLContent, ucCopyLen, pstRecord->Email.Email, ucCopyLen);
    /*lint +e534*/
                                        ...
                                        SI_PB_RECORD_STRU *pstRecord)
{
    ...
    /*lint -e534*/
    VOS_MemSet_s((VOS_VOID*)(&stSPBReq), sizeof(SI_PB_SPBDATA_STRU), 0, sizeof(SI_PB_SPBDATA_STRU));
    /*lint +e534*/
                                        ...
                                        VOS_UINT8           ucRecord)
{
    ...
    for(i = 0; i < SI_PB_ANR_MAX; i++)
    {
        ...
        {
            /*lint -e534*/
            VOS_MemCpy_s(gstPBReqUnit.stSPBReq.aucANRExtContent[i], SI_PB_EXT_LEN, aucContent, SI_PB_EXT_LEN);
            /*lint +e534*/
        ...
        {
            /*lint -e534*/
            VOS_MemCpy_s(gstPBReqUnit.stSPBReq.aucANRContent[i], gastANRContent[i].ucRecordLen, aucContent, gastANRContent[i].ucRecordLen);
            /*lint +e534*/
                                          ...
                                          VOS_UINT16          usFileId)
{
    ...
    {
        /*lint -e534*/
        VOS_MemCpy_s(gstPBReqUnit.stSPBReq.aucEMLContent, gstEMLContent.ucRecordLen, aucContent, gstEMLContent.ucRecordLen);
        /*lint +e534*/
                                      ...
                                      VOS_UINT8 ucOffset,VOS_UINT16 usIndex)
{
        ...
        &&(0xFF != ucExtRecord )&&(0 != ucExtRecord)&&(0xFFFF != usExtFileId))
    {
        gstPBReqUnit.usExtIndex = ucExtRecord;
        /*lint -e534*/
        VOS_MemCpy_s(gstPBReqUnit.aucEXTContent, SI_PB_EXT_LEN, aucContent, SI_PB_EXT_LEN);
        /*lint +e534*/
        gstPBReqUnit.aucEXTContent[0] = 0;
    ...
    {
        /*lint -e534*/
        VOS_MemCpy_s(gstPBReqUnit.aucXDNContent, ucRecordLen, aucContent, ucRecordLen);
        /*lint +e534*/
...
VOS_UINT32 SI_PB_QueryProc(PBMsgBlock *pMsg)
{
    ...
    /*lint -e534*/
    VOS_MemSet_s(&stCnfData, sizeof(SI_PB_EVENT_INFO_STRU), 0, sizeof(SI_PB_EVENT_INFO_STRU));/*初始化当前的局部变量*/
    /*lint +e534*/
...
VOS_UINT32 SI_PB_SetProc(PBMsgBlock *pMsg)
{
    ...
    /*lint -e534*/
    VOS_MemSet_s(&stCnfData, sizeof(SI_PB_EVENT_INFO_STRU), 0, sizeof(SI_PB_EVENT_INFO_STRU));/*初始化局部变量*/
    /*lint +e534*/
...
VOS_UINT32 SI_PB_SAddProc(PBMsgBlock *pMsg)
{
    ...
    /*lint -e534*/
    VOS_MemSet_s(&stSPBFid, sizeof(stSPBFid), 0, sizeof(stSPBFid));
    /*lint +e534*/
...
/*lint -restore */
    ...
    if (TAF_ERR_NO_ERROR == ulRslt)
    {
        ...
        /*lint -e534*/
        VOS_MemSet_s(pstEcallQryCnf->astECallNumber,
                     sizeof(SI_PB_ECALL_NUM_STRU) * ulRecordNum,
                     0,
                     sizeof(SI_PB_ECALL_NUM_STRU) * ulRecordNum);
        /*lint +e534*/
...
VOS_UINT32 SI_PB_RefreshMemory(VOS_UINT16 usFileId,VOS_UINT16 usRecordLen,VOS_UINT8 ucOffset,VOS_UINT8 ucRecordNum)
{
    ...
    /*lint -e534*/
    VOS_MemCpy_s(pucDstStorage, usRecordLen, pucSrcReq, usRecordLen);
    /*lint +e534*/
...
VOS_VOID SI_PB_UsimSetExtFileProc(USIMM_UPDATEFILE_CNF_STRU *pstMsg, VOS_UINT8 ucPBOffset)
{
    ...
    if(VOS_OK == pstMsg->stCmdResult.ulResult)
    {
        ...
        /*lint -e534*/
        VOS_MemCpy_s(ptemp, SI_PB_EXT_LEN, gstPBReqUnit.aucEXTContent, SI_PB_EXT_LEN);
        /*lint +e534*/
    }
    else
    {
...
VOS_VOID SI_PBSendGlobalToAcpu(VOS_VOID)
{
    ...
    /*拷贝全局 Acpu 需要的全局变量内容*/
    /*lint -e534*/
    VOS_MemCpy_s(&pstMsg->stPBCtrlInfo,   sizeof(gstPBCtrlInfo),      &gstPBCtrlInfo,  sizeof(gstPBCtrlInfo));
    VOS_MemCpy_s(&pstMsg->stPBConfigInfo, sizeof(gstPBConfigInfo),    &gstPBConfigInfo,sizeof(gstPBConfigInfo));
    VOS_MemCpy_s(pstMsg->astPBContent,    sizeof(gastPBContent),      gastPBContent,   sizeof(gastPBContent));
    VOS_MemCpy_s(pstMsg->astEXTContent,   sizeof(gastEXTContent),     gastEXTContent,  sizeof(gastEXTContent));
    VOS_MemCpy_s(pstMsg->astANRContent,   sizeof(gastANRContent),     gastANRContent,  sizeof(gastANRContent));
    VOS_MemCpy_s(&pstMsg->stEMLContent,   sizeof(gstEMLContent),      &gstEMLContent,  sizeof(gstEMLContent));
    VOS_MemCpy_s(&pstMsg->stIAPContent,   sizeof(gstIAPContent),      &gstIAPContent,  sizeof(gstIAPContent));
    VOS_MemCpy_s(&pstMsg->stPBInitState,  sizeof(gstPBInitState),     &gstPBInitState, sizeof(gstPBInitState));
    /*lint +e534*/
...
VOS_UINT32 SI_PBUsimCnfMsgProc(PBMsgBlock *pMsg)
{
    ...
    /*lint -e534*/
    VOS_MemSet_s(&stCnfData, sizeof(stCnfData), 0, sizeof(stCnfData));
    /*lint +e534*/
...
VOS_VOID SI_PB_InitGlobeVariable(VOS_VOID)
{
    ...
    {
    /*lint -e534*/
        VOS_MemSet_s(&gastPBContent[PB_ECC_CONTENT], sizeof(gastPBContent), 0, sizeof(gastPBContent));
    /*lint +e534*/
    }
    else
    {
        /*lint -e534*/
        VOS_MemSet_s(&gastPBContent[PB_ADN_CONTENT], sizeof(SI_PB_CONTENT_STRU), 0, sizeof(SI_PB_CONTENT_STRU));
        VOS_MemSet_s(&gastPBContent[PB_FDN_CONTENT], sizeof(SI_PB_CONTENT_STRU), 0, sizeof(SI_PB_CONTENT_STRU));
        VOS_MemSet_s(&gastPBContent[PB_BDN_CONTENT], sizeof(SI_PB_CONTENT_STRU), 0, sizeof(SI_PB_CONTENT_STRU));
        VOS_MemSet_s(&gastPBContent[PB_MSISDN_CONTENT], sizeof(SI_PB_CONTENT_STRU), 0, sizeof(SI_PB_CONTENT_STRU));
        VOS_MemSet_s(&gastPBContent[PB_SDN_CONTENT], sizeof(SI_PB_CONTENT_STRU), 0, sizeof(SI_PB_CONTENT_STRU));
        /*lint +e534*/
    }

    /*lint -e534*/
    VOS_MemSet_s(&gstPBSearchCtrlInfo, sizeof(SI_PB_SEARCH_CTRL_STRU), (VOS_CHAR)0xFF, sizeof(SI_PB_SEARCH_CTRL_STRU));
    /*lint +e534*/
...
VOS_UINT32 SI_PBCallback(SI_PB_EVENT_INFO_STRU *pstEvent)
{
    ...
    /*lint -e534*/
    VOS_MemCpy_s(&pstMsg->stPBAtEvent, sizeof(SI_PB_EVENT_INFO_STRU), pstEvent, sizeof(SI_PB_EVENT_INFO_STRU));
    /*lint +e534*/
