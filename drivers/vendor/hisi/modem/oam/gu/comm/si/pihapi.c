...
)
{
    ...
    /*lint -e534*/
    VOS_MemCpy_s(&(pstCrsmMsg->stMsgContent), sizeof(SI_PIH_CRSM_STRU), pstCrsmPara, sizeof(SI_PIH_CRSM_STRU));
    /*lint +e534*/
...
)
{
    ...
    /*lint -e534*/
    VOS_MemCpy_s(&(pstCrlaMsg->stMsgContent), sizeof(SI_PIH_CRLA_STRU), pstCrlaPara, sizeof(SI_PIH_CRLA_STRU));
    /*lint +e534*/
...
)
{
    ...
    {
        (VOS_VOID)VOS_MemCpy_s(pucApnData, ulDataLen, g_aucVsimAPNData, ulDataLen);  /*拷贝不包含字符串结尾*/
