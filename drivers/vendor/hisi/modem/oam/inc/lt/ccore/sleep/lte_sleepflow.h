...
struct msp_power_control
{
    ...
    VOS_UINT32                  tldsp_dfs_reqid;        /*TLDSP调频请求ID*/
    VOS_INT32                   tldsp_qos_frequency;    /*TLDSP请求的频率值*/
    VOS_INT32                   bbp_voltage;            /*BBP电压*/
    VOS_INT32                   bbp_low_voltage;        /*BBP低电压*/
...
#define TLSLEEP_DFS_DSP_300M           (300000)
...
VOS_VOID TLSLEEP_SetSramRFPowerUpTimeStamp(VOS_UINT32 timestamp);
...
VOS_VOID TLSLEEP_RttForceAwake(VOS_UINT32 awake_type);
