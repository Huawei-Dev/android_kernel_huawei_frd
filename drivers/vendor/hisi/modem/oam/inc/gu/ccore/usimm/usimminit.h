...
typedef USIMM_INITSTEPS_RST_ENUM_UINT32 (*PFAPPSETPINITPROC)(VOS_UINT8 ucChannelNo, VOS_UINT8 ucInitCnt);
...
extern VOS_VOID USIMM_COMM_ReportIccid(VOS_VOID);
...
extern VOS_UINT32 USIMM_GetAppInitList(
    USIMM_CARDAPP_ENUM_UINT32         enAppType,
