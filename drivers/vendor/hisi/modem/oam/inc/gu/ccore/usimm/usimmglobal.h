...
/*****************************************************************************
  2 宏定义
*****************************************************************************/
#define USIMM_DLAPDU_DATA_MAX       (5)
...
typedef struct
{
    VOS_UINT32                          ulDLError;          /* 当前链路层错误信息*/
    struct rtc_time                     stRtctime;
    USIMM_APDU_ST                       stApudData;
}USIMM_DLAPDULOG_STRU;

typedef struct
{
    VOS_UINT32                          ulDLMode;
    VOS_UINT32                          ulDataIndex;
    USIMM_DLAPDULOG_STRU                astDLData[USIMM_DLAPDU_DATA_MAX];
}USIMM_DLDATALOG_STRU;
...
extern USIMM_DLDATALOG_STRU             *g_pstUSIMMDLLogData;
...
extern USIMM_CARD_SERVIC_ENUM_UINT32 USIMM_CCB_GetAppStateByCH(
    VOS_UINT8                           ucChannelNo);
...
extern VOS_VOID USIMM_CCB_ClearLogDataAll(VOS_VOID);

extern VOS_VOID USIMM_CCB_ClearLogData(
    USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32  enFileType);

extern USIMM_LOGDATACTRL_STRU* USIMM_CCB_GetLogDataCtrlPtr(
    USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32  enFileType);

extern USIMM_DLDATALOG_STRU* USIMM_CCB_GetDLDataLogPtr(VOS_VOID);

extern VOS_VOID USIMM_CCB_ClearDLDataLog(VOS_VOID);

extern VOS_VOID USIMM_CCB_InitErrorInfo(VOS_VOID);

extern VOS_VOID USIMM_CCB_AddErrorInfo(
    VOS_UINT32                          ulErrInfo);

extern VOS_UINT32 USIMM_CCB_GetErrorInfoNum(VOS_VOID);
