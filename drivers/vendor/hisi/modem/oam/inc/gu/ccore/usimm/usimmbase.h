...
#define USIMM_LOG_FILE_MAX_NUM              (10)
...
/*当前记录的数据区域的大小*/
#define USIMM_LOG_DATA_MAX_LEN              (15*1024)
...
#define USIMM_ATT_LTE_DATA_NULL             (0x00)
...
/* 判断输入文件是否为DF文件 */
#define USIMM_IS_DF_FILE(usFileId)          (USIMM_DF_FILE == (((usFileId)>>0x0C)&0x01))

#if( (VOS_WIN32 == VOS_OS_VER) ||  (defined __PS_WIN32_RECUR__) )
#define USIMM_UNITARY_LOG_PATH          "Sim0"
#define USIMM_UNITARY_INITLOGCTRL_FILE  "Sim0/usimminitlogctrl.bin"
#define USIMM_UNITARY_ERRLOGCTRL_FILE   "Sim0/usimmerrlogctrl.bin"

#elif (( VOS_VXWORKS == VOS_OS_VER ) || ( VOS_RTOSCK == VOS_OS_VER ))
#if defined (INSTANCE_1)    /*SIM card 1*/
#define USIMM_UNITARY_LOG_PATH          "/modem_log/PAM/Sim1"
#define USIMM_UNITARY_INITLOGCTRL_FILE  "/modem_log/PAM/Sim1/usimminitlogctrl.bin"
#define USIMM_UNITARY_ERRLOGCTRL_FILE   "/modem_log/PAM/Sim1/usimmerrlogctrl.bin"

#elif defined (INSTANCE_2)   /*SIM card 2*/
#define USIMM_UNITARY_LOG_PATH          "/modem_log/PAM/Sim2"
#define USIMM_UNITARY_INITLOGCTRL_FILE  "/modem_log/PAM/Sim2/usimminitlogctrl.bin"
#define USIMM_UNITARY_ERRLOGCTRL_FILE   "/modem_log/PAM/Sim2/usimmerrlogctrl.bin"
#else                       /*SIM Card 0*/
#define USIMM_UNITARY_LOG_PATH          "/modem_log/PAM/Sim0"
#define USIMM_UNITARY_INITLOGCTRL_FILE  "/modem_log/PAM/Sim0/usimminitlogctrl.bin"
#define USIMM_UNITARY_ERRLOGCTRL_FILE   "/modem_log/PAM/Sim0/usimmerrlogctrl.bin"
...
/*****************************************************************************
 枚举名    : USIMM_LOGCTRLFILE_TYPE_ENUM
 结构说明  : 初始化信息文件类型
*****************************************************************************/
enum USIMM_LOGCTRLFILE_TYPE_ENUM
{
    USIMM_LOGCTRLFILE_INIT      = 0x00,
    USIMM_LOGCTRLFILE_ERROR,
    USIMM_LOGCTRLFILE_BUTT
};
typedef VOS_UINT32 USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32;

enum USIMM_ERROR_INFO_ENUM
{
    USIMM_ERROR_BASE_VALUE          = 0x10000000,
    USIMM_ERROR_CARDRESET_FAIL      = 0x10000001,
    USIMM_ERROR_GETATR_FAIL         = 0x10000002,
    USIMM_ERROR_UICCMF_FAIL         = 0x10000003,
    USIMM_ERROR_SELECTEFDIR_FAIL    = 0x10000004,
    USIMM_ERROR_READEFDIR_FAIL      = 0x10000005,
    USIMM_ERROR_DECODEEFDIR_FAIL    = 0x10000006,
    USIMM_ERROR_ICCMF_FAIL          = 0x10000007,
    USIMM_ERROR_CHANGEVCC_FAIL      = 0x10000008,
    USIMM_ERROR_PROFILEDOWN_FAIL    = 0x10000009,
    USIMM_ERROR_SELECTMF_FAIL       = 0x1000000A,
    USIMM_ERROR_CHECKCSIM_FAIL      = 0x1000000B,
    USIMM_ERROR_CHECKUIM_FAIL       = 0x1000000C,
    USIMM_ERROR_PIN1NUM_FAIL        = 0x1000000D,
    USIMM_ERROR_INITPIN1_FAIL       = 0x1000000E,
    USIMM_ERROR_INITPUK1_FAIL       = 0x1000000F,

    /*文件缺失类错误会把文件ID放在后2字节上报*/
    USIMM_ERROR_SIMFILE_FAIL        = 0x10010000,
    USIMM_ERROR_USIMFILE_FAIL       = 0x10020000,
    USIMM_ERROR_ISIMFILE_FAIL       = 0x10030000,
    USIMM_ERROR_UIMFILE_FAIL        = 0x10040000,
    USIMM_ERROR_CSIMFILE_FAIL       = 0x10050000,
    USIMM_ERROR_NVREAD_FAIL         = 0x10060000,
    USIMM_ERROR_INFO_BUTT
};
typedef VOS_UINT32 USIMM_ERROR_INFO_ENUM_UINT32;
...
typedef struct
{
    ...
    struct rtc_time                         stCurRTCTime;
    VOS_UINT32                              ulDataLen;
    VOS_UINT8                               *pucData;
}USIMM_LOGDATACTRL_STRU;

typedef struct
{
    struct rtc_time                         stRTCTimeInfo;
    VOS_CHAR                                aucFileName[USIMM_LOG_FILE_NAME_LEN];
}USIMM_LOGFILEINFO_STRU;

typedef struct
{
    VOS_UINT32                              ulCurFile;
    USIMM_LOGFILEINFO_STRU                  astLogInfo[USIMM_LOG_FILE_MAX_NUM];
...
extern USIMM_LOGDATACTRL_STRU                g_astUSIMMLogData[USIMM_LOGCTRLFILE_BUTT];
...
extern USIMM_ERRORINFO_DATA_STRU        g_stUSIMMErrorInfo;
...
extern VOS_UINT32 USIMM_IsFileDefIdExistInPool(
    USIMM_CARDAPP_ENUM_UINT32           enAppType,
    USIMM_DEF_FILEID_ENUM_UINT32        enFileID);
...
/*log保存接口*/
extern VOS_UINT32 USIMM_CheckCtrlFile(
    USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32  enFileType);

extern VOS_CHAR* USIMM_GetCtrlFilePath(
    USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32  enFileType);

extern VOS_UINT32 USIMM_CreatCtrlLog(
    VOS_CHAR                            *pcFilePath,
    VOS_CHAR                            *pcCtrlFilePath,
    USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32  enFileType);

extern VOS_VOID USIMM_InitUsimmLogFile(VOS_VOID);

extern VOS_VOID USIMM_WriteLogToFile(
    USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32  enFileType);

extern VOS_VOID USIMM_SaveLogData(
    USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32  enFileType,
    VOS_UINT8                           *pucData,
    VOS_UINT8                           ucDataLen);

extern VOS_VOID USIMM_StartLogData(
    USIMM_LOGCTRLFILE_TYPE_ENUM_UINT32  enFileType);

extern VOS_VOID USIMM_ERROR_LOG(
    VOS_CHAR                            *pcString);

extern VOS_VOID USIMM_InitDLLogFile(VOS_VOID);
...
#if( (VOS_WIN32 == VOS_OS_VER) ||  (defined __PS_WIN32_RECUR__) )
#define USIMM_UNITARY_LOG_PATH          "Sim1"

#define USIMM_UNITARY_LOGCTRL_FILE      "Sim1/usimmlogctrl.bin"

#elif (( VOS_VXWORKS == VOS_OS_VER ) || ( VOS_RTOSCK == VOS_OS_VER ))
#if defined (INSTANCE_1)    /*SIM card 1*/
#define USIMM_UNITARY_LOG_PATH          "/modem_log/PAM/Sim1"

#define USIMM_UNITARY_LOGCTRL_FILE      "/modem_log/PAM/Sim1/usimmlogctrl.bin"
#elif defined (INSTANCE_2)   /*SIM card 2*/
#define USIMM_UNITARY_LOG_PATH          "/modem_log/PAM/Sim2"

#define USIMM_UNITARY_LOGCTRL_FILE      "/modem_log/PAM/Sim2/usimmlogctrl.bin"
#else                       /*SIM Card 0*/
#define USIMM_UNITARY_LOG_PATH          "/modem_log/PAM/Sim0"

#define USIMM_UNITARY_LOGCTRL_FILE      "/modem_log/PAM/Sim0/usimmlogctrl.bin"
...
VOS_VOID USIMM_RefreshTypeInd(USIMM_STKREFRESH_REQ_STRU *pstMsg);
...
/*外部接口*/
extern VOS_UINT32 USIMM_SearchCHFree(VOS_VOID);
