...
typedef enum {
	...
	HOOK_POS_IF4               = 0x00000008,
	HOOK_POS_IF5               = 0x00000010,
	HOOK_POS_IF6               = 0x00000020,
	HOOK_POS_IF7               = 0x00000040,
	HOOK_POS_IF8               = 0x00000080,
	HOOK_POS_ANC_CORE          = 0x00000100,
	HOOK_POS_LOG               = 0x00000200,
	HOOK_POS_ANC_PCM_RX_VOICE  = 0x00000400,
	HOOK_POS_ANC_PCM_REF       = 0x00000800,
	HOOK_POS_ANC_PCM_ERR       = 0x00001000,
	HOOK_POS_ANC_PCM_ANTI      = 0x00002000,
	HOOK_POS_ANC_PCM_TX_VOICE  = 0x00004000,
	HOOK_POS_ANC_CS_OUT        = 0x00008000,
	HOOK_POS_PA_EFFECTIN       = 0x00010000,
	HOOK_POS_PA_EFFECTOUT      = 0x00020000,
	HOOK_POS_WAKEUP_MICIN      = 0x00040000,
	HOOK_POS_WAKEUP_EFFECTOUT  = 0x00080000,
	HOOK_POS_PA_I              = 0x00100000,
	HOOK_POS_PA_V              = 0x00200000,
	HOOK_POS_NONE_TEST         = 0x01054200,
}hook_pos;
...
enum APDSP_MSG_ENUM
{
	...
	ID_AP_DSP_HOOK_START       = 0xDD62,  /*AP发给DSP的开始hook数据消息*/
	ID_AP_DSP_HOOK_STOP        = 0xDD63,  /*AP发给DSP的停止hook数据消息*/
	ID_AP_DSP_SET_OM_BW        = 0xDD64,  /*AP发给DSP的设置维测带宽消息*/
	ID_AP_AP_SET_HOOK_PATH     = 0xDD65,  /* user空间发给维测模块的设置维测日志保存路径的消息*/
	ID_AP_DSP_PWR_TEST_WFI_IN  = 0xDD70,
	ID_AP_DSP_PWR_TEST_WFI_OUT = 0xDD71,
	ID_AP_DSP_PWR_TEST_WFI_LOWPLL_IN  = 0xDD72,
	ID_AP_DSP_PWR_TEST_WFI_LOWPLL_OUT = 0xDD73,
	ID_AP_DSP_DEBUG_MSG        = 0xDD74,  /* for dsp debug message */
