...
/** for chicago only **/
/** 非安全区 3.5M **/
/* |~hifi unsec~|~PCM data  ~|~hifi uart ~|~panic stack|~icc debug~ |~0xom log  ~|~flag data ~|~DDR sec head~|~~~AP NV ~~~|~AP&HIFI MB~|~unsec reserve| */
/* |~Music data~|~~~PCM data~|~~hifi uart~|~panic stack|~icc debug~~|~~~OM log~~~|~flag data ~|~DDR sec head~|~~~AP NV ~~~|~AP&HIFI MB~|~unsec reserve| */
/* |~~~~~1M~~~~~|~~~~~1M~~~~~|~~~508k~~~~~|~~~~~~4k~~~~|~~~~100k~~~~|~~~~392k~~~~|~~~~~4k~~~~~|~~~~~~4k~~~~~~|~~~~202k~~~~|~~~~~64k~~~~|~~~~~~258k~~~~| */

/** 安全区 9.5 M**/
/* |~~~secddrbase~~~|~~~ocram img ~~~|~~~tcm bak   ~~|~~~img bak   ~~~|~~~sec reserv~~~| */
/* |~~HIFI RUNNING~~|~OCRAM img bak~~|~~TCM img bak~~|~~~~IMG bak~~~~~|~~~sec reserve~~| */
/* |~~~~~~~5M~~~~~~~|~~~~~~192K~~~~~~|~~~~~208k~~~~~~|~~~~~4M-88k ~~~~|~~~~~200k~~~~~~~| */
