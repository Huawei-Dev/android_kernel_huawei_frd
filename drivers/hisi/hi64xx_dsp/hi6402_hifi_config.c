...
{
	unsigned int original_val = 0;

	original_val = hi64xx_hifi_read_reg(HI6402_MISC_RECORD_SN_ADDR);
	hi64xx_hifi_write_reg(HI6402_MISC_RECORD_SN_ADDR, ++original_val);
...
static void hi6402_hifi_clear_msg_sn(void)
{
	hi64xx_hifi_write_reg(HI6402_MISC_RECORD_SN_ADDR, 0);
	hi64xx_hifi_write_reg(HI6402_DSP_RECORD_SN_ADDR, 0);
}
				...
				struct hi64xx_irq *irqmgr)
{
	...
	dsp_config.dsp_ops.clear_msg_sn = hi6402_hifi_clear_msg_sn;
