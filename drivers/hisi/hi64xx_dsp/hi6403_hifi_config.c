				...
				struct hi64xx_irq *irqmgr)
{
	...
	dsp_config.dump_ocram_addr = HI6403_DUMP_OCRAM_ADDR;
	dsp_config.dump_ocram_size = HI6403_DUMP_OCRAM_SIZE;
	dsp_config.dump_log_addr = HI6403_DUMP_LOG_ADDR;
	dsp_config.dump_log_size = HI6403_DUMP_LOG_SIZE;
