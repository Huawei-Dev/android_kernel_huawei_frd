...
/*lint -e813*/
    ...
    /*lint -e534*/
    VOS_MemSet_s(&stEvent, sizeof(stEvent), 0, sizeof(stEvent));
    /*lint +e534*/
    ...
    if (VOS_TRUE == pstRspData->uResp.CallCtrlRsp.OP_Alaph)
    {
        ...
        /*lint -e534*/
        VOS_MemCpy_s(stEvent.STKCmdStru.CmdStru.STKCcIndInfo.stAlphaIdInfo.aucAlphaId,
                     stEvent.STKCmdStru.CmdStru.STKCcIndInfo.stAlphaIdInfo.ulAlphaLen,
    ...
    if (VOS_TRUE == pstRspData->uResp.CallCtrlRsp.OP_SepcialData)
    {
        ...
        /*lint -e534*/
        VOS_MemCpy_s(stEvent.STKCmdStru.CmdStru.STKCcIndInfo.uInfo.stCtrlDataInfo.aucData,
                     pstRspData->uResp.CallCtrlRsp.SpecialData.ucLen - 1,
...
/*lint -e813*/
    ...
    if (VOS_TRUE == pstRspData->uResp.MoSmsCtrlRsp.OP_Addr1)
    {
        ...
        /*lint -e534*/
        VOS_MemCpy_s(stEvent.STKCmdStru.CmdStru.STKCcIndInfo.uInfo.stMoSmsCtrlInfo.stDstAddrInfo.aucAddr,
                     pstRspData->uResp.MoSmsCtrlRsp.Addr1.ucLen,
    ...
    if (VOS_TRUE == pstRspData->uResp.MoSmsCtrlRsp.OP_Addr2)
    {
        ...
        /*lint -e534*/
        VOS_MemCpy_s(stEvent.STKCmdStru.CmdStru.STKCcIndInfo.uInfo.stMoSmsCtrlInfo.stSerCenterAddrInfo.aucAddr,
                     pstRspData->uResp.MoSmsCtrlRsp.Addr2.ucLen,
    ...
    SI_STK_ENVELOPE_RSP_STRU            *pstRspData)
{
    ...
    for(i=0; i<sizeof(aucTagList); i++)
    {
        ...
        if(ulCCTagOffset != SI_TAGNOTFOUND)
        {
            ...
            {
                /*lint -e534*/
                VOS_MemCpy_s(pstRspData->uResp.CallCtrlRsp.SpecialData.pValue,
    ...
    SI_STK_ENVELOPE_RSP_STRU            *pstRspData)
{
    ...
    if(ulTagOffset != SI_TAGNOTFOUND)
    {
        ...
        {
            /*lint -e534*/
            VOS_MemCpy_s(pstRspData->uResp.MoSmsCtrlRsp.Addr1.pucAddr,
                         pstRspData->uResp.MoSmsCtrlRsp.Addr1.ucLen,
    ...
    if(ulTagOffset != SI_TAGNOTFOUND)
    {
        ...
        {
            /*lint -e534*/
            VOS_MemCpy_s(pstRspData->uResp.MoSmsCtrlRsp.Addr2.pucAddr,
                         pstRspData->uResp.MoSmsCtrlRsp.Addr2.ucLen,
                         &pucCmdData[ulTagOffset+2],
                         pstRspData->uResp.MoSmsCtrlRsp.Addr2.ucLen);
            /*lint +e534*/
    ...
    VOS_UINT8                           *pucData)
{
    ...
    {
        /*lint -e534*/
        VOS_MemCpy_s(pstSTKReq->Data, ulDataLen, pucData, ulDataLen);
        /*lint +e534*/
    }
