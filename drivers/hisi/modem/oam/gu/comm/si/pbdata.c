    ...
    VOS_UINT32                          ulCmpNumLen)
{
    ...
    {
        (VOS_VOID)VOS_MemSet_s(stUsimmFeatureCfg.unCfg.aulValue ,
...
VOS_UINT32 SI_PB_BcdCompare(VOS_UINT8 *pucBcdNumSrc, VOS_UINT8 ucBcdSrcLen, VOS_UINT8 *pucFdnBcdNum, VOS_UINT8 ucFdnBcdLen)
{
    ...
    /*lint -e534*/
    VOS_MemSet_s(aucFdnNum, sizeof(aucFdnNum), (VOS_CHAR)0xFF, sizeof(aucFdnNum));

    VOS_MemSet_s(aucCmpNum, sizeof(aucCmpNum), (VOS_CHAR)0xFF, sizeof(aucCmpNum));
    /*lint +e534*/
...
VOS_UINT32 SI_PB_CheckEXT2(VOS_UINT8 ucExtRecord, VOS_UINT32 ulExtInfoNum, VOS_UINT8 *pucDstNum, VOS_UINT8 *pucExNumLen)
{
    ...
    /*lint -e534*/
    VOS_MemCpy_s(pucDstNum, ucExNumLen, (pExTemp+2), ucExNumLen);
    /*lint +e534*/
...
VOS_UINT32 SI_PB_CheckFdn(VOS_UINT8 *pucNum, VOS_UINT32 ulNumLength)
{
    ...
    for(i=0; i<usTotalNum; i++)   /*根据数据结构最大长度循环*/
    {
        ...
        /*lint -e534*/
        VOS_MemCpy_s(aucNumber, ucNumLen, pTemp+2, ucNumLen);
        /*lint +e534*/
...
/*lint -restore */
                ...
                &&(ucExtRecord <= gastEXTContent[ulExtInfoNum].usExtTotalNum))
        {
            ...
            /*lint -e534*/
            VOS_MemCpy_s(pstEcallNum->aucCallNumber, (SI_PB_NUM_LEN/2), pucTmp + pstXdnContent->ucNameLen + 2, (SI_PB_NUM_LEN/2));
            VOS_MemCpy_s(pstEcallNum->aucCallNumber + (SI_PB_NUM_LEN/2), (SI_PB_NUM_LEN/2), pucExtContent + 2, (SI_PB_NUM_LEN/2));
            /*lint +e534*/
