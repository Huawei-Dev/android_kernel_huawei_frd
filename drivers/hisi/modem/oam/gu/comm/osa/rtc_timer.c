...
VOS_VOID RTC_SocTimerMemDump(VOS_VOID)
{
    ...
    /*lint -e534*/
    VOS_MemSet_s((VOS_VOID *)pucDumpBuffer, ulBufferSize, 0, VOS_DUMP_MEM_TOTAL_SIZE);

    VOS_MemCpy_s((VOS_VOID *)pucDumpBuffer, ulBufferSize, (VOS_VOID *)g_acRtcTimerCtrlBuf, RTC_TIMER_CTRL_BUF_SIZE);
    /*lint +e534*/
    ...
    /*lint -e534*/
    VOS_MemCpy_s((VOS_VOID *)pucDumpBuffer, ulBufferSize, (VOS_VOID *)g_astRtcSocTimerDebugInfo, sizeof(g_astRtcSocTimerDebugInfo));
    /*lint +e534*/
    ...
    /*lint -e534*/
    VOS_MemCpy_s((VOS_VOID *)pucDumpBuffer, ulBufferSize, (VOS_VOID *)(&g_stRtcSocTimerInfo), sizeof(g_stRtcSocTimerInfo));
    /*lint +e534*/
