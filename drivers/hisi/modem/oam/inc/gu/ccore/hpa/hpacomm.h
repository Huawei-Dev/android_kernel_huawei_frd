...
typedef struct
{
    ...
    VOS_UINT_PTR          ulWBBP0BaseAddr;
    VOS_UINT_PTR          ulWBBP0DRXBaseAddr;
    VOS_UINT_PTR          ulWBBP1BaseAddr;
    VOS_UINT_PTR          ulWBBP1DRXBaseAddr;
...
extern VOS_VOID HPA_Conncet3GISR0(VOS_VOID);

extern VOS_VOID HPA_Conncet3GISR1(VOS_VOID);
...
extern VOS_VOID HPA_3GAwakeIsr(MODEM_ID_ENUM_UINT16 enModemID);

extern VOS_VOID HPA_3GAwakeIsr0(VOS_VOID);

extern VOS_VOID HPA_3GAwakeIsr1(VOS_VOID);
...
extern VOS_VOID HPA_3GSwitchClockIsr(MODEM_ID_ENUM_UINT16 enModemID);

extern VOS_VOID HPA_3GSwitchClockIsr0(VOS_VOID);

extern VOS_VOID HPA_3GSwitchClockIsr1(VOS_VOID);
