...
enum USIMMDL_DRV_API_NUM_ENUM
{
    ...
    USIMM_DRV_FILEAPI_FOPEN             = 0x02F0,
    USIMM_DRV_FILEAPI_FWRITE            = 0x02F1,
    USIMM_DRV_FILEAPI_FREAD             = 0x02F2,
    USIMM_DRV_FILEAPI_FCLOSE            = 0x02F3,
    USIMM_DRV_FILEAPI_FSEEK             = 0x02F4,
    USIMM_DRV_FILEAPI_FREMOVE           = 0x02F5,
    USIMM_DRV_FILEAPI_MAKEDIR           = 0x02F6,
...
extern VOS_VOID USIMM_DLLogDataSave(
    VOS_UINT32                          enDLMode,
    VOS_UINT32                          ulDLResult);
