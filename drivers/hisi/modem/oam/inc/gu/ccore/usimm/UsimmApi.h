...
#if (OSA_CPU_CCPU == VOS_OSA_CPU)
extern VOS_VOID USIMM_SciCardStatusNotifySndMsg(
    VOS_UINT32                          ulSenderPid,
    VOS_UINT32                          ulReceiverPid,
...
extern VOS_VOID USIMM_CardErrorEventInd(VOS_VOID);

extern VOS_VOID USIMM_CardEventInt(VOS_VOID);
...
/* 定义USIM初始化列表长度 */
#define USIMM_INIT_USIM_CARD_NUM        (13)
