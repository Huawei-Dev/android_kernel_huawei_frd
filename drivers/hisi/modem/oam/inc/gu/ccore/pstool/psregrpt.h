...
enum PS_REG_DMA_CHANNEL_ENUM
{
    PS_REG_DMA_CHANNEL_0,
    PS_REG_DMA_CHANNEL_1,
    PS_REG_DMA_CHANNEL_2,
    PS_REG_DMA_CHANNEL_BUTT
};
typedef VOS_UINT16  PS_REG_DMA_CHANNEL_ENUM_UINT32;
...
typedef struct
{
    VOS_UINT32          ulDmaBusySlice;           /* 记录EDMA通道处于忙态slice */
    VOS_UINT32          ulGetDmaLliAddrFailSlice; /* 记录获取EDMA链表地址失败slice */
    VOS_UINT32          ulSetDmaNodeFailSlice;    /* 记录设置EDMA链表节点地址失败slice */
    VOS_UINT32          ulDmaStartFailSlice;      /* 记录启动EDMA抓寄存器失败slice */
    VOS_UINT32          ulDmaStartSunccSlice;     /* 记录成功启动EDMA抓寄存器slice */
    VOS_UINT32          ulIsrRptSlice;            /* 记录EDMA中断上报slice */
}PS_REG_CAP_TIME_STRU;


typedef struct
{
    PS_REG_CAP_TIME_STRU  astPsRegCapInfo[PS_REG_DMA_CHANNEL_BUTT];
}PS_REG_EDMA_CAP_TIME_STRU;
