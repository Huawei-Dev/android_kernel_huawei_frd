# MD5: 665e9f6ff78ea742ab052c01691b0b45
...
set(CFG_PRODUCT_VERSION V700R500C31B120) 

set(CFG_PRODUCT_VERSION_STR "V700R500C31B120") 

set(CFG_PRODUCT_FULL_VERSION_STR "Balong V700R500C31B120") 

set(CFG_PRODUCT_FILE_VERSION_STR "2.1.6.8") 

set(CFG_PRODUCT_DLOAD_SOFTWARE_VER		 "21.120.00.00.120") 
...
set(CFG_PRODUCT_HISILICON_VERSION hi6960) 
...
set(CFG_XTENSA_CORE				 Boston_bbe16_cache_tl) 

set(CFG_TENSILICA_BUILDS	 $(ROOT_XTENSA_PATH_W)/XtDevTools/install/builds/RF-2015.3-linux) 

set(CFG_TENSILICA_TOOLS	 $(ROOT_XTENSA_PATH_W)/XtDevTools/install/tools/RF-2015.3-linux) 
...
set(CFG_XTENSA_SYSTEM			 $(ROOT_XTENSA_PATH_W)/XtDevTools/install/builds/RF-2015.3-linux/$(CFG_XTENSA_CORE)/config) 

set(LPHY_LD_MAP_PUB_PATH modem/phy/lt/Tensilica_LSP/BBE16_V7R6_LSP/mainlsp) 

set(LPHY_LD_SDR_LIB_FILE	 BBE16_V760_O2) 

set(LPHY_XTENSA_RULES cc_tensilica5.0.5_rules_boston.mk) 

set(CFG_LPHY_PUB_DTCM_BASE	 0xE3000000) 

set(CFG_LPHY_PUB_ITCM_BASE	 0xE3100000) 

set(CFG_LPHY_PRV_DTCM_BASE	 0xE3060000) 

set(CFG_LPHY_PRV_ITCM_BASE	 0xE3160000) 

set(CFG_LPHY_PUB_DTCM_SIZE		 0x60000) 

set(CFG_LPHY_PUB_ITCM_SIZE		 0x60000) 

set(CFG_LPHY_PRV_DTCM_SIZE 0xA0000) 

set(CFG_LPHY_PRV_ITCM_SIZE 0xA0000) 

set(CFG_LPHY_LTE_DTCM_SIZE		 0xA0000) 

set(CFG_LPHY_LTE_ITCM_SIZE		 0xA0000) 
...
set(CFG_TL_PHY_ASIC_V760    	 YES) 

set(CFG_TL_PHY_BBE16_CACHE NO) 

set(CFG_TL_PHY_HI6960         	 YES) 
...
set(CFG_CONFIG_TSENSOR_V610 YES) 
...
set(CFG_CONFIG_GET_SYSTEM_STATUS YES) 
...
set(CFG_CONFIG_DDR_AUTOSREF YES) 
...
set(CFG_FEATURE_TLPHY_DPD FEATURE_OFF) 
