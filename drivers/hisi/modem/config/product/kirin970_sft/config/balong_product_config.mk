...
CFG_PRODUCT_HISILICON_VERSION               :=hi6960
...
CFG_XTENSA_CORE				:=Boston_bbe16_cache_tl
CFG_TENSILICA_BUILDS	    :=$(ROOT_XTENSA_PATH_W)/XtDevTools/install/builds/RF-2015.3-linux
CFG_TENSILICA_TOOLS	        :=$(ROOT_XTENSA_PATH_W)/XtDevTools/install/tools/RF-2015.3-linux
...
CFG_XTENSA_SYSTEM			:=$(ROOT_XTENSA_PATH_W)/XtDevTools/install/builds/RF-2015.3-linux/$(CFG_XTENSA_CORE)/config
LPHY_LD_MAP_PUB_PATH        :=modem/phy/lt/Tensilica_LSP/BBE16_V7R6_LSP/mainlsp
LPHY_LD_SDR_LIB_FILE	    :=BBE16_V760_O2
LPHY_XTENSA_RULES           :=cc_tensilica5.0.5_rules_boston.mk
CFG_LPHY_PUB_DTCM_BASE	    :=0xE3000000
CFG_LPHY_PUB_ITCM_BASE	    :=0xE3100000
CFG_LPHY_PRV_DTCM_BASE	    :=0xE3060000
CFG_LPHY_PRV_ITCM_BASE	    :=0xE3160000
CFG_LPHY_PUB_DTCM_SIZE		:=0x60000
CFG_LPHY_PUB_ITCM_SIZE		:=0x60000
CFG_LPHY_PRV_DTCM_SIZE      :=0xA0000
CFG_LPHY_PRV_ITCM_SIZE      :=0xA0000
CFG_LPHY_LTE_DTCM_SIZE		:=0xA0000
CFG_LPHY_LTE_ITCM_SIZE		:=0xA0000
...
CFG_TL_PHY_ASIC_V760    	:= YES
CFG_TL_PHY_BBE16_CACHE          := NO
CFG_TL_PHY_HI6960         	:= YES
