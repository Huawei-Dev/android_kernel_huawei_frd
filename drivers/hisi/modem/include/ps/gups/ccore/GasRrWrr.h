...
enum RR_WRRC_MSG_TYPE_ENUM
{
    ...
    WRRCRR_SEARCHED_PLMN_INFO_IND                         = 0x997B,       /* _H2ASN_MsgChoice WRRCRR_SEARCHED_PLMN_INFO_IND_STRU */
    RRWRRC_SEARCHED_PLMN_INFO_IND                         = 0x997C,       /* _H2ASN_MsgChoice RRWRRC_SEARCHED_PLMN_INFO_IND_STRU */
...
#define WRRC_RR_LAC_INVALID_VALUE                      (0xFFFF)                 /* GU之间LAC无效值 */
...
{
    WRRCRR_PLMN_ID_STRU                 stPlmnId;           /* PLMN ID    */
    VOS_UINT16                          usLac;              /* 位置区信息,如果没有位置信息，填WRRC_RR_LAC_INVALID_VALUE, 0xFFFF*/
    VOS_UINT8                           aucReserved[2];
}WRRCRR_PLMN_ID_WITH_RAC_STRU;
...
typedef enum
{
    EN_RRC_RR_SEARCH_BG_SPEC                 = 0,                               /* WAS/GAS通知GAS/WAS做背景搜 */
    EN_RRC_RR_SEARCH_PLMN_USER_LIST             ,                               /* WAS/GAS通知GAS/WAS做PLMN LIST搜  */
    EN_RRC_RR_SEARCH_NET_SCAN                   ,                               /* WAS/GAS通知GAS/WAS做NET SCAN搜  */
    EN_RRC_RR_SEARCH_BG_HIGH_RAT                ,                               /* 高优先级RAT BG搜 */

    EN_RRC_RR_SEARCH_BG_HISTORY                 ,                               /* WAS/GAS通知GAS/WAS做BG HISTORY搜 */
    EN_RRC_RR_SEARCH_PLMN_INTER_LIST            ,                               /* WAS/GAS通知GAS/WAS做PLMN INTER LIST搜 */
    EN_RRC_RR_SEARCH_PLMN_INTER_LIST_PREFER_BAND,                               /* WAS/GAS通知GAS/WAS做PLMN INTER LIST PREFER_BAND搜 */
...
typedef struct
{
    ...
    VOS_UINT32                          ulPlmnNum;                              /* PLMN的个数，个数范围[0,WRRCRR_MAX_AVAIL_PLMN_NUM] */
    WRRCRR_PLMN_ID_STRU                 astPlmnId[WRRCRR_MAX_EQUAL_PLMN_NUM];   /* PlMN标识数组，背景搜仅下发一个，而HISTORY背景搜、PREFER BAND背景搜时可以下发多个 */
...
typedef struct
{
    ...
    VOS_UINT32                          ulAvailPlmnNum;        /* PLMN ID个数,范围[0, WRRCRR_MAX_AVAIL_PLMN_NUM] */
    WRRCRR_PLMN_ID_WITH_RAC_STRU        astPlmnWithLacList[WRRCRR_MAX_AVAIL_PLMN_NUM];       /* PlMN标识 */
}WRRCRR_SEARCHED_PLMN_INFO_IND_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                          ulAvailPlmnNum;        /* PLMN ID个数,范围[0, WRRCRR_MAX_AVAIL_PLMN_NUM] */
    WRRCRR_PLMN_ID_WITH_RAC_STRU        astPlmnWithLacList[WRRCRR_MAX_AVAIL_PLMN_NUM];       /* PlMN标识 */
}RRWRRC_SEARCHED_PLMN_INFO_IND_STRU;
