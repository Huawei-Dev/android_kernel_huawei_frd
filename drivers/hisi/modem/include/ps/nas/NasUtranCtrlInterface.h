...
enum NAS_UTRANCTRL_ROAM_ZONE_ENUM
{
    NAS_UTRANCTRL_ROAM_ZONE_UNKNOWN,                                            /* 未知的区域 */
    NAS_UTRANCTRL_ROAM_ZONE_CHINA_MAINLAND,                                     /* UE 漫游在中国大陆地区 */
    NAS_UTRANCTRL_ROAM_ZONE_CHINA_BORDER,                                       /* UE 漫游在中国大陆边境 */
    NAS_UTRANCTRL_ROAM_ZONE_OUTSIDE_CHINA_MAINLAND,                             /* UE 漫游在中国大陆以外的地区 */
    NAS_UTRANCTRL_ROAM_ZONE_BUTT
};
typedef VOS_UINT8 NAS_UTRANCTRL_ROAM_ZONE_ENUM_UINT8;
