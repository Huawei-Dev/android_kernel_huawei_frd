...
enum TRRC_ERRORLOG_ALARM_ID_ENUM
{
    ...
    TRRC_ERRORLOG_ALARM_ID_OUT_OF_SYNC,             /* TRRC发生了失步流程 */
    TRRC_ERRORLOG_ALARM_ID_OUT_OF_SYNC_CELL_UPDATE, /* TRRC先失步，然后又走了CELL UPDATE流程 */
    TRRC_ERRORLOG_ALARM_ID_CS_ASY_CELL_UPDATE,      /* 打电话过程中，TRRC先失步，然后又走了CELL UPDATE流程 */
...
enum TRRC_APP_ERROR_CODE_ENUM
{
    ...
    TRRC_APP_OUT_OF_SYNC                          = 99, /*TRRC发生了失步流程*/
    TRRC_APP_OUT_OF_SYNC_CELL_UPDATE              = 101,/*TRRC先发生失步流程，然后又走了CELL UPDATE流程*/
    TRRC_APP_CS_OUT_OF_SYNC_CELL_UPDATE           = 102,/*CS CALL时，TRRC先发生失步流程，然后又走了CELL UPDATE流程*/
...
#if (FEATURE_ON == FEATURE_PTM)
/*****************************************************************************
 枚举名    : TRRC_CHR_OUT_OF_SYNC_CAUSE_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : 失步时上报的具体原因值
*****************************************************************************/
enum TRRC_CHR_OUT_OF_SYNC_CAUSE_ENUM
{
    ...
    TRRC_CHR_OUTOFSYNC_INTRAFREQDISTURB            = 1,    /*同频干扰*/
    TRRC_CHR_OUTOFSYNC_NETWORKCONFIGUNREASONABLE   = 2,    /*网络配置不合理*/
...
typedef struct
{
    PS_BOOL_ENUM_UINT8                              enOutOfSyncCellUpdtFailFlg; /* 判断流程是否发生了先失步然后又走了CELL UPDATE*/
    VOS_INT8                                        ucCellUpdateRscp;           /* CELL UPDATE时的小区能量 */
    VOS_INT8                                        ucOutOfSyncRscp;            /* 失步时服务小区的能量 */
    PS_BOOL_ENUM_UINT8                              enRrcConnRelFlag;           /* 判断本次的CELL UPDATE FAIL是否是由于发生了RRC CONN REL导致的*/
    VOS_UINT16                                      usOutOfSyncFreq;            /* 失步时服务小区的频点 */
    VOS_UINT16                                      usOutOfSyncParaId;          /* 失步时服务小区的cellParameters ID */
    VOS_UINT16                                      usCellUpdateFreq;           /* CELL UPDATE时的频点 */
    VOS_UINT16                                      usCellUpdateParaId;         /* CELL UPDATE时的小区ID */
    VOS_UINT32                                      ulOutOfSyncIdentityId;      /* SIB3中携带的cellIdentity ID */
    VOS_UINT32                                      ulCellUpdtIdentityId;       /* SIB3中携带的cellIdentity ID */
...
typedef struct
{
    ...
    TRRC_APP_ERROR_CODE_ENUM_UINT8                      enErrorCode;                                          /* 错误码*/
    VOS_UINT8                                           aucResv[3];                                           /* 保留位*/
    TRRC_CHR_OUT_OF_SYNC_CAUSE_ENUM_UINT8               enOutOfSyncCause[TRRC_CHR_OUT_OF_SYNC_REACH_RPT_NUM]; /* 失步的具体原因值*/
    VOS_INT8                                            ucIntraFreqRscp[TRRC_CHR_OUT_OF_SYNC_REACH_RPT_NUM];  /* 同频小区能量 */
    VOS_UINT32                                          ulAsyMsgBitmap;                                       /* 记录失步时某些信息的BIT MAP，具体见上面介绍*/
    VOS_UINT32                                          ulAsyAssistMsgBitmap;                                 /* 辅助定位usAsyMsgBitmap中信息的BIT MAP*/
    VOS_UINT32                                          ulTrrcT314Length;                                     /* UE使用的T314定时器的时长 */
    VOS_UINT32                                          ulTrrcT315Length;                                     /* UE使用的T315定时器的时长 */
    VOS_UINT32                                          ulMcc;                                                /* 当前服务小区所在PLMN的Mcc*/
    VOS_UINT32                                          ulMnc;                                                /* 当前服务小区所在PLMN的Mnc*/
    VOS_UINT16                                          usLac;                                                /* 当前服务小区所在的Lac*/
    VOS_UINT16                                          usServFreq;                                           /* 服务小区频点 */
    VOS_UINT16                                          usServParaId;                                         /* 服务小区的cellParameters ID */
    VOS_INT8                                            ucServRscp[TRRC_CHR_OUT_OF_SYNC_REACH_RPT_NUM];       /* 服务小区能量 */
    VOS_UINT32                                          ulServIdentityId;                                     /* SIB3中携带的cellIdentity ID */
...
typedef struct
{
    ...
    VOS_UINT16                                          usOutOfSyncParaId;        /* 失步时服务小区的cellParameters ID */
    VOS_UINT16                                          usCellUpdateFreq;         /* CELL UPDATE时的频点 */
    VOS_UINT16                                          usCellUpdateParaId;       /* CELL UPDATE时的小区cellParameters ID */
    VOS_UINT32                                          ulAsyToCellUpdtTimeDiff;  /* OUT OF SYNC到第一次CELL UPDATE的时长 */
    VOS_UINT32                                          ulOutOfSyncIdentityId;    /* SIB3中携带的cellIdentity ID */
    VOS_UINT32                                          ulCellUpdtIdentityId;     /* SIB3中携带的cellIdentity ID */
    VOS_UINT32                                          ulTrrcT314Length;         /* UE使用的T314定时器的时长 */
    VOS_UINT32                                          ulTrrcT315Length;         /* UE使用的T315定时器的时长 */
...
typedef struct
{
    ...
    PS_BOOL_ENUM_UINT8                                  enRrcConnRelFlag;         /* 判断本次的CELL UPDATE FAIL是否是由于发生了RRC CONN REL导致的*/
    VOS_UINT16                                          usOutOfSyncFreq;          /* 失步时服务小区的频点 */
    VOS_UINT16                                          usOutOfSyncParaId;        /* 失步时服务小区的ID */
    VOS_UINT16                                          usCellUpdateFreq;         /* CELL UPDATE时的频点 */
    VOS_UINT16                                          usCellUpdateParaId;       /* CELL UPDATE时的小区ID */
    VOS_UINT32                                          ulOutOfSyncIdentityId;    /* SIB3中携带的cellIdentity ID */
    VOS_UINT32                                          ulCellUpdtIdentityId;     /* SIB3中携带的cellIdentity ID */
