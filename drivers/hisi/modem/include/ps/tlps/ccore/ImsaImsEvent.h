...
enum IMSA_IMS_INPUT_SERVICE_REASON_ENUM{
    ...
    IMSA_IMS_INPUT_SERVICE_RE_REGISTER,
...
enum IMSA_IMS_REALISIM_STATE_ENUM{
    IMSA_IMS_REALISIM_STATE_OFF         = 0,            /* USIM模拟ISIM */
    IMSA_IMS_REALISIM_STATE_ON          = 1,            /* 真实ISIM */
    IMSA_IMS_REALISIM_STATE_BUTT
};
typedef VOS_UINT32 IMSA_IMS_REALISIM_STATE_ENUM_UINT8;
...
enum IMAS_IMS_INPUT_PARA_REASON_ENUM{
	...
	IMSA_IMS_INPUT_PARA_REASON_SET_WLANNODEID,
    IMAS_IMS_INPUT_PARA_REASON_SET_CALL_ENCRYPT,
...
enum IMSA_IMS_HO_TYPE_ENUM {
	/* 指定IMS正在进行切换的类型：LTE2WIFI/WIFI2LTE */
	IMSA_IMS_HO_TYPE_NO_HO       = 0,
	IMSA_IMS_HO_TYPE_LTE2WIFI,
	IMSA_IMS_HO_TYPE_WIFI2LTE,
	IMSA_IMS_HO_TYPE_BUTT
};
...
enum IMSA_IMS_CALL_REL_CAUSE_ENUM{
    ...
    IMSA_IMS_CALL_REL_CAUSE_EMC_BAR,                            /* 紧急呼被罢 */
    IMSA_IMS_CALL_REL_CAUSE_NOT_SUPPORT_EMC_CALL,               /* 网络不支持紧急呼 */
    IMSA_IMS_CALL_REL_CAUSE_BUTT
} ;
typedef VOS_UINT8 IMSA_IMS_CALL_REL_CAUSE_ENUM_UINT8;
enum IMSA_IMS_PDN_HO_STATE_ENUM{
     IMSA_IMS_PDN_HO_STATE_INACTIVE  = 0,
     IMSA_IMS_PDN_HO_STATE_ACTIVE,
     IMSA_IMS_PDN_HO_STATE_HANDLED_AFTER_SUCC,
     IMSA_IMS_PDN_HO_STATE_HANDLED_AFTER_FAILED,
     IMSA_IMS_PDN_HO_STATE_BUTT
};

typedef VOS_UINT8 IMSA_IMS_PDN_HO_STATE_ENUM_UINT8;
...
enum IMSA_IMS_NW_ACCESS_TYPE_ENUM
{
    ...
    IMSA_IMS_NW_ACCESS_TYPE_IEEE_802_11,
    IMSA_IMS_NW_ACCESS_TYPE_IEEE_802_11A,
    IMSA_IMS_NW_ACCESS_TYPE_IEEE_802_11B,
    IMSA_IMS_NW_ACCESS_TYPE_IEEE_802_11G,
    IMSA_IMS_NW_ACCESS_TYPE_IEEE_802_11N,
    IMSA_IMS_NW_ACCESS_TYPE_IEEE_802_11AC,
    IMSA_IMS_NW_ACCESS_TYPE_IEEE_802_11AD,
    IMSA_IMS_NW_ACCESS_TYPE_IEEE_802_11AH,
...
enum IMSA_IMS_INT_ERROR_CODE_ENUM
{
    ...
    IMSA_IMS_INT_ERROR_CODE_CALL_SRVCC_FAIL_BACK_FAIL,
...
typedef struct {
    ...
    VOS_UINT8                               ucCallEncrypt; /* 0:不加密 1:加密 */
    VOS_UINT8                               ucNoCardEmergencyFlag; /* 0:普通紧急呼 1:无卡紧急呼 */
    VOS_UINT8                               aucRsv[1];
...
typedef struct{
    ...
    union {
        ...
        struct {
            ...
            IMSA_IMS_REALISIM_STATE_ENUM_UINT8 enISIMState;
            VOS_UINT8     aucRsv[2];
        } stNormalAccount;
        struct {
            VOS_CHAR      acDomain[IMSA_IMS_EVENT_STRING_SZ + 1];
        ...
        struct{
            ...
            VOS_UINT8     aucRsv[3];
            #endif
            VOS_UINT8     ucCallEncrypt;          /*0:不支持加密，1:支持加密*/
            VOS_UINT8     aucRsv[3];
        } stUeCapability;
        struct{
       ...
       {
           IMSA_IMS_NW_ACCESS_TYPE_ENUM_UINT8           enNwAccessType;
           VOS_CHAR                                     acApMacAddr[IMSA_IMS_AP_MAC_LEN+1]; /*以'\0’结尾 */
           VOS_UINT8                                    auReserved[2];
       } stIWlanNodeId;
    }u;
...
typedef struct {
    ...
    VOS_CHAR                               acDisplayName[IMSA_IMS_DISPLAY_NAME_STRING_SZ + 1];

    VOS_UINT8                              ucContactSuptVideo;
    VOS_UINT8                              ucCallEncrypt;/* 0 = not encrypt. 1 = encrypt */
