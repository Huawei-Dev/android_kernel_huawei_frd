...
enum LRRC_WRRC_MSG_TYPE_ENUM
{
   ...
   /* L -> W ANR STOP */
    ...
    ID_LRRC_WRRC_BG_PLMN_SEARCH_CSG_IND    = (LRRC_WRRC_MSG_HDR + 0x33),        /* _H2ASN_MsgChoice LRRC_WRRC_BG_PLMN_SEARCH_CSG_IND_STRU */
    ID_WRRC_LRRC_SEARCHED_PLMN_INFO_IND               = (WRRC_LRRC_MSG_HDR + 0x34),        /* _H2ASN_MsgChoice WRRC_LRRC_SEARCHED_PLMN_INFO_IND_STRU */
    ID_LRRC_WRRC_SEARCHED_PLMN_INFO_IND               = (LRRC_WRRC_MSG_HDR + 0x34),        /* _H2ASN_MsgChoice LRRC_WRRC_SEARCHED_PLMN_INFO_IND_STRU */
...
typedef struct
{
    ...
    VOS_UINT8                                   aucRsv1[3];
    LRRC_GURRC_CSG_ID_INFO_STRU                 stCsgId;                        /* csg id */
...
/*****************************************************************************
 结构名    :    LRRC_WRRC_BG_PLMN_SEARCH_CSG_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :   LRRC指示WRRC执行背景CSG搜索的结果
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
...
}LRRC_WRRC_BG_PLMN_SEARCH_CSG_IND_STRU;
...
{
    VOS_MSG_HEADER                                            /*_H2ASN_Skip*/
    LRRC_WRRC_MSG_TYPE_ENUM_UINT32      enMsgId;
    VOS_UINT32                          ulAvailPlmnNum;       /* 上报PLMN个数 */
    
    /* 上报plmn 接入技术和位置区信息 */
    LRRC_GURRC_PLMN_RAT_WITH_LAC_STRU   astPlmnWithLacList[LRRC_GURRC_MAX_AVAILPLMN_NUM];
}WRRC_LRRC_SEARCHED_PLMN_INFO_IND_STRU;
...
typedef struct
{
    ...
    /* 上报plmn 接入技术和位置区信息 */
    LRRC_GURRC_PLMN_RAT_WITH_LAC_STRU   astPlmnWithLacList[LRRC_GURRC_MAX_AVAILPLMN_NUM];
}LRRC_WRRC_SEARCHED_PLMN_INFO_IND_STRU;
