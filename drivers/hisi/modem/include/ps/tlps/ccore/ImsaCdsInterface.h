...
enum IMSA_CDS_IMS_BEARER_RAT_TYPE_ENUM
{
    IMSA_CDS_IMS_BEARER_RAT_TYPE_3GPP_EUTRAN     = 0x00,
    IMSA_CDS_IMS_BEARER_RAT_TYPE_IEEE_802_11     = 0x01,

    IMSA_CDS_IMS_BEARER_RAT_TYPE_BUTT       = 0xFF
};
typedef VOS_UINT8 IMSA_CDS_IMS_BEARER_RAT_TYPE_ENUM_UINT8;
...
typedef struct
{
    ...
    /* CDS仅支持一种类型的承载存在，否则CDS会不知道使用哪个承载发消息 */
