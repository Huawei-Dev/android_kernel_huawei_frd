...
enum RRM_PS_TASK_TYPE_ENUM
{
    ...
    RRM_PS_TASK_TYPE_GSM_CS_MO_EMERGENCY_CALL       = 104,
    RRM_PS_TASK_TYPE_GSM_CS_MT_EMERGENCY_CALLBACK   = 105,
    ...
    RRM_PS_TASK_TYPE_GSM_CS_MO_SS                   = 110,
    RRM_PS_TASK_TYPE_GSM_CS_MO_SMS                  = 111,
    ...
    RRM_PS_TASK_TYPE_GSM_CS_MT_SS                   = 122,
    RRM_PS_TASK_TYPE_GSM_CS_MT_SMS                  = 123,
    RRM_PS_TASK_TYPE_GSM_CS_MO_NORMAL_CSFB          = 124,
    RRM_PS_TASK_TYPE_GSM_CS_MO_EMERGENCY_CSFB       = 125,
    RRM_PS_TASK_TYPE_GSM_CS_MT_CSFB                 = 126,
    RRM_PS_TASK_TYPE_GSM_CS_PAGING                  = 127,
    ...
    RRM_PS_TASK_TYPE_LTE_IRAT_HRPD                  = 439,
    RRM_PS_TASK_TYPE_LTE_IRAT_FR                    = 440,
    ...
    RRM_PS_TASK_TYPE_HRPD_CAS_SIGNAL                = 532,
    RRM_PS_TASK_TYPE_HRPD_MO_KEEP_ALIVE             = 533,
    RRM_PS_TASK_TYPE_HRPD_MT_KEEP_ALIVE             = 534,
    RRM_PS_TASK_TYPE_HRPD_HARD_ID                   = 535,
    RRM_PS_TASK_TYPE_HRPD_ACCESS_AUTH               = 536,
    RRM_PS_TASK_TYPE_HRPD_RN_SERVICE_STREAM_SIGNALING = 537,
    RRM_PS_TASK_TYPE_HRPD_DATA_SERVICE_STREAM_SIGNALING = 538,
    RRM_PS_TASK_TYPE_HRPD_DOS_SIGNALING             = 539,
...
enum PS_RRM_VERSION_ENUM
{
    PS_RRM_VERSION_SVLTE                    = 0, /* 版本为SVLTE, 同一个MODEM上, LTE和C不共天线 */
    PS_RRM_VERSION_SRLTE                    = 1, /* 版本为SVLTE, 同一个MODEM上, LTE和C共天线 */
    PS_RRM_VERSION_BUTT
};
typedef VOS_UINT8 PS_RRM_VERSION_ENUM_UINT8;


enum PS_RRM_DSDS_VERSION_ENUM
{
    PS_RRM_DSDS_1_0                     = 0, /* DSDS1.0 */
    PS_RRM_DSDS_2_0                     = 1, /* DSDS2.0 */
    PS_RRM_DSDS_BUTT
};
typedef VOS_UINT8 PS_RRM_DSDS_VERSION_ENUM_UINT8;
...
typedef struct
{
    ...
    VOS_UINT8                           aucReserved[1];
    RRM_PS_TASK_TYPE_ENUM_UINT16        enTaskTypeValue;    /* 抢占的最高优先级任务, 如果存在多个相同的优先级最高任务, 为其中任意一个 */
...
/* DSDS版本类型 */
extern PS_RRM_DSDS_VERSION_ENUM_UINT8 RRM_GetDsdsVersion(VOS_VOID);

/* SRLTE or SVLTE */
extern PS_RRM_VERSION_ENUM_UINT8 RRM_GetVersionType(VOS_VOID);
