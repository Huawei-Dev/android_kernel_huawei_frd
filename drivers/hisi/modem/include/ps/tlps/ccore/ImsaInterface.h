...
{
    IMSA_NORMAL_REG_STATUS_LTE_DEREG           = 0x00,
    IMSA_NORMAL_REG_STATUS_LTE_DEREGING        = 0x01,
    IMSA_NORMAL_REG_STATUS_LTE_REGING          = 0x02,
    IMSA_NORMAL_REG_STATUS_LTE_REG             = 0x03,

    IMSA_NORMAL_REG_STATUS_WIFI_DEREG          = 0x08,
    IMSA_NORMAL_REG_STATUS_WIFI_DEREGING       = 0x09,
    IMSA_NORMAL_REG_STATUS_WIFI_REGING         = 0x0A,
    IMSA_NORMAL_REG_STATUS_WIFI_REG            = 0x0B,

    IMSA_NORMAL_REG_STATUS_WIFI2LTE_HO_START   = 0x10,
    IMSA_NORMAL_REG_STATUS_LTE2WIFI_HO_START   = 0x80,
