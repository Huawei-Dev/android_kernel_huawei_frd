...
typedef struct
{
    TAF_LCS_MSG_ID_ENUM_UINT32          ulMsgId;                                /*_H2ASN_MsgChoice_Export TAF_LCS_MSG_ID_ENUM_UINT32*/
    VOS_UINT8                           aucMsgBlock[4];
    /***************************************************************************
        _H2ASN_MsgChoice_When_Comment          TAF_LCS_MSG_ID_ENUM_UINT32
    ****************************************************************************/
}TAF_LCS_MSG_DATA;
