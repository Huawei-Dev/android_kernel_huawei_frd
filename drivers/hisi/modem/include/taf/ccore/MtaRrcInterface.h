...
enum MTA_RRC_MSG_TYPE_ENUM
{
    ...
    ID_MTA_WRR_CSNR_QRY_REQ                        = 0x002D,                    /* _H2ASN_MsgChoice MTA_WRR_CSNR_QRY_REQ_STRU */
    ...
    ID_WRR_MTA_CSNR_QRY_CNF                        = 0x0030,                    /* _H2ASN_MsgChoice WRR_MTA_CSNR_QRY_CNF_STRU     */
    ...
    ID_LRRC_MTA_CAMPED_RESTRICTED_BAND_IND     = MTA_LRRC_MSG_TYPE_BASE + 64,   /* _H2ASN_MsgChoice LRRC_MTA_CAMPED_RESTRICTED_BAND_IND_STRU */
...
enum LRRC_MTA_CAMPED_BAND_TYPE_ENUM
{
    LRRC_MTA_CAMPED_BAND_COMM           = 1,                       /* UE驻留在普通Band，包括:
                                                                      1、IDLE态，从异系统移动到LTE,包括GU->L,重选，重定向，CCO
                                                                      2、IDLE态，驻留在非受限band
                                                                      3、IDLE态，驻留在受限band，但是有非受限Band L邻区，或有异系统邻区，即系统消息中广播非受限Band邻区或异系统邻区
                                                                      4、连接态，从异系统切换到LTE
                                                                      5、连接态，从LTE切换进入连接态，收到网侧配置的测量对象包括非受限Band测量对象或异系统测量对象 */
    LRRC_MTA_CAMPED_BAND_RESTRICTED     = 2,                       /* UE驻留在受限band，包括:
                                                                      1、IDLE态，驻留在受限band，且SIB5中没有非受限band邻区，不广播SIB6,SIB7,SIB8 */
    LRRC_MTA_CAMPED_BAND_BUTT
};
typedef VOS_UINT8   LRRC_MTA_CAMPED_BAND_TYPE_ENUM_UINT8;
...
typedef struct
{
    VOS_UINT32                           aulBand[8];               /* 受限Band，8*32=256bit，每个bit指示一个band，该bit为1表示该bit是受限band，如下举例:
                                                                      值aulBand[0]=0x01,表示Band1是受限Band
                                                                      值aulBand[1]=0x02,表示Band34时受限Band
                                                                      值aulBand[0]=0x01,aulBand[1]=0x02表示Band1，Band34是受限Band，以此类推
                                                                      目前只支持Band12受限，aulBand[0]=0x00000800，其它数组为0 */
} LRRC_MTA_RESTRICTED_BAND_STRU;


typedef struct
{
    MSG_HEADER_STRU                      stMsgHeader;               /*_H2ASN_Skip*/
    RRC_MTA_BAND_IND_ENUM_UINT16         enBandInd;                 /* UE驻留Band */
    LRRC_MTA_CAMPED_BAND_TYPE_ENUM_UINT8 enCampedBandType;          /* 驻留band的类型:1、普通Band驻留;2、受限Band驻留 */
    VOS_UINT8                            ucReserved;
    LRRC_MTA_RESTRICTED_BAND_STRU        stRestrictedBand;          /* 受限band范围，NV可配，当前只有Band12 */
} LRRC_MTA_CAMPED_RESTRICTED_BAND_IND_STRU;
