...
enum SPM_IMSA_MSG_TYPE_ENUM
{
    ...
    ID_SPM_IMSA_GET_CS_SRV_STATUS_RSP        = TAF_SPM_IMSA_MSG_BASE+0x800,     /* _H2ASN_MsgChoice SPM_IMSA_GET_CS_SRV_STATUS_RSP_STRU */
    ...
    ID_IMSA_SPM_GET_CS_SRV_STATUS_IND        = TAF_SPM_IMSA_MSG_BASE+0x400,     /* _H2ASN_MsgChoice IMSA_SPM_GET_CS_SRV_STATUS_IND_STRU */
    ID_IMSA_SPM_IMS_SWITCH_STATE_IND         = TAF_SPM_IMSA_MSG_BASE+0x401,     /* _H2ASN_MsgChoice IMSA_SPM_IMS_SWITCH_STATE_IND_STRU */
...
enum SPM_IMSA_CS_SRV_STATUS_ENUM
{
    SPM_IMSA_CS_SRV_STATUS_INACTIVE             = 0x0,                          /* 无业务 */
    SPM_IMSA_CS_SRV_STATUS_VOICE_CALL_ACTIVE    = 0x1,                          /* CS域语音呼叫 */
    SPM_IMSA_CS_SRV_STATUS_VIDEO_CALL_ACITVE    = 0x2,                          /* CS域视频呼叫 */
    SPM_IMSA_CS_SRV_STATUS_SMS_ACTIVE           = 0x4,                          /* CS域短信业务 */
    SPM_IMSA_CS_SRV_STATUS_SS_ACTIVE            = 0x8,                          /* CS域补充业务 */
    SPM_IMSA_CS_SRV_STATUS_BUTT
};
typedef  VOS_UINT32  SPM_IMSA_CS_SRV_STATUS_ENUM_UINT32;


enum IMSA_SPM_IMS_SWITCH_STATE_ENUM
{
    IMSA_SPM_IMS_SWITCH_STATE_OFF               = 0x0,
    IMSA_SPM_IMS_SWITCH_STATE_ON                = 0x1,
    IMSA_SPM_IMS_SWITCH_STATE_BUTT
};
typedef  VOS_UINT8 IMSA_SPM_IMS_SWITCH_STATE_ENUM_UINT8;
...
typedef struct
{
    VOS_MSG_HEADER                                                              /* _H2ASN_Skip */
    VOS_UINT32                          ulMsgId;                                /* _H2ASN_Skip */
    SPM_IMSA_CS_SRV_STATUS_ENUM_UINT32  enCsSrvStatus;
}SPM_IMSA_GET_CS_SRV_STATUS_RSP_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                          ulMsgId;                                /* _H2ASN_Skip */
    VOS_UINT8                           aucRsv[4];
}IMSA_SPM_GET_CS_SRV_STATUS_IND_STRU;
...
typedef struct
{
    VOS_MSG_HEADER                                                              /* _H2ASN_Skip */
    VOS_UINT32                              ulMsgId;                            /* _H2ASN_Skip */
    IMSA_SPM_IMS_SWITCH_STATE_ENUM_UINT8    enImsSwitch;
    VOS_UINT8                               aucReserved[3];
}IMSA_SPM_IMS_SWITCH_STATE_IND_STRU;
