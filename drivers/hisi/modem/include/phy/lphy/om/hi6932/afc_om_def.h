...
typedef struct
{
    AFC_OM_SWITCH_ENUM_UINT16           enFrmsRsEn;
    UINT16                              usRev;
}LPHY_REQ_AFC_FRMS_RS_ENA_STRU;
...
typedef struct
{
    ...
    UINT32                     ulLastDemodTimeReg;
    UINT16                     usDemodTimeRegValid;
    UINT16                     usFrmsRsEn;

    UINT16                     usLastLnaGain[LPHY_MAX_RX_ANTENNA_NUM];
	
    UINT16                     usSampleStopFlag;
    UINT16                     usSampleStopCounter;
}AFC_CC_PARA_STRU;
