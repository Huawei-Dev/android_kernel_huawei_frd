...
typedef UINT16 RFE_DL_PATH_ENUM_UINT16;
...
typedef enum
{
    RFE_TX_ANT1 = 0,  //上行使用分集天线
    RFE_TX_ANT0,        //上行使用主集天线
    RFE_TX_BUTT
}RFE_TX_ANT_IND_ENUM;

typedef UINT16 RFE_TX_ANT_IND_ENUM_UINT16;
...
typedef struct
{
    ...
    UINT16 usTxAntSelInd                : 1;
    UINT16 usTxEx0AntSelInd             : 1;
    UINT16 usTxEx1AntSelInd             : 1;
    UINT16 usRsv0                       : 1;

    UINT16 usOnlyTxAntCfgInd            : 1;
    UINT16 usOnlyTxEx0AntCfgInd         : 1;
    UINT16 usOnlyTxEx1AntCfgInd         : 1;
	UINT16 usRes1                       : 13;
...
typedef struct
{
    ...
    UINT16                              usSsiTxOnEx;                /* SSI TXon EX0 Ex1*/
    UINT16                              usRsv;
    ...
    UINT8                              ucTddChFisrtOnFlag;
    UINT8                              ucULCtuChIdx;
    RFE_TX_ANT_IND_ENUM_UINT16   enTxAntInd; 
    UINT16                            usOnlyTxAntFlag;
