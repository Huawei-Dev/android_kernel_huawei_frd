...
typedef enum
{
    ...
    #if defined(LPHY_FEATURE_DSDS_20)
    LPHY_TRACE_RFD_DSDS_PARA_RPT,  /*DSDS2.0 OM上报*/
    #endif
...
typedef struct
{
    UINT16                              usFeListenChFlag; //Dsds流程中是否使用侦听通道标志
    UINT16                              usNcitRfPathIdx;  //综测所使用的通道号
    UINT16                              usNcitListenFlag; //综测流程中是否使用侦听通道标志
    UINT16                              usRsv;
}RFE_DSDS_OM_RPT_STRU;
#endif
#ifdef __cplusplus
}
#endif /* __cplusplus */
