...
#elif defined(LPHY_CHIP_BB_6960CS)
    #define CHIP_BB_VERSION           "HI6960CS"	
#else
 ...
 *    单板/芯片平台&特性差异                                               *
 *-------------------------------------------------------------------------*/
#if (defined(LPHY_ASIC_K3V5))

	#define SG_REPORT
	#define LPHY_IN_FACT_ASIC_BOARD

    #define LPHY_FEATURE_THRL_SWITCH                    PHY_OFF
	#define LPHY_FEATURE_LCS_SWITCH						PHY_ON
	...
	#define LPHY_MAX_UL_CH_NUM                          (LPHY_MAX_RFIC_NUM)
        ...
        #define LPHY_LPC_REGISTER_READY_SWITCH          PHY_ON
    #endif
#elif (defined(LPHY_K3V6))
    #define LPHY_FEATURE_THRL_SWITCH                    PHY_ON
...
#endif
#if (PHY_ON == LPHY_FEATURE_THRL_SWITCH)
	#define LPHY_FEATURE_THRL_ENABLE
	#define LPHY_FEATURE_THRL
#else
	#define LPHY_FEATURE_THRL_DISABLE
#endif
