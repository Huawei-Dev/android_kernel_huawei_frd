...
/*****************************************************************************
 枚举名    : PHYITF_BMC_MSG_DESC_TYPE_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : CBS消息块类型枚举
*****************************************************************************/
enum PHYITF_BMC_MSG_DESC_TYPE_ENUM
{
    PHYITF_BMC_REPETITION_NEW_MSG         = 0,                                    /*调度周期内重复的新消息*/
    PHYITF_BMC_NEW_MSG                    = 1,                                    /*未在上个调度周期内发送过的新消息*/
    PHYITF_BMC_READ_ADVISED               = 2,                                    /*建议读取*/
    PHYITF_BMC_READ_OPT                   = 3,                                    /*可选读取*/
    PHYITF_BMC_REPETITION_OLD_MSG         = 4,                                    /*调度周期内重复的老消息*/
    PHYITF_BMC_OLD_MSG                    = 5,                                    /*在上个调度周期内发送过的老消息*/
    PHYITF_BMC_SCHEDULE_MSG               = 6,                                    /*调度消息*/
    PHYITF_BMC_CBS41_MSG                  = 7,                                    /*CBS41消息*/
    PHYITF_BMC_NO_MSG                     = 8,                                    /*无消息*/
    PHYITF_BMC_MSG_DESCRIP_TYPE_BUTT
};
typedef VOS_UINT8 PHYITF_BMC_MSG_DESC_TYPE_ENUM_UINT8;
...
typedef struct
{
    VOS_UINT16                                  usDrxBSOffset;  /* CTCH BS offset */
    PHYITF_BMC_MSG_DESC_TYPE_ENUM_UINT8         enDrxBlockType; /* CTCH BS 类型 */
    VOS_UINT8                                   aucReserved[1];

} PHYITF_CBS_DRX_LIST_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                                  usReserve;                  /*4字节对齐*/
    PHYITF_CBS_DRX_LIST_STRU                    astDrxBSOffsetListInfo[RRC_PHY_MAX_DRXBS_OFFSETLSTLEN]; /* CTCH BS offset列表 */
...
/*****************************************************************************
 结构名    : RRC_PHY_PENDING_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 指示启动/停止 pending
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
    RRC_PHY_MSG_ID_ENUM_UINT16  enMsgID;                                        /* 原语类型 */ /*_H2ASN_Skip*/
    PHYITF_PENDING_ENUM_UINT16  enPendingFlg;                                   /* Pending标志 */
}RRC_PHY_PENDING_IND_STRU;
