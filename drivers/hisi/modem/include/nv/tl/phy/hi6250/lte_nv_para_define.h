...
typedef struct
{
    ...
    UINT16 usRficSweepDB;
 	INT16  asPoutOffset[4][16];                           /*从无符号转为有符号*/
...
/*用于初始随机接入第一次就失败来切天线的门限*/
typedef struct{
    UINT16                       usTasDeltaThr;
    UINT8			             ucRsv;
    UINT8			             ucRsv1;
}NV_TAS_ACCESS_THR_STRU;
...
/*    NV_FE_PBAND_MIPI_INFO_STRU          stPBandMipiCfg;
    ...
    NV_TAS_ACCESS_THR_STRU          stTasAccessThr;
}LTE_NV_PARA_STRU;
/**********************************************************************************************/
/*******************************band相关的nv项*******************************************/
typedef struct
