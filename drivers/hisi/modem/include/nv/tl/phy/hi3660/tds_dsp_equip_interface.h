...
typedef struct
{
    UINT16 usCompDCI[32];
    UINT16 usCompDCQ[32];
    UINT16 usCompDCIListening[2];
    UINT16 usCompDCQListening[2];
}TDS_DCOC_CAL_STRU;
...
typedef struct
{
    INT16 asRxFreqComp[2][1];
}TDS_AGC_FREQ_COMP_UNIT_LISTEN_STRU;

typedef struct
{
    TDS_AGC_FREQ_COMP_UNIT_STRU stNoBlk;
    TDS_AGC_FREQ_COMP_UNIT_STRU stBlk;
    TDS_AGC_FREQ_COMP_UNIT_LISTEN_STRU stNoBlkListening;
    TDS_AGC_FREQ_COMP_UNIT_LISTEN_STRU stBlkListening;
