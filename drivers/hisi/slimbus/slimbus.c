				...
				slimbus_track_param_t	*params)
{
	...
	case SLIMBUS_TRACK_SOUND_TRIGGER:
		...
		if (ret)
			break;
		if (pdata->device_type == SLIMBUS_DEVICE_HI6402) {
			ret = slimbus_drv_track_configure(voice_up, SLIMBUS_VOICE_UP_SOUNDTRIGGER);
		} else if (pdata->device_type == SLIMBUS_DEVICE_HI6403) {
			ret = slimbus_drv_track_configure(audio_capture, SLIMBUS_VOICE_UP_SOUNDTRIGGER);
		}
		break;
				...
				slimbus_track_type_t	track)
{
	...
	case SLIMBUS_TRACK_SOUND_TRIGGER:
		...
		if (pdata->device_type == SLIMBUS_DEVICE_HI6402) {
			...
			ret = slimbus_drv_track_activate(audio_capture, SLIMBUS_VOICE_UP_SOUNDTRIGGER);
		}
		break;
	case SLIMBUS_TRACK_DEBUG:
				...
				slimbus_track_type_t	track)
{
	...
	case SLIMBUS_TRACK_SOUND_TRIGGER:
		...
		if (pdata->device_type == SLIMBUS_DEVICE_HI6402) {
			...
			ret = slimbus_drv_track_deactivate(audio_capture, SLIMBUS_VOICE_UP_SOUNDTRIGGER);
		}
		break;
	case SLIMBUS_TRACK_DEBUG:
				...
				slimbus_track_type_t	track)
{
	...
	case SLIMBUS_TRACK_SOUND_TRIGGER:
		...
		if (pdata->device_type == SLIMBUS_DEVICE_HI6402) {
			...
			ret = slimbus_drv_track_remove(audio_capture, SLIMBUS_VOICE_UP_SOUNDTRIGGER);
		}
		break;
	case SLIMBUS_TRACK_DEBUG:
