                ...
                mac_cfg_add_vap_param_stru *pst_param)
{
    ...
    switch(pst_vap->en_vap_mode)
    {
        ...
        case WLAN_VAP_MODE_BSS_AP:
            ...
            /* 响应帧由软件控制标识位置0 */
            pst_vap->bit_rsp_soft_ctl_launcher = 0;
#endif
            /* 初始化dpd能力 */
...
oal_bool_enum_uint8 mac_vap_search_other_rsp_launcher(mac_vap_stru *pst_mac_vap)
{
    mac_device_stru         *pst_mac_dev;
    ...
    {
        pst_tmp_vap = (mac_vap_stru *)mac_res_get_mac_vap(pst_mac_dev->auc_vap_id[uc_vap_index]);
        if (OAL_PTR_NULL != pst_tmp_vap)
        {
            if (pst_mac_vap->uc_vap_id != pst_tmp_vap->uc_vap_id
            && OAL_TRUE == pst_tmp_vap->bit_rsp_soft_ctl_launcher)
            {
                en_launcher_vap_found = OAL_TRUE;
                break;
            }
        }
    }
    return en_launcher_vap_found;
}
#endif
...
oal_uint32 mac_vap_set_vowifi_param(mac_vap_stru *pst_mac_vap, mac_vowifi_cmd_enum_uint8 en_vowifi_cfg_cmd, oal_uint8 uc_value)
{
    ...
    if ((BIT0 | BIT1 | BIT2 | BIT3 | BIT4) == pst_mac_vap->pst_vowifi_cfg_param->uc_cfg_cmd_cnt)
    {
