...
#define MAC_SCAN_WORK_TIME_ON_HOME_CHANNEL_DEFAULT      100         /* 背景扫描时，返回工作信道工作的时间 */
#define MAC_SCAN_CHANNEL_INTERVAL_PERFORMANCE           2           /* 间隔2个信道，切回工作信道工作一段时间 */
#define MAC_SCAN_WORK_TIME_ON_HOME_CHANNEL_PERFORMANCE  60          /* WLAN未关联，P2P关联，返回工作信道工作的时间 */
...
typedef struct
{
    ...
    oal_uint16                          us_scan_work_time_swith_home_channel;   /* 背景扫描时，返回工作信道工作的时间 */
    oal_uint8                           auc_resv[1];
}mac_scan_req_stru;
