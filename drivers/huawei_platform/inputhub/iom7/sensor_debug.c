...
static int ar_test(int tag, int argv[], int argc)
{
	...
	if ((cmd == CMD_CMN_OPEN_REQ) || (cmd == CMD_CMN_CLOSE_REQ)) {
		...
		ar_start.start_param.activity_list[0].activity =
		    AR_ACTIVITY_VEHICLE;
		ar_start.start_param.activity_list[0].event_type =
		    EVENT_BOTH * ((para2 >> 0) & 1);
		ar_start.start_param.activity_list[1].activity =
		    AR_ACTIVITY_RIDING;
		ar_start.start_param.activity_list[1].event_type =
		    EVENT_BOTH * ((para2 >> 4) & 1);
		ar_start.start_param.activity_list[2].activity =
		    AR_ACTIVITY_WALK_SLOW;
		ar_start.start_param.activity_list[2].event_type =
		    EVENT_BOTH * ((para2 >> 8) & 1);
		ar_start.start_param.activity_list[3].activity =
		    AR_ACTIVITY_RUN_FAST;
		ar_start.start_param.activity_list[3].event_type =
		    EVENT_BOTH * ((para2 >> 12) & 1);
		ar_start.start_param.activity_list[4].activity =
		    AR_ACTIVITY_STATIONARY;
		ar_start.start_param.activity_list[4].event_type =
		    EVENT_BOTH * ((para2 >> 16) & 1);
		ar_start.start_param.activity_list[5].activity =
		    AR_ACTIVITY_UNKNOWN;
