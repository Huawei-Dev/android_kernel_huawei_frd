...
/**********************************************************
*  Function:       dual_loadswitch_get_ls_resistance
*  Discription:    dual loadswitch get_ls_resistance
*  Parameters: NULL
*  return value:  resistance
**********************************************************/
static int dual_loadswitch_get_ls_resistance(int *r)
{
	int ret = -1;
	IF_OPS(g_main_ops, get_ls_resistance)
		ret = g_main_ops->get_ls_resistance(r);
	return ret;
}
struct loadswitch_ops dual_loadswitch_ops = {
	...
	.get_ls_resistance = dual_loadswitch_get_ls_resistance,
};
