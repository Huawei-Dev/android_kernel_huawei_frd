...
#define DSS_COMPOSER_TIMEOUT_THRESHOLD_ASIC	(200)
...
void hisi_remove_mctl_mutex(struct hisi_fb_data_type *hisifd, dss_overlay_t *pov_req, int mctl_idx, uint32_t cmdlist_idxs);
#endif
