...
#define HISIFB_DSS_ARSR1P_INFO_GET _IOW(HISIFB_IOCTL_MAGIC, 0x803, struct dss_arsr1p_info)
...
typedef struct dss_arsr1p_info {
    uint32_t xres; //framebuffer resolution of horizental, before arsr1p
    uint32_t yres; //framebuffer resolution of vertical, before arsr1p
    uint32_t lcd_xres; //lcd resolution of horizental, after arsr1p
    uint32_t lcd_yres; //lcd resolution of vertical, after arsr1p
    uint32_t arsr1p_used;
} dss_arsr1p_info_t;
