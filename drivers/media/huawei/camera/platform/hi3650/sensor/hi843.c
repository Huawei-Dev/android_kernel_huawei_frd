...
static struct sensor_power_setting hi843_nts_power_setting[] = {
...
static sensor_t s_hi843_nts =
{
    .intf = { .vtbl = &s_hi843_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(hi843_nts_power_setting),
            .power_setting = hi843_nts_power_setting,
     },
};
...
static const struct of_device_id s_hi843_dt_match[] =
{
    ...
    {
        .compatible = "huawei,hi843_nts",
        .data = &s_hi843_nts.intf,
    },
    {
