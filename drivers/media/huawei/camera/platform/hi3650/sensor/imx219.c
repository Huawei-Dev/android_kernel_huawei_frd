...
static struct sensor_power_setting imx219_nts_power_setting[] = {
...
static sensor_t s_imx219_nts =
{
    .intf = { .vtbl = &s_imx219_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(imx219_nts_power_setting),
            .power_setting = imx219_nts_power_setting,
     },
};
...
static const struct of_device_id s_imx219_dt_match[] =
{
    ...
    {
        .compatible = "huawei,imx219_nts",
        .data = &s_imx219_nts.intf,
    },
    {
