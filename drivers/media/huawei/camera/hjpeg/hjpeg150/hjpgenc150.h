...
#define CVDR_NR_RD_CFG1_OFFSET               0xA10
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t    nrrd_allocated_du     : 5   ; /* [9..5]  */
        uint32_t    nrrd_access_limiter   : 4   ; /* [13..10]  */
        uint32_t    reserved_1            : 17  ; /* [30..14]  */
        uint32_t    nrrd_enable           : 1   ; /* [31]  */
    } bits;
