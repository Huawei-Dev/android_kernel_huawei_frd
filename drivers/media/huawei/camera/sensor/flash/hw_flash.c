    ...
    const struct i2c_device_id *id)
{
    ...
    if (flash_ctrl->flash_info.index == REAR_FLASH_INDEX) {
        group_id = HWCAM_SUBDEV_FLASH0;
    } else if (flash_ctrl->flash_info.index == FORE_FLASH_INDEX) {
        group_id = HWCAM_SUBDEV_FLASH1;
    } else if (flash_ctrl->flash_info.index == GAZE_LED_INDEX) {
        group_id = HWCAM_SUBDEV_GAZELED;
    } else {
        group_id = HWCAM_SUBDEV_FLASH0;
    }
