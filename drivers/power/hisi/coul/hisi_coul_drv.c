...
/****************************************************************************
  Function:     is_fcc_invalid
  Description:  return the coul fcc invalid
  Input:        NA
  Output:       NA
  Return:       0:coul fcc is invalid
                        1:coul module is valid
****************************************************************************/
int is_fcc_invalid(void)
{
	/*declare the local variable of struct hisi_coul_ops */
	LOCAL_HISI_COUL_OPS();
	...
	/*execute the operation of coul module */
	HISI_EXEC_COUL_OP(is_fcc_invalid);
