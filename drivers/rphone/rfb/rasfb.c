...
#if defined(CONFIG_FB_3650) || defined(CONFIG_FB_6250)
		       ...
		       unsigned long arg)
{
...
#if defined(CONFIG_FB_3630) || \
	defined(CONFIG_FB_3650) || \
	defined(CONFIG_FB_3635) || \
	defined(CONFIG_FB_6250) || \
	defined(CONFIG_HISI_FB_3650)
	...
	if (bFlag && fault) {
		if (fault_injected.fb_ioctl[info->node])
			ret =
			    fault_injected.fb_ioctl[info->node] (info, cmd,
								 arg);
