...
//	pProcItem = p->private;
    ...
    PROC_PRINT(p,"\n");
	PROC_PRINT(p, "***********Config by user ************\n");
    seq_printf(p, "Channel ID                :(%d)\n",u32ChnID);
    PROC_PRINT(p, "CodecID                   :%s(0x%x)\n"
                  "Resolution                :%uX%u\n"
...
//    DRV_PROC_ITEM_S *pProcItem;
 ...
 //   Ret = HI_OSAL_Snprintf(ProcName, sizeof(ProcName), "venc%02x", u32ChnID);
    ...
    HI_DBG_VENC("proc create success\n");
    return HI_SUCCESS;
}
