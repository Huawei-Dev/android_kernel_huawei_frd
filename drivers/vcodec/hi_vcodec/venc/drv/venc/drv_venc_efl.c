...
static HI_VOID venc_drv_EflsetRGBtoYUVcoeff(VeduEfl_EncPara_S* pstEncChnPara, HI_UNF_RGB_TO_YUV_E enRgbtoYuvType)
{
    if ((NULL == pstEncChnPara)
        || (NULL == pstEncChnPara->pstCfg_EncPara))
    {
        HI_ERR_VENC("%s, venc_drv_setRGBtoYUVcoef failed,parameter is NULL \n", __func__);
        return;
    }
    /* ITU-BT-601 narrow **** bit depth = 8 */
    if (HI_UNF_RGB_TO_YUV_BT601NARROW == enRgbtoYuvType)
    {
        /* Y =  （264×R + 516×G + 100×B）/1024+ 2^(bit depth-4) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_ry  = 264;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gy  = 516;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_by  = 100;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndy  = 16;
        /* Cb =((-148)×R + (-292)×G + 448×B)/1024+ 2^(bit depth-1) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_rcb = -148;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gcb = -292;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_bcb = 448;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndcb = 128;
        /* Cr =(448×R + (-372)×G + (-68)×B)/1024+ 2^(bit depth-1) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_rcr = 448;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gcr = -372;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_bcr = -68;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndcr = 128;
        /* 1024 = 2^10 */
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_shift = 10;
    } /* ITU-BT-709 narrow */
    else if (HI_UNF_RGB_TO_YUV_BT709NARROW == enRgbtoYuvType)
    {
        /* Y =(188×R + 628×G + 64×B)/1024+ 2^(bit depth-4) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_ry  = 188;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gy  = 628;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_by  = 64;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndy  = 16;
        /* Cb =((-100)×R +(-344)×G + 448×B)/1024+ 2^(bit depth-1) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_rcb = -100;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gcb = -344;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_bcb = 448;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndcb = 128;
        /* Cr =(448×R +(-404)×G +(-36)×B)/1024+ 2^(bit depth-1) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_rcr = 448;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gcr = -404;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_bcr = -36;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndcr = 128;
        /* 1024 = 2^10 */
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_shift = 10;
    } /* ITU-BT-601 wide */
    else if (HI_UNF_RGB_TO_YUV_BT601WIDE == enRgbtoYuvType)
    {
        /* Y =  （308×R + 600×G + 116×B）/1024 */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_ry  = 308;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gy  = 600;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_by  = 116;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndy  = 0;
        /* Cb =((-172)×R + (-404)×G + 524×B)/1024+ 2^(bit depth-1) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_rcb = -172;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gcb = -404;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_bcb = 524;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndcb = 128;
        /* Cr =(524×R + (-436)×G + (-80)×B)/1024+ 2^(bit depth-1) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_rcr = 524;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gcr = -436;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_bcr = -80;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndcr = 128;
        /* 1024 = 2^10 */
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_shift = 10;
    } /* ITU-BT-709 wide */
    else if (HI_UNF_RGB_TO_YUV_BT709WIDE == enRgbtoYuvType)
    {
        /* Y =(220×R + 732×G + 72×B)/1024 */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_ry  = 220;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gy  = 732;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_by  = 72;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndy  = 0;
        /* Cb =((-116)×R +(-400)×G + 524×B)/1024+ 2^(bit depth-1) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_rcb = -116;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gcb = -400;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_bcb = 524;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndcb = 128;
        /* Cr =(524×R +(-472)×G +(-44)×B)/1024+ 2^(bit depth-1) */
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_rcr = 524;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_gcr = -472;
        pstEncChnPara->pstCfg_EncPara->vcpi_coeff_bcr = -44;
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_rndcr = 128;
        /* 1024 = 2^10 */
        pstEncChnPara->pstCfg_EncPara->vcpi_rgb_shift = 10;
    }
    ...
    {
        HI_ERR_VENC("%s, enVencRGBtoYUVtype(%d) is wrong.\n", __func__, enRgbtoYuvType);
    }
    return;
}
...
static HI_U32 H264e_MakeSPS(HI_U8 *pSPSBuf, const VeduEfl_H264e_SPS_S *pSPS)
{
	...
	HI_DBG_VENC("VENC h264 profile_id:%d,level_id:%d,num_ref_frames: %d\n",profile_idc,level_idc,1);
	return (HI_U32)BS.totalBits;
}
...
HI_S32 VENC_DRV_EflInitEncParaCfgHevc_LowPwr0( VeduEfl_EncPara_S  *pEncPara)
{
...
#if 1
    venc_drv_EflsetRGBtoYUVcoeff(pEncPara, HI_UNF_RGB_TO_YUV_BT601NARROW);
#else
    ...
    pEncParaCfg->refld_ddr_cross_idx = 0x94;
    pEncParaCfg->recst_ddr_cross_idx = 0x94;
    ...
    pEncParaCfg->comn0_smr_rd_shadow = 0x0;
    pEncParaCfg->comn0_wqos = 0x0;
    pEncParaCfg->comn0_rqos = 0x0;
    pEncParaCfg->comn0_cache_l2_en = 0x1;
    pEncParaCfg->comn0_cache_l1_en = 0x1;
    pEncParaCfg->comn0_int_en = 0x1;
    pEncParaCfg->comn0_wqos_en = 0x1;
    pEncParaCfg->comn0_rqos_en = 0x1;
    ...
    pEncParaCfg->down_freq_en = 1; // 初始化使能降频
    return 0;
}
...
HI_S32 VENC_DRV_EflStartVencByReg( HI_HANDLE EncHandle )
{
    ...
    HI_DBG_VENC("start encod by reg!!\n");
    return HI_SUCCESS;
}
...
HI_S32 VENC_DRV_EflStartOneFrameVenc( HI_HANDLE EncHandle, VeduEfl_EncIn_S *pEncIn )
{
	...
	HI_DBG_VENC("%s, pEncPara->IntraPic:%d\n", __func__, pEncPara->IntraPic);
    ...
    if (pEncPara->vcpi_protocol == VEDU_H265)
    {
		...
		HI_DBG_VENC("sao2vcpi_lcu_cnt:%d",pEncPara->sao2vcpi_lcu_cnt);
		HI_DBG_VENC("sao2vcpi_saooff_num_lum:%d",pEncPara->sao2vcpi_saooff_num_luma);
		HI_DBG_VENC("sao2vcpi_saooff_num_chroma:%d",pEncPara->sao2vcpi_saooff_num_chroma);
...
{
    HI_DBG_VENC("enter %s()\n", __func__);
    HI_DBG_VENC("pEncCfg->FrameWidth:%d\n",pEncCfg->FrameWidth);
    HI_DBG_VENC("pEncCfg->FrameHeight:%d\n",pEncCfg->FrameHeight);
    HI_DBG_VENC("pEncCfg->vcpi_protocol:%d\n",pEncCfg->Protocol);
    HI_DBG_VENC("pEncCfg->Profile:%d\n",pEncCfg->Profile);
...
HI_S32 VENC_DRV_EflCreateVenc( HI_HANDLE *pEncHandle, VeduEfl_EncCfg_S *pEncCfg, HI_U32 Index, HI_UNF_VENC_CHN_ATTR_S *pstAttr)
{
	...
	HI_DBG_VENC("enter %s, pEncHandle:0x%x\n", __func__, pEncHandle);
    if(NULL == pEncHandle)
    {
    ...
    venc_drv_EflsetRGBtoYUVcoeff(pEncPara, pstAttr->enVencRGBtoYUVtype);
...

	{
        ...
        HI_DBG_VENC("enVencHevcProfile:%d\n",pstAttr->enVencHevcProfile);
        HI_DBG_VENC("enVencAvcProfile:%d\n",pstAttr->enVencProfile);
        HI_DBG_VENC("u32TargetBitRate:%d\n",pstAttr->u32TargetBitRate);
        HI_DBG_VENC("u32Gop:%d\n",pstAttr->u32Gop);
        HI_DBG_VENC("MaxQp:%d MinQp:%d \n",pstAttr->u32MaxQp,pstAttr->u32MinQp);
        HI_DBG_VENC("h265Level:%d\n",pstAttr->h265Level);
        HI_DBG_VENC("pstAttr->ui32nSlices:%d pstAttr->bSlcSplitEn:%d\n",pstAttr->ui32nSlices,pstAttr->bSlcSplitEn);
        HI_DBG_VENC("pstAttr->bEnableCrop:%d\n",pstAttr->bEnableCrop);
        HI_DBG_VENC("CropInfo.u32CropHeight:%d\n",pstAttr->CropInfo.u32CropHeight);
        HI_DBG_VENC("CropInfo.u32CropWidth:%d\n",pstAttr->CropInfo.u32CropWidth);
        HI_DBG_VENC("CropInfo.u32CropLeft:%d\n",pstAttr->CropInfo.u32CropLeft);
        HI_DBG_VENC("CropInfo.u32CropTop:%d\n",pstAttr->CropInfo.u32CropTop);
        HI_DBG_VENC("pstAttr->bEnableCrop:%d\n",pstAttr->bEnableScale);
        HI_DBG_VENC("ScaleInfo.s32Height:%d\n",pstAttr->ScaleInfo.s32Height);
        HI_DBG_VENC("ScaleInfo.s32Widt:%d\n",pstAttr->ScaleInfo.s32Width);
        HI_DBG_VENC("bEnableROI:%d\n",pstAttr->bEnableROI);
        HI_DBG_VENC("bLowPowerMode:%d\n",pstAttr->bLowPowerMode);
        HI_DBG_VENC("bInputLowDelayMode:%d\n",pstAttr->bInputLowDelayMode);
        HI_DBG_VENC("bOutputLowDelayMode:%d\n",pstAttr->bOutputLowDelayMode);
        HI_DBG_VENC("pEncPara->bMMUByPass:%d\n",pEncPara->bMMUByPass);
	}
...
*/
    ...
    HI_DBG_VENC("u32StartPhyAlignAddr - pEncPara->MEM_VEDU_START_ADDR.u32StartPhyAddr:0x%x uAllocteTotalSize:0x%x\n",
...
/************************************* add ******************************************/
	...
	HI_DBG_VENC("pEncPara->StreamQueue_OMX:0x%x\n", pEncPara->StreamQueue_OMX);
    ...
    HI_DBG_VENC("vcpi_imgheight_pix:%d", pEncPara->vcpi_imgheight_pix);
    HI_DBG_VENC("vcpi_imgwidth_pix:%d", pEncPara->vcpi_imgwidth_pix);
    ...
    *pEncHandle = (HI_HANDLE)pEncPara;
	...
	HI_DBG_VENC("exit %s, pEncHandle:0x%x\n", __func__, pEncHandle);
    return HI_SUCCESS;
...
HI_S32 VENC_DRV_EflRcOpenOneFrm( HI_HANDLE EncHandle )
{
	...
	HI_DBG_VENC("iDelta0:%d iDelta1:%d iDelta2:%d iDelta3:%d iDelta4:%d iDelta5:%d iDelta11:%d iDelta12:%d\n",
    ...
    HI_DBG_VENC("rcinfo: pEncPara->iAveLcuBits:%d iFrameQp:%d \n",pEncPara->iAveLcuBits,pEncPara->iFrameQp);
    return HI_SUCCESS;
}
...
HI_S32 VENC_DRV_EflStartVenc( HI_HANDLE EncHandle )
{
    ...
    VEDU_LOCK_FLAG flag;
    VeduEfl_EncPara_S *pEncPara = NULL;
	HI_DBG_VENC("enter %s, EncHandle:0x%llx\n", __func__, EncHandle);
    ...
    for (i = 0; i < MAX_VEDU_CHN; i++)
    {
        ...
        {
            HI_DBG_VENC("%s, VeduChnCtx[%d].EncHandle:0x%llx\n", __func__, i, EncHandle);
	...
	pEncPara->iLastEncodedStreamCnt = 0;
#endif
	HI_DBG_VENC("exit %s, EncHandle:0x%llx\n", __func__, EncHandle);
	return HI_SUCCESS;
}
...
static HI_S32 VENC_DRV_EflQueryChn_X(HI_U32 u32ChnID, VeduEfl_EncIn_S *pEncIn )    //for venc
{
	...
	//----end-------
	HI_DBG_VENC("pEncPara->iSliceSplitNum:%d pEncPara->iCurrentStreamCnt:%d\n",pEncPara->iSliceSplitNum,pEncPara->iCurrentStreamCnt);
...
*/
        HI_DBG_VENC("%s, get new channal and yuv\n", __func__);
        return hHd_ret;
    }
}
...
static HI_VOID Venc_ISR( HI_VOID )
{
	...
	{
       HI_ERR_VENC("%s, no such channel:0x%x\n", __func__, VeduIpCtx.CurrHandle);
	   return;
	}
...
//	pEncPara->CanBeDestroy = HI_FALSE;
 ...
 //       pAllReg->VEDU_VCPI_REGS.VEDU_SOFT.bits.vedu_soft_rst = 0x1;//2015/07/18 软复位
    ...
    {
        HI_DBG_VENC("slice in ,SliceIrqNum:%d\n",pEncPara->stStat.u32SliceIrqNum);
        ...
        for (i = pEncPara->iLastEncodedStreamCnt; i < pEncPara->iSliceSplitNum; i++)
        {
            ...
            HI_DBG_VENC("Streambuffer:%d  Data length:%d \n",i,pEncPara->stStream_OMX[i].data_len);
            ...
            {
                HI_ERR_VENC("put stream error\n");
            }
            pEncPara->iCurrentStreamCnt--;
            HI_DBG_VENC("slice isr output done!!!\n");

        }
        pEncPara->iLastEncodedStreamCnt = i;

        HI_DBG_VENC("pEncPara->iLastEncodedStreamCnt:%d \n",pEncPara->iLastEncodedStreamCnt);
#endif
...
//#endif
    ...
    if (VencEndOfPic) //帧级中断  pAllReg->VEDU_RAWINT.bits.VencEndOfPic
    {
        ...
        *pINTCLR = 0xFFFFFFFF;
        ...
        {
            Venc_Regulator_Disable(HI_FALSE);
            b_Regular_down_flag = HI_TRUE;
            HI_DBG_VENC("hardware power down!!!\n");
        }
#endif
...
#endif
        HI_DBG_VENC("fill buffer done, VencBufFull:%d\n",pEncPara->VencBufFull);
        ...
        if (VeduIpCtx.IpFree)
        {
           ...
           // VENC_DRV_OsalLock( VeduIpCtx.pChnLock, &flag);
            ...
            if (EncHandle != (HI_HANDLE)NULL)
            {
                ...
                if (pEncPara->IntraPic ||pEncPara->InterFrmCnt == 0)
                {
                    HI_DBG_VENC("check in task pEncPara->IntraPic :%d pEncPara->InterFrmCnt :%d\n",
                                pEncPara->IntraPic ,pEncPara->InterFrmCnt );
                    check_enc_para(pEncPara->pstCfg_EncPara,pEncPara->IntraPic);
                }
                ...
                HI_DBG_VENC("%s, pEncPara->stStat.StartVencNumInTask:%d\n", __func__, pEncPara->stStat.StartVencNumInTask);

                VENC_DRV_EflStartVencByReg( EncHandle );
                pEncPara->CalcMd5Flag = 0;
                HI_DBG_VENC("%s, start venc in task\n", __func__);
            }
        }
