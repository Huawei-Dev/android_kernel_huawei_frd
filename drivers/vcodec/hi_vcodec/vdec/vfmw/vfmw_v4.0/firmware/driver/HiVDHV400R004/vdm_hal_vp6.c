...
SINT32 VP6HAL_StartDec(VP6_DEC_PARAM_S *pVp6DecParam, SINT32 VdhId)
{
    ...
    /* 2.  ?????(???????) */
    VP6HAL_CfgReg(pVp6DecParam, pHwMem, VdhId);

    /* 3.  ??????? */
    VP6HAL_CfgDnMsg(pVp6DecParam, pHwMem , VdhId);
...
SINT32 VP6HAL_CfgReg(VP6_DEC_PARAM_S *pVp6DecParam, VDMHAL_HWMEM_S *pHwMem , SINT32 VdhId)
{
    ...
    //BASIC_CFG0
    D32 = 0;
    ((BASIC_CFG0 *)(&D32))->mbamt_to_dec      = pVp6DecParam->PicWidthInMb * pVp6DecParam->PicHeightInMb - 1;
    ...
    //BASIC_CFG1
    D32 = 0x20000000;
    ((BASIC_CFG1 *)(&D32))->video_standard    = 0xA;
    ((BASIC_CFG1 *)(&D32))->ddr_stride        = pVp6DecParam->VahbStride >> 6;
    ...
    ((BASIC_CFG1 *)(&D32))->compress_en       = pVp6DecParam->Compress_en;
    ...
    //STREAM_BASE_ADDR
    D32 = 0;
    ((STREAM_BASE_ADDR *)(&D32))->stream_base_addr = pVp6DecParam->StreamBaseAddr;
    WR_VREG( VREG_STREAM_BASE_ADDR, D32, VdhId);
    dprint(PRN_VDMREG, "STREAM_BASE_ADDR = 0x%x\n", D32);

    //PPFD_BUF_ADDR
    D32 = 0;
    ((PPFD_BUF_ADDR *)(&D32))->ppfd_buf_addr = pHwMem->PpfdBufAddr & 0xFFFFFFF0;
    WR_VREG( VREG_PPFD_BUF_ADDR, D32, VdhId );
    dprint(PRN_VDMREG, "PPFD_BUF_ADDR = 0x%x\n", D32);

    //PPFD_BUF_LEN
    D32 = 0;
    ((PPFD_BUF_LEN *)(&D32))->ppfd_buf_len = pHwMem->PpfdBufLen;
    ...
    //YSTADDR_1D
    D32 = 0;
    ((YSTADDR_1D *)(&D32))->ystaddr_1d = pVp6DecParam->image_curr_recon_addr & 0xFFFFFFF0;
    ...
    ((UVOFFSET_1D *)(&D32))->uvoffset_1d = (pVp6DecParam->VahbStride) * (((pVp6DecParam->PicHeightInMb + 1) / 2) * 2)
...
SINT32 VP6HAL_CfgDnMsg(VP6_DEC_PARAM_S *pVp6DecParam, VDMHAL_HWMEM_S *pHwMem , SINT32 VdhId)
{
    ...
    D32 = 0;
    p32 = pMsgBase;
    ((VP6_DWNMSG_D0 *)(&D32))->pic_coding_type	= pVp6DecParam->FrameType;
    //((VP6_DWNMSG_D0*)(&D32))->RefreshGoldenFrame = pVp6DecParam->RefreshGoldenFrame;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D1 *)(&D32))->pic_width_in_mb    = pVp6DecParam->PicWidthInMb - 1;
    ((VP6_DWNMSG_D1 *)(&D32))->pic_height_in_mb   = pVp6DecParam->PicHeightInMb - 1;
    ((VP6_DWNMSG_D1 *)(&D32))->reserved1 = 0;
    ((VP6_DWNMSG_D1 *)(&D32))->reserved0 = 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D2 *)(&D32))->Vp3VersionNo  		= pVp6DecParam->Vp3VersionNo;
    ((VP6_DWNMSG_D2 *)(&D32))->VpProfile				= pVp6DecParam->VpProfile;
    ((VP6_DWNMSG_D2 *)(&D32))->MultiStream			= pVp6DecParam->MultiStream;
    ((VP6_DWNMSG_D2 *)(&D32))->UseHuffman			= pVp6DecParam->UseHuffman;
    ((VP6_DWNMSG_D2 *)(&D32))->UseLoopFilter			= (pVp6DecParam->UseLoopFilter >> 1) & 1;
    //((VP6_DWNMSG_D2*)(&D32))->ScalingMode			= pVp6DecParam->ScalingMode;
    ((VP6_DWNMSG_D2 *)(&D32))->reserved				= 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D3 *)(&D32))->PredictionFilterAlpha = pVp6DecParam->PredictionFilterAlpha;
    ((VP6_DWNMSG_D3 *)(&D32))->PredictionFilterMvSizeThresh = pVp6DecParam->PredictionFilterMvSizeThresh;
    ((VP6_DWNMSG_D3 *)(&D32))->PredictionFilterVarThresh = pVp6DecParam->PredictionFilterVarThresh;
    ((VP6_DWNMSG_D3 *)(&D32))->PredictionFilterMode = pVp6DecParam->PredictionFilterMode;
    ((VP6_DWNMSG_D3 *)(&D32))->reserved = 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D4 *)(&D32))->FLimit = pVp6DecParam->FLimit;
    ((VP6_DWNMSG_D4 *)(&D32))->DcQuant = pVp6DecParam->DcQuant;
    ((VP6_DWNMSG_D4 *)(&D32))->AcQuant = pVp6DecParam->AcQuant;
    ((VP6_DWNMSG_D4 *)(&D32))->reserved = 0;
    WR_MSGWORD( p32, D32 );
    ...
    p32 += 4;
    D32 = 0;
    ((VP6_DWNMSG_D8 *)(&D32))->value = pVp6DecParam->value;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D9 *)(&D32))->range = pVp6DecParam->range;
    ((VP6_DWNMSG_D9 *)(&D32))->count = pVp6DecParam->count;
    ((VP6_DWNMSG_D9 *)(&D32))->reserved0 = 0;
    ((VP6_DWNMSG_D9 *)(&D32))->reserved1 = 0;
    WR_MSGWORD( p32, D32 );
    ...
    p32 += 7;
    D32 = 0;
    ((VP6_DWNMSG_D16 *)(&D32))->bit0_len_0 = D16_bit_len_0; //pVp6DecParam->bit0_len_0;  //pAvsDecParam->CurPicAddr & 0xFFFFFFF0;
    ((VP6_DWNMSG_D16 *)(&D32))->bit0_offset_0 = D16_bit_offset_0; //pVp6DecParam->bit0_offset_0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D17 *)(&D32))->bit0_stream_addr_0   = D17_bit_byte_offset_0; //pVp6DecParam->bit0_stream_addr_0;
    ((VP6_DWNMSG_D17 *)(&D32))->reserved = 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D18 *)(&D32))->bit0_len_1    = pVp6DecParam->bit0_len_1;
    ((VP6_DWNMSG_D18 *)(&D32))->bit0_offset_1 = pVp6DecParam->bit0_offset_1;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D19 *)(&D32))->bit0_stream_addr_1 = pVp6DecParam->bit0_stream_addr_1;
    ((VP6_DWNMSG_D19 *)(&D32))->reserved = 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D20 *)(&D32))->bit1_len_0    = pVp6DecParam->bit1_len_0;
    ((VP6_DWNMSG_D20 *)(&D32))->bit1_offset_0 = pVp6DecParam->bit1_offset_0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D21 *)(&D32))->bit1_stream_addr_0 = pVp6DecParam->bit1_stream_addr_0;
    ((VP6_DWNMSG_D21 *)(&D32))->reserved = 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D22 *)(&D32))->bit1_len_1    = pVp6DecParam->bit1_len_1;
    ((VP6_DWNMSG_D22 *)(&D32))->bit1_offset_1 = pVp6DecParam->bit1_offset_1;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D23 *)(&D32))->bit1_stream_addr_1 = pVp6DecParam->bit1_stream_addr_1;
    ((VP6_DWNMSG_D23 *)(&D32))->reserved = 0;
    WR_MSGWORD( p32, D32 );
    ...
    p32 += 9;
    D32 = 0;
    ((VP6_DWNMSG_D32 *)(&D32))->curr_rcn_addr =
    ...
    p32 += 2;
    D32 = 0;
    ((VP6_DWNMSG_D34 *)(&D32))->golden_ref_addr =
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D35 *)(&D32))->last_ref_addr =
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D36 *)(&D32))->sed_top_addr =
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D37 *)(&D32))->pmv_top_addr =
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D38 *)(&D32))->rcn_top_addr =
    ...
    ++p32;
    D32 = 0;
    ((VP6_DWNMSG_D39 *)(&D32))->tab_addr =
        (pHwMem->Vp6TabAddr + 0xF) & 0xFFFFFFF0;//FIXME: ;//pVp6DecParam->tab_addr;
    WR_MSGWORD( p32, D32 );
    dprint(PRN_DNMSG, "D39 = 0x%x\n", D32);

    tmpAddr = TabBaseAddr = (UINT8 *)MEM_Phy2Vir(((VP6_DWNMSG_D39 *)(&D32))->tab_addr);
    ...
    {
        TabBaseAddr = (UINT8 *)MEM_Phy2Vir(((VP6_DWNMSG_D39 *)(&D32))->tab_addr) + 0x300;
    ...
    TabBaseAddr = (UINT8 *)MEM_Phy2Vir(((VP6_DWNMSG_D39 *)(&D32))->tab_addr) + 0xA00;
    ...
    TabBaseAddr = (UINT8 *)MEM_Phy2Vir(((VP6_DWNMSG_D39 *)(&D32))->tab_addr) + 0x800 + 0x300;
