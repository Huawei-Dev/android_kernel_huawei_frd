...
SINT32 MP2HAL_CfgReg(MP2_DEC_PARAM_S *pMp2DecParam, VDMHAL_HWMEM_S *pHwMem, SINT32 VdhId, UINT32 *StreamBaseAddr);
...
SINT32 MP2HAL_StartDec( MP2_DEC_PARAM_S *pMp2DecParam, SINT32 VdhId)
{
    ...
    if (VDMHAL_OK != MP2HAL_CfgReg(pMp2DecParam, pHwMem, VdhId, &StreamBaseAddr))
    {
        dprint(PRN_ERROR, "MP2HAL_CfgReg ERROR!\n");
        return VDMHAL_ERR;
    }

    MP2HAL_CfgDnMsg(pMp2DecParam, pHwMem, VdhId, StreamBaseAddr);
...
SINT32 MP2HAL_CfgReg(MP2_DEC_PARAM_S *pMp2DecParam, VDMHAL_HWMEM_S *pHwMem, SINT32 VdhId, UINT32 *StreamBaseAddr)
{
    ...
    D32 = 0;
    ((BASIC_CFG0 *)(&D32))->mbamt_to_dec         = pMp2DecParam->PicWidthInMb * pMp2DecParam->PicHeightInMb - 1;
    ...
    ((BASIC_CFG1 *)(&D32))->ddr_stride           = pMp2DecParam->VahbStride >> 6;
    ...
    ((BASIC_CFG1 *)(&D32))->compress_en = pMp2DecParam->Compress_en;
    ...
    D32 = 0;
    ((YSTADDR_1D *)(&D32))->ystaddr_1d = pMp2DecParam->CurPicPhyAddr & 0xFFFFFFF0;
    ...
    ((YSTRIDE_1D *)(&D32))->ystride_1d = pMp2DecParam->VahbStride;//pMp2DecParam->VahbStride*32;
    WR_VREG( VREG_YSTRIDE_1D, D32, VdhId );
	
    D32 = 0;
	level = 0;

    ((UVOFFSET_1D *)(&D32))->uvoffset_1d = (pMp2DecParam->VahbStride) * ((height_in_mb + 1) / 2) * 2
            + ((height_in_mb * 16 + 31) / 32) * 32 * level;
    WR_VREG( VREG_UVOFFSET_1D, D32, VdhId );

    D32 = 0;
    ((REF_PIC_TYPE *)(&D32))->ref_pic_type_0 = pMp2DecParam->FwdRefIsFldSave;
    ((REF_PIC_TYPE *)(&D32))->ref_pic_type_1 = pMp2DecParam->BwdRefIsFldSave;
