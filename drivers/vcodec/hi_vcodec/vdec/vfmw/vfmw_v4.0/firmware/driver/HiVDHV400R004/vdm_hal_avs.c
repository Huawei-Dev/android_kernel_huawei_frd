...
/*  函数实现                                                            */
/************************************************************************/
SINT32 AVSHAL_WirteSlicMsg(AVS_DEC_PARAM_S *pAvsDecParam, UADDR stream_base_addr, SINT32 VdhId);
...
SINT32 AVSHAL_StartDec(AVS_DEC_PARAM_S *pAvsDecParam, SINT32 VdhId)
{
    ...
    //BASIC_CFG0
    D32 = 0;
    ((BASIC_CFG0 *)(&D32))->mbamt_to_dec         = pAvsDecParam->PicWidthInMb * pAvsDecParam->PicHeightInMb - 1;
    ...
    //BASIC_CFG1
    D32 = 0x30000000;
    ((BASIC_CFG1 *)(&D32))->video_standard = 0x6;
    ((BASIC_CFG1 *)(&D32))->ddr_stride     = pAvsDecParam->VahbStride >> 6;
    ...
    //AVM_ADDR
    D32 = 0;
    ((AVM_ADDR *)(&D32))->av_msg_addr = g_HwMem[VdhId].MsgSlotAddr[DN_MSG_SLOT_INDEX] & 0xFFFFFFF0;
    WR_VREG( VREG_AVM_ADDR, D32, VdhId);
    dprint(PRN_VDMREG, "AVM_ADDR = 0x%x\n", D32);

    //VAM_ADDR
    D32 = 0;
    ((VAM_ADDR *)(&D32))->va_msg_addr = g_HwMem[VdhId].MsgSlotAddr[UP_MSG_SLOT_INDEX] & 0xFFFFFFF0;
    WR_VREG( VREG_VAM_ADDR, D32, VdhId );
    dprint(PRN_VDMREG, "VAM_ADDR = 0x%x\n", D32);

    //STREAM_BASE_ADDR
    D32 = 0;
    ((STREAM_BASE_ADDR *)(&D32))->stream_base_addr = stream_base_addr;
    ...
    //YSTADDR_1D
    D32 = 0;
    ((YSTADDR_1D *)(&D32))->ystaddr_1d = pAvsDecParam->CurPicAddr & 0xFFFFFFF0;
    ...
    ((YSTRIDE_1D *)(&D32))->ystride_1d = pAvsDecParam->VahbStride; //pAvsDecParam->VahbStride*32;
    ...
    ((UVOFFSET_1D *)(&D32))->uvoffset_1d = (pAvsDecParam->VahbStride) * (((height_in_mb + 1) / 2) * 2)
    ...
    WR_VREG( VREG_REF_PIC_TYPE, D32, VdhId );
    dprint(PRN_VDMREG, "VREG_REF_PIC_TYPE = 0x%x\n", D32);

    //FF_APT_EN
    D32 = 0; //USE_FF_APT_EN;  // 0:frm save, 1:apt save  //AVS固定帧存,以保证安全. z56361, 2011-3-25
    WR_VREG( VREG_FF_APT_EN, D32, VdhId );
    ...
    /* 3.  配置下行消息池 */
    pMsgBase = (SINT32 *)MEM_Phy2Vir(g_HwMem[VdhId].MsgSlotAddr[DN_MSG_SLOT_INDEX]);

    VDMHAL_ASSERT_RET( pMsgBase != NULL, "can not map down msg virtual address!");
    // D0
    p32 = pMsgBase;
    ((AVS_DWNMSG_D0 *)(&D32))->pic_width_in_mb  = pAvsDecParam->PicWidthInMb - 1;
    ((AVS_DWNMSG_D0 *)(&D32))->pic_height_in_mb = pAvsDecParam->PicHeightInMb - 1;
    ((AVS_DWNMSG_D0 *)(&D32))->chroma_format = pAvsDecParam->ChromaFormat;
    ((AVS_DWNMSG_D0 *)(&D32))->sample_precision = pAvsDecParam->SamplePrecision;
    ((AVS_DWNMSG_D0 *)(&D32))->rsv0 = 0;
    ((AVS_DWNMSG_D0 *)(&D32))->rsv1 = 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D1 *)(&D32))->progressive_frame   = pAvsDecParam->ProgrsvFrame;
    ((AVS_DWNMSG_D1 *)(&D32))->picture_structure   = pAvsDecParam->PicStruct;
    ((AVS_DWNMSG_D1 *)(&D32))->pic_coding_type     = pAvsDecParam->PicCodingType;
    ((AVS_DWNMSG_D1 *)(&D32))->top_field_first     = pAvsDecParam->TopFieldFirst;
    ((AVS_DWNMSG_D1 *)(&D32))->repeat_first_field  = pAvsDecParam->RepeatFirstField;
    ((AVS_DWNMSG_D1 *)(&D32))->fix_qp              = pAvsDecParam->FixQPFlag;
    ((AVS_DWNMSG_D1 *)(&D32))->pic_qp              = pAvsDecParam->PicQuant;
    ((AVS_DWNMSG_D1 *)(&D32))->skip_mode_flag      = pAvsDecParam->SkipModeFlag;
    ((AVS_DWNMSG_D1 *)(&D32))->ad_pred_mode_disable = pAvsDecParam->AdvPredModeDisable;
    ((AVS_DWNMSG_D1 *)(&D32))->pic_ref_flag        = pAvsDecParam->PicRefFlag;
    ((AVS_DWNMSG_D1 *)(&D32))->no_fwd_ref_flag     = pAvsDecParam->NoFwdRefFlag;
    ((AVS_DWNMSG_D1 *)(&D32))->rsv = 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D2 *)(&D32))->loop_flt_disable    = pAvsDecParam->LoopFiltDisable;
    ((AVS_DWNMSG_D2 *)(&D32))->loop_flt_para_flag  = pAvsDecParam->LoopFiltParamFlag;
    ((AVS_DWNMSG_D2 *)(&D32))->alpha_c_offset      = pAvsDecParam->AlphaOffset;
    ((AVS_DWNMSG_D2 *)(&D32))->beta_offset         = pAvsDecParam->BetaOffset;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D3 *)(&D32))->fwd_top_field_first_0 = pAvsDecParam->FwdTopFieldFirst0;
    ((AVS_DWNMSG_D3 *)(&D32))->fwd_picture_structure_0 = pAvsDecParam->FwdPicStruct0;
    ((AVS_DWNMSG_D3 *)(&D32))->fwd_top_field_first_1 = pAvsDecParam->FwdTopFieldFirst1;
    ((AVS_DWNMSG_D3 *)(&D32))->fwd_picture_structure_1 = pAvsDecParam->FwdPicStruct1;
    ((AVS_DWNMSG_D3 *)(&D32))->bwd_top_field_first = pAvsDecParam->BwdTopFieldFirst;
    ((AVS_DWNMSG_D3 *)(&D32))->bwd_picture_structure = pAvsDecParam->BwdPicStruct;
    ((AVS_DWNMSG_D3 *)(&D32))->rsv = 0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D4 *)(&D32))->bwd_address = (pAvsDecParam->BwdRefPicAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D5 *)(&D32))->fwd_address_0 = (pAvsDecParam->FwdRefPic0Addr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D6 *)(&D32))->fwd_address_1 = (pAvsDecParam->FwdRefPic1Addr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D7 *)(&D32))->rcn_address = (pAvsDecParam->rcn_address + 0xF) & 0xFFFFFFF0; //pAvsDecParam->CurPicAddr & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D8 *)(&D32))->col_pic_type   = pAvsDecParam->ColPicType;
    ((AVS_DWNMSG_D8 *)(&D32))->col_pic_struct = pAvsDecParam->ColPicStruct;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D9 *)(&D32))->bit_stream_address_0 = pAvsDecParam->StreamPhyAddr[0];
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D10 *)(&D32))->bit_len_0    = pAvsDecParam->StreamLength[0];
    ((AVS_DWNMSG_D10 *)(&D32))->bit_offset_0 = pAvsDecParam->StreamBitOffset[0];
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D11 *)(&D32))->bit_stream_address_1 = pAvsDecParam->StreamPhyAddr[1];
    WR_MSGWORD( p32, D32 );
    ...
    D32 = 0;
#if 1
    ((AVS_DWNMSG_D12 *)(&D32))->weighting_quant_flag        = pAvsDecParam->weighting_quant_flag;
    ((AVS_DWNMSG_D12 *)(&D32))->chroma_quant_param_disable  = pAvsDecParam->chroma_quant_param_disable;
    ((AVS_DWNMSG_D12 *)(&D32))->chroma_quant_param_delta_v  = pAvsDecParam->chroma_quant_param_delta_v;
    ((AVS_DWNMSG_D12 *)(&D32))->chroma_quant_param_delta_u  = pAvsDecParam->chroma_quant_param_delta_u;
    ((AVS_DWNMSG_D12 *)(&D32))->aec_enable                  = pAvsDecParam->aec_enable;
    ((AVS_DWNMSG_D12 *)(&D32))->p_filed_enhanced_flag       = pAvsDecParam->p_filed_enhanced_flag;
    ((AVS_DWNMSG_D12 *)(&D32))->b_filed_enhanced_flag       = pAvsDecParam->b_filed_enhanced_flag;
#endif
#if 0
    ((AVS_DWNMSG_D12 *)(&D32))->bit_len_1    = pAvsDecParam->StreamLength[1];
    ((AVS_DWNMSG_D12 *)(&D32))->bit_offset_1 = pAvsDecParam->StreamBitOffset[1];
#endif
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D13 *)(&D32))->pmv_top_addr = (g_HwMem[VdhId].PmvTopAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D14 *)(&D32))->topmb_intra_addr = (g_HwMem[VdhId].RcnTopAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((AVS_DWNMSG_D16 *)(&D32))->colpic_mv_addr = (pAvsDecParam->ColPmvAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    p32 = pMsgBase + 49;
    D32 = 0;
    ((AVS_DWNMSG_D49 *)(&D32))->pmv_colmb_addr = (pAvsDecParam->CurPmvAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    p32 = pMsgBase + 50;
    D32 = 0;
    ((AVS_DWNMSG_D50 *)(&D32))->dblk_top_addr = (g_HwMem[VdhId].DblkTopAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    dprint(PRN_DNMSG, "D50 = 0x%x\n", D32);
    // D51
    p32 = pMsgBase + 51;
    D32 = 0;
    ((AVS_DWNMSG_D51 *)(&D32))->sed_top_addr = (g_HwMem[VdhId].SedTopAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    dprint(PRN_DNMSG, "D51 = 0x%x\n", D32);

    // D63
    p32 = pMsgBase + 63;
    D32 = g_HwMem[VdhId].MsgSlotAddr[DN_MSG_SLOT_INDEX] + (64 + WQNUM) * 4; //g_HwMem.MsgSlotAddr[DN_MSG_SLOT_INDEX+1];// + 64*sizeof(UINT32);
    WR_MSGWORD( p32, D32 );
...
#endif
    s32Ret = AVSHAL_WirteSlicMsg(pAvsDecParam, stream_base_addr, VdhId);
...
SINT32 AVSHAL_WirteSlicMsg(AVS_DEC_PARAM_S *pAvsDecParam, UADDR stream_base_addr, SINT32 VdhId)
{
    ...
    MsgBlockPhy = g_HwMem[VdhId].MsgSlotAddr[DN_MSG_SLOT_INDEX] + 4 * (64 + WQNUM);
    pMsgBase = (SINT32 *)MEM_Phy2Vir(g_HwMem[VdhId].MsgSlotAddr[DN_MSG_SLOT_INDEX]);
    VDMHAL_ASSERT_RET( pMsgBase != NULL, "can not map down msg virtual address!");
