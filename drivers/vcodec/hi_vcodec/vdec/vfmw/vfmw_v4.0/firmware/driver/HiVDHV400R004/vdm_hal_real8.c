...
VOID RV8HAL_WriteReg(VDMHAL_HWMEM_S *pHwMem, RV8_DEC_PARAM_S *pRv8DecParam, SINT32 VdhId);
...
SINT32 RV8HAL_StartDec( RV8_DEC_PARAM_S *pRv8DecParam, SINT32 VdhId )
{
    ...
    RV8HAL_WriteReg(pHwMem, pRv8DecParam, VdhId);
    RV8HAL_WritePicMsg(pHwMem, pRv8DecParam);
    RV8HAL_WriteSliceMsg(pHwMem, pRv8DecParam);
...
VOID RV8HAL_WriteReg(VDMHAL_HWMEM_S *pHwMem, RV8_DEC_PARAM_S *pRv8DecParam, SINT32 VdhId)
{
    ...
    D32 = 0;
    ((RV8_BASIC_CFG0 *)(&D32))->mbamt_to_dec         = pRv8DecParam->PicWidthInMb * pRv8DecParam->PicHeightInMb - 1;
    ...
    ((RV8_BASIC_CFG1 *)(&D32))->ddr_stride           = pRv8DecParam->DDRStride >> 6;
    ((RV8_BASIC_CFG1 *)(&D32))->fst_slc_grp          = pRv8DecParam->FstSlcGrp;
    if (pRv8DecParam->PicCodingType == 0 || pRv8DecParam->PicCodingType == 1 || pRv8DecParam->PicCodingType == 3)
    {
        ((RV8_BASIC_CFG1 *)(&D32))->mv_output_en     = 1;
    }
    else
    {
        ((RV8_BASIC_CFG1 *)(&D32))->mv_output_en     = 0;
    }
    ((RV8_BASIC_CFG1 *)(&D32))->uv_order_en          = 0;
    ((RV8_BASIC_CFG1 *)(&D32))->vdh_2d_en            = 1;
    ((RV8_BASIC_CFG1 *)(&D32))->max_slcgrp_num       = 0;
    ((RV8_BASIC_CFG1 *)(&D32))->line_num_output_en   = 0;
    ((RV8_BASIC_CFG1 *)(&D32))->compress_en          = pRv8DecParam->Compress_en;
    ...
    //AVM_ADDR
    D32 = 0;
    ((RV8_AVM_ADDR *)(&D32))->av_msg_addr = pHwMem->MsgSlotAddr[DN_MSG_SLOT_INDEX] & 0xFFFFFFF0;
    WR_VREG( VREG_AVM_ADDR, D32, VdhId );
    dprint(PRN_VDMREG, "AVM_ADDR=0x%x\n", D32);

    //VAM_ADDR
    D32 = 0;
    ((RV8_VAM_ADDR *)(&D32))->va_msg_addr = pHwMem->MsgSlotAddr[UP_MSG_SLOT_INDEX] & 0xFFFFFFF0;
    WR_VREG( VREG_VAM_ADDR, D32, VdhId );
    dprint(PRN_VDMREG, "VAM_ADDR=0x%x\n", D32);

    //STREAM_BASE_ADDR
    D32 = 0;
    ((RV8_STREAM_BASE_ADDR *)(&D32))->stream_base_addr = pRv8DecParam->StreamBaseAddr;
...
VOID RV8HAL_WritePicMsg(VDMHAL_HWMEM_S *pHwMem, RV8_DEC_PARAM_S *pRv8DecParam)
{
    ...
    pMsgBase = (SINT32 *)MEM_Phy2Vir(pHwMem->MsgSlotAddr[DN_MSG_SLOT_INDEX] & 0xFFFFFFF0);
    VDMHAL_ASSERT(NULL != pMsgBase, "can not map dn msg virtual address!\n");

    /* D0 */
    p32 = pMsgBase;
    D32 = 0;
    ((RV8_PICDNMSG_D0 *)(&D32))->pic_coding_type = pRv8DecParam->PicCodingType;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D1 *)(&D32))->pic_width_in_mb = pRv8DecParam->PicWidthInMb - 1;
    ((RV8_PICDNMSG_D1 *)(&D32))->pic_height_in_mb = pRv8DecParam->PicHeightInMb - 1;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D2 *)(&D32))->Ratio0 = pRv8DecParam->Ratio0;
    ((RV8_PICDNMSG_D2 *)(&D32))->Ratio1 = pRv8DecParam->Ratio1;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D3 *)(&D32))->rv_deblocking_strength = RV8_Default_Deblocking_Strength;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D4 *)(&D32))->currpicqp = pRv8DecParam->PQUANT;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D5 *)(&D32))->prevpicqp = pRv8DecParam->PrevPicQP;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D6 *)(&D32))->prevpicmb0qp = pRv8DecParam->PrevPicMb0QP;
    WR_MSGWORD( p32, D32 );
    ...
    p32 = pMsgBase + 16;
    D32 = 0;
    ((RV8_PICDNMSG_D16 *)(&D32))->curr_rcn_addr = (pRv8DecParam->DispFramePhyAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D17 *)(&D32))->fwd_ref_addr = (pRv8DecParam->FwdRefPhyAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D18 *)(&D32))->bwd_ref_addr = (pRv8DecParam->BwdRefPhyAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D19 *)(&D32))->curr_colmb_addr = (pRv8DecParam->CurrPmvPhyAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D20 *)(&D32))->bwd_colmb_addr = (pRv8DecParam->ColPmvPhyAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D21 *)(&D32))->sed_top_addr = (pHwMem->SedTopAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D22 *)(&D32))->pmv_top_addr = (pHwMem->PmvTopAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D23 *)(&D32))->rcn_top_addr = (pHwMem->RcnTopAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    ++p32;
    D32 = 0;
    ((RV8_PICDNMSG_D24 *)(&D32))->dblk_top_addr = (pHwMem->DblkTopAddr + 0xF) & 0xFFFFFFF0;
    WR_MSGWORD( p32, D32 );
    ...
    p32 = pMsgBase + 63;
    D32 = 0;
    ((RV8_PICDNMSG_D63 *)(&D32))->next_slice_para_addr = (pHwMem->MsgSlotAddr[DN_MSG_SLOT_INDEX] & 0xFFFFFFF0) + 4 * 64;
    WR_MSGWORD( p32, D32 );
...
VOID RV8HAL_WriteSliceMsg(VDMHAL_HWMEM_S * pHwMem, RV8_DEC_PARAM_S * pRv8DecParam)
{
    ...
    MsgBlockPhy = (pHwMem->MsgSlotAddr[DN_MSG_SLOT_INDEX] & 0xFFFFFFF0) + 4 * 64;
    ...
    if (pRv8DecParam->SliceParam[0].first_mb_in_slice != 0)
    {
        ...
        /* D0 */
        D32 = 0;
        ((RV8_SLCDNMSG_D0 *)(&D32))->bit_len_0 = 0;
        ((RV8_SLCDNMSG_D0 *)(&D32))->bit_offset_0 = pSliceParam[i].StreamBitOffset[0];
        WR_MSGWORD( pMsgBase + i * 64, D32 );
        dprint(PRN_DNMSG, "D0 = 0x%x\n", D32);
        /* D1 */
        D32 = 0;
        ((RV8_SLCDNMSG_D1 *)(&D32))->bit_stream_addr_0 = pSliceParam[i].StreamPhyAddr[0];
        WR_MSGWORD( pMsgBase + 1 + i * 64, D32 );
        dprint(PRN_DNMSG, "D1 = 0x%x\n", D32);
        /* D2 */
        D32 = 0;
        ((RV8_SLCDNMSG_D2 *)(&D32))->bit_len_1 = 0;
        ((RV8_SLCDNMSG_D2 *)(&D32))->bit_offset_1 = pSliceParam[i].StreamBitOffset[1];
        WR_MSGWORD( pMsgBase + 2 + i * 64, D32 );
        dprint(PRN_DNMSG, "D2 = 0x%x\n", D32);
        /* D3 */
        D32 = 0;
        ((RV8_SLCDNMSG_D3 *)(&D32))->bit_stream_addr_1 = pSliceParam[i].StreamPhyAddr[1];
        WR_MSGWORD( pMsgBase + 3 + i * 64, D32 );
        dprint(PRN_DNMSG, "D3 = 0x%x\n", D32);
        /* D4 */
        D32 = 0;
        ((RV8_SLCDNMSG_D4 *)(&D32))->dblk_filter_passthrough = pSliceParam[i].dblk_filter_passthrough;
        ((RV8_SLCDNMSG_D4 *)(&D32))->osvquant = pSliceParam[i].osvquant;
        ((RV8_SLCDNMSG_D4 *)(&D32))->sliceqp = pSliceParam[i].sliceqp;
        WR_MSGWORD( pMsgBase + 4 + i * 64, D32 );
        dprint(PRN_DNMSG, "D4 = 0x%x\n", D32);
        /* D5 */
        D32 = 0;
        ((RV8_SLCDNMSG_D5 *)(&D32))->slice_start_mbn = 0;
        ((RV8_SLCDNMSG_D5 *)(&D32))->slice_end_mbn = pSliceParam[i].first_mb_in_slice - 1;
        WR_MSGWORD( pMsgBase + 5 + i * 64, D32 );
        dprint(PRN_DNMSG, "D5 = 0x%x\n", D32);

        /* D63 */
        D32 = 0;
        ((RV8_SLCDNMSG_D63 *)(&D32))->next_slice_para_addr = MsgBlockPhy + (i + 1) * 4 * 64;
    ...
    for (i = 0; i < pRv8DecParam->TotalSliceNum; i++)
    {
        ...
        /* D0 */
        D32 = 0;
        ((RV8_SLCDNMSG_D0 *)(&D32))->bit_len_0 = pSliceParam[i].StreamLength[0];
        ((RV8_SLCDNMSG_D0 *)(&D32))->bit_offset_0 = pSliceParam[i].StreamBitOffset[0];
        ...
        /* D2 */
        D32 = 0;
        ((RV8_SLCDNMSG_D2 *)(&D32))->bit_len_1 = pSliceParam[i].StreamLength[1];
        ((RV8_SLCDNMSG_D2 *)(&D32))->bit_offset_1 = pSliceParam[i].StreamBitOffset[1];
        ...
        /* D5 */
        D32 = 0;
        ((RV8_SLCDNMSG_D5 *)(&D32))->slice_start_mbn = pSliceParam[i].first_mb_in_slice;
        ...
        ((RV8_SLCDNMSG_D5 *)(&D32))->slice_end_mbn = pSliceParam[i].last_mb_in_slice;
        ...
        /* D63 */
        D32 = 0;
        ((RV8_SLCDNMSG_D63 *)(&D32))->next_slice_para_addr = next_slice_para_addr;
