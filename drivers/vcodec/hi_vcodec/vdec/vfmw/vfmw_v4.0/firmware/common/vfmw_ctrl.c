...
/*if user create channel with eCapLevel != CAP_LEVEL_USER_DEFINE_WITH_OPTION , flag should be 1 and option is classic to avoid error; if eCapLevel == CAP_LEVEL_USER_DEFINE_WITH_OPTION, it means
user could create channel with all kinds of option*/
