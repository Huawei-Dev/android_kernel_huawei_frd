...
{
    //we use reset value here, if not, same value should be configed after GlbReset.
	//WR_VREG( VREG_CRG_CLK_EN,  CRG_CLK_EN_DEFAULT_VALUE,  VdhId );
	//WR_VREG( VREG_MFDE_CLK_EN, MFDE_CLK_EN_DEFAULT_VALUE, VdhId );
...
SINT32 VDEC_Init(VDEC_OPERATION_S *pArgs)
{
    ...
    g_vdm_hal_fun_ptr.pfun_VDMHAL_GetHalMemSize          = VDMHAL_IMP_GetHalMemSize;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_OpenHAL                = VDMHAL_IMP_OpenHAL;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_CloseHAL               = VDMHAL_IMP_CloseHAL;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_ArrangeMem             = VDMHAL_IMP_ArrangeMem;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_ResetVdm               = VDMHAL_IMP_ResetVdm;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_GlbReset               = VDMHAL_IMP_GlbReset;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_ClearIntState          = VDMHAL_IMP_ClearIntState;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_CheckReg               = VDMHAL_IMP_CheckReg;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_StartHwRepair          = VDMHAL_IMP_StartHwRepair;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_StartHwDecode          = VDMHAL_IMP_StartHwDecode;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_PrepareDec             = VDMHAL_IMP_PrepareDec;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_IsVdmReady             = VDMHAL_IMP_IsVdmReady;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_IsVdmRun               = VDMHAL_IMP_IsVdmRun;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_PrepareRepair          = VDMHAL_IMP_PrepareRepair;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_MakeDecReport          = VDMHAL_IMP_MakeDecReport;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_BackupInfo             = VDMHAL_IMP_BackupInfo;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_GetCharacter           = VDMHAL_IMP_GetCharacter;
    g_vdm_hal_fun_ptr.pfun_VDMHAL_WriteScdEMARID         = VDMHAL_IMP_WriteScdEMARID;
