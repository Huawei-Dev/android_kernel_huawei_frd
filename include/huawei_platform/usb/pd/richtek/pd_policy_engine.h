...
void pe_src_transition_to_default_entry(pd_port_t *pd_port, pd_event_t* pd_event);
...
void pe_src_wait_new_capabilities_entry(pd_port_t *pd_port, pd_event_t* pd_event);
...
void pe_drs_dfp_ufp_evaluate_dr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_drs_dfp_ufp_accept_dr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_drs_dfp_ufp_change_to_ufp_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_drs_dfp_ufp_send_dr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_drs_dfp_ufp_reject_dr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);

void pe_drs_ufp_dfp_evaluate_dr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_drs_ufp_dfp_accept_dr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_drs_ufp_dfp_change_to_dfp_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_drs_ufp_dfp_send_dr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_drs_ufp_dfp_reject_dr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);


/* ---- Policy Engine (PRS) ---- */

void pe_prs_src_snk_evaluate_pr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_src_snk_accept_pr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_src_snk_transition_to_off_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_src_snk_assert_rd_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_src_snk_wait_source_on_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_src_snk_send_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_src_snk_reject_pr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);

void pe_prs_snk_src_evaluate_pr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_snk_src_accept_pr_swap_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_snk_src_transition_to_off_entry(pd_port_t *pd_port, pd_event_t* pd_event);
...
void pe_prs_src_snk_wait_source_on_exit(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_prs_snk_src_transition_to_off_exit(pd_port_t *pd_port, pd_event_t* pd_event);
...
void pe_ufp_vdm_attention_request_entry(pd_port_t *pd_port, pd_event_t* pd_event);
...
void pe_dfp_ufp_vdm_identity_request_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_dfp_ufp_vdm_identity_acked_entry(pd_port_t *pd_port, pd_event_t* pd_event);
void pe_dfp_ufp_vdm_identity_naked_entry(pd_port_t *pd_port, pd_event_t* pd_event);
