...
enum hw_device_type {
    ...
    DEV_CONNECTIVITY_WIFI = DEV_CONNECTIVITY_START, /* 35 */
    DEV_CONNECTIVITY_BT,                            /* 36 */
    DEV_CONNECTIVITY_FM,                            /* 37 */
    DEV_CONNECTIVITY_GPS,                           /* 38 */
    DEV_CONNECTIVITY_GPU,                           /* 39 */
    DEV_CONNECTIVITY_MAX,                           /* 40 */
};
