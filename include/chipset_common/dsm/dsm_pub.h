...
#define DSM_DIRECT_CHARGE_VOL_ACCURACY                (10460)
#define DSM_DIRECT_CHARGE_FULL_PATH_RESISTANCE        (10461)
#define DSM_DIRECT_CHARGE_LOADSWITCH_RESISTANCE       (10462)
#define DSM_DIRECT_CHARGE_USB_PORT_LEAKAGE_CURRENT    (10463)
#define DSM_DIRECT_CHARGE_VBUS_OVP                    (10464)
#define DSM_DIRECT_CHARGE_REVERSE_OCP                 (10465)
#define DSM_DIRECT_CHARGE_OTP                         (10466)
#define DSM_DIRECT_CHARGE_INPUT_OCP                   (10467)
...
#define DSM_TP_HID_TIMEOUT_ERROR_NO         (20012)
#define DSM_TP_STARTUP_FAIDED_ERROR_NO      (20013)
#define DSM_TP_GET_LCD_PANEL_NAME_ERROR_NO  (20014)
...
/* camera hal flash*/
#define DSM_DALLAS_FLASH_SCHARGER_ERROR_NO  (20667)
...
#define DSM_DM_VERITY_FEC_INFO_NO	(22701)
