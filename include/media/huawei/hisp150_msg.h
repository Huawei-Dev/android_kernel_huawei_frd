...
typedef enum
{
    ...
    STREAM_ISP_RAW_OUT,
    STREAM_ISP_YUV_OUT_FD,
    STREAM_ISP_YUV_OUT_DMAP,
...
{
    unsigned short multipass_cost_shift;
    unsigned int multipass_disp_threshold;

    unsigned short inval_disp_conf_threshold;

    unsigned int var_threshold;
    unsigned int var_threshold_low;
    unsigned int var_threshold_mid;
    unsigned int var_gray_threshold_mid;
    unsigned int var_gray_threshold_low;
    unsigned int var_threshold_high;
    unsigned int var_gray_threshold_high;
    unsigned int var_gray_weight;
    unsigned int var_gray_shift;
    ...
    unsigned short robust_x_a;
    unsigned short robust_k_a;
    unsigned short robust_a;
    unsigned short robust_x_b;
    unsigned short robust_k_b;
    unsigned short robust_b;
    unsigned short robust_k_c;
    unsigned short robust_c;

    unsigned int ad_lambda;
    unsigned int census_lambda;

    unsigned short v_mask_max;
    unsigned short h_mask_max;
    unsigned short v_mask_mid;
    unsigned short h_mask_mid;
    unsigned int yuv_threshold_high;
    unsigned int yuv_threshold_edge_high;
    unsigned int yuv_threshold_low;

    unsigned int scanline_yuv_threshold;
    unsigned int scanline_penalty_2;
    unsigned int scanline_penalty_1;
    unsigned int scanline_penalty_mid_2;
    unsigned int scanline_penalty_mid_1;
    unsigned int scanline_penalty_low_2;
    unsigned int scanline_penalty_low_1;
    unsigned short weight_dir7;
    unsigned short weight_dir2;
    unsigned short weight_dir4;
    unsigned short weight_dir0;

    unsigned int conf_cost_threshold;
    unsigned int disp_gap;
    unsigned int disp_gap_ratio;
    unsigned int disp_gap_ratio_shift;
    unsigned int lrcheck_threshold;

    unsigned int conf_low_intercept;
    unsigned int conf_low_slop;
    unsigned int conf_high_intercept;
    unsigned int conf_high_slop;

    int histogram_thres_ratio;
    int histogram_thres_shift;
...
typedef struct _msg_req_dopt_request_t
{
    ...
    unsigned int  output_disp_buffer;
    unsigned int  histogram_enable;
    unsigned int  output_format;
    unsigned int  dfil_horz_en;
    unsigned int  dfil_vert_en;
    unsigned int  double_chech_invalidate;
    unsigned int  dsmth_ref_en;
    unsigned int  dref_loop;
    unsigned int  input_bit_number;
    unsigned int  output_bit_number;
    unsigned int  disp_direction;
    unsigned int  dmap_crop_x;
    unsigned int  dmap_crop_y;
    unsigned int  dmap_crop_width;
    unsigned int  dmap_crop_height;
    //unsigned int  from_dgen;
    unsigned int  algo_cfg_buffer;
...
typedef enum
{
    ...
    SUBCMD_SET_DMAP_ALGO = 132,
    SUBCMD_SET_WARP_GRID = 133,
    SUBCMD_GET_LCD_STATE = 134,
	//tmp
